...
ALTER TABLE TLIST RENAME DESCR_temp TO DESCRIPTION;
ALTER TABLE TLIST ADD MOREPROPS VARCHAR(10000);
ALTER TABLE TSCRIPTS ADD SCRIPTROLE INTEGER;
ALTER TABLE TREPORTPERSONSETTINGS ADD PARAMSETTINGS VARCHAR(10000);

--set the projects directly in TWORKITEM
UPDATE TWORKITEM SET PROJECTKEY=(SELECT max(PROJKEY)
