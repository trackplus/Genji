...
ALTER TABLE TBASELINE DROP FOREIGN KEY CURRENCY;            
ALTER TABLE TNOTIFY DROP FOREIGN KEY THEGROUP;
ALTER TABLE TWORKITEM DROP FOREIGN KEY CURRENCY;
ALTER TABLE TCOST DROP FOREIGN KEY CURRENCY;    
ALTER TABLE TPCURRENCY DROP FOREIGN KEY CURRENCY;

ALTER TABLE TPCURRENCY DROP FOREIGN KEY PROJECTTYPE;
ALTER TABLE TGROUPMEMBER DROP FOREIGN KEY THEGROUP;            
