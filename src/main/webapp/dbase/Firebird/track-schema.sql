...
(
    ...
    CHANGEDESCRIPTION VARCHAR (6000),
    LASTEDIT TIMESTAMP,
    TPUUID VARCHAR (36),
...
(
    ...
    PACKAGEDESCRIPTION VARCHAR (8191),
...
(
    ...
    ALLOWEDEMAILPATTERN VARCHAR (4096),
    ISLDAPON CHAR (1),
...
(
    ...
    FILECONTENT BLOB SUB_TYPE TEXT,
    CHANGEDBY INTEGER,
    LASTEDIT TIMESTAMP,
    TPUUID VARCHAR (36),
    PRIMARY KEY(OBJECTID)
