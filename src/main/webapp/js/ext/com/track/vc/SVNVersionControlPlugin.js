...
Ext.define("js.ext.com.track.vc.SVNVersionControlPlugin",{
	extend:'com.trackplus.vc.VersionControlPlugin',
	accessMethodOptions:[
		{id:'http',label:'http'},
		{id:'https',label:'https'},
		{id:'svn+ssh',label:'svn+ssh'},
		{id:'file',label:'file'}
	],
	...
	createFieldSetGeneral:function(){
		...
		me.txtRepositoryPathWrapper=Ext.create('com.trackplus.util.HelpWrapperComponent',{
			...
			helpStr:getText('plugins.versionControl.repositoryPath.svn.help')
		});
	...
	initPanelPpk:function(){
		...
		me.panelPpk=Ext.create('Ext.panel.Panel',{
			...
			bodyBorder:false,
			layout:'anchor',
			items:[me.txtPpk, me.txtPassphrase]
		});
	},
