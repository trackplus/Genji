...
Ext.define("js.ext.com.track.setter.dateSetter", {
	...
	getSetterValue:function() {
		if (this.value) {
			return Ext.Date.format(this.value, com.trackplus.TrackplusConfig.ISODateFormat);
		}
		return null;
	},
	...
	getSetterDisplayValue:function(){
		if (this.value) {
			return Ext.Date.format(this.value, com.trackplus.TrackplusConfig.DateFormat);
		}
		return null;
		//return this.value;
	}
