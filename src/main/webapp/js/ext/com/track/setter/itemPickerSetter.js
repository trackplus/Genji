...
Ext.define("js.ext.com.track.setter.itemPickerSetter", {
	...
	initComponent: function() {
		...
		this.callParent();
		this.add(CWHF.createHiddenField(this.name, {disabled:this.jsonData.disabled, value:this.jsonData.value}));
	...
	getSetterValue:function(){
		var hiddenIssueObjectID = this.getComponent(this.name);
		if (hiddenIssueObjectID) {
			return hiddenIssueObjectID.getValue();
		}
		return null;
	},
	...
	getSetterDisplayValue:function() {
		...
		var txtIssueNo = this.getComponent("txtIssueNo");
        if (txtIssueNo) {
        	displayValue+=txtIssueNo.getValue();
        }
		var txtIssueTitle=this.getComponent("txtIssueTitle");
		if (txtIssueTitle) {
			displayValue+=" "+txtIssueTitle.getValue();
		}
		return displayValue;
	}
