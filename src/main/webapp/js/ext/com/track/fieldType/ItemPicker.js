...
Ext.define('js.ext.com.track.fieldType.ItemPicker', {
	...
	onDataReady : function(data) {
		...
		var datasouceOptionRadioGroup = CWHF.getRadioGroup(data['dataSourceLabel'],
				500, datasourceOptionRadioGroup, {itemId:"datasourceOption", labelIsLocalized:true, labelWidth:150}, {
