...
Ext.define("com.trackplus.util.NameAndPathPicker",{
	...
	showDialog:function(){
		var me=this;
		items = [];
		me.filterName = CWHF.createTextField("common.lbl.name", "label", {labelWidth:80, allowBlank:false, msgTarget: "qtip"});
		me.pathPicker = CWHF.createSingleTreePicker("common.lbl.path", "path", me.pathTree, null, {labelWidth:80, allowBlank:false});
