...
Ext.define('com.trackplus.admin.NotifySettingsList', {
	...
	getLoadStoreUrl:function() {
		return this.baseAction + '!loadList.action';
	},
	...
	getEditParams:function(recordData) {
		var params = {defaultSettings: this.getDefaultSettings(), exclusiveProjectID: this.getExclusiveProjectID()};
	...
	getDeleteParams:function(selectedRecord) {
		...
		params['defaultSettings']=this.getDefaultSettings();
		return params;
	},
	...
	getFormItems: function(recordData, type) {
		...
		return [projectPicker,
				CWHF.createCombo("admin.customize.automail.trigger.lblAlone",
						"trigger", {itemId:"trigger", labelWidth:this.labelWidth}),
				filterPicker];
	},
	...
	onProjectSelect: function(projectPicker, selectedProject, options) {
	    ...
	    Ext.Ajax.request({
	        ...
	        params:{defaultSettings: this.getDefaultSettings(), project: projectPicker.getValue(), filter: filterPicker.getValue()},
	        scope:this,
