...
Ext.define("com.trackplus.admin.customize.treeConfig.AssignmentConfigEditController", {
	extend: "Ext.app.ViewController",
	alias: "controller.assignmentConfigEdit",
	mixins: {
	...
	onSave: function(button, event) {
		this.submitHandler(button, this.getView().submitUrl);
	},
