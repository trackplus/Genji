...
Ext.define("com.trackplus.admin.customize.role.Role", {
	...
	getLoadStoreUrl:function() {
		return this.baseAction + '!loadRoles.action';
	},
	...
	initActions : function() {
	    ...
	    if (sys) {
	        this.actionIssueTypes = CWHF.createLocalizedAction("common.btn.issueType", "issueTypeLock",
	                this.onAssignIssueType, this, {disabled:true, tooltip:getText("admin.customize.role.issueTypeToRole.lbl.explanation")});
	        this.actionFieldsRestictions = CWHF.createLocalizedAction(
	                "admin.customize.role.lbl.fieldsRestrictions", "fieldsRestrictions",
	                this.onFieldsRestrictions, this, {disabled:true, tooltip:getText("admin.customize.role.fieldsRestrictions.lbl.explanation")});
