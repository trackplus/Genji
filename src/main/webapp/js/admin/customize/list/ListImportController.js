...
Ext.define("com.trackplus.admin.customize.list.ListImportController", {
	extend: "Ext.app.ViewController",
	alias: "controller.listImport",
	mixins: {
	...
	onUpload: function(button, event) {
        ...
        var uploadFile = theForm.getComponent("uploadFile");
        if (!this.validateFileExtension(uploadFile.getRawValue())) {
