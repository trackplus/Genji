...
Ext.define('com.trackplus.admin.user.UserRolesInProject',{
	...
	getColumnModel:function() {
		return [{text: getText('admin.project.lbl.project'), flex:1,
	...
	getAddParams: function() {
		return {personID:this.getPersonID(), add:true};
	},

	getEditParams: function(recordData) {
		return {personID:this.getPersonID(), projectID:recordData["projectID"], roleID:recordData["roleID"]};
	},
	...
	getDeleteParams: function(selectedRecords, extraConfig) {
		...
		params["personID"] = this.getPersonID();
		return params;
	},
