...
Ext.define("com.trackplus.admin.user.UserRolesInProjectWindow", {
	extend: "com.trackplus.admin.WindowBase",
	xtype: "userRolesInProjectWindow",
    controller: "userRolesInProjectWindow",
    ...
    initBase: function() {
    	...
    	this.formPanel = Ext.create("com.trackplus.admin.user.UserRolesInProject",
				{personID:personID, group:entityContext.isGroup});
    	this.initActions();
    },
