...
Ext.define("com.trackplus.admin.user.PersonEditController",{
	extend: "Ext.app.ViewController",
	alias: "controller.personEdit",
	mixins: {
		baseController: "com.trackplus.admin.WindowBaseController"
	},

	onSave: function(button, event) {
		this.getView().profile.save.call(this.getView().profile, this.reloadAfterSave, this);
		//this.getView().close();
	},
