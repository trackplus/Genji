	    ...
	    if (me.model.empty) {
		    ...
		    if (missingPlugin) {
			    ...
			    if (srcImage != null) {
				    ...
				    var iconRendering = me.model.iconRendering != null ? me.model.iconRendering : 0;
...
Ext.define('com.trackplus.screen.FieldListPanel', {
    ...
    columns : [ {
        ...
        header : getText('common.lbl.description'),
        flex : 1,
...
Ext.define('com.trackplus.screen.ScreenEditFacade', {
    ...
    createScreenEditViewComponent : function() {
	    ...
	    me.screenEditView.propertiesPanel.addListener('propertychange', me.controller.changeAttribute, me.controller);
	    me.controller.screenEditView = me.screenEditView;
