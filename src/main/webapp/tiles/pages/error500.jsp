...
<div style="min-width: 300px; border: solid 1px #666666; padding: 20px; 
     background-color: #ffe8e8; max-width: 700px; margin-left:auto; margin-right:auto;">
     <div style="margin-left:-5px; margin-bottom: 25px; float:left; margin-right: 20px;"><img src='<%=request.getContextPath()%>/design/silver/32x32/cancel.png'/></div>
     <div style:"float:right;">
<h2>
		We are sorry, but the server got an internal problem serving your request!
</h2><p>
To get to the cause of this problem you have to take a look into the server log file. 
</p>
<p>
You usually find this file under &lt;webserver installation directory&gt;/log or /var/log on Unix systems.
</p>
</div>
</div>
</div>
