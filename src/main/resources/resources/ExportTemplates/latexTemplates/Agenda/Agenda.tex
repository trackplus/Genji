...
\begin{tabularx}{\textwidth}{!{\Vl}p{10cm}!{\Vl}X!{\Vl}l!{\Vl}c!{\Vl}} \htpline
\rowcolor{Gray} 
 \rule[-2.5mm]{0mm}{8mm}{\StrTopic} & {\StrPriority}  & {\StrStatus} & {\StrPage}  \\ \htpline
%\rule[-4mm]{0mm}{10mm}hhh  gjh h jghjg hj hjhghg    jhgh h g hj jg h & ghighghg & jghhhhj & 4 \\ \htpline
%\rule[-4mm]{0mm}{10mm}hhh  gjh h jghjg hj hjhghg    jhgh h g hj jg h & ghighghg & jghhhhj & 4 \\ \htpline
%\rule[-4mm]{0mm}{10mm}hhh  gjh h jghjg hj hjhghg    jhgh h g hj jg h & ghighghg & jghhhhj & 4 \\ \htpline
