...
<table cellPadding="0" cellSpacing="0">
	<tr>
		...
		<td style="padding-left: 10px;">
			<@s.checkbox name="displayValueMap[1]" theme="simple" 
				id="systemDateCheckBox%{fieldID}"
				disabled="fieldDisabled" onchange="updateSystemDateAdjustBoth(%{fieldID})"/>
				<@s.text name="itemov.massOperation.lbl.adjust">
					<@s.param value="displayValueMap[2]"/>
				</@s.text>
		</td>	
	</tr>
</table>
