...
<table>	
	<tr>
	    ...
	    <td class="dataRow4">
		    <@s.radio name="textBoxSettingsList[0].defaultOption" id="Default" 
		    	value="%{textBoxSettingsList[0].defaultOption}"
		    	list="specificConfigData[0]" listKey="value" listValue="label"
		    	onclick="javascript:dateSettingChanged('Default')"
		    	disabled="inheritedConfig" theme="simple"/>
		</td>		
		<td class="dataRow4">		
	      	<@s.set name="dateFieldDefaultDateSelected" value="textBoxSettingsList[0].defaultOption==2"></@s.set>
			<@s.set name="datePickerDefaultDisplay" value="%{'none'}"></@s.set>
			<@s.set name="textBoxDefaultDisplay" value="%{'none'}"></@s.set>
			<@s.if test="dateFieldDefaultDateSelected">
				<@s.set name="textBoxDefaultDisplay" value="%{'block'}"></@s.set>
			...
			<@s.if test="fieldErrors['textBoxSettingsList[0].defaultDate']!=null">
				<@s.textfield name="textBoxSettingsList[0].defaultDate" theme="simple" 
		      		id="dateFieldDefault" size="10" maxlength="15" cssStyle="width:80px;display:%{#textBoxDefaultDisplay}" disabled="inheritedConfig"></@s.textfield>
	    	</@s.if>
			<@s.else>
