...
public class MassOperationJSON {
	...
	public static String getBulkExpressionListJSON(
		...
		//stringBuilder.append(BULK_EXPRESSION_JSON_FIELDS.EXPRESSIONS).append(":[");
	 ...
	 * @return
	 */
	public static String getBulkExpressionValueJSON(String name, boolean valueRequired,	
			String valueRenderer, String jsonConfig) {
		StringBuilder stringBuilder=new StringBuilder();
		stringBuilder.append("{");
		stringBuilder.append(getBulkExpressionValueBaseJSON(name, valueRequired, valueRenderer, jsonConfig, true));
		stringBuilder.append("}");
		return stringBuilder.toString();
	}
	 ...
	 * @return
	 */
	private static String getBulkExpressionValueBaseJSON(String name, boolean valueRequired,
		...
		JSONUtility.appendStringValue(stringBuilder,
				BULK_EXPRESSION_JSON_FIELDS.VALUE_NAME, name, last);
		return stringBuilder.toString();
	}
