...
public class AddCommentActionPlugin extends AbstractPluginItemAction {
	@Override
	public boolean isEnabled(Integer personID, TWorkItemBean workItem, 
		...
		if (workItem==null || workItem.getObjectID()==null) {
			//no comment for new issues
			return false;
		}						
		if (workItem.getOriginatorID().equals(personID)) {
			//the originator can always add a new comment
			return true;
		}				
