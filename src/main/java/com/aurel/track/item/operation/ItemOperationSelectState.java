...
/**
 */
public class ItemOperationSelectState extends ItemOperationSelect {
	private List<ILabelBean> statusList;
	public ItemOperationSelectState(List<ILabelBean> statusList,Locale locale){
		super(SystemFields.STATE,locale);
		this.iconName= ListBL.ICONS_CLS.STATUS_ICON;
	...
	protected String getSymbol(ILabelBean labelBean) {
		return ((TStateBean)labelBean).getSymbol();
	}
}
