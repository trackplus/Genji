...
public class ItemOperationSelectPriority extends ItemOperationSelect {
	public ItemOperationSelectPriority(Locale locale){
		super(SystemFields.PRIORITY,locale);
		this.iconName= ListBL.ICONS_CLS.PRIORITY_ICON;
	}
	@Override
	...
	protected String getSymbol(ILabelBean labelBean) {
		return ((TPriorityBean)labelBean).getSymbol();
	}
}
