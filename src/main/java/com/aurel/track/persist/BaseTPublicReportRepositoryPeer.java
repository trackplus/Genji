...
/**
 */
public abstract class BaseTPublicReportRepositoryPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TPublicReportRepositoryMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TPublicReportRepositoryMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TPUBLICREPORTREPOSITORY";

        PKEY = "TPUBLICREPORTREPOSITORY.PKEY";
        OWNER = "TPUBLICREPORTREPOSITORY.OWNER";
        NAME = "TPUBLICREPORTREPOSITORY.NAME";
        QUERY = "TPUBLICREPORTREPOSITORY.QUERY";
        TPUUID = "TPUBLICREPORTREPOSITORY.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TPublicReportRepositoryMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TPublicReportRepositoryMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TPublicReportRepository";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPublicReportRepository> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTPublicReportRepositoryPeer
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TPublicReportRepository row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TPublicReportRepository obj = (TPublicReportRepository) cls.newInstance();
            TPublicReportRepositoryPeer.populateObject(row, offset, obj);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPublicReportRepository> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPublicReportRepository> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPublicReportRepository> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TPublicReportRepository> results = new ArrayList<TPublicReportRepository>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TPublicReportRepositoryPeer.row2Object(row, 1,
                TPublicReportRepositoryPeer.getOMClass()));
        }
        return results;
    }
    ...
    {
         BaseTPublicReportRepositoryPeer
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPublicReportRepository> doSelect(TPublicReportRepository obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TPublicReportRepository obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TPublicReportRepository obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TPublicReportRepository obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TPublicReportRepository) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TPublicReportRepository obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TPublicReportRepository) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TPublicReportRepository obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TPublicReportRepository) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TPublicReportRepository obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TPublicReportRepository obj )
    {
    ...
    public static Criteria buildSelectCriteria( TPublicReportRepository obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TPublicReportRepository retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TPublicReportRepository retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TPublicReportRepository retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TPublicReportRepository retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TPublicReportRepository retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TPublicReportRepository> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (TPublicReportRepository)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPublicReportRepository> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TPublicReportRepository> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPublicReportRepository> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TPublicReportRepository> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TPublicReportRepository>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TPublicReportRepository objects pre-filled with their
     * TPerson objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TPublicReportRepositoryPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPublicReportRepository> doSelectJoinTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPublicReportRepository> doSelectJoinTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TPublicReportRepositoryPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TPersonPeer.addSelectColumns(criteria);

        criteria.addJoin(TPublicReportRepositoryPeer.OWNER,
            TPersonPeer.PKEY);
        ...
        List<TPublicReportRepository> results = new ArrayList<TPublicReportRepository>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TPublicReportRepositoryPeer.getOMClass();
            TPublicReportRepository obj1 = (TPublicReportRepository) TPublicReportRepositoryPeer
            ...
            {
                TPublicReportRepository temp_obj1 =  results.get(j);
                TPerson temp_obj2 = (TPerson) temp_obj1.getTPerson();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTPublicReportRepository(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTPublicReportRepositorys();
                obj2.addTPublicReportRepository(obj1);
            }
            results.add(obj1);
        }
        return results;
