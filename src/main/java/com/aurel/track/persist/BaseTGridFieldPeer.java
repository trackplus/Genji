 ...
 *
 */
public abstract class BaseTGridFieldPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TGridFieldMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TGridFieldMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the FIELDPOSITION field */
    public static final String FIELDPOSITION;
    /** the column name for the FIELDWIDTH field */
    public static final String FIELDWIDTH;
    /** the column name for the FILTERSTRING field */
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TGRIDFIELD";

        OBJECTID = "TGRIDFIELD.OBJECTID";
        GRIDLAYOUT = "TGRIDFIELD.GRIDLAYOUT";
        GRIDFIELD = "TGRIDFIELD.GRIDFIELD";
        FIELDPOSITION = "TGRIDFIELD.FIELDPOSITION";
        FIELDWIDTH = "TGRIDFIELD.FIELDWIDTH";
        FILTERSTRING = "TGRIDFIELD.FILTERSTRING";
        TPUUID = "TGRIDFIELD.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TGridFieldMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TGridFieldMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TGridField";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TGridField> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(FIELDPOSITION);
        criteria.addSelectColumn(FIELDWIDTH);
        criteria.addSelectColumn(FILTERSTRING);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TGridField row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TGridField obj = (TGridField) cls.newInstance();
            TGridFieldPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setFieldPosition(row.getValue(offset + 3).asIntegerObj());
            obj.setFieldWidth(row.getValue(offset + 4).asIntegerObj());
            obj.setFilterString(row.getValue(offset + 5).asString());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TGridField> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TGridField> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TGridField> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TGridField> results = new ArrayList<TGridField>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TGridFieldPeer.row2Object(row, 1,
                TGridFieldPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TGridField> doSelect(TGridField obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TGridField obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TGridField obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TGridField obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TGridField) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TGridField obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TGridField) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TGridField obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TGridField) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TGridField obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TGridField obj )
    {
        ...
        criteria.add(FIELDPOSITION, obj.getFieldPosition());
        criteria.add(FIELDWIDTH, obj.getFieldWidth());
        criteria.add(FILTERSTRING, obj.getFilterString());
        criteria.add(TPUUID, obj.getUuid());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( TGridField obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TGridField retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TGridField retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TGridField retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TGridField retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TGridField retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TGridField> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TGridField> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TGridField> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TGridField> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TGridField> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TGridField>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TGridField objects pre-filled with their
     * TGridLayout objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TGridFieldPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TGridField> doSelectJoinTGridLayout(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TGridField> doSelectJoinTGridLayout(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TGridFieldPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TGridLayoutPeer.addSelectColumns(criteria);

        criteria.addJoin(TGridFieldPeer.GRIDLAYOUT,
        ...
        List<TGridField> results = new ArrayList<TGridField>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TGridFieldPeer.getOMClass();
            TGridField obj1 = (TGridField) TGridFieldPeer
            ...
            {
                TGridField temp_obj1 =  results.get(j);
                TGridLayout temp_obj2 = (TGridLayout) temp_obj1.getTGridLayout();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTGridField(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTGridFields();
                obj2.addTGridField(obj1);
            }
            results.add(obj1);
        }
        return results;
