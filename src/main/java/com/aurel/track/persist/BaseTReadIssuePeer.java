 ...
 *
 */
public abstract class BaseTReadIssuePeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TReadIssueMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TReadIssueMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the READTYPE field */
    public static final String READTYPE;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TREADISSUE";

        OBJECTID = "TREADISSUE.OBJECTID";
        WORKITEM = "TREADISSUE.WORKITEM";
        FIELDKEY = "TREADISSUE.FIELDKEY";
        PERSON = "TREADISSUE.PERSON";
        READTYPE = "TREADISSUE.READTYPE";
        LASTEDIT = "TREADISSUE.LASTEDIT";
        TPUUID = "TREADISSUE.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TReadIssueMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TReadIssueMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TReadIssue";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TReadIssue> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(READTYPE);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TReadIssue row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TReadIssue obj = (TReadIssue) cls.newInstance();
            TReadIssuePeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setFieldKey(row.getValue(offset + 2).asIntegerObj());
            obj.setPerson(row.getValue(offset + 3).asIntegerObj());
            obj.setReadType(row.getValue(offset + 4).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TReadIssue> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TReadIssue> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TReadIssue> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TReadIssue> results = new ArrayList<TReadIssue>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TReadIssuePeer.row2Object(row, 1,
                TReadIssuePeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TReadIssue> doSelect(TReadIssue obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TReadIssue obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TReadIssue obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TReadIssue obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TReadIssue) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TReadIssue obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TReadIssue) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TReadIssue obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TReadIssue) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TReadIssue obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TReadIssue obj )
    {
        ...
        criteria.add(READTYPE, obj.getReadType());
    ...
    public static Criteria buildSelectCriteria( TReadIssue obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TReadIssue retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TReadIssue retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TReadIssue retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TReadIssue retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TReadIssue retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TReadIssue> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TReadIssue> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TReadIssue> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TReadIssue> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TReadIssue> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TReadIssue>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TReadIssue objects pre-filled with their
     * TWorkItem objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TReadIssuePeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TReadIssue> doSelectJoinTWorkItem(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TReadIssue> doSelectJoinTWorkItem(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TReadIssuePeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TWorkItemPeer.addSelectColumns(criteria);

        criteria.addJoin(TReadIssuePeer.WORKITEM,
        ...
        List<TReadIssue> results = new ArrayList<TReadIssue>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TReadIssuePeer.getOMClass();
            TReadIssue obj1 = (TReadIssue) TReadIssuePeer
            ...
            {
                TReadIssue temp_obj1 =  results.get(j);
                TWorkItem temp_obj2 = (TWorkItem) temp_obj1.getTWorkItem();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTReadIssue(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTReadIssues();
                obj2.addTReadIssue(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TReadIssue> doSelectJoinTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TReadIssue> doSelectJoinTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TReadIssuePeer.PERSON,
            TPersonPeer.PKEY);
