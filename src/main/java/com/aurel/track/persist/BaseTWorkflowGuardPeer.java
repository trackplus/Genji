...
/**
 */
public abstract class BaseTWorkflowGuardPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TWorkflowGuardMapBuilder.CLASS_NAME) instead
     */
    ...
    /** the column name for the GUARDTYPE field */
    public static final String GUARDTYPE;
    /** the column name for the GUARDPARAMS field */
    public static final String GUARDPARAMS;
    /** the column name for the WORKFLOWTRANSITION field */
    public static final String WORKFLOWTRANSITION;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TWORKFLOWGUARD";

        OBJECTID = "TWORKFLOWGUARD.OBJECTID";
        GUARDTYPE = "TWORKFLOWGUARD.GUARDTYPE";
        GUARDPARAMS = "TWORKFLOWGUARD.GUARDPARAMS";
        WORKFLOWTRANSITION = "TWORKFLOWGUARD.WORKFLOWTRANSITION";
        ROLEKEY = "TWORKFLOWGUARD.ROLEKEY";
        GROOVYSCRIPT = "TWORKFLOWGUARD.GROOVYSCRIPT";
        PERSON = "TWORKFLOWGUARD.PERSON";
        TPUUID = "TWORKFLOWGUARD.TPUUID";
        if (Torque.isInit())
        {
            try
            {
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TWorkflowGuard";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkflowGuard> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TWorkflowGuard row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TWorkflowGuard obj = (TWorkflowGuard) cls.newInstance();
            TWorkflowGuardPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setGuardType(row.getValue(offset + 1).asIntegerObj());
            obj.setGuardParams(row.getValue(offset + 2).asString());
            obj.setWorkflowTransition(row.getValue(offset + 3).asIntegerObj());
            obj.setRole(row.getValue(offset + 4).asIntegerObj());
            obj.setGroovyScript(row.getValue(offset + 5).asIntegerObj());
            obj.setPerson(row.getValue(offset + 6).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkflowGuard> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkflowGuard> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TWorkflowGuard> results = new ArrayList<TWorkflowGuard>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TWorkflowGuardPeer.row2Object(row, 1,
                TWorkflowGuardPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkflowGuard> doSelect(TWorkflowGuard obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TWorkflowGuard obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TWorkflowGuard obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TWorkflowGuard obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TWorkflowGuard) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TWorkflowGuard obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TWorkflowGuard) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TWorkflowGuard obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TWorkflowGuard) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TWorkflowGuard obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TWorkflowGuard obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(OBJECTID, obj.getObjectID());
        criteria.add(GUARDTYPE, obj.getGuardType());
        criteria.add(GUARDPARAMS, obj.getGuardParams());
        criteria.add(WORKFLOWTRANSITION, obj.getWorkflowTransition());
        criteria.add(ROLEKEY, obj.getRole());
    ...
    public static Criteria buildSelectCriteria( TWorkflowGuard obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TWorkflowGuard retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TWorkflowGuard retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TWorkflowGuard retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TWorkflowGuard retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TWorkflowGuard retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TWorkflowGuard> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkflowGuard> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TWorkflowGuard> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkflowGuard> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TWorkflowGuard> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TWorkflowGuard>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TWorkflowGuard objects pre-filled with their
     * TWorkflowTransition objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TWorkflowGuardPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TWorkflowGuard> doSelectJoinTWorkflowTransition(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TWorkflowGuard> doSelectJoinTWorkflowTransition(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TWorkflowGuardPeer.WORKFLOWTRANSITION,
        ...
        List<TWorkflowGuard> results = new ArrayList<TWorkflowGuard>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TWorkflowGuardPeer.getOMClass();
            TWorkflowGuard obj1 = (TWorkflowGuard) TWorkflowGuardPeer
            ...
            {
                TWorkflowGuard temp_obj1 =  results.get(j);
                TWorkflowTransition temp_obj2 = (TWorkflowTransition) temp_obj1.getTWorkflowTransition();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTWorkflowGuard(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTWorkflowGuards();
                obj2.addTWorkflowGuard(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TWorkflowGuard> doSelectJoinTRole(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TWorkflowGuard> doSelectJoinTRole(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TWorkflowGuardPeer.ROLEKEY,
            TRolePeer.PKEY);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TWorkflowGuard> doSelectJoinTScripts(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TWorkflowGuard> doSelectJoinTScripts(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TWorkflowGuardPeer.GROOVYSCRIPT,
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TWorkflowGuard> doSelectJoinTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TWorkflowGuard> doSelectJoinTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TWorkflowGuardPeer.PERSON,
            TPersonPeer.PKEY);
    ...
    /**
     * selects a collection of TWorkflowGuard objects pre-filled with
     * all related objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TWorkflowGuard> doSelectJoinAllExceptTWorkflowTransition(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TWorkflowGuard> doSelectJoinAllExceptTWorkflowTransition(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
 ...
 newObject = true;
            for (int j = 0; j < results.size(); j++)
            {
                ...
                {
                    newObject = false;
                    temp_obj3.addTWorkflowGuard(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj3.initTWorkflowGuards();
                obj3.addTWorkflowGuard(obj1);
            }
 ...
 newObject = true;
            for (int j = 0; j < results.size(); j++)
            {
                ...
                {
                    newObject = false;
                    temp_obj4.addTWorkflowGuard(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj4.initTWorkflowGuards();
                obj4.addTWorkflowGuard(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TWorkflowGuard> doSelectJoinAllExceptTRole(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TWorkflowGuard> doSelectJoinAllExceptTRole(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
 ...
 newObject = true;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TWorkflowGuard> doSelectJoinAllExceptTScripts(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TWorkflowGuard> doSelectJoinAllExceptTScripts(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        TRolePeer.addSelectColumns(criteria);
        criteria.addJoin(TWorkflowGuardPeer.ROLEKEY, TRolePeer.PKEY);
        int offset4 = offset3 + TRolePeer.numColumns;
 ...
 newObject = true;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TWorkflowGuard> doSelectJoinAllExceptTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TWorkflowGuard> doSelectJoinAllExceptTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
 ...
 newObject = true;
            ...
            if (newObject)
            {
             ...
             omClass = TScriptsPeer.getOMClass();
            TScripts obj4 = (TScripts) TScriptsPeer
                .row2Object( row, offset4, omClass);
 ...
 newObject = true;
            ...
            {
                TWorkflowGuard temp_obj1 =  results.get(j);
                TScripts temp_obj4 = (TScripts) temp_obj1.getTScripts();
                if (temp_obj4.getPrimaryKey().equals(obj4.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj4.addTWorkflowGuard(obj1);
