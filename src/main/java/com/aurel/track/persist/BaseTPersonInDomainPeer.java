...
/**
 */
public abstract class BaseTPersonInDomainPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TPersonInDomainMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TPersonInDomainMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TPERSONINDOMAIN";

        OBJECTID = "TPERSONINDOMAIN.OBJECTID";
        PERSONKEY = "TPERSONINDOMAIN.PERSONKEY";
        DOMAINKEY = "TPERSONINDOMAIN.DOMAINKEY";
        DESCRIPTION = "TPERSONINDOMAIN.DESCRIPTION";
        TPUUID = "TPERSONINDOMAIN.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TPersonInDomainMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TPersonInDomainMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TPersonInDomain";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPersonInDomain> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTPersonInDomainPeer
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TPersonInDomain row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TPersonInDomain obj = (TPersonInDomain) cls.newInstance();
            TPersonInDomainPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setDomain(row.getValue(offset + 2).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPersonInDomain> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPersonInDomain> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPersonInDomain> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TPersonInDomain> results = new ArrayList<TPersonInDomain>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TPersonInDomainPeer.row2Object(row, 1,
                TPersonInDomainPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPersonInDomain> doSelect(TPersonInDomain obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TPersonInDomain obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TPersonInDomain obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TPersonInDomain obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TPersonInDomain) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TPersonInDomain obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TPersonInDomain) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TPersonInDomain obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TPersonInDomain) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TPersonInDomain obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TPersonInDomain obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(OBJECTID, obj.getObjectID());
        criteria.add(PERSONKEY, obj.getPerson());
    ...
    public static Criteria buildSelectCriteria( TPersonInDomain obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TPersonInDomain retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TPersonInDomain retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TPersonInDomain retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TPersonInDomain retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TPersonInDomain retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TPersonInDomain> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (TPersonInDomain)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPersonInDomain> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TPersonInDomain> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPersonInDomain> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TPersonInDomain> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TPersonInDomain>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TPersonInDomain objects pre-filled with their
     * TPerson objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TPersonInDomainPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPersonInDomain> doSelectJoinTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPersonInDomain> doSelectJoinTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TPersonInDomainPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TPersonPeer.addSelectColumns(criteria);

        criteria.addJoin(TPersonInDomainPeer.PERSONKEY,
            TPersonPeer.PKEY);
        ...
        List<TPersonInDomain> results = new ArrayList<TPersonInDomain>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TPersonInDomainPeer.getOMClass();
            TPersonInDomain obj1 = (TPersonInDomain) TPersonInDomainPeer
            ...
            {
                TPersonInDomain temp_obj1 =  results.get(j);
                TPerson temp_obj2 = (TPerson) temp_obj1.getTPerson();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTPersonInDomain(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTPersonInDomains();
                obj2.addTPersonInDomain(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPersonInDomain> doSelectJoinTDomain(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPersonInDomain> doSelectJoinTDomain(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TPersonInDomainPeer.DOMAINKEY,
