...
/**
 */
public abstract class BaseTScreenConfigPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TScreenConfigMapBuilder.CLASS_NAME) instead
     */
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TSCREENCONFIG";

        OBJECTID = "TSCREENCONFIG.OBJECTID";
        NAME = "TSCREENCONFIG.NAME";
        DESCRIPTION = "TSCREENCONFIG.DESCRIPTION";
        SCREEN = "TSCREENCONFIG.SCREEN";
        ISSUETYPE = "TSCREENCONFIG.ISSUETYPE";
        PROJECTTYPE = "TSCREENCONFIG.PROJECTTYPE";
        PROJECT = "TSCREENCONFIG.PROJECT";
        ACTIONKEY = "TSCREENCONFIG.ACTIONKEY";
        TPUUID = "TSCREENCONFIG.TPUUID";
        if (Torque.isInit())
        {
            try
            {
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TScreenConfig";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TScreenConfig> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TScreenConfig row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TScreenConfig obj = (TScreenConfig) cls.newInstance();
            TScreenConfigPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setScreen(row.getValue(offset + 3).asIntegerObj());
            obj.setIssueType(row.getValue(offset + 4).asIntegerObj());
            obj.setProjectType(row.getValue(offset + 5).asIntegerObj());
            obj.setProject(row.getValue(offset + 6).asIntegerObj());
            obj.setAction(row.getValue(offset + 7).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TScreenConfig> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TScreenConfig> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TScreenConfig> results = new ArrayList<TScreenConfig>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TScreenConfigPeer.row2Object(row, 1,
                TScreenConfigPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TScreenConfig> doSelect(TScreenConfig obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TScreenConfig obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TScreenConfig obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TScreenConfig obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TScreenConfig) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TScreenConfig obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TScreenConfig) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TScreenConfig obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TScreenConfig) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TScreenConfig obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TScreenConfig obj )
    {
        ...
        criteria.add(ACTIONKEY, obj.getAction());
        criteria.add(TPUUID, obj.getUuid());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( TScreenConfig obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TScreenConfig retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TScreenConfig retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TScreenConfig retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TScreenConfig retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TScreenConfig retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TScreenConfig> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TScreenConfig> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TScreenConfig> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TScreenConfig> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TScreenConfig> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TScreenConfig>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TScreenConfig objects pre-filled with their
     * TScreen objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TScreenConfigPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TScreenConfig> doSelectJoinTScreen(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TScreenConfig> doSelectJoinTScreen(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TScreenConfigPeer.SCREEN,
        ...
        List<TScreenConfig> results = new ArrayList<TScreenConfig>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TScreenConfigPeer.getOMClass();
            TScreenConfig obj1 = (TScreenConfig) TScreenConfigPeer
            ...
            {
                TScreenConfig temp_obj1 =  results.get(j);
                TScreen temp_obj2 = (TScreen) temp_obj1.getTScreen();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTScreenConfig(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTScreenConfigs();
                obj2.addTScreenConfig(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TScreenConfig> doSelectJoinTListType(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TScreenConfig> doSelectJoinTListType(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TScreenConfigPeer.ISSUETYPE,
            TListTypePeer.PKEY);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TScreenConfig> doSelectJoinTProjectType(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TScreenConfig> doSelectJoinTProjectType(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TScreenConfigPeer.PROJECTTYPE,
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TScreenConfig> doSelectJoinTProject(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TScreenConfig> doSelectJoinTProject(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TScreenConfigPeer.PROJECT,
            TProjectPeer.PKEY);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TScreenConfig> doSelectJoinTAction(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TScreenConfig> doSelectJoinTAction(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TScreenConfigPeer.ACTIONKEY,
    ...
    /**
     * selects a collection of TScreenConfig objects pre-filled with
     * all related objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TScreenConfig> doSelectJoinAllExceptTScreen(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TScreenConfig> doSelectJoinAllExceptTScreen(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
 ...
 newObject = true;
            for (int j = 0; j < results.size(); j++)
            {
                ...
                {
                    newObject = false;
                    temp_obj3.addTScreenConfig(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj3.initTScreenConfigs();
                obj3.addTScreenConfig(obj1);
            }
 ...
 newObject = true;
            for (int j = 0; j < results.size(); j++)
            {
                ...
                {
                    newObject = false;
                    temp_obj4.addTScreenConfig(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj4.initTScreenConfigs();
                obj4.addTScreenConfig(obj1);
            }
             ...
             omClass = TActionPeer.getOMClass();
            TAction obj5 = (TAction) TActionPeer
 ...
 newObject = true;
            ...
            {
                TScreenConfig temp_obj1 =  results.get(j);
                TAction temp_obj5 = (TAction) temp_obj1.getTAction();
                if (temp_obj5.getPrimaryKey().equals(obj5.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj5.addTScreenConfig(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj5.initTScreenConfigs();
                obj5.addTScreenConfig(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TScreenConfig> doSelectJoinAllExceptTListType(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TScreenConfig> doSelectJoinAllExceptTListType(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        int offset3 = offset2 + TScreenPeer.numColumns;
 ...
 newObject = true;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TScreenConfig> doSelectJoinAllExceptTProjectType(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TScreenConfig> doSelectJoinAllExceptTProjectType(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
 ...
 newObject = true;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TScreenConfig> doSelectJoinAllExceptTProject(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TScreenConfig> doSelectJoinAllExceptTProject(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
 ...
 newObject = true;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TScreenConfig> doSelectJoinAllExceptTAction(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TScreenConfig> doSelectJoinAllExceptTAction(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
