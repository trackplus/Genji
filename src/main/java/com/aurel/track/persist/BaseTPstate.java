 ...
 * extended all references should be to TPstate
 */
public abstract class BaseTPstate extends TpBaseObject
{
    /** The Peer class */
    private static final TPstatePeer peer =
        new TPstatePeer();
    ...
    public TState getTState()
        throws TorqueException
    {
        if (aTState == null && (!ObjectUtils.equals(this.state, null)))
        {
            aTState = TStatePeer.retrieveByPK(SimpleKey.keyFor(this.state));
        }
        return aTState;
    }
        ...
        throws TorqueException
    {
        if (aTState == null && (!ObjectUtils.equals(this.state, null)))
        {
            aTState = TStatePeer.retrieveByPK(SimpleKey.keyFor(this.state), connection);
        }
        return aTState;
    }
    ...
    public void setTStateKey(ObjectKey key) throws TorqueException
    {
        ...
        setState(new Integer(((NumberKey) key).intValue()));
    }
    ...
    {
        if (name.equals(TPstatePeer.OBJECTID))
        {
            return getObjectID();
        }
        if (name.equals(TPstatePeer.STATE))
        {
            return getState();
        }
        if (name.equals(TPstatePeer.PROJECTTYPE))
        {
            return getProjectType();
        }
        if (name.equals(TPstatePeer.LISTTYPE))
        {
            return getListType();
        }
        if (name.equals(TPstatePeer.TPUUID))
        {
            return getUuid();
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (TPstatePeer.OBJECTID.equals(name))
        {
            return setByName("ObjectID", value);
        }
      if (TPstatePeer.STATE.equals(name))
        {
            return setByName("State", value);
        }
      if (TPstatePeer.PROJECTTYPE.equals(name))
        {
            return setByName("ProjectType", value);
        }
      if (TPstatePeer.LISTTYPE.equals(name))
        {
            return setByName("ListType", value);
        }
      if (TPstatePeer.TPUUID.equals(name))
        {
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    TPstatePeer.doInsert((TPstate) this, con);
                    setNew(false);
                }
                else
                {
                    TPstatePeer.doUpdate((TPstate) this, con);
                }
            }
     ...
     */
    public TPstate copy(Connection con) throws TorqueException
    {
     ...
     */
    public TPstate copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new TPstate(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public TPstate copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new TPstate(), deepcopy, con);
    }
     ...
     */
    protected TPstate copyInto(TPstate copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected TPstate copyInto(TPstate copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected TPstate copyInto(TPstate copyObj, boolean deepcopy) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected TPstate copyInto(TPstate copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setObjectID(objectID);
        copyObj.setState(state);
        copyObj.setProjectType(projectType);
    ...
    /**
     * Creates a TPstateBean with the contents of this object
     * This also creates beans for cached related objects, if they exist
     * @return a TPstateBean with the contents of this object
     */
     ...
     * @return a TPstateBean with the contents of this object
     */
    public TPstateBean getBean(IdentityMap createdBeans)
    {
        TPstateBean result = (TPstateBean) createdBeans.get(this);
        if (result != null ) {
            // we have already created a bean for this object, return it
            return result;
        }
        // no bean exists for this object; create a new one
        result = new TPstateBean();
    ...
    /**
     * Creates an instance of TPstate with the contents
     * of a TPstateBean.
     * This behaviour could have also been achieved using a constructor,
     * however as this class is abstract no constructors are allowed
     * @param bean the TPstateBean which contents are used to create
     *        the resulting class
     * @return an instance of TPstate with the contents of bean
     */
    public static TPstate createTPstate(TPstateBean bean)
        throws TorqueException
    {
        return createTPstate(bean, new IdentityMap());
    }
    ...
    public static TPstate createTPstate(TPstateBean bean, IdentityMap createdObjects)
        throws TorqueException
    {
        TPstate result = (TPstate) createdObjects.get(bean);
        if (result != null)
        {
