...
/**
 */
public abstract class BaseTStatePeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TStateMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TStateMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the ICONCHANGED field */
    public static final String ICONCHANGED;
    /** the column name for the CSSSTYLE field */
    public static final String CSSSTYLE;
    /** the column name for the PERCENTCOMPLETE field */
    public static final String PERCENTCOMPLETE;
    ...
    static
    {
        ...
        PKEY = "TSTATE.PKEY";
        LABEL = "TSTATE.LABEL";
        TOOLTIP = "TSTATE.TOOLTIP";
        STATEFLAG = "TSTATE.STATEFLAG";
        SORTORDER = "TSTATE.SORTORDER";
        SYMBOL = "TSTATE.SYMBOL";
        ICONKEY = "TSTATE.ICONKEY";
        ICONCHANGED = "TSTATE.ICONCHANGED";
        CSSSTYLE = "TSTATE.CSSSTYLE";
        PERCENTCOMPLETE = "TSTATE.PERCENTCOMPLETE";
        TPUUID = "TSTATE.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TStateMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TStateMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TState";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TState> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(ICONCHANGED);
        criteria.addSelectColumn(CSSSTYLE);
        criteria.addSelectColumn(PERCENTCOMPLETE);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TState row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TState obj = (TState) cls.newInstance();
            TStatePeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setTooltip(row.getValue(offset + 2).asString());
            obj.setStateflag(row.getValue(offset + 3).asIntegerObj());
            obj.setSortorder(row.getValue(offset + 4).asIntegerObj());
            obj.setSymbol(row.getValue(offset + 5).asString());
            obj.setIconKey(row.getValue(offset + 6).asIntegerObj());
            obj.setIconChanged(row.getValue(offset + 7).asString());
            obj.setCSSStyle(row.getValue(offset + 8).asString());
            obj.setPercentComplete(row.getValue(offset + 9).asIntegerObj());
            obj.setUuid(row.getValue(offset + 10).asString());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TState> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TState> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TState> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TState> results = new ArrayList<TState>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TStatePeer.row2Object(row, 1,
                TStatePeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TState> doSelect(TState obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TState obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TState obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TState obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TState) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TState obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TState) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TState obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TState) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TState obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TState obj )
    {
        ...
        criteria.add(ICONCHANGED, obj.getIconChanged());
        criteria.add(CSSSTYLE, obj.getCSSStyle());
        criteria.add(PERCENTCOMPLETE, obj.getPercentComplete());
        criteria.add(TPUUID, obj.getUuid());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( TState obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TState retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TState retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TState retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TState retVal = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TState retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TState> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TState> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TState> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TState> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TState> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TState>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TState objects pre-filled with their
     * TBLOB objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TStatePeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TState> doSelectJoinTBLOB(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TState> doSelectJoinTBLOB(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TStatePeer.ICONKEY,
            TBLOBPeer.OBJECTID);
        ...
        List<TState> results = new ArrayList<TState>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TStatePeer.getOMClass();
            TState obj1 = (TState) TStatePeer
            ...
            {
                TState temp_obj1 =  results.get(j);
                TBLOB temp_obj2 = (TBLOB) temp_obj1.getTBLOB();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTState(obj1);
                    break;
                }
            }
            if (newObject)
