...
/**
 */
public abstract class BaseTPriorityPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TPriorityMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TPriorityMapBuilder.CLASS_NAME);
    }
    ...
    static
    {
        ...
        PKEY = "TPRIORITY.PKEY";
        LABEL = "TPRIORITY.LABEL";
        TOOLTIP = "TPRIORITY.TOOLTIP";
        SORTORDER = "TPRIORITY.SORTORDER";
        WLEVEL = "TPRIORITY.WLEVEL";
        SYMBOL = "TPRIORITY.SYMBOL";
        ICONKEY = "TPRIORITY.ICONKEY";
        ICONCHANGED = "TPRIORITY.ICONCHANGED";
        CSSSTYLE = "TPRIORITY.CSSSTYLE";
        TPUUID = "TPRIORITY.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TPriorityMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TPriorityMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TPriority";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPriority> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TPriority row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TPriority obj = (TPriority) cls.newInstance();
            TPriorityPeer.populateObject(row, offset, obj);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPriority> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPriority> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPriority> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TPriority> results = new ArrayList<TPriority>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TPriorityPeer.row2Object(row, 1,
                TPriorityPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPriority> doSelect(TPriority obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TPriority obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TPriority obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TPriority obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TPriority) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TPriority obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TPriority) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TPriority obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TPriority) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TPriority obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TPriority obj )
    {
    ...
    public static Criteria buildSelectCriteria( TPriority obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TPriority retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TPriority retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TPriority retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TPriority retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TPriority retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TPriority> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPriority> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TPriority> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPriority> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TPriority> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TPriority>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TPriority objects pre-filled with their
     * TBLOB objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TPriorityPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPriority> doSelectJoinTBLOB(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPriority> doSelectJoinTBLOB(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TPriorityPeer.ICONKEY,
            TBLOBPeer.OBJECTID);
        ...
        List<TPriority> results = new ArrayList<TPriority>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TPriorityPeer.getOMClass();
            TPriority obj1 = (TPriority) TPriorityPeer
            ...
            {
                TPriority temp_obj1 =  results.get(j);
                TBLOB temp_obj2 = (TBLOB) temp_obj1.getTBLOB();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTPriority(obj1);
                    break;
                }
            }
            if (newObject)
