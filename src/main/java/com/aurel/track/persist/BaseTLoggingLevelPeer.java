...
/**
 */
public abstract class BaseTLoggingLevelPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TLoggingLevelMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TLoggingLevelMapBuilder.CLASS_NAME);
    }

    /** the column name for the OBJECTID field */
    public static final String OBJECTID;
    /** the column name for the THECLASSNAME field */
    public static final String THECLASSNAME;
    /** the column name for the LOGLEVEL field */
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TLOGGINGLEVEL";

        OBJECTID = "TLOGGINGLEVEL.OBJECTID";
        THECLASSNAME = "TLOGGINGLEVEL.THECLASSNAME";
        LOGLEVEL = "TLOGGINGLEVEL.LOGLEVEL";
        TPUUID = "TLOGGINGLEVEL.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TLoggingLevelMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TLoggingLevelMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TLoggingLevel";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TLoggingLevel> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(THECLASSNAME);
        criteria.addSelectColumn(LOGLEVEL);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TLoggingLevel row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TLoggingLevel obj = (TLoggingLevel) cls.newInstance();
            TLoggingLevelPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setTheClassName(row.getValue(offset + 1).asString());
            obj.setLogLevel(row.getValue(offset + 2).asString());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TLoggingLevel> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TLoggingLevel> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TLoggingLevel> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TLoggingLevel> results = new ArrayList<TLoggingLevel>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TLoggingLevelPeer.row2Object(row, 1,
                TLoggingLevelPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TLoggingLevel> doSelect(TLoggingLevel obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TLoggingLevel obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TLoggingLevel obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TLoggingLevel obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TLoggingLevel) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TLoggingLevel obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TLoggingLevel) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TLoggingLevel obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TLoggingLevel) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TLoggingLevel obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TLoggingLevel obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(OBJECTID, obj.getObjectID());
        criteria.add(THECLASSNAME, obj.getTheClassName());
        criteria.add(LOGLEVEL, obj.getLogLevel());
        criteria.add(TPUUID, obj.getUuid());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( TLoggingLevel obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TLoggingLevel retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TLoggingLevel retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TLoggingLevel retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TLoggingLevel retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TLoggingLevel retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TLoggingLevel> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TLoggingLevel> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TLoggingLevel> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TLoggingLevel> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TLoggingLevel> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TLoggingLevel>();
        }
        else
        {
            Criteria criteria = new Criteria();
