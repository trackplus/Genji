...
/**
 */
public abstract class BaseTPlistTypePeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TPlistTypeMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TPlistTypeMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TPLISTTYPE";

        OBJECTID = "TPLISTTYPE.OBJECTID";
        PROJECTTYPE = "TPLISTTYPE.PROJECTTYPE";
        CATEGORY = "TPLISTTYPE.CATEGORY";
        TPUUID = "TPLISTTYPE.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TPlistTypeMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TPlistTypeMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TPlistType";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPlistType> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TPlistType row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TPlistType obj = (TPlistType) cls.newInstance();
            TPlistTypePeer.populateObject(row, offset, obj);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPlistType> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPlistType> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPlistType> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TPlistType> results = new ArrayList<TPlistType>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TPlistTypePeer.row2Object(row, 1,
                TPlistTypePeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPlistType> doSelect(TPlistType obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TPlistType obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TPlistType obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TPlistType obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TPlistType) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TPlistType obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TPlistType) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TPlistType obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TPlistType) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TPlistType obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TPlistType obj )
    {
    ...
    public static Criteria buildSelectCriteria( TPlistType obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TPlistType retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TPlistType retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TPlistType retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TPlistType retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TPlistType retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TPlistType> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPlistType> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TPlistType> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPlistType> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TPlistType> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TPlistType>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TPlistType objects pre-filled with their
     * TProjectType objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TPlistTypePeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPlistType> doSelectJoinTProjectType(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPlistType> doSelectJoinTProjectType(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TPlistTypePeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TProjectTypePeer.addSelectColumns(criteria);

        criteria.addJoin(TPlistTypePeer.PROJECTTYPE,
        ...
        List<TPlistType> results = new ArrayList<TPlistType>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TPlistTypePeer.getOMClass();
            TPlistType obj1 = (TPlistType) TPlistTypePeer
            ...
            {
                TPlistType temp_obj1 =  results.get(j);
                TProjectType temp_obj2 = (TProjectType) temp_obj1.getTProjectType();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTPlistType(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTPlistTypes();
                obj2.addTPlistType(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPlistType> doSelectJoinTListType(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPlistType> doSelectJoinTListType(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TPlistTypePeer.CATEGORY,
            TListTypePeer.PKEY);
