...
/**
 */
public abstract class BaseTPrivateReportRepositoryPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TPrivateReportRepositoryMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TPrivateReportRepositoryMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TPRIVATEREPORTREPOSITORY";

        PKEY = "TPRIVATEREPORTREPOSITORY.PKEY";
        OWNER = "TPRIVATEREPORTREPOSITORY.OWNER";
        NAME = "TPRIVATEREPORTREPOSITORY.NAME";
        QUERY = "TPRIVATEREPORTREPOSITORY.QUERY";
        MENUITEM = "TPRIVATEREPORTREPOSITORY.MENUITEM";
        TPUUID = "TPRIVATEREPORTREPOSITORY.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TPrivateReportRepositoryMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TPrivateReportRepositoryMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TPrivateReportRepository";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPrivateReportRepository> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTPrivateReportRepositoryPeer
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(QUERY);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TPrivateReportRepository row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TPrivateReportRepository obj = (TPrivateReportRepository) cls.newInstance();
            TPrivateReportRepositoryPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setQuery(row.getValue(offset + 3).asString());
            obj.setMenuItem(row.getValue(offset + 4).asString());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPrivateReportRepository> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPrivateReportRepository> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPrivateReportRepository> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TPrivateReportRepository> results = new ArrayList<TPrivateReportRepository>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TPrivateReportRepositoryPeer.row2Object(row, 1,
                TPrivateReportRepositoryPeer.getOMClass()));
        }
        return results;
    }
    ...
    {
         BaseTPrivateReportRepositoryPeer
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPrivateReportRepository> doSelect(TPrivateReportRepository obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TPrivateReportRepository obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TPrivateReportRepository obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TPrivateReportRepository obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TPrivateReportRepository) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TPrivateReportRepository obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TPrivateReportRepository) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TPrivateReportRepository obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TPrivateReportRepository) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TPrivateReportRepository obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TPrivateReportRepository obj )
    {
        ...
        criteria.add(QUERY, obj.getQuery());
    ...
    public static Criteria buildSelectCriteria( TPrivateReportRepository obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TPrivateReportRepository retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TPrivateReportRepository retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TPrivateReportRepository retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TPrivateReportRepository retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TPrivateReportRepository retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TPrivateReportRepository> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (TPrivateReportRepository)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPrivateReportRepository> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TPrivateReportRepository> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPrivateReportRepository> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TPrivateReportRepository> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TPrivateReportRepository>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TPrivateReportRepository objects pre-filled with their
     * TPerson objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TPrivateReportRepositoryPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPrivateReportRepository> doSelectJoinTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPrivateReportRepository> doSelectJoinTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TPrivateReportRepositoryPeer.OWNER,
            TPersonPeer.PKEY);
        ...
        List<TPrivateReportRepository> results = new ArrayList<TPrivateReportRepository>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TPrivateReportRepositoryPeer.getOMClass();
            TPrivateReportRepository obj1 = (TPrivateReportRepository) TPrivateReportRepositoryPeer
            ...
            {
                TPrivateReportRepository temp_obj1 =  results.get(j);
                TPerson temp_obj2 = (TPerson) temp_obj1.getTPerson();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTPrivateReportRepository(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTPrivateReportRepositorys();
                obj2.addTPrivateReportRepository(obj1);
            }
            results.add(obj1);
        }
        return results;
