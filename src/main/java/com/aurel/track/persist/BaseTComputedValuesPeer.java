...
/**
 */
public abstract class BaseTComputedValuesPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TComputedValuesMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TComputedValuesMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the COMPUTEDVALUETYPE field */
    public static final String COMPUTEDVALUETYPE;
    /** the column name for the COMPUTEDVALUE field */
    public static final String COMPUTEDVALUE;
    /** the column name for the MEASUREMENTUNIT field */
    public static final String MEASUREMENTUNIT;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TCOMPUTEDVALUES";

        PKEY = "TCOMPUTEDVALUES.PKEY";
        WORKITEMKEY = "TCOMPUTEDVALUES.WORKITEMKEY";
        EFFORTTYPE = "TCOMPUTEDVALUES.EFFORTTYPE";
        COMPUTEDVALUETYPE = "TCOMPUTEDVALUES.COMPUTEDVALUETYPE";
        COMPUTEDVALUE = "TCOMPUTEDVALUES.COMPUTEDVALUE";
        MEASUREMENTUNIT = "TCOMPUTEDVALUES.MEASUREMENTUNIT";
        PERSON = "TCOMPUTEDVALUES.PERSON";
        TPUUID = "TCOMPUTEDVALUES.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TComputedValuesMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TComputedValuesMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TComputedValues";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TComputedValues> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTComputedValuesPeer
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(COMPUTEDVALUETYPE);
        criteria.addSelectColumn(COMPUTEDVALUE);
        criteria.addSelectColumn(MEASUREMENTUNIT);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TComputedValues row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TComputedValues obj = (TComputedValues) cls.newInstance();
            TComputedValuesPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setWorkitemKey(row.getValue(offset + 1).asIntegerObj());
            obj.setEffortType(row.getValue(offset + 2).asIntegerObj());
            obj.setComputedValueType(row.getValue(offset + 3).asIntegerObj());
            obj.setComputedValue(row.getValue(offset + 4).asDoubleObj());
            obj.setMeasurementUnit(row.getValue(offset + 5).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TComputedValues> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TComputedValues> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TComputedValues> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TComputedValues> results = new ArrayList<TComputedValues>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TComputedValuesPeer.row2Object(row, 1,
                TComputedValuesPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TComputedValues> doSelect(TComputedValues obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TComputedValues obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TComputedValues obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TComputedValues obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TComputedValues) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TComputedValues obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TComputedValues) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TComputedValues obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TComputedValues) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TComputedValues obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TComputedValues obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(PKEY, obj.getObjectID());
        criteria.add(WORKITEMKEY, obj.getWorkitemKey());
        criteria.add(EFFORTTYPE, obj.getEffortType());
        criteria.add(COMPUTEDVALUETYPE, obj.getComputedValueType());
        criteria.add(COMPUTEDVALUE, obj.getComputedValue());
        criteria.add(MEASUREMENTUNIT, obj.getMeasurementUnit());
    ...
    public static Criteria buildSelectCriteria( TComputedValues obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TComputedValues retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TComputedValues retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TComputedValues retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TComputedValues retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TComputedValues retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TComputedValues> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (TComputedValues)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TComputedValues> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TComputedValues> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TComputedValues> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TComputedValues> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TComputedValues>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TComputedValues objects pre-filled with their
     * TWorkItem objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TComputedValuesPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TComputedValues> doSelectJoinTWorkItem(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TComputedValues> doSelectJoinTWorkItem(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TComputedValuesPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TWorkItemPeer.addSelectColumns(criteria);

        criteria.addJoin(TComputedValuesPeer.WORKITEMKEY,
        ...
        List<TComputedValues> results = new ArrayList<TComputedValues>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TComputedValuesPeer.getOMClass();
            TComputedValues obj1 = (TComputedValues) TComputedValuesPeer
            ...
            {
                TComputedValues temp_obj1 =  results.get(j);
                TWorkItem temp_obj2 = (TWorkItem) temp_obj1.getTWorkItem();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTComputedValues(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTComputedValuess();
                obj2.addTComputedValues(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TComputedValues> doSelectJoinTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TComputedValues> doSelectJoinTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TComputedValuesPeer.PERSON,
            TPersonPeer.PKEY);
