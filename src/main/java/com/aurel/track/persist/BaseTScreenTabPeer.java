...
/**
 */
public abstract class BaseTScreenTabPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TScreenTabMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TScreenTabMapBuilder.CLASS_NAME);
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TScreenTab";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TScreenTab> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TScreenTab row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TScreenTab> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TScreenTab> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TScreenTab> populateObjects(List<Record> records)
        throws TorqueException
    {
        ...
        for (int i = 0; i < records.size(); i++)
        {
            ...
            results.add(TScreenTabPeer.row2Object(row, 1,
                TScreenTabPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TScreenTab> doSelect(TScreenTab obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TScreenTab obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TScreenTab obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TScreenTab obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TScreenTab) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TScreenTab obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TScreenTab) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TScreenTab obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TScreenTab) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TScreenTab obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TScreenTab obj )
    {
    ...
    public static Criteria buildSelectCriteria( TScreenTab obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TScreenTab retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TScreenTab retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TScreenTab retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TScreenTab retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TScreenTab retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TScreenTab> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TScreenTab> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TScreenTab> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TScreenTab> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TScreenTab> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TScreenTab>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TScreenTab objects pre-filled with their
     * TScreen objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TScreenTabPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TScreenTab> doSelectJoinTScreen(Criteria criteria)
        throws TorqueException
    {
        ...
        throws TorqueException
    {
        ...
        criteria.addJoin(TScreenTabPeer.PARENT,
        ...
        for (int i = 0; i < rows.size(); i++)
        {
            ...
            TScreenTab obj1 = (TScreenTab) TScreenTabPeer
