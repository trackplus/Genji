...
/**
 */
public abstract class BaseTEscalationStatePeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TEscalationStateMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TEscalationStateMapBuilder.CLASS_NAME);
    }

    /** the column name for the OBJECTID field */
    public static final String OBJECTID;
    /** the column name for the ESCALATIONENTRY field */
    public static final String ESCALATIONENTRY;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TESCALATIONSTATE";

        OBJECTID = "TESCALATIONSTATE.OBJECTID";
        ESCALATIONENTRY = "TESCALATIONSTATE.ESCALATIONENTRY";
        STATUS = "TESCALATIONSTATE.STATUS";
        TPUUID = "TESCALATIONSTATE.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TEscalationStateMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TEscalationStateMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TEscalationState";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEscalationState> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTEscalationStatePeer
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(ESCALATIONENTRY);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TEscalationState row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TEscalationState obj = (TEscalationState) cls.newInstance();
            TEscalationStatePeer.populateObject(row, offset, obj);
    ...
    public static void populateObject(Record row,
                                      int offset,
                                      TEscalationState obj)
        throws TorqueException
    {
        try
        {
            obj.setObjectID(row.getValue(offset + 0).asIntegerObj());
            obj.setEscalationentry(row.getValue(offset + 1).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEscalationState> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEscalationState> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEscalationState> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TEscalationState> results = new ArrayList<TEscalationState>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TEscalationStatePeer.row2Object(row, 1,
                TEscalationStatePeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEscalationState> doSelect(TEscalationState obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TEscalationState obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TEscalationState obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TEscalationState obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TEscalationState) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TEscalationState obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TEscalationState) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TEscalationState obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TEscalationState) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TEscalationState obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TEscalationState obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(OBJECTID, obj.getObjectID());
        criteria.add(ESCALATIONENTRY, obj.getEscalationentry());
    ...
    public static Criteria buildSelectCriteria( TEscalationState obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TEscalationState retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TEscalationState retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TEscalationState retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TEscalationState retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TEscalationState retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TEscalationState> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (TEscalationState)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEscalationState> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TEscalationState> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEscalationState> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TEscalationState> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TEscalationState>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TEscalationState objects pre-filled with their
     * TEscalationEntry objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TEscalationStatePeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TEscalationState> doSelectJoinTEscalationEntry(Criteria criteria)
        throws TorqueException
    {
        return doSelectJoinTEscalationEntry(criteria, null);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TEscalationState> doSelectJoinTEscalationEntry(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TEscalationStatePeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TEscalationEntryPeer.addSelectColumns(criteria);

        criteria.addJoin(TEscalationStatePeer.ESCALATIONENTRY,
            TEscalationEntryPeer.OBJECTID);
        ...
        List<TEscalationState> results = new ArrayList<TEscalationState>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TEscalationStatePeer.getOMClass();
            TEscalationState obj1 = (TEscalationState) TEscalationStatePeer
                .row2Object(row, 1, omClass);
             omClass = TEscalationEntryPeer.getOMClass();
            TEscalationEntry obj2 = (TEscalationEntry) TEscalationEntryPeer
                .row2Object(row, offset, omClass);

            boolean newObject = true;
            for (int j = 0; j < results.size(); j++)
            {
                TEscalationState temp_obj1 =  results.get(j);
                TEscalationEntry temp_obj2 = (TEscalationEntry) temp_obj1.getTEscalationEntry();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTEscalationState(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTEscalationStates();
                obj2.addTEscalationState(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TEscalationState> doSelectJoinTState(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TEscalationState> doSelectJoinTState(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TEscalationStatePeer.STATUS,
            TStatePeer.PKEY);
