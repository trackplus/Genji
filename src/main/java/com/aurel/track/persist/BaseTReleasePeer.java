...
/**
 */
public abstract class BaseTReleasePeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TReleaseMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TReleaseMapBuilder.CLASS_NAME);
    }
    ...
    static
    {
        ...
        PROJKEY = "TRELEASE.PROJKEY";
        STATUS = "TRELEASE.STATUS";
        SORTORDER = "TRELEASE.SORTORDER";
        MOREPROPS = "TRELEASE.MOREPROPS";
        DESCRIPTION = "TRELEASE.DESCRIPTION";
        DUEDATE = "TRELEASE.DUEDATE";
        PARENT = "TRELEASE.PARENT";
        TPUUID = "TRELEASE.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TReleaseMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TReleaseMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TRelease";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRelease> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(DUEDATE);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TRelease row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TRelease obj = (TRelease) cls.newInstance();
            TReleasePeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setStatus(row.getValue(offset + 3).asIntegerObj());
            obj.setSortorder(row.getValue(offset + 4).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRelease> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRelease> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRelease> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TRelease> results = new ArrayList<TRelease>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TReleasePeer.row2Object(row, 1,
                TReleasePeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRelease> doSelect(TRelease obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TRelease obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TRelease obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TRelease obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TRelease) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TRelease obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TRelease) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TRelease obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TRelease) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TRelease obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TRelease obj )
    {
        ...
        criteria.add(DUEDATE, obj.getDueDate());
    ...
    public static Criteria buildSelectCriteria( TRelease obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TRelease retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TRelease retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TRelease retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TRelease retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TRelease retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TRelease> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRelease> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TRelease> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRelease> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TRelease> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TRelease>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TRelease objects pre-filled with their
     * TProject objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TReleasePeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TRelease> doSelectJoinTProject(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TRelease> doSelectJoinTProject(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TReleasePeer.PROJKEY,
            TProjectPeer.PKEY);
        ...
        List<TRelease> results = new ArrayList<TRelease>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TReleasePeer.getOMClass();
            TRelease obj1 = (TRelease) TReleasePeer
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TRelease> doSelectJoinTSystemState(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TRelease> doSelectJoinTSystemState(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TReleasePeer.STATUS,
    ...
    /**
     * selects a collection of TRelease objects pre-filled with
     * all related objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TRelease> doSelectJoinAllExceptTProject(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TRelease> doSelectJoinAllExceptTProject(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        TSystemStatePeer.addSelectColumns(criteria);
        criteria.addJoin(TReleasePeer.STATUS, TSystemStatePeer.OBJECTID);
        int offset3 = offset2 + TSystemStatePeer.numColumns;
 ...
 boolean  newObject = true;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TRelease> doSelectJoinAllExceptTSystemState(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TRelease> doSelectJoinAllExceptTSystemState(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        TProjectPeer.addSelectColumns(criteria);
        criteria.addJoin(TReleasePeer.PROJKEY, TProjectPeer.PKEY);
 ...
 boolean  newObject = true;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TRelease> doSelectJoinAllExceptTRelease(Criteria criteria)
        throws TorqueException
    {
        return doSelectJoinAllExceptTRelease(criteria, null);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TRelease> doSelectJoinAllExceptTRelease(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
 ...
 boolean  newObject = true;
            ...
            if (newObject)
            {
             ...
             omClass = TSystemStatePeer.getOMClass();
            TSystemState obj3 = (TSystemState) TSystemStatePeer
 ...
 newObject = true;
            ...
            {
                TRelease temp_obj1 =  results.get(j);
                TSystemState temp_obj3 = (TSystemState) temp_obj1.getTSystemState();
                if (temp_obj3.getPrimaryKey().equals(obj3.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj3.addTRelease(obj1);
                    break;
                }
            }
            if (newObject)
