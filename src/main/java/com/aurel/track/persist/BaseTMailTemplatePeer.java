 ...
 *
 */
public abstract class BaseTMailTemplatePeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TMailTemplateMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TMailTemplateMapBuilder.CLASS_NAME);
    }

    /** the column name for the OBJECTID field */
    public static final String OBJECTID;
    /** the column name for the TEMPLATETYPE field */
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TMAILTEMPLATE";

        OBJECTID = "TMAILTEMPLATE.OBJECTID";
        TEMPLATETYPE = "TMAILTEMPLATE.TEMPLATETYPE";
        NAME = "TMAILTEMPLATE.NAME";
        DESCRIPTION = "TMAILTEMPLATE.DESCRIPTION";
        TAGLABEL = "TMAILTEMPLATE.TAGLABEL";
        TPUUID = "TMAILTEMPLATE.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TMailTemplateMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TMailTemplateMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TMailTemplate";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TMailTemplate> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(TEMPLATETYPE);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TMailTemplate row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TMailTemplate obj = (TMailTemplate) cls.newInstance();
            TMailTemplatePeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setTemplateType(row.getValue(offset + 1).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TMailTemplate> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TMailTemplate> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TMailTemplate> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TMailTemplate> results = new ArrayList<TMailTemplate>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TMailTemplatePeer.row2Object(row, 1,
                TMailTemplatePeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TMailTemplate> doSelect(TMailTemplate obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TMailTemplate obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TMailTemplate obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TMailTemplate obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TMailTemplate) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TMailTemplate obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TMailTemplate) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TMailTemplate obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TMailTemplate) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TMailTemplate obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TMailTemplate obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(OBJECTID, obj.getObjectID());
        criteria.add(TEMPLATETYPE, obj.getTemplateType());
    ...
    public static Criteria buildSelectCriteria( TMailTemplate obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TMailTemplate retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TMailTemplate retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TMailTemplate retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TMailTemplate retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TMailTemplate retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TMailTemplate> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TMailTemplate> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TMailTemplate> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TMailTemplate> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TMailTemplate> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TMailTemplate>();
        }
        else
        {
            Criteria criteria = new Criteria();
