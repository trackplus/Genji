 ...
 *
 */
public abstract class BaseTRepositoryPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TRepositoryMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TRepositoryMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the REPOSITORYURL field */
    public static final String REPOSITORYURL;
    ...
    /** the column name for the STATUSKEY field */
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TREPOSITORY";

        OBJECTID = "TREPOSITORY.OBJECTID";
        REPOSITORYTYPE = "TREPOSITORY.REPOSITORYTYPE";
        REPOSITORYURL = "TREPOSITORY.REPOSITORYURL";
        STARTDATE = "TREPOSITORY.STARTDATE";
        ENDDATE = "TREPOSITORY.ENDDATE";
        STATUSKEY = "TREPOSITORY.STATUSKEY";
        TPUUID = "TREPOSITORY.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TRepositoryMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TRepositoryMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TRepository";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRepository> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(REPOSITORYURL);
        criteria.addSelectColumn(STARTDATE);
        criteria.addSelectColumn(ENDDATE);
        criteria.addSelectColumn(STATUSKEY);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TRepository row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TRepository obj = (TRepository) cls.newInstance();
            TRepositoryPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setRepositoryType(row.getValue(offset + 1).asString());
            obj.setRepositoryURL(row.getValue(offset + 2).asString());
            obj.setStartDate(row.getValue(offset + 3).asUtilDate());
            obj.setEndDate(row.getValue(offset + 4).asUtilDate());
            obj.setStatusKey(row.getValue(offset + 5).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRepository> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRepository> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRepository> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TRepository> results = new ArrayList<TRepository>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TRepositoryPeer.row2Object(row, 1,
                TRepositoryPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRepository> doSelect(TRepository obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TRepository obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TRepository obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TRepository obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TRepository) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TRepository obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TRepository) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TRepository obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TRepository) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TRepository obj, Connection con)
        throws TorqueException
    {
     ...
     */
    public static TRepository retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TRepository retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TRepository retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TRepository retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TRepository retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TRepository> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRepository> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TRepository> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRepository> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TRepository> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TRepository>();
        }
        else
        {
            Criteria criteria = new Criteria();
