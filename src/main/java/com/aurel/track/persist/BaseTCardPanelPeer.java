...
/**
 */
public abstract class BaseTCardPanelPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TCardPanelMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TCardPanelMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TCARDPANEL";

        OBJECTID = "TCARDPANEL.OBJECTID";
        PERSON = "TCARDPANEL.PERSON";
        ROWSNO = "TCARDPANEL.ROWSNO";
        COLSNO = "TCARDPANEL.COLSNO";
        TPUUID = "TCARDPANEL.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TCardPanelMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TCardPanelMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TCardPanel";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TCardPanel> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TCardPanel row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TCardPanel obj = (TCardPanel) cls.newInstance();
            TCardPanelPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setRowsNo(row.getValue(offset + 2).asIntegerObj());
            obj.setColsNo(row.getValue(offset + 3).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TCardPanel> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TCardPanel> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TCardPanel> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TCardPanel> results = new ArrayList<TCardPanel>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TCardPanelPeer.row2Object(row, 1,
                TCardPanelPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TCardPanel> doSelect(TCardPanel obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TCardPanel obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TCardPanel obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TCardPanel obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TCardPanel) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TCardPanel obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TCardPanel) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TCardPanel obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TCardPanel) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TCardPanel obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TCardPanel obj )
    {
    ...
    public static Criteria buildSelectCriteria( TCardPanel obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TCardPanel retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TCardPanel retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TCardPanel retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TCardPanel retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TCardPanel retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TCardPanel> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TCardPanel> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TCardPanel> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TCardPanel> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TCardPanel> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TCardPanel>();
        }
        else
        {
            Criteria criteria = new Criteria();
