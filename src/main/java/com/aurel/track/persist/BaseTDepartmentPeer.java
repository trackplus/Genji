 ...
 *
 */
public abstract class BaseTDepartmentPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TDepartmentMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TDepartmentMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the COSTCENTER field */
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TDEPARTMENT";

        PKEY = "TDEPARTMENT.PKEY";
        LABEL = "TDEPARTMENT.LABEL";
        COSTCENTER = "TDEPARTMENT.COSTCENTER";
        PARENT = "TDEPARTMENT.PARENT";
        DOMAINKEY = "TDEPARTMENT.DOMAINKEY";
        TPUUID = "TDEPARTMENT.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TDepartmentMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TDepartmentMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TDepartment";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDepartment> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(COSTCENTER);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TDepartment row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TDepartment obj = (TDepartment) cls.newInstance();
            TDepartmentPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setCostcenter(row.getValue(offset + 2).asIntegerObj());
            obj.setParent(row.getValue(offset + 3).asIntegerObj());
            obj.setDomain(row.getValue(offset + 4).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDepartment> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDepartment> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDepartment> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TDepartment> results = new ArrayList<TDepartment>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TDepartmentPeer.row2Object(row, 1,
                TDepartmentPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDepartment> doSelect(TDepartment obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TDepartment obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TDepartment obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TDepartment obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TDepartment) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TDepartment obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TDepartment) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TDepartment obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TDepartment) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TDepartment obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TDepartment obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(PKEY, obj.getObjectID());
        criteria.add(LABEL, obj.getLabel());
        criteria.add(COSTCENTER, obj.getCostcenter());
    ...
    public static Criteria buildSelectCriteria( TDepartment obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TDepartment retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TDepartment retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TDepartment retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TDepartment retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TDepartment retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TDepartment> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDepartment> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TDepartment> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDepartment> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TDepartment> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TDepartment>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TDepartment objects pre-filled with their
     * TCostCenter objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TDepartmentPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TDepartment> doSelectJoinTCostCenter(Criteria criteria)
        throws TorqueException
    {
        return doSelectJoinTCostCenter(criteria, null);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TDepartment> doSelectJoinTCostCenter(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        TCostCenterPeer.addSelectColumns(criteria);

        criteria.addJoin(TDepartmentPeer.COSTCENTER,
        ...
        List<TDepartment> results = new ArrayList<TDepartment>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TDepartmentPeer.getOMClass();
            TDepartment obj1 = (TDepartment) TDepartmentPeer
                .row2Object(row, 1, omClass);
             omClass = TCostCenterPeer.getOMClass();
            TCostCenter obj2 = (TCostCenter) TCostCenterPeer
                .row2Object(row, offset, omClass);

            boolean newObject = true;
            for (int j = 0; j < results.size(); j++)
            {
                TDepartment temp_obj1 =  results.get(j);
                TCostCenter temp_obj2 = (TCostCenter) temp_obj1.getTCostCenter();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTDepartment(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTDepartments();
                obj2.addTDepartment(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TDepartment> doSelectJoinTDomain(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TDepartment> doSelectJoinTDomain(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TDepartmentPeer.DOMAINKEY,
