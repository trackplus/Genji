 ...
 *
 */
public abstract class BaseTNavigatorColumnPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TNavigatorColumnMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TNavigatorColumnMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TNAVIGATORCOLUMN";

        OBJECTID = "TNAVIGATORCOLUMN.OBJECTID";
        NAVIGATORLAYOUT = "TNAVIGATORCOLUMN.NAVIGATORLAYOUT";
        FIELD = "TNAVIGATORCOLUMN.FIELD";
        FIELDPOSITION = "TNAVIGATORCOLUMN.FIELDPOSITION";
        FIELDWIDTH = "TNAVIGATORCOLUMN.FIELDWIDTH";
        TPUUID = "TNAVIGATORCOLUMN.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TNavigatorColumnMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TNavigatorColumnMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TNavigatorColumn";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TNavigatorColumn> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTNavigatorColumnPeer
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TNavigatorColumn row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TNavigatorColumn obj = (TNavigatorColumn) cls.newInstance();
            TNavigatorColumnPeer.populateObject(row, offset, obj);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TNavigatorColumn> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TNavigatorColumn> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TNavigatorColumn> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TNavigatorColumn> results = new ArrayList<TNavigatorColumn>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TNavigatorColumnPeer.row2Object(row, 1,
                TNavigatorColumnPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TNavigatorColumn> doSelect(TNavigatorColumn obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TNavigatorColumn obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TNavigatorColumn obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TNavigatorColumn obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TNavigatorColumn) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TNavigatorColumn obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TNavigatorColumn) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TNavigatorColumn obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TNavigatorColumn) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TNavigatorColumn obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TNavigatorColumn obj )
    {
    ...
    public static Criteria buildSelectCriteria( TNavigatorColumn obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TNavigatorColumn retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TNavigatorColumn retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TNavigatorColumn retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TNavigatorColumn retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TNavigatorColumn retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TNavigatorColumn> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (TNavigatorColumn)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TNavigatorColumn> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TNavigatorColumn> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TNavigatorColumn> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TNavigatorColumn> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TNavigatorColumn>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TNavigatorColumn objects pre-filled with their
     * TNavigatorLayout objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TNavigatorColumnPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TNavigatorColumn> doSelectJoinTNavigatorLayout(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TNavigatorColumn> doSelectJoinTNavigatorLayout(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TNavigatorColumnPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TNavigatorLayoutPeer.addSelectColumns(criteria);

        criteria.addJoin(TNavigatorColumnPeer.NAVIGATORLAYOUT,
        ...
        List<TNavigatorColumn> results = new ArrayList<TNavigatorColumn>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TNavigatorColumnPeer.getOMClass();
            TNavigatorColumn obj1 = (TNavigatorColumn) TNavigatorColumnPeer
            ...
            {
                TNavigatorColumn temp_obj1 =  results.get(j);
                TNavigatorLayout temp_obj2 = (TNavigatorLayout) temp_obj1.getTNavigatorLayout();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTNavigatorColumn(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTNavigatorColumns();
                obj2.addTNavigatorColumn(obj1);
            }
            results.add(obj1);
        }
        return results;
