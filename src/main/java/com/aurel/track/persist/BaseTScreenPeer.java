...
/**
 */
public abstract class BaseTScreenPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TScreenMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TScreenMapBuilder.CLASS_NAME);
    }
    ...
    static
    {
        ...
        OBJECTID = "TSCREEN.OBJECTID";
        NAME = "TSCREEN.NAME";
        LABEL = "TSCREEN.LABEL";
        TAGLABEL = "TSCREEN.TAGLABEL";
        DESCRIPTION = "TSCREEN.DESCRIPTION";
        OWNER = "TSCREEN.OWNER";
        PROJECTTYPE = "TSCREEN.PROJECTTYPE";
        PROJECT = "TSCREEN.PROJECT";
        TPUUID = "TSCREEN.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TScreenMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TScreenMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TScreen";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TScreen> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TScreen row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TScreen obj = (TScreen) cls.newInstance();
            TScreenPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setTagLabel(row.getValue(offset + 3).asString());
            obj.setDescription(row.getValue(offset + 4).asString());
            obj.setOwner(row.getValue(offset + 5).asIntegerObj());
            obj.setProjectType(row.getValue(offset + 6).asIntegerObj());
            obj.setProject(row.getValue(offset + 7).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TScreen> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TScreen> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TScreen> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TScreen> results = new ArrayList<TScreen>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TScreenPeer.row2Object(row, 1,
                TScreenPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TScreen> doSelect(TScreen obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TScreen obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TScreen obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TScreen obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TScreen) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TScreen obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TScreen) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TScreen obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TScreen) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TScreen obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TScreen obj )
    {
    ...
    public static Criteria buildSelectCriteria( TScreen obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TScreen retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TScreen retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TScreen retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TScreen retVal = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TScreen retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TScreen> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TScreen> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TScreen> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TScreen> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TScreen> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TScreen>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TScreen objects pre-filled with their
     * TPerson objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TScreenPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TScreen> doSelectJoinTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TScreen> doSelectJoinTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TScreenPeer.OWNER,
            TPersonPeer.PKEY);
        ...
        List<TScreen> results = new ArrayList<TScreen>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TScreenPeer.getOMClass();
            TScreen obj1 = (TScreen) TScreenPeer
            ...
            {
                TScreen temp_obj1 =  results.get(j);
                TPerson temp_obj2 = (TPerson) temp_obj1.getTPerson();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTScreen(obj1);
                    break;
                }
            }
            if (newObject)
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TScreen> doSelectJoinTProjectType(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TScreen> doSelectJoinTProjectType(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TScreenPeer.PROJECTTYPE,
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TScreen> doSelectJoinTProject(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TScreen> doSelectJoinTProject(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TScreenPeer.PROJECT,
            TProjectPeer.PKEY);
    ...
    /**
     * selects a collection of TScreen objects pre-filled with
     * all related objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TScreen> doSelectJoinAllExceptTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TScreen> doSelectJoinAllExceptTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        TProjectTypePeer.addSelectColumns(criteria);
        criteria.addJoin(TScreenPeer.PROJECTTYPE, TProjectTypePeer.OBJECTID);
        int offset3 = offset2 + TProjectTypePeer.numColumns;

        TProjectPeer.addSelectColumns(criteria);
        criteria.addJoin(TScreenPeer.PROJECT, TProjectPeer.PKEY);
 ...
 newObject = true;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TScreen> doSelectJoinAllExceptTProjectType(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TScreen> doSelectJoinAllExceptTProjectType(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        TPersonPeer.addSelectColumns(criteria);
        criteria.addJoin(TScreenPeer.OWNER, TPersonPeer.PKEY);
 ...
 newObject = true;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TScreen> doSelectJoinAllExceptTProject(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TScreen> doSelectJoinAllExceptTProject(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
