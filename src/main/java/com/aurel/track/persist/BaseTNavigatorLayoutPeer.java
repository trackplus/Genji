 ...
 *
 */
public abstract class BaseTNavigatorLayoutPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TNavigatorLayoutMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TNavigatorLayoutMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the FILTERID field */
    public static final String FILTERID;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TNAVIGATORLAYOUT";

        OBJECTID = "TNAVIGATORLAYOUT.OBJECTID";
        PERSON = "TNAVIGATORLAYOUT.PERSON";
        FILTERID = "TNAVIGATORLAYOUT.FILTERID";
        FILTERTYPE = "TNAVIGATORLAYOUT.FILTERTYPE";
        TPUUID = "TNAVIGATORLAYOUT.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TNavigatorLayoutMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TNavigatorLayoutMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TNavigatorLayout";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TNavigatorLayout> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTNavigatorLayoutPeer
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(FILTERID);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TNavigatorLayout row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TNavigatorLayout obj = (TNavigatorLayout) cls.newInstance();
            TNavigatorLayoutPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setFilterID(row.getValue(offset + 2).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TNavigatorLayout> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TNavigatorLayout> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TNavigatorLayout> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TNavigatorLayout> results = new ArrayList<TNavigatorLayout>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TNavigatorLayoutPeer.row2Object(row, 1,
                TNavigatorLayoutPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TNavigatorLayout> doSelect(TNavigatorLayout obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TNavigatorLayout obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TNavigatorLayout obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TNavigatorLayout obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TNavigatorLayout) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TNavigatorLayout obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TNavigatorLayout) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TNavigatorLayout obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TNavigatorLayout) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TNavigatorLayout obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TNavigatorLayout obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(OBJECTID, obj.getObjectID());
        criteria.add(PERSON, obj.getPerson());
        criteria.add(FILTERID, obj.getFilterID());
    ...
    public static Criteria buildSelectCriteria( TNavigatorLayout obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TNavigatorLayout retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TNavigatorLayout retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TNavigatorLayout retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TNavigatorLayout retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TNavigatorLayout retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TNavigatorLayout> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (TNavigatorLayout)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TNavigatorLayout> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TNavigatorLayout> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TNavigatorLayout> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TNavigatorLayout> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TNavigatorLayout>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TNavigatorLayout objects pre-filled with their
     * TPerson objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TNavigatorLayoutPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TNavigatorLayout> doSelectJoinTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TNavigatorLayout> doSelectJoinTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TNavigatorLayoutPeer.PERSON,
            TPersonPeer.PKEY);
        ...
        List<TNavigatorLayout> results = new ArrayList<TNavigatorLayout>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TNavigatorLayoutPeer.getOMClass();
            TNavigatorLayout obj1 = (TNavigatorLayout) TNavigatorLayoutPeer
            ...
            {
                TNavigatorLayout temp_obj1 =  results.get(j);
                TPerson temp_obj2 = (TPerson) temp_obj1.getTPerson();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTNavigatorLayout(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTNavigatorLayouts();
                obj2.addTNavigatorLayout(obj1);
            }
            results.add(obj1);
        }
        return results;
