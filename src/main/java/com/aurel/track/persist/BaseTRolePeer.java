...
/**
 */
public abstract class BaseTRolePeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TRoleMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TRoleMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the EXTENDEDACCESSKEY field */
    public static final String EXTENDEDACCESSKEY;
    ...
    static
    {
        ...
        PKEY = "TROLE.PKEY";
        LABEL = "TROLE.LABEL";
        ACCESSKEY = "TROLE.ACCESSKEY";
        EXTENDEDACCESSKEY = "TROLE.EXTENDEDACCESSKEY";
        PROJECTTYPE = "TROLE.PROJECTTYPE";
        TPUUID = "TROLE.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TRoleMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TRoleMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRole> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(ACCESSKEY);
        criteria.addSelectColumn(EXTENDEDACCESSKEY);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TRole row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TRole obj = (TRole) cls.newInstance();
            TRolePeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setAccesskey(row.getValue(offset + 2).asIntegerObj());
            obj.setExtendedaccesskey(row.getValue(offset + 3).asString());
            obj.setProjecttype(row.getValue(offset + 4).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRole> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRole> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRole> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TRole> results = new ArrayList<TRole>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TRolePeer.row2Object(row, 1,
                TRolePeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRole> doSelect(TRole obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TRole obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TRole obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TRole obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TRole) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TRole obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TRole) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TRole obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TRole) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TRole obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TRole obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(PKEY, obj.getObjectID());
        criteria.add(LABEL, obj.getLabel());
        criteria.add(ACCESSKEY, obj.getAccesskey());
        criteria.add(EXTENDEDACCESSKEY, obj.getExtendedaccesskey());
    ...
    public static Criteria buildSelectCriteria( TRole obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TRole retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TRole retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TRole retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TRole retVal = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TRole retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TRole> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRole> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TRole> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRole> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TRole> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TRole>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TRole objects pre-filled with their
     * TProjectType objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TRolePeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TRole> doSelectJoinTProjectType(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TRole> doSelectJoinTProjectType(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TRolePeer.PROJECTTYPE,
        ...
        for (int i = 0; i < rows.size(); i++)
        {
            ...
            Class omClass = TRolePeer.getOMClass();
            TRole obj1 = (TRole) TRolePeer
