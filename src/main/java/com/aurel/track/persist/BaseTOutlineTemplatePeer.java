 ...
 *
 */
public abstract class BaseTOutlineTemplatePeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TOutlineTemplateMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TOutlineTemplateMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TOUTLINETEMPLATE";

        OBJECTID = "TOUTLINETEMPLATE.OBJECTID";
        LABEL = "TOUTLINETEMPLATE.LABEL";
        ENTITYTYPE = "TOUTLINETEMPLATE.ENTITYTYPE";
        TPUUID = "TOUTLINETEMPLATE.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TOutlineTemplateMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TOutlineTemplateMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TOutlineTemplate";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TOutlineTemplate> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTOutlineTemplatePeer
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TOutlineTemplate row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TOutlineTemplate obj = (TOutlineTemplate) cls.newInstance();
            TOutlineTemplatePeer.populateObject(row, offset, obj);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TOutlineTemplate> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TOutlineTemplate> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TOutlineTemplate> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TOutlineTemplate> results = new ArrayList<TOutlineTemplate>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TOutlineTemplatePeer.row2Object(row, 1,
                TOutlineTemplatePeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TOutlineTemplate> doSelect(TOutlineTemplate obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TOutlineTemplate obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TOutlineTemplate obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TOutlineTemplate obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TOutlineTemplate) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TOutlineTemplate obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TOutlineTemplate) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TOutlineTemplate obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TOutlineTemplate) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TOutlineTemplate obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TOutlineTemplate obj )
    {
    ...
    public static Criteria buildSelectCriteria( TOutlineTemplate obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TOutlineTemplate retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TOutlineTemplate retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TOutlineTemplate retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TOutlineTemplate retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TOutlineTemplate retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TOutlineTemplate> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (TOutlineTemplate)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TOutlineTemplate> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TOutlineTemplate> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TOutlineTemplate> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TOutlineTemplate> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TOutlineTemplate>();
        }
        else
        {
            Criteria criteria = new Criteria();
