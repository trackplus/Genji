...
/**
 */
public abstract class BaseTAttributePeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TAttributeMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TAttributeMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the ATTRIBUTETYPE field */
    ...
    /** the column name for the REQUIREDOPTION field */
    public static final String REQUIREDOPTION;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TATTRIBUTE";

        OBJECTID = "TATTRIBUTE.OBJECTID";
        ATTRIBUTENAME = "TATTRIBUTE.ATTRIBUTENAME";
        ATTRIBUTETYPE = "TATTRIBUTE.ATTRIBUTETYPE";
        DELETED = "TATTRIBUTE.DELETED";
        DESCRIPTION = "TATTRIBUTE.DESCRIPTION";
        PERMISSION = "TATTRIBUTE.PERMISSION";
        REQUIREDOPTION = "TATTRIBUTE.REQUIREDOPTION";
        TPUUID = "TATTRIBUTE.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TAttributeMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TAttributeMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAttribute> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(ATTRIBUTENAME);
        criteria.addSelectColumn(ATTRIBUTETYPE);
        criteria.addSelectColumn(DELETED);
        criteria.addSelectColumn(DESCRIPTION);
        criteria.addSelectColumn(PERMISSION);
        criteria.addSelectColumn(REQUIREDOPTION);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TAttribute row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TAttribute obj = (TAttribute) cls.newInstance();
            TAttributePeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setAttributeName(row.getValue(offset + 1).asString());
            obj.setAttributeType(row.getValue(offset + 2).asIntegerObj());
            obj.setDeleted(row.getValue(offset + 3).asIntegerObj());
            obj.setDescription(row.getValue(offset + 4).asString());
            obj.setPermission(row.getValue(offset + 5).asString());
            obj.setRequiredOption(row.getValue(offset + 6).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAttribute> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAttribute> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAttribute> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TAttribute> results = new ArrayList<TAttribute>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TAttributePeer.row2Object(row, 1,
                TAttributePeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAttribute> doSelect(TAttribute obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TAttribute obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TAttribute obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TAttribute obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TAttribute) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TAttribute obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TAttribute) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TAttribute obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TAttribute) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TAttribute obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TAttribute obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(OBJECTID, obj.getObjectID());
        criteria.add(ATTRIBUTENAME, obj.getAttributeName());
        criteria.add(ATTRIBUTETYPE, obj.getAttributeType());
        criteria.add(DELETED, obj.getDeleted());
        criteria.add(DESCRIPTION, obj.getDescription());
        criteria.add(PERMISSION, obj.getPermission());
        criteria.add(REQUIREDOPTION, obj.getRequiredOption());
        criteria.add(TPUUID, obj.getUuid());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( TAttribute obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TAttribute retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TAttribute retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TAttribute retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TAttribute retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TAttribute> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAttribute> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TAttribute> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAttribute> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TAttribute> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TAttribute>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TAttribute objects pre-filled with their
     * TAttributeOption objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TAttributePeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TAttribute> doSelectJoinTAttributeOption(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TAttribute> doSelectJoinTAttributeOption(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TAttributePeer.REQUIREDOPTION,
        ...
        List<TAttribute> results = new ArrayList<TAttribute>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TAttributePeer.getOMClass();
            TAttribute obj1 = (TAttribute) TAttributePeer
            ...
            {
                TAttribute temp_obj1 =  results.get(j);
                TAttributeOption temp_obj2 = (TAttributeOption) temp_obj1.getTAttributeOption();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTAttribute(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTAttributes();
                obj2.addTAttribute(obj1);
            }
            results.add(obj1);
        }
        return results;
