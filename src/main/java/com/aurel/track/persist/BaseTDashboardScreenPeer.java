...
/**
 */
public abstract class BaseTDashboardScreenPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TDashboardScreenMapBuilder.CLASS_NAME) instead
     */
    ...
    /** the column name for the PERSONPKEY field */
    public static final String PERSONPKEY;
    /** the column name for the PROJECT field */
    public static final String PROJECT;
    /** the column name for the ENTITYTYPE field */
    public static final String ENTITYTYPE;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TDASHBOARDSCREEN";

        OBJECTID = "TDASHBOARDSCREEN.OBJECTID";
        NAME = "TDASHBOARDSCREEN.NAME";
        LABEL = "TDASHBOARDSCREEN.LABEL";
        PERSONPKEY = "TDASHBOARDSCREEN.PERSONPKEY";
        PROJECT = "TDASHBOARDSCREEN.PROJECT";
        ENTITYTYPE = "TDASHBOARDSCREEN.ENTITYTYPE";
        OWNER = "TDASHBOARDSCREEN.OWNER";
        DESCRIPTION = "TDASHBOARDSCREEN.DESCRIPTION";
        TPUUID = "TDASHBOARDSCREEN.TPUUID";
        if (Torque.isInit())
        {
            try
            {
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TDashboardScreen";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDashboardScreen> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTDashboardScreenPeer
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TDashboardScreen row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TDashboardScreen obj = (TDashboardScreen) cls.newInstance();
            TDashboardScreenPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setEntityType(row.getValue(offset + 5).asIntegerObj());
            obj.setOwner(row.getValue(offset + 6).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDashboardScreen> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDashboardScreen> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TDashboardScreen> results = new ArrayList<TDashboardScreen>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TDashboardScreenPeer.row2Object(row, 1,
                TDashboardScreenPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDashboardScreen> doSelect(TDashboardScreen obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TDashboardScreen obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TDashboardScreen obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TDashboardScreen obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TDashboardScreen) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TDashboardScreen obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TDashboardScreen) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TDashboardScreen obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TDashboardScreen) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TDashboardScreen obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TDashboardScreen obj )
    {
        ...
        criteria.add(PERSONPKEY, obj.getPerson());
        criteria.add(PROJECT, obj.getProject());
        criteria.add(ENTITYTYPE, obj.getEntityType());
    ...
    public static Criteria buildSelectCriteria( TDashboardScreen obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TDashboardScreen retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TDashboardScreen retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TDashboardScreen retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TDashboardScreen retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TDashboardScreen retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TDashboardScreen> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (TDashboardScreen)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDashboardScreen> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TDashboardScreen> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDashboardScreen> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TDashboardScreen> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TDashboardScreen>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TDashboardScreen objects pre-filled with their
     * TPerson objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TDashboardScreenPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TDashboardScreen> doSelectJoinTPersonRelatedByPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TDashboardScreen> doSelectJoinTPersonRelatedByPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TDashboardScreenPeer.PERSONPKEY,
            TPersonPeer.PKEY);
        ...
        List<TDashboardScreen> results = new ArrayList<TDashboardScreen>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TDashboardScreenPeer.getOMClass();
            TDashboardScreen obj1 = (TDashboardScreen) TDashboardScreenPeer
            ...
            {
                TDashboardScreen temp_obj1 =  results.get(j);
                TPerson temp_obj2 = (TPerson) temp_obj1.getTPersonRelatedByPerson();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTDashboardScreenRelatedByPerson(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTDashboardScreensRelatedByPerson();
                obj2.addTDashboardScreenRelatedByPerson(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TDashboardScreen> doSelectJoinTProject(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TDashboardScreen> doSelectJoinTProject(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TDashboardScreenPeer.PROJECT,
            TProjectPeer.PKEY);
        ...
        for (int i = 0; i < rows.size(); i++)
        {
            ...
            for (int j = 0; j < results.size(); j++)
            {
                ...
                {
                    newObject = false;
                    temp_obj2.addTDashboardScreen(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTDashboardScreens();
                obj2.addTDashboardScreen(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TDashboardScreen> doSelectJoinTPersonRelatedByOwner(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TDashboardScreen> doSelectJoinTPersonRelatedByOwner(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TDashboardScreenPeer.OWNER,
            TPersonPeer.PKEY);
        ...
        for (int i = 0; i < rows.size(); i++)
        {
            ...
            {
                TDashboardScreen temp_obj1 =  results.get(j);
                TPerson temp_obj2 = (TPerson) temp_obj1.getTPersonRelatedByOwner();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTDashboardScreenRelatedByOwner(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTDashboardScreensRelatedByOwner();
                obj2.addTDashboardScreenRelatedByOwner(obj1);
            }
            results.add(obj1);
        }
        return results;
    ...
    /**
     * selects a collection of TDashboardScreen objects pre-filled with
     * all related objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TDashboardScreen> doSelectJoinAllExceptTPersonRelatedByPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TDashboardScreen> doSelectJoinAllExceptTPersonRelatedByPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
 ...
 boolean  newObject = true;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TDashboardScreen> doSelectJoinAllExceptTProject(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TDashboardScreen> doSelectJoinAllExceptTProject(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
 ...
 newObject = true;
            ...
            {
                TDashboardScreen temp_obj1 =  results.get(j);
                TPerson temp_obj3 = (TPerson) temp_obj1.getTPersonRelatedByOwner();
                if (temp_obj3.getPrimaryKey().equals(obj3.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj3.addTDashboardScreenRelatedByOwner(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj3.initTDashboardScreensRelatedByOwner();
                obj3.addTDashboardScreenRelatedByOwner(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TDashboardScreen> doSelectJoinAllExceptTPersonRelatedByOwner(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TDashboardScreen> doSelectJoinAllExceptTPersonRelatedByOwner(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
