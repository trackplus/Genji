 ...
 *
 */
public abstract class BaseTMailTextBlockPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TMailTextBlockMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TMailTextBlockMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the BLOCKTITLE field */
    public static final String BLOCKTITLE;
    /** the column name for the BLOCKCONTENT field */
    public static final String BLOCKCONTENT;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TMAILTEXTBLOCK";

        OBJECTID = "TMAILTEXTBLOCK.OBJECTID";
        PERSON = "TMAILTEXTBLOCK.PERSON";
        BLOCKTITLE = "TMAILTEXTBLOCK.BLOCKTITLE";
        BLOCKCONTENT = "TMAILTEXTBLOCK.BLOCKCONTENT";
        TAGLABEL = "TMAILTEXTBLOCK.TAGLABEL";
        REPOSITORYTYPE = "TMAILTEXTBLOCK.REPOSITORYTYPE";
        PROJECT = "TMAILTEXTBLOCK.PROJECT";
        TPUUID = "TMAILTEXTBLOCK.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TMailTextBlockMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TMailTextBlockMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TMailTextBlock";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TMailTextBlock> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(BLOCKTITLE);
        criteria.addSelectColumn(BLOCKCONTENT);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TMailTextBlock row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TMailTextBlock obj = (TMailTextBlock) cls.newInstance();
            TMailTextBlockPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setBlockTitle(row.getValue(offset + 2).asString());
            obj.setBlockContent(row.getValue(offset + 3).asString());
            obj.setTagLabel(row.getValue(offset + 4).asString());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TMailTextBlock> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TMailTextBlock> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TMailTextBlock> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TMailTextBlock> results = new ArrayList<TMailTextBlock>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TMailTextBlockPeer.row2Object(row, 1,
                TMailTextBlockPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TMailTextBlock> doSelect(TMailTextBlock obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TMailTextBlock obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TMailTextBlock obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TMailTextBlock obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TMailTextBlock) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TMailTextBlock obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TMailTextBlock) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TMailTextBlock obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TMailTextBlock) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TMailTextBlock obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TMailTextBlock obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(OBJECTID, obj.getObjectID());
        criteria.add(PERSON, obj.getPerson());
        criteria.add(BLOCKTITLE, obj.getBlockTitle());
        criteria.add(BLOCKCONTENT, obj.getBlockContent());
    ...
    public static Criteria buildSelectCriteria( TMailTextBlock obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TMailTextBlock retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TMailTextBlock retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TMailTextBlock retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TMailTextBlock retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TMailTextBlock retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TMailTextBlock> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TMailTextBlock> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TMailTextBlock> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TMailTextBlock> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TMailTextBlock> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TMailTextBlock>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TMailTextBlock objects pre-filled with their
     * TPerson objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TMailTextBlockPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TMailTextBlock> doSelectJoinTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TMailTextBlock> doSelectJoinTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TMailTextBlockPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TPersonPeer.addSelectColumns(criteria);

        criteria.addJoin(TMailTextBlockPeer.PERSON,
            TPersonPeer.PKEY);
        ...
        List<TMailTextBlock> results = new ArrayList<TMailTextBlock>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TMailTextBlockPeer.getOMClass();
            TMailTextBlock obj1 = (TMailTextBlock) TMailTextBlockPeer
            ...
            {
                TMailTextBlock temp_obj1 =  results.get(j);
                TPerson temp_obj2 = (TPerson) temp_obj1.getTPerson();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTMailTextBlock(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTMailTextBlocks();
                obj2.addTMailTextBlock(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TMailTextBlock> doSelectJoinTProject(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TMailTextBlock> doSelectJoinTProject(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TMailTextBlockPeer.PROJECT,
            TProjectPeer.PKEY);
