...
/**
 * application wide css styles for in time, overdue, overbudget etc. issues
 *
 */
public abstract class BaseTGlobalCssStylePeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TGlobalCssStyleMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TGlobalCssStyleMapBuilder.CLASS_NAME);
    }

    /** the column name for the OBJECTID field */
    public static final String OBJECTID;
    /** the column name for the STYLEFOR field */
    public static final String STYLEFOR;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TGLOBALCSSSTYLE";

        OBJECTID = "TGLOBALCSSSTYLE.OBJECTID";
        STYLEFOR = "TGLOBALCSSSTYLE.STYLEFOR";
        CSSSTYLE = "TGLOBALCSSSTYLE.CSSSTYLE";
        TPUUID = "TGLOBALCSSSTYLE.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TGlobalCssStyleMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TGlobalCssStyleMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TGlobalCssStyle";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TGlobalCssStyle> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTGlobalCssStylePeer
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(STYLEFOR);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TGlobalCssStyle row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TGlobalCssStyle obj = (TGlobalCssStyle) cls.newInstance();
            TGlobalCssStylePeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setStyleFor(row.getValue(offset + 1).asIntegerObj());
            obj.setCSSStyle(row.getValue(offset + 2).asString());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TGlobalCssStyle> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TGlobalCssStyle> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TGlobalCssStyle> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TGlobalCssStyle> results = new ArrayList<TGlobalCssStyle>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TGlobalCssStylePeer.row2Object(row, 1,
                TGlobalCssStylePeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TGlobalCssStyle> doSelect(TGlobalCssStyle obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TGlobalCssStyle obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TGlobalCssStyle obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TGlobalCssStyle obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TGlobalCssStyle) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TGlobalCssStyle obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TGlobalCssStyle) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TGlobalCssStyle obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TGlobalCssStyle) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TGlobalCssStyle obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TGlobalCssStyle obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(OBJECTID, obj.getObjectID());
        criteria.add(STYLEFOR, obj.getStyleFor());
    ...
    public static Criteria buildSelectCriteria( TGlobalCssStyle obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TGlobalCssStyle retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TGlobalCssStyle retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TGlobalCssStyle retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TGlobalCssStyle retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TGlobalCssStyle retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TGlobalCssStyle> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (TGlobalCssStyle)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TGlobalCssStyle> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TGlobalCssStyle> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TGlobalCssStyle> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TGlobalCssStyle> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TGlobalCssStyle>();
        }
        else
        {
            Criteria criteria = new Criteria();
