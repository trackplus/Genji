...
/**
 */
public abstract class BaseTProjectAccountPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TProjectAccountMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TProjectAccountMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TPROJECTACCOUNT";

        ACCOUNT = "TPROJECTACCOUNT.ACCOUNT";
        PROJECT = "TPROJECTACCOUNT.PROJECT";
        TPUUID = "TPROJECTACCOUNT.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TProjectAccountMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TProjectAccountMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TProjectAccount";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TProjectAccount> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTProjectAccountPeer
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TProjectAccount row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TProjectAccount obj = (TProjectAccount) cls.newInstance();
            TProjectAccountPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            obj.setAccount(row.getValue(offset + 0).asIntegerObj());
            obj.setProject(row.getValue(offset + 1).asIntegerObj());
            obj.setUuid(row.getValue(offset + 2).asString());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TProjectAccount> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TProjectAccount> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TProjectAccount> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TProjectAccount> results = new ArrayList<TProjectAccount>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TProjectAccountPeer.row2Object(row, 1,
                TProjectAccountPeer.getOMClass()));
        }
        return results;
    }
        ...
        throws TorqueException
    {
        ...
        correctBooleans(criteria);
         ...
         selectCriteria.put(ACCOUNT, criteria.remove(ACCOUNT));

         selectCriteria.put(PROJECT, criteria.remove(PROJECT));
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TProjectAccount> doSelect(TProjectAccount obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TProjectAccount obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TProjectAccount obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TProjectAccount obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TProjectAccount) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TProjectAccount obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TProjectAccount) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TProjectAccount obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TProjectAccount) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TProjectAccount obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( ObjectKey pk )
    {
        ...
        SimpleKey[] keys = (SimpleKey[])pk.getValue();
            criteria.add(ACCOUNT, keys[0]);
            criteria.add(PROJECT, keys[1]);
        return criteria;
     }

    /** Build a Criteria object from the data object for this peer */
    public static Criteria buildCriteria( TProjectAccount obj )
    {
    ...
    public static Criteria buildSelectCriteria( TProjectAccount obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
            criteria.add(ACCOUNT, obj.getAccount());
            criteria.add(PROJECT, obj.getProject());
     ...
     */
    public static TProjectAccount retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TProjectAccount retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TProjectAccount retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TProjectAccount> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (TProjectAccount)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TProjectAccount> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TProjectAccount> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TProjectAccount> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TProjectAccount> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TProjectAccount>();
        }
        else
        {
            Criteria criteria = new Criteria();
            ...
            while (iter.hasNext())
            {
                ...
                SimpleKey[] keys = (SimpleKey[])pk.getValue();
                    Criteria.Criterion c0 = criteria.getNewCriterion(
                        ACCOUNT, keys[0], Criteria.EQUAL);
                    Criteria.Criterion c1 = criteria.getNewCriterion(
                        PROJECT, keys[1], Criteria.EQUAL);
                        c0.and(c1);
                criteria.or(c0);
            }
     ...
     */
    public static TProjectAccount retrieveByPK(
 Integer account
, Integer project
        ) throws TorqueException
    {
...
, Integer project
    ...
    /**
     * selects a collection of TProjectAccount objects pre-filled with their
     * TProject objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TProjectAccountPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TProjectAccount> doSelectJoinTProject(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TProjectAccount> doSelectJoinTProject(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TProjectAccountPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TProjectPeer.addSelectColumns(criteria);

        criteria.addJoin(TProjectAccountPeer.PROJECT,
            TProjectPeer.PKEY);
        ...
        List<TProjectAccount> results = new ArrayList<TProjectAccount>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TProjectAccountPeer.getOMClass();
            TProjectAccount obj1 = (TProjectAccount) TProjectAccountPeer
            ...
            {
                TProjectAccount temp_obj1 =  results.get(j);
                TProject temp_obj2 = (TProject) temp_obj1.getTProject();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTProjectAccount(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTProjectAccounts();
                obj2.addTProjectAccount(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TProjectAccount> doSelectJoinTAccount(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TProjectAccount> doSelectJoinTAccount(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TProjectAccountPeer.ACCOUNT,
