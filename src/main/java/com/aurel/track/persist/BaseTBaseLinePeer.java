 ...
 *
 */
public abstract class BaseTBaseLinePeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TBaseLineMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TBaseLineMapBuilder.CLASS_NAME);
    }

    /** the column name for the BLKEY field */
    public static final String BLKEY;
    ...
    /** the column name for the REASONFORCHANGE field */
    public static final String REASONFORCHANGE;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TBASELINE";

        BLKEY = "TBASELINE.BLKEY";
        WORKITEMKEY = "TBASELINE.WORKITEMKEY";
        STARTDATE = "TBASELINE.STARTDATE";
        ENDDATE = "TBASELINE.ENDDATE";
        REASONFORCHANGE = "TBASELINE.REASONFORCHANGE";
        CHANGEDBY = "TBASELINE.CHANGEDBY";
        LASTEDIT = "TBASELINE.LASTEDIT";
        TPUUID = "TBASELINE.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TBaseLineMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TBaseLineMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TBaseLine";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TBaseLine> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TBaseLine row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TBaseLine obj = (TBaseLine) cls.newInstance();
            TBaseLinePeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setStartDate(row.getValue(offset + 2).asUtilDate());
            obj.setEndDate(row.getValue(offset + 3).asUtilDate());
            obj.setReasonForChange(row.getValue(offset + 4).asString());
            obj.setChangedByID(row.getValue(offset + 5).asIntegerObj());
            obj.setLastEdit(row.getValue(offset + 6).asUtilDate());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TBaseLine> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TBaseLine> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TBaseLine> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TBaseLine> results = new ArrayList<TBaseLine>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TBaseLinePeer.row2Object(row, 1,
                TBaseLinePeer.getOMClass()));
        }
        return results;
    }
        ...
        throws TorqueException
    {
        ...
        correctBooleans(criteria);
         ...
         selectCriteria.put(BLKEY, criteria.remove(BLKEY));
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TBaseLine> doSelect(TBaseLine obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TBaseLine obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TBaseLine obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TBaseLine obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TBaseLine) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TBaseLine obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TBaseLine) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TBaseLine obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TBaseLine) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TBaseLine obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( ObjectKey pk )
    {
        Criteria criteria = new Criteria();
            criteria.add(BLKEY, pk);
        return criteria;
     }

    /** Build a Criteria object from the data object for this peer */
    public static Criteria buildCriteria( TBaseLine obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(BLKEY, obj.getObjectID());
        criteria.add(WORKITEMKEY, obj.getWorkItemID());
        criteria.add(STARTDATE, obj.getStartDate());
        criteria.add(ENDDATE, obj.getEndDate());
        criteria.add(REASONFORCHANGE, obj.getReasonForChange());
    ...
    public static Criteria buildSelectCriteria( TBaseLine obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TBaseLine retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TBaseLine retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TBaseLine retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TBaseLine retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TBaseLine retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TBaseLine> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TBaseLine> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TBaseLine> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TBaseLine> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TBaseLine> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TBaseLine>();
        }
        else
        {
            Criteria criteria = new Criteria();
            criteria.addIn( BLKEY, pks );
    ...
    /**
     * selects a collection of TBaseLine objects pre-filled with their
     * TWorkItem objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TBaseLinePeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TBaseLine> doSelectJoinTWorkItem(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TBaseLine> doSelectJoinTWorkItem(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TBaseLinePeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TWorkItemPeer.addSelectColumns(criteria);

        criteria.addJoin(TBaseLinePeer.WORKITEMKEY,
        ...
        List<TBaseLine> results = new ArrayList<TBaseLine>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TBaseLinePeer.getOMClass();
            TBaseLine obj1 = (TBaseLine) TBaseLinePeer
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TBaseLine> doSelectJoinTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TBaseLine> doSelectJoinTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TBaseLinePeer.CHANGEDBY,
            TPersonPeer.PKEY);
