...
/**
 */
public abstract class BaseTProjectTypePeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TProjectTypeMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TProjectTypeMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the NOTIFYOWNERLEVEL field */
    public static final String NOTIFYOWNERLEVEL;
    /** the column name for the NOTIFYMANAGERLEVEL field */
    public static final String NOTIFYMANAGERLEVEL;
    ...
    /** the column name for the DEFAULTFORPRIVATE field */
    public static final String DEFAULTFORPRIVATE;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TPROJECTTYPE";

        OBJECTID = "TPROJECTTYPE.OBJECTID";
        LABEL = "TPROJECTTYPE.LABEL";
        NOTIFYOWNERLEVEL = "TPROJECTTYPE.NOTIFYOWNERLEVEL";
        NOTIFYMANAGERLEVEL = "TPROJECTTYPE.NOTIFYMANAGERLEVEL";
        HOURSPERWORKDAY = "TPROJECTTYPE.HOURSPERWORKDAY";
        MOREPROPS = "TPROJECTTYPE.MOREPROPS";
        DEFAULTFORPRIVATE = "TPROJECTTYPE.DEFAULTFORPRIVATE";
        TPUUID = "TPROJECTTYPE.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TProjectTypeMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TProjectTypeMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TProjectType";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TProjectType> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(NOTIFYOWNERLEVEL);
        criteria.addSelectColumn(NOTIFYMANAGERLEVEL);
        criteria.addSelectColumn(HOURSPERWORKDAY);
        criteria.addSelectColumn(MOREPROPS);
        criteria.addSelectColumn(DEFAULTFORPRIVATE);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TProjectType row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TProjectType obj = (TProjectType) cls.newInstance();
            TProjectTypePeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setNotifyOwnerLevel(row.getValue(offset + 2).asIntegerObj());
            obj.setNotifyManagerLevel(row.getValue(offset + 3).asIntegerObj());
            obj.setHoursPerWorkDay(row.getValue(offset + 4).asDoubleObj());
            obj.setMoreProps(row.getValue(offset + 5).asString());
            obj.setDefaultForPrivate(row.getValue(offset + 6).asString());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TProjectType> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TProjectType> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TProjectType> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TProjectType> results = new ArrayList<TProjectType>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TProjectTypePeer.row2Object(row, 1,
                TProjectTypePeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TProjectType> doSelect(TProjectType obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TProjectType obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TProjectType obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TProjectType obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TProjectType) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TProjectType obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TProjectType) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TProjectType obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TProjectType) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TProjectType obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TProjectType obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(OBJECTID, obj.getObjectID());
        criteria.add(LABEL, obj.getLabel());
        criteria.add(NOTIFYOWNERLEVEL, obj.getNotifyOwnerLevel());
        criteria.add(NOTIFYMANAGERLEVEL, obj.getNotifyManagerLevel());
        criteria.add(HOURSPERWORKDAY, obj.getHoursPerWorkDay());
        criteria.add(MOREPROPS, obj.getMoreProps());
        criteria.add(DEFAULTFORPRIVATE, obj.getDefaultForPrivate());
        criteria.add(TPUUID, obj.getUuid());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( TProjectType obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TProjectType retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TProjectType retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TProjectType retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TProjectType retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TProjectType retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TProjectType> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TProjectType> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TProjectType> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TProjectType> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TProjectType> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TProjectType>();
        }
        else
        {
            Criteria criteria = new Criteria();
