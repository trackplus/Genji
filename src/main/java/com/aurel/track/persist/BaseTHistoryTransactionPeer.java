...
/**
 */
public abstract class BaseTHistoryTransactionPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(THistoryTransactionMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(THistoryTransactionMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "THISTORYTRANSACTION";

        OBJECTID = "THISTORYTRANSACTION.OBJECTID";
        WORKITEM = "THISTORYTRANSACTION.WORKITEM";
        CHANGEDBY = "THISTORYTRANSACTION.CHANGEDBY";
        LASTEDIT = "THISTORYTRANSACTION.LASTEDIT";
        TPUUID = "THISTORYTRANSACTION.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(THistoryTransactionMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(THistoryTransactionMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.THistoryTransaction";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<THistoryTransaction> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTHistoryTransactionPeer
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static THistoryTransaction row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            THistoryTransaction obj = (THistoryTransaction) cls.newInstance();
            THistoryTransactionPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setLastEdit(row.getValue(offset + 3).asUtilDate());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<THistoryTransaction> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<THistoryTransaction> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<THistoryTransaction> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<THistoryTransaction> results = new ArrayList<THistoryTransaction>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(THistoryTransactionPeer.row2Object(row, 1,
                THistoryTransactionPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<THistoryTransaction> doSelect(THistoryTransaction obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(THistoryTransaction obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(THistoryTransaction obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(THistoryTransaction obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(THistoryTransaction) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(THistoryTransaction obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(THistoryTransaction) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(THistoryTransaction obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(THistoryTransaction) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(THistoryTransaction obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( THistoryTransaction obj )
    {
    ...
    public static Criteria buildSelectCriteria( THistoryTransaction obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static THistoryTransaction retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static THistoryTransaction retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static THistoryTransaction retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        THistoryTransaction retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static THistoryTransaction retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<THistoryTransaction> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (THistoryTransaction)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<THistoryTransaction> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<THistoryTransaction> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<THistoryTransaction> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<THistoryTransaction> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<THistoryTransaction>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of THistoryTransaction objects pre-filled with their
     * TWorkItem objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in THistoryTransactionPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<THistoryTransaction> doSelectJoinTWorkItem(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<THistoryTransaction> doSelectJoinTWorkItem(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(THistoryTransactionPeer.WORKITEM,
        ...
        List<THistoryTransaction> results = new ArrayList<THistoryTransaction>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = THistoryTransactionPeer.getOMClass();
            THistoryTransaction obj1 = (THistoryTransaction) THistoryTransactionPeer
            ...
            {
                THistoryTransaction temp_obj1 =  results.get(j);
                TWorkItem temp_obj2 = (TWorkItem) temp_obj1.getTWorkItem();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTHistoryTransaction(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTHistoryTransactions();
                obj2.addTHistoryTransaction(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<THistoryTransaction> doSelectJoinTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<THistoryTransaction> doSelectJoinTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(THistoryTransactionPeer.CHANGEDBY,
            TPersonPeer.PKEY);
