 ...
 * extended all references should be to TSeverity
 */
public abstract class BaseTSeverity extends TpBaseObject
{
    /** The Peer class */
    private static final TSeverityPeer peer =
        new TSeverityPeer();
     ...
     * Otherwise if this TSeverity has previously
     * been saved, it will retrieve related TPseveritys from storage.
     * If this TSeverity is new, it will return
    ...
    public List<TPseverity> getTPseveritys(Criteria criteria) throws TorqueException
    {
        if (collTPseveritys == null)
        {
            ...
            {
                criteria.add(TPseverityPeer.SEVERITY, getObjectID() );
     ...
     * If this collection has already been initialized with
     * an identical criteria, it returns the collection.
     * Otherwise if this TSeverity is new, it will return
     * an empty collection; or if this TSeverity has previously
     * been saved, it will retrieve related TPseveritys from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TSeverity.
     */
    ...
    public List<TWorkItem> getTWorkItems(Criteria criteria) throws TorqueException
    {
        if (collTWorkItems == null)
        {
            ...
            {
                criteria.add(TWorkItemPeer.SEVERITYKEY, getObjectID() );
    ...
    {
        if (name.equals(TSeverityPeer.PKEY))
        {
            return getObjectID();
        }
        if (name.equals(TSeverityPeer.LABEL))
        {
            return getLabel();
        }
        if (name.equals(TSeverityPeer.TOOLTIP))
        {
            return getTooltip();
        }
        if (name.equals(TSeverityPeer.SORTORDER))
        {
            return getSortorder();
        }
        if (name.equals(TSeverityPeer.WLEVEL))
        {
            return getWlevel();
        }
        if (name.equals(TSeverityPeer.SYMBOL))
        {
            return getSymbol();
        }
        if (name.equals(TSeverityPeer.ICONKEY))
        {
            return getIconKey();
        }
        if (name.equals(TSeverityPeer.ICONCHANGED))
        {
            return getIconChanged();
        }
        if (name.equals(TSeverityPeer.CSSSTYLE))
        {
            return getCSSStyle();
        }
        if (name.equals(TSeverityPeer.TPUUID))
        {
            return getUuid();
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (TSeverityPeer.PKEY.equals(name))
        {
            return setByName("ObjectID", value);
        }
      if (TSeverityPeer.LABEL.equals(name))
        {
            return setByName("Label", value);
        }
      if (TSeverityPeer.TOOLTIP.equals(name))
        {
            return setByName("Tooltip", value);
        }
      if (TSeverityPeer.SORTORDER.equals(name))
        {
            return setByName("Sortorder", value);
        }
      if (TSeverityPeer.WLEVEL.equals(name))
        {
            return setByName("Wlevel", value);
        }
      if (TSeverityPeer.SYMBOL.equals(name))
        {
            return setByName("Symbol", value);
        }
      if (TSeverityPeer.ICONKEY.equals(name))
        {
            return setByName("IconKey", value);
        }
      if (TSeverityPeer.ICONCHANGED.equals(name))
        {
            return setByName("IconChanged", value);
        }
      if (TSeverityPeer.CSSSTYLE.equals(name))
        {
            return setByName("CSSStyle", value);
        }
      if (TSeverityPeer.TPUUID.equals(name))
        {
    ...
    {
        save(TSeverityPeer.DATABASE_NAME);
    }
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    TSeverityPeer.doInsert((TSeverity) this, con);
                    setNew(false);
                }
                else
                {
                    TSeverityPeer.doUpdate((TSeverity) this, con);
                }
            }
     ...
     */
    public TSeverity copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     */
    public TSeverity copy(Connection con) throws TorqueException
    {
     ...
     */
    public TSeverity copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new TSeverity(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public TSeverity copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new TSeverity(), deepcopy, con);
    }
     ...
     */
    protected TSeverity copyInto(TSeverity copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected TSeverity copyInto(TSeverity copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected TSeverity copyInto(TSeverity copyObj, boolean deepcopy) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected TSeverity copyInto(TSeverity copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setObjectID(objectID);
        copyObj.setLabel(label);
        copyObj.setTooltip(tooltip);
    ...
    {
        return TSeverityPeer.getTableMap();
    }

  
    /**
     * Creates a TSeverityBean with the contents of this object
     * This also creates beans for cached related objects, if they exist
     * @return a TSeverityBean with the contents of this object
     */
    public TSeverityBean getBean()
    {
     ...
     * @return a TSeverityBean with the contents of this object
     */
    public TSeverityBean getBean(IdentityMap createdBeans)
    {
        TSeverityBean result = (TSeverityBean) createdBeans.get(this);
        if (result != null ) {
            // we have already created a bean for this object, return it
            return result;
        }
        // no bean exists for this object; create a new one
        result = new TSeverityBean();
    ...
    /**
     * Creates an instance of TSeverity with the contents
     * of a TSeverityBean.
     * This behaviour could have also been achieved using a constructor,
     * however as this class is abstract no constructors are allowed
     * @param bean the TSeverityBean which contents are used to create
     *        the resulting class
     * @return an instance of TSeverity with the contents of bean
     */
    public static TSeverity createTSeverity(TSeverityBean bean)
        throws TorqueException
    {
        return createTSeverity(bean, new IdentityMap());
    }
    ...
    public static TSeverity createTSeverity(TSeverityBean bean, IdentityMap createdObjects)
        throws TorqueException
    {
        TSeverity result = (TSeverity) createdObjects.get(bean);
        if (result != null)
        {
            // we already have an object for the bean, return it
            return result;
        }
        result = new TSeverity();
