...
/**
 */
public abstract class BaseTTrailPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TTrailMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TTrailMapBuilder.CLASS_NAME);
    }

    /** the column name for the TRAILKEY field */
    public static final String TRAILKEY;
    ...
    static
    {
        ...
        TRAILKEY = "TTRAIL.TRAILKEY";
        WORKITEMKEY = "TTRAIL.WORKITEMKEY";
        CHANGEDBY = "TTRAIL.CHANGEDBY";
        CHANGEDESCRIPTION = "TTRAIL.CHANGEDESCRIPTION";
        LASTEDIT = "TTRAIL.LASTEDIT";
        TPUUID = "TTRAIL.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TTrailMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TTrailMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TTrail";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TTrail> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static void addSelectColumns(Criteria criteria)
            throws TorqueException
    {
        criteria.addSelectColumn(TRAILKEY);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TTrail row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TTrail obj = (TTrail) cls.newInstance();
            TTrailPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setLastEdit(row.getValue(offset + 4).asUtilDate());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TTrail> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TTrail> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TTrail> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TTrail> results = new ArrayList<TTrail>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TTrailPeer.row2Object(row, 1,
                TTrailPeer.getOMClass()));
        }
        return results;
    }
        ...
        throws TorqueException
    {
        ...
        correctBooleans(criteria);
         ...
         selectCriteria.put(TRAILKEY, criteria.remove(TRAILKEY));
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TTrail> doSelect(TTrail obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TTrail obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TTrail obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TTrail obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TTrail) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TTrail obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TTrail) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TTrail obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TTrail) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TTrail obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( ObjectKey pk )
    {
        Criteria criteria = new Criteria();
            criteria.add(TRAILKEY, pk);
        return criteria;
     }

    /** Build a Criteria object from the data object for this peer */
    public static Criteria buildCriteria( TTrail obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(TRAILKEY, obj.getObjectID());
    ...
    public static Criteria buildSelectCriteria( TTrail obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TTrail retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TTrail retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TTrail retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TTrail retVal = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TTrail retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TTrail> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TTrail> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TTrail> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TTrail> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TTrail> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TTrail>();
        }
        else
        {
            Criteria criteria = new Criteria();
            criteria.addIn( TRAILKEY, pks );
    ...
    /**
     * selects a collection of TTrail objects pre-filled with their
     * TWorkItem objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TTrailPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TTrail> doSelectJoinTWorkItem(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TTrail> doSelectJoinTWorkItem(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TTrailPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TWorkItemPeer.addSelectColumns(criteria);

        criteria.addJoin(TTrailPeer.WORKITEMKEY,
        ...
        List<TTrail> results = new ArrayList<TTrail>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TTrailPeer.getOMClass();
            TTrail obj1 = (TTrail) TTrailPeer
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TTrail> doSelectJoinTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TTrail> doSelectJoinTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TTrailPeer.CHANGEDBY,
            TPersonPeer.PKEY);
