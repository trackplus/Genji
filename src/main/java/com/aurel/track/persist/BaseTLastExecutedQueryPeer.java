 ...
 *
 */
public abstract class BaseTLastExecutedQueryPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TLastExecutedQueryMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TLastExecutedQueryMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the QUERYCLOB field */
    public static final String QUERYCLOB;
    /** the column name for the QUERYKEY field */
    public static final String QUERYKEY;
    /** the column name for the LASTEXECUTEDTIME field */
    public static final String LASTEXECUTEDTIME;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TLASTEXECUTEDQUERY";

        OBJECTID = "TLASTEXECUTEDQUERY.OBJECTID";
        PERSON = "TLASTEXECUTEDQUERY.PERSON";
        QUERYTYPE = "TLASTEXECUTEDQUERY.QUERYTYPE";
        QUERYCLOB = "TLASTEXECUTEDQUERY.QUERYCLOB";
        QUERYKEY = "TLASTEXECUTEDQUERY.QUERYKEY";
        LASTEXECUTEDTIME = "TLASTEXECUTEDQUERY.LASTEXECUTEDTIME";
        TPUUID = "TLASTEXECUTEDQUERY.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TLastExecutedQueryMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TLastExecutedQueryMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TLastExecutedQuery";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TLastExecutedQuery> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTLastExecutedQueryPeer
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(QUERYCLOB);
        criteria.addSelectColumn(QUERYKEY);
        criteria.addSelectColumn(LASTEXECUTEDTIME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TLastExecutedQuery row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TLastExecutedQuery obj = (TLastExecutedQuery) cls.newInstance();
            TLastExecutedQueryPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setQueryType(row.getValue(offset + 2).asIntegerObj());
            obj.setQueryClob(row.getValue(offset + 3).asIntegerObj());
            obj.setQueryKey(row.getValue(offset + 4).asIntegerObj());
            obj.setLastExecutedTime(row.getValue(offset + 5).asUtilDate());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TLastExecutedQuery> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TLastExecutedQuery> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TLastExecutedQuery> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TLastExecutedQuery> results = new ArrayList<TLastExecutedQuery>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TLastExecutedQueryPeer.row2Object(row, 1,
                TLastExecutedQueryPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TLastExecutedQuery> doSelect(TLastExecutedQuery obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TLastExecutedQuery obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TLastExecutedQuery obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TLastExecutedQuery obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TLastExecutedQuery) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TLastExecutedQuery obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TLastExecutedQuery) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TLastExecutedQuery obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TLastExecutedQuery) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TLastExecutedQuery obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TLastExecutedQuery obj )
    {
        ...
        criteria.add(QUERYCLOB, obj.getQueryClob());
        criteria.add(QUERYKEY, obj.getQueryKey());
        criteria.add(LASTEXECUTEDTIME, obj.getLastExecutedTime());
        criteria.add(TPUUID, obj.getUuid());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( TLastExecutedQuery obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TLastExecutedQuery retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TLastExecutedQuery retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TLastExecutedQuery retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TLastExecutedQuery retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TLastExecutedQuery retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TLastExecutedQuery> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (TLastExecutedQuery)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TLastExecutedQuery> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TLastExecutedQuery> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TLastExecutedQuery> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TLastExecutedQuery> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TLastExecutedQuery>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TLastExecutedQuery objects pre-filled with their
     * TPerson objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TLastExecutedQueryPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TLastExecutedQuery> doSelectJoinTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TLastExecutedQuery> doSelectJoinTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TLastExecutedQueryPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TPersonPeer.addSelectColumns(criteria);

        criteria.addJoin(TLastExecutedQueryPeer.PERSON,
            TPersonPeer.PKEY);
        ...
        List<TLastExecutedQuery> results = new ArrayList<TLastExecutedQuery>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TLastExecutedQueryPeer.getOMClass();
            TLastExecutedQuery obj1 = (TLastExecutedQuery) TLastExecutedQueryPeer
            ...
            {
                TLastExecutedQuery temp_obj1 =  results.get(j);
                TPerson temp_obj2 = (TPerson) temp_obj1.getTPerson();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTLastExecutedQuery(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTLastExecutedQuerys();
                obj2.addTLastExecutedQuery(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TLastExecutedQuery> doSelectJoinTCLOB(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TLastExecutedQuery> doSelectJoinTCLOB(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TLastExecutedQueryPeer.QUERYCLOB,
            TCLOBPeer.OBJECTID);
