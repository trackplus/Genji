...
/**
 */
public abstract class BaseTLoggedInUsersPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TLoggedInUsersMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TLoggedInUsersMapBuilder.CLASS_NAME);
    }

    /** the column name for the OBJECTID field */
    public static final String OBJECTID;
    /** the column name for the NODEADDRESS field */
    public static final String NODEADDRESS;
    /** the column name for the SESSIONID field */
    public static final String SESSIONID;
    /** the column name for the LOGGEDUSER field */
    public static final String LOGGEDUSER;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TLOGGEDINUSERS";

        OBJECTID = "TLOGGEDINUSERS.OBJECTID";
        NODEADDRESS = "TLOGGEDINUSERS.NODEADDRESS";
        SESSIONID = "TLOGGEDINUSERS.SESSIONID";
        LOGGEDUSER = "TLOGGEDINUSERS.LOGGEDUSER";
        USERLEVEL = "TLOGGEDINUSERS.USERLEVEL";
        LASTUPDATE = "TLOGGEDINUSERS.LASTUPDATE";
        MOREPROPS = "TLOGGEDINUSERS.MOREPROPS";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TLoggedInUsersMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TLoggedInUsersMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TLoggedInUsers";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TLoggedInUsers> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(NODEADDRESS);
        criteria.addSelectColumn(SESSIONID);
        criteria.addSelectColumn(LOGGEDUSER);
        criteria.addSelectColumn(USERLEVEL);
        criteria.addSelectColumn(LASTUPDATE);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TLoggedInUsers row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TLoggedInUsers obj = (TLoggedInUsers) cls.newInstance();
            TLoggedInUsersPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setNodeAddress(row.getValue(offset + 1).asIntegerObj());
            obj.setSessionId(row.getValue(offset + 2).asString());
            obj.setLoggedUser(row.getValue(offset + 3).asIntegerObj());
            obj.setUserLevel(row.getValue(offset + 4).asIntegerObj());
            obj.setLastUpdate(row.getValue(offset + 5).asUtilDate());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TLoggedInUsers> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TLoggedInUsers> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TLoggedInUsers> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TLoggedInUsers> results = new ArrayList<TLoggedInUsers>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TLoggedInUsersPeer.row2Object(row, 1,
                TLoggedInUsersPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TLoggedInUsers> doSelect(TLoggedInUsers obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TLoggedInUsers obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TLoggedInUsers obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TLoggedInUsers obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TLoggedInUsers) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TLoggedInUsers obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TLoggedInUsers) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TLoggedInUsers obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TLoggedInUsers) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TLoggedInUsers obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TLoggedInUsers obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(OBJECTID, obj.getObjectID());
        criteria.add(NODEADDRESS, obj.getNodeAddress());
        criteria.add(SESSIONID, obj.getSessionId());
        criteria.add(LOGGEDUSER, obj.getLoggedUser());
        criteria.add(USERLEVEL, obj.getUserLevel());
        criteria.add(LASTUPDATE, obj.getLastUpdate());
        criteria.add(MOREPROPS, obj.getMoreProps());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( TLoggedInUsers obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TLoggedInUsers retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TLoggedInUsers retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TLoggedInUsers retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TLoggedInUsers retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TLoggedInUsers retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TLoggedInUsers> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TLoggedInUsers> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TLoggedInUsers> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TLoggedInUsers> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TLoggedInUsers> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TLoggedInUsers>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TLoggedInUsers objects pre-filled with their
     * TPerson objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TLoggedInUsersPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TLoggedInUsers> doSelectJoinTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TLoggedInUsers> doSelectJoinTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TLoggedInUsersPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TPersonPeer.addSelectColumns(criteria);

        criteria.addJoin(TLoggedInUsersPeer.LOGGEDUSER,
            TPersonPeer.PKEY);
        ...
        List<TLoggedInUsers> results = new ArrayList<TLoggedInUsers>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TLoggedInUsersPeer.getOMClass();
            TLoggedInUsers obj1 = (TLoggedInUsers) TLoggedInUsersPeer
            ...
            {
                TLoggedInUsers temp_obj1 =  results.get(j);
                TPerson temp_obj2 = (TPerson) temp_obj1.getTPerson();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTLoggedInUsers(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTLoggedInUserss();
                obj2.addTLoggedInUsers(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TLoggedInUsers> doSelectJoinTClusterNode(Criteria criteria)
        throws TorqueException
    {
        return doSelectJoinTClusterNode(criteria, null);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TLoggedInUsers> doSelectJoinTClusterNode(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        TLoggedInUsersPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TClusterNodePeer.addSelectColumns(criteria);

        criteria.addJoin(TLoggedInUsersPeer.NODEADDRESS,
            TClusterNodePeer.OBJECTID);
        ...
        for (int i = 0; i < rows.size(); i++)
        {
            ...
            TLoggedInUsers obj1 = (TLoggedInUsers) TLoggedInUsersPeer
                .row2Object(row, 1, omClass);
             omClass = TClusterNodePeer.getOMClass();
            TClusterNode obj2 = (TClusterNode) TClusterNodePeer
                .row2Object(row, offset, omClass);
            ...
            {
                TLoggedInUsers temp_obj1 =  results.get(j);
                TClusterNode temp_obj2 = (TClusterNode) temp_obj1.getTClusterNode();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTLoggedInUsers(obj1);
