 ...
 *
 */
public abstract class BaseTEntityChangesPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TEntityChangesMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TEntityChangesMapBuilder.CLASS_NAME);
    }

    /** the column name for the OBJECTID field */
    public static final String OBJECTID;
    /** the column name for the ENTITYKEY field */
    public static final String ENTITYKEY;
    /** the column name for the ENTITYTYPE field */
    public static final String ENTITYTYPE;
    /** the column name for the CLUSTERNODE field */
    public static final String CLUSTERNODE;
    /** the column name for the LIST field */
    public static final String LIST;
    /** the column name for the CHANGETYPE field */
    public static final String CHANGETYPE;

    static
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TENTITYCHANGES";

        OBJECTID = "TENTITYCHANGES.OBJECTID";
        ENTITYKEY = "TENTITYCHANGES.ENTITYKEY";
        ENTITYTYPE = "TENTITYCHANGES.ENTITYTYPE";
        CLUSTERNODE = "TENTITYCHANGES.CLUSTERNODE";
        LIST = "TENTITYCHANGES.LIST";
        CHANGETYPE = "TENTITYCHANGES.CHANGETYPE";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TEntityChangesMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TEntityChangesMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TEntityChanges";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEntityChanges> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(ENTITYKEY);
        criteria.addSelectColumn(ENTITYTYPE);
        criteria.addSelectColumn(CLUSTERNODE);
        criteria.addSelectColumn(LIST);
        criteria.addSelectColumn(CHANGETYPE);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TEntityChanges row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TEntityChanges obj = (TEntityChanges) cls.newInstance();
            TEntityChangesPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setEntityKey(row.getValue(offset + 1).asIntegerObj());
            obj.setEntityType(row.getValue(offset + 2).asIntegerObj());
            obj.setClusterNode(row.getValue(offset + 3).asIntegerObj());
            obj.setList(row.getValue(offset + 4).asIntegerObj());
            obj.setChangeType(row.getValue(offset + 5).asIntegerObj());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEntityChanges> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEntityChanges> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEntityChanges> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TEntityChanges> results = new ArrayList<TEntityChanges>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TEntityChangesPeer.row2Object(row, 1,
                TEntityChangesPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEntityChanges> doSelect(TEntityChanges obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TEntityChanges obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TEntityChanges obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TEntityChanges obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TEntityChanges) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TEntityChanges obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TEntityChanges) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TEntityChanges obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TEntityChanges) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TEntityChanges obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TEntityChanges obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(OBJECTID, obj.getObjectID());
        criteria.add(ENTITYKEY, obj.getEntityKey());
        criteria.add(ENTITYTYPE, obj.getEntityType());
        criteria.add(CLUSTERNODE, obj.getClusterNode());
        criteria.add(LIST, obj.getList());
        criteria.add(CHANGETYPE, obj.getChangeType());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( TEntityChanges obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TEntityChanges retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TEntityChanges retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TEntityChanges retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TEntityChanges retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TEntityChanges retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TEntityChanges> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEntityChanges> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TEntityChanges> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEntityChanges> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TEntityChanges> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TEntityChanges>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TEntityChanges objects pre-filled with their
     * TClusterNode objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TEntityChangesPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TEntityChanges> doSelectJoinTClusterNode(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TEntityChanges> doSelectJoinTClusterNode(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TEntityChangesPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TClusterNodePeer.addSelectColumns(criteria);

        criteria.addJoin(TEntityChangesPeer.CLUSTERNODE,
        ...
        List<TEntityChanges> results = new ArrayList<TEntityChanges>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TEntityChangesPeer.getOMClass();
            TEntityChanges obj1 = (TEntityChanges) TEntityChangesPeer
            ...
            {
                TEntityChanges temp_obj1 =  results.get(j);
                TClusterNode temp_obj2 = (TClusterNode) temp_obj1.getTClusterNode();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTEntityChanges(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTEntityChangess();
                obj2.addTEntityChanges(obj1);
            }
            results.add(obj1);
        }
        return results;
