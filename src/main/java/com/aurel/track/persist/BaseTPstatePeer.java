...
/**
 */
public abstract class BaseTPstatePeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TPstateMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TPstateMapBuilder.CLASS_NAME);
    }
    ...
    static
    {
        ...
        OBJECTID = "TPSTATE.OBJECTID";
        STATE = "TPSTATE.STATE";
        PROJECTTYPE = "TPSTATE.PROJECTTYPE";
        LISTTYPE = "TPSTATE.LISTTYPE";
        TPUUID = "TPSTATE.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TPstateMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TPstateMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TPstate";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPstate> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TPstate row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TPstate obj = (TPstate) cls.newInstance();
            TPstatePeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setState(row.getValue(offset + 1).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPstate> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPstate> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPstate> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TPstate> results = new ArrayList<TPstate>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TPstatePeer.row2Object(row, 1,
                TPstatePeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPstate> doSelect(TPstate obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TPstate obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TPstate obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TPstate obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TPstate) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TPstate obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TPstate) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TPstate obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TPstate) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TPstate obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TPstate obj )
    {
    ...
    public static Criteria buildSelectCriteria( TPstate obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TPstate retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TPstate retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TPstate retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TPstate retVal = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TPstate retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TPstate> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPstate> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TPstate> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPstate> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TPstate> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TPstate>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TPstate objects pre-filled with their
     * TState objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TPstatePeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPstate> doSelectJoinTState(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPstate> doSelectJoinTState(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TPstatePeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TStatePeer.addSelectColumns(criteria);

        criteria.addJoin(TPstatePeer.STATE,
            TStatePeer.PKEY);
        ...
        List<TPstate> results = new ArrayList<TPstate>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TPstatePeer.getOMClass();
            TPstate obj1 = (TPstate) TPstatePeer
            ...
            {
                TPstate temp_obj1 =  results.get(j);
                TState temp_obj2 = (TState) temp_obj1.getTState();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTPstate(obj1);
                    break;
                }
            }
            if (newObject)
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPstate> doSelectJoinTProjectType(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPstate> doSelectJoinTProjectType(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TPstatePeer.PROJECTTYPE,
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPstate> doSelectJoinTListType(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPstate> doSelectJoinTListType(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TPstatePeer.LISTTYPE,
            TListTypePeer.PKEY);
    ...
    /**
     * selects a collection of TPstate objects pre-filled with
     * all related objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPstate> doSelectJoinAllExceptTState(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPstate> doSelectJoinAllExceptTState(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        TProjectTypePeer.addSelectColumns(criteria);
        criteria.addJoin(TPstatePeer.PROJECTTYPE, TProjectTypePeer.OBJECTID);
        int offset3 = offset2 + TProjectTypePeer.numColumns;

        TListTypePeer.addSelectColumns(criteria);
        criteria.addJoin(TPstatePeer.LISTTYPE, TListTypePeer.PKEY);
 ...
 newObject = true;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPstate> doSelectJoinAllExceptTProjectType(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPstate> doSelectJoinAllExceptTProjectType(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        TStatePeer.addSelectColumns(criteria);
        criteria.addJoin(TPstatePeer.STATE, TStatePeer.PKEY);
 ...
 newObject = true;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPstate> doSelectJoinAllExceptTListType(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPstate> doSelectJoinAllExceptTListType(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
