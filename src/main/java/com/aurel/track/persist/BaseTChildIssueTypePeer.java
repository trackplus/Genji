 ...
 *
 */
public abstract class BaseTChildIssueTypePeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TChildIssueTypeMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TChildIssueTypeMapBuilder.CLASS_NAME);
    }

    /** the column name for the OBJECTID field */
    public static final String OBJECTID;
    /** the column name for the ISSUETYPEPARENT field */
    public static final String ISSUETYPEPARENT;
    /** the column name for the ISSUETYPECHILD field */
    public static final String ISSUETYPECHILD;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TCHILDISSUETYPE";

        OBJECTID = "TCHILDISSUETYPE.OBJECTID";
        ISSUETYPEPARENT = "TCHILDISSUETYPE.ISSUETYPEPARENT";
        ISSUETYPECHILD = "TCHILDISSUETYPE.ISSUETYPECHILD";
        TPUUID = "TCHILDISSUETYPE.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TChildIssueTypeMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TChildIssueTypeMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TChildIssueType";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TChildIssueType> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTChildIssueTypePeer
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(ISSUETYPEPARENT);
        criteria.addSelectColumn(ISSUETYPECHILD);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TChildIssueType row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TChildIssueType obj = (TChildIssueType) cls.newInstance();
            TChildIssueTypePeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setIssueTypeParent(row.getValue(offset + 1).asIntegerObj());
            obj.setIssueTypeChild(row.getValue(offset + 2).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TChildIssueType> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TChildIssueType> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TChildIssueType> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TChildIssueType> results = new ArrayList<TChildIssueType>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TChildIssueTypePeer.row2Object(row, 1,
                TChildIssueTypePeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TChildIssueType> doSelect(TChildIssueType obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TChildIssueType obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TChildIssueType obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TChildIssueType obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TChildIssueType) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TChildIssueType obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TChildIssueType) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TChildIssueType obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TChildIssueType) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TChildIssueType obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TChildIssueType obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(OBJECTID, obj.getObjectID());
        criteria.add(ISSUETYPEPARENT, obj.getIssueTypeParent());
        criteria.add(ISSUETYPECHILD, obj.getIssueTypeChild());
        criteria.add(TPUUID, obj.getUuid());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( TChildIssueType obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TChildIssueType retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TChildIssueType retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TChildIssueType retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TChildIssueType retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TChildIssueType retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TChildIssueType> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (TChildIssueType)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TChildIssueType> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TChildIssueType> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TChildIssueType> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TChildIssueType> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TChildIssueType>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TChildIssueType objects pre-filled with their
     * TListType objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TChildIssueTypePeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TChildIssueType> doSelectJoinTListTypeRelatedByIssueTypeParent(Criteria criteria)
        throws TorqueException
    {
        return doSelectJoinTListTypeRelatedByIssueTypeParent(criteria, null);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TChildIssueType> doSelectJoinTListTypeRelatedByIssueTypeParent(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TChildIssueTypePeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TListTypePeer.addSelectColumns(criteria);

        criteria.addJoin(TChildIssueTypePeer.ISSUETYPEPARENT,
            TListTypePeer.PKEY);
        ...
        List<TChildIssueType> results = new ArrayList<TChildIssueType>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TChildIssueTypePeer.getOMClass();
            TChildIssueType obj1 = (TChildIssueType) TChildIssueTypePeer
            ...
            {
                TChildIssueType temp_obj1 =  results.get(j);
                TListType temp_obj2 = (TListType) temp_obj1.getTListTypeRelatedByIssueTypeParent();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTChildIssueTypeRelatedByIssueTypeParent(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTChildIssueTypesRelatedByIssueTypeParent();
                obj2.addTChildIssueTypeRelatedByIssueTypeParent(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TChildIssueType> doSelectJoinTListTypeRelatedByIssueTypeChild(Criteria criteria)
        throws TorqueException
    {
        return doSelectJoinTListTypeRelatedByIssueTypeChild(criteria, null);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TChildIssueType> doSelectJoinTListTypeRelatedByIssueTypeChild(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TChildIssueTypePeer.ISSUETYPECHILD,
            TListTypePeer.PKEY);
        ...
        for (int i = 0; i < rows.size(); i++)
        {
            ...
            {
                TChildIssueType temp_obj1 =  results.get(j);
                TListType temp_obj2 = (TListType) temp_obj1.getTListTypeRelatedByIssueTypeChild();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTChildIssueTypeRelatedByIssueTypeChild(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTChildIssueTypesRelatedByIssueTypeChild();
                obj2.addTChildIssueTypeRelatedByIssueTypeChild(obj1);
            }
            results.add(obj1);
        }
        return results;
