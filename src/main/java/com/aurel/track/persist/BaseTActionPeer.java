...
/**
 */
public abstract class BaseTActionPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TActionMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TActionMapBuilder.CLASS_NAME);
    }
    ...
    static
    {
        ...
        OBJECTID = "TACTION.OBJECTID";
        NAME = "TACTION.NAME";
        LABEL = "TACTION.LABEL";
        DESCRIPTION = "TACTION.DESCRIPTION";
        ACTIONTYPE = "TACTION.ACTIONTYPE";
        ICONKEY = "TACTION.ICONKEY";
        TPUUID = "TACTION.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TActionMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TActionMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TAction";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAction> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TAction row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TAction obj = (TAction) cls.newInstance();
            TActionPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setActionType(row.getValue(offset + 4).asIntegerObj());
            obj.setIconKey(row.getValue(offset + 5).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAction> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAction> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAction> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TAction> results = new ArrayList<TAction>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TActionPeer.row2Object(row, 1,
                TActionPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAction> doSelect(TAction obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TAction obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TAction obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TAction obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TAction) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TAction obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TAction) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TAction obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TAction) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TAction obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TAction obj )
    {
    ...
    public static Criteria buildSelectCriteria( TAction obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TAction retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TAction retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TAction retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TAction retVal = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TAction retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TAction> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAction> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TAction> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAction> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TAction> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TAction>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TAction objects pre-filled with their
     * TBLOB objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TActionPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TAction> doSelectJoinTBLOB(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TAction> doSelectJoinTBLOB(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TActionPeer.ICONKEY,
            TBLOBPeer.OBJECTID);
        ...
        List<TAction> results = new ArrayList<TAction>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TActionPeer.getOMClass();
            TAction obj1 = (TAction) TActionPeer
            ...
            {
                TAction temp_obj1 =  results.get(j);
                TBLOB temp_obj2 = (TBLOB) temp_obj1.getTBLOB();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTAction(obj1);
                    break;
                }
            }
            if (newObject)
