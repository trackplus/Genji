...
/**
 */
public abstract class BaseTWorkFlowRolePeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TWorkFlowRoleMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TWorkFlowRoleMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the MAYCHANGEROLE field */
    public static final String MAYCHANGEROLE;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TWORKFLOWROLE";

        OBJECTID = "TWORKFLOWROLE.OBJECTID";
        WORKFLOW = "TWORKFLOWROLE.WORKFLOW";
        MAYCHANGEROLE = "TWORKFLOWROLE.MAYCHANGEROLE";
        TPUUID = "TWORKFLOWROLE.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TWorkFlowRoleMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TWorkFlowRoleMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TWorkFlowRole";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkFlowRole> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(MAYCHANGEROLE);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TWorkFlowRole row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TWorkFlowRole obj = (TWorkFlowRole) cls.newInstance();
            TWorkFlowRolePeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setMayChangeRole(row.getValue(offset + 2).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkFlowRole> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkFlowRole> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkFlowRole> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TWorkFlowRole> results = new ArrayList<TWorkFlowRole>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TWorkFlowRolePeer.row2Object(row, 1,
                TWorkFlowRolePeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkFlowRole> doSelect(TWorkFlowRole obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TWorkFlowRole obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TWorkFlowRole obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TWorkFlowRole obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TWorkFlowRole) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TWorkFlowRole obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TWorkFlowRole) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TWorkFlowRole obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TWorkFlowRole) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TWorkFlowRole obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TWorkFlowRole obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(OBJECTID, obj.getObjectID());
        criteria.add(WORKFLOW, obj.getWorkFlow());
        criteria.add(MAYCHANGEROLE, obj.getMayChangeRole());
        criteria.add(TPUUID, obj.getUuid());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( TWorkFlowRole obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TWorkFlowRole retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TWorkFlowRole retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TWorkFlowRole retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TWorkFlowRole retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TWorkFlowRole retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TWorkFlowRole> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkFlowRole> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TWorkFlowRole> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkFlowRole> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TWorkFlowRole> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TWorkFlowRole>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TWorkFlowRole objects pre-filled with their
     * TWorkFlow objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TWorkFlowRolePeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TWorkFlowRole> doSelectJoinTWorkFlow(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TWorkFlowRole> doSelectJoinTWorkFlow(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TWorkFlowRolePeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TWorkFlowPeer.addSelectColumns(criteria);

        criteria.addJoin(TWorkFlowRolePeer.WORKFLOW,
        ...
        List<TWorkFlowRole> results = new ArrayList<TWorkFlowRole>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TWorkFlowRolePeer.getOMClass();
            TWorkFlowRole obj1 = (TWorkFlowRole) TWorkFlowRolePeer
            ...
            {
                TWorkFlowRole temp_obj1 =  results.get(j);
                TWorkFlow temp_obj2 = (TWorkFlow) temp_obj1.getTWorkFlow();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTWorkFlowRole(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTWorkFlowRoles();
                obj2.addTWorkFlowRole(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TWorkFlowRole> doSelectJoinTRole(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TWorkFlowRole> doSelectJoinTRole(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TWorkFlowRolePeer.MAYCHANGEROLE,
            TRolePeer.PKEY);
