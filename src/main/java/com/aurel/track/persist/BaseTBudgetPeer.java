...
/**
 */
public abstract class BaseTBudgetPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TBudgetMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TBudgetMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the BUDGETTYPE field */
    public static final String BUDGETTYPE;
    ...
    static
    {
        ...
        OBJECTID = "TBUDGET.OBJECTID";
        WORKITEMKEY = "TBUDGET.WORKITEMKEY";
        ESTIMATEDHOURS = "TBUDGET.ESTIMATEDHOURS";
        TIMEUNIT = "TBUDGET.TIMEUNIT";
        ESTIMATEDCOST = "TBUDGET.ESTIMATEDCOST";
        EFFORTTYPE = "TBUDGET.EFFORTTYPE";
        EFFORTVALUE = "TBUDGET.EFFORTVALUE";
        CHANGEDESCRIPTION = "TBUDGET.CHANGEDESCRIPTION";
        MOREPROPS = "TBUDGET.MOREPROPS";
        CHANGEDBY = "TBUDGET.CHANGEDBY";
        LASTEDIT = "TBUDGET.LASTEDIT";
        BUDGETTYPE = "TBUDGET.BUDGETTYPE";
        TPUUID = "TBUDGET.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TBudgetMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TBudgetMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TBudget";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TBudget> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(BUDGETTYPE);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TBudget row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TBudget obj = (TBudget) cls.newInstance();
            TBudgetPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setChangeDescription(row.getValue(offset + 7).asString());
            obj.setMoreProps(row.getValue(offset + 8).asString());
            obj.setChangedByID(row.getValue(offset + 9).asIntegerObj());
            obj.setLastEdit(row.getValue(offset + 10).asUtilDate());
            obj.setBudgetType(row.getValue(offset + 11).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TBudget> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TBudget> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TBudget> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TBudget> results = new ArrayList<TBudget>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TBudgetPeer.row2Object(row, 1,
                TBudgetPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TBudget> doSelect(TBudget obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TBudget obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TBudget obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TBudget obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TBudget) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TBudget obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TBudget) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TBudget obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TBudget) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TBudget obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TBudget obj )
    {
        ...
        criteria.add(BUDGETTYPE, obj.getBudgetType());
        criteria.add(TPUUID, obj.getUuid());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( TBudget obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TBudget retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TBudget retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TBudget retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TBudget retVal = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TBudget retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TBudget> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TBudget> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TBudget> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TBudget> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TBudget> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TBudget>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TBudget objects pre-filled with their
     * TWorkItem objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TBudgetPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TBudget> doSelectJoinTWorkItem(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TBudget> doSelectJoinTWorkItem(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TBudgetPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TWorkItemPeer.addSelectColumns(criteria);

        criteria.addJoin(TBudgetPeer.WORKITEMKEY,
        ...
        List<TBudget> results = new ArrayList<TBudget>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TBudgetPeer.getOMClass();
            TBudget obj1 = (TBudget) TBudgetPeer
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TBudget> doSelectJoinTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TBudget> doSelectJoinTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TBudgetPeer.CHANGEDBY,
            TPersonPeer.PKEY);
