 ...
 * extended all references should be to TWorkItemLock
 */
public abstract class BaseTWorkItemLock extends TpBaseObject
{
    /** The Peer class */
    private static final TWorkItemLockPeer peer =
        new TWorkItemLockPeer();
    ...
    {
        if (name.equals(TWorkItemLockPeer.WORKITEM))
        {
            return getWorkItem();
        }
        if (name.equals(TWorkItemLockPeer.PERSON))
        {
            return getPerson();
        }
        if (name.equals(TWorkItemLockPeer.HTTPSESSION))
        {
            return getHttpSession();
        }
        if (name.equals(TWorkItemLockPeer.TPUUID))
        {
            return getUuid();
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (TWorkItemLockPeer.WORKITEM.equals(name))
        {
            return setByName("WorkItem", value);
        }
      if (TWorkItemLockPeer.PERSON.equals(name))
        {
            return setByName("Person", value);
        }
      if (TWorkItemLockPeer.HTTPSESSION.equals(name))
        {
            return setByName("HttpSession", value);
        }
      if (TWorkItemLockPeer.TPUUID.equals(name))
        {
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    TWorkItemLockPeer.doInsert((TWorkItemLock) this, con);
                    setNew(false);
                }
                else
                {
                    TWorkItemLockPeer.doUpdate((TWorkItemLock) this, con);
                }
            }
     ...
     */
    public TWorkItemLock copy(Connection con) throws TorqueException
    {
     ...
     */
    public TWorkItemLock copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new TWorkItemLock(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public TWorkItemLock copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new TWorkItemLock(), deepcopy, con);
    }
     ...
     */
    protected TWorkItemLock copyInto(TWorkItemLock copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected TWorkItemLock copyInto(TWorkItemLock copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected TWorkItemLock copyInto(TWorkItemLock copyObj, boolean deepcopy) throws TorqueException
    {
        ...
        copyObj.setWorkItem((Integer)null);
     ...
     * @param con the database connection to read associated objects.
     */
    protected TWorkItemLock copyInto(TWorkItemLock copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setWorkItem(workItem);
        copyObj.setPerson(person);
        copyObj.setHttpSession(httpSession);
    ...
    /**
     * Creates a TWorkItemLockBean with the contents of this object
     * This also creates beans for cached related objects, if they exist
     * @return a TWorkItemLockBean with the contents of this object
     */
     ...
     * @return a TWorkItemLockBean with the contents of this object
     */
    public TWorkItemLockBean getBean(IdentityMap createdBeans)
    {
        TWorkItemLockBean result = (TWorkItemLockBean) createdBeans.get(this);
        if (result != null ) {
            // we have already created a bean for this object, return it
            return result;
        }
        // no bean exists for this object; create a new one
        result = new TWorkItemLockBean();
    ...
    /**
     * Creates an instance of TWorkItemLock with the contents
     * of a TWorkItemLockBean.
     * This behaviour could have also been achieved using a constructor,
     * however as this class is abstract no constructors are allowed
     * @param bean the TWorkItemLockBean which contents are used to create
     *        the resulting class
     * @return an instance of TWorkItemLock with the contents of bean
     */
    public static TWorkItemLock createTWorkItemLock(TWorkItemLockBean bean)
        throws TorqueException
    {
        return createTWorkItemLock(bean, new IdentityMap());
    }
    ...
    public static TWorkItemLock createTWorkItemLock(TWorkItemLockBean bean, IdentityMap createdObjects)
        throws TorqueException
    {
        TWorkItemLock result = (TWorkItemLock) createdObjects.get(bean);
        if (result != null)
        {
            // we already have an object for the bean, return it
            return result;
        }
        result = new TWorkItemLock();
