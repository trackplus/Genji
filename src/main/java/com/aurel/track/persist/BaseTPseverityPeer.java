...
/**
 */
public abstract class BaseTPseverityPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TPseverityMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TPseverityMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TPSEVERITY";

        OBJECTID = "TPSEVERITY.OBJECTID";
        SEVERITY = "TPSEVERITY.SEVERITY";
        PROJECTTYPE = "TPSEVERITY.PROJECTTYPE";
        LISTTYPE = "TPSEVERITY.LISTTYPE";
        TPUUID = "TPSEVERITY.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TPseverityMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TPseverityMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TPseverity";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPseverity> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(SEVERITY);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TPseverity row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TPseverity obj = (TPseverity) cls.newInstance();
            TPseverityPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setSeverity(row.getValue(offset + 1).asIntegerObj());
            obj.setProjectType(row.getValue(offset + 2).asIntegerObj());
            obj.setListType(row.getValue(offset + 3).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPseverity> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPseverity> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPseverity> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TPseverity> results = new ArrayList<TPseverity>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TPseverityPeer.row2Object(row, 1,
                TPseverityPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPseverity> doSelect(TPseverity obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TPseverity obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TPseverity obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TPseverity obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TPseverity) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TPseverity obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TPseverity) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TPseverity obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TPseverity) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TPseverity obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TPseverity obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(OBJECTID, obj.getObjectID());
        criteria.add(SEVERITY, obj.getSeverity());
    ...
    public static Criteria buildSelectCriteria( TPseverity obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TPseverity retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TPseverity retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TPseverity retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TPseverity retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TPseverity retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TPseverity> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPseverity> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TPseverity> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPseverity> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TPseverity> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TPseverity>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TPseverity objects pre-filled with their
     * TSeverity objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TPseverityPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPseverity> doSelectJoinTSeverity(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPseverity> doSelectJoinTSeverity(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TPseverityPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TSeverityPeer.addSelectColumns(criteria);

        criteria.addJoin(TPseverityPeer.SEVERITY,
            TSeverityPeer.PKEY);
        ...
        List<TPseverity> results = new ArrayList<TPseverity>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TPseverityPeer.getOMClass();
            TPseverity obj1 = (TPseverity) TPseverityPeer
            ...
            {
                TPseverity temp_obj1 =  results.get(j);
                TSeverity temp_obj2 = (TSeverity) temp_obj1.getTSeverity();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTPseverity(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTPseveritys();
                obj2.addTPseverity(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPseverity> doSelectJoinTProjectType(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPseverity> doSelectJoinTProjectType(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TPseverityPeer.PROJECTTYPE,
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPseverity> doSelectJoinTListType(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPseverity> doSelectJoinTListType(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TPseverityPeer.LISTTYPE,
            TListTypePeer.PKEY);
    ...
    /**
     * selects a collection of TPseverity objects pre-filled with
     * all related objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPseverity> doSelectJoinAllExceptTSeverity(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPseverity> doSelectJoinAllExceptTSeverity(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        TProjectTypePeer.addSelectColumns(criteria);
        criteria.addJoin(TPseverityPeer.PROJECTTYPE, TProjectTypePeer.OBJECTID);
        int offset3 = offset2 + TProjectTypePeer.numColumns;

        TListTypePeer.addSelectColumns(criteria);
        criteria.addJoin(TPseverityPeer.LISTTYPE, TListTypePeer.PKEY);
 ...
 newObject = true;
            for (int j = 0; j < results.size(); j++)
            {
                ...
                {
                    newObject = false;
                    temp_obj3.addTPseverity(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj3.initTPseveritys();
                obj3.addTPseverity(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPseverity> doSelectJoinAllExceptTProjectType(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPseverity> doSelectJoinAllExceptTProjectType(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        TSeverityPeer.addSelectColumns(criteria);
        criteria.addJoin(TPseverityPeer.SEVERITY, TSeverityPeer.PKEY);
        int offset3 = offset2 + TSeverityPeer.numColumns;
 ...
 newObject = true;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPseverity> doSelectJoinAllExceptTListType(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPseverity> doSelectJoinAllExceptTListType(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
