...
/**
 */
public abstract class BaseTScreenPanelPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TScreenPanelMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TScreenPanelMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TSCREENPANEL";

        OBJECTID = "TSCREENPANEL.OBJECTID";
        NAME = "TSCREENPANEL.NAME";
        LABEL = "TSCREENPANEL.LABEL";
        DESCRIPTION = "TSCREENPANEL.DESCRIPTION";
        SORTORDER = "TSCREENPANEL.SORTORDER";
        ROWSNO = "TSCREENPANEL.ROWSNO";
        COLSNO = "TSCREENPANEL.COLSNO";
        PARENT = "TSCREENPANEL.PARENT";
        TPUUID = "TSCREENPANEL.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TScreenPanelMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TScreenPanelMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TScreenPanel";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TScreenPanel> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TScreenPanel row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TScreenPanel obj = (TScreenPanel) cls.newInstance();
            TScreenPanelPeer.populateObject(row, offset, obj);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TScreenPanel> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TScreenPanel> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TScreenPanel> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TScreenPanel> results = new ArrayList<TScreenPanel>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TScreenPanelPeer.row2Object(row, 1,
                TScreenPanelPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TScreenPanel> doSelect(TScreenPanel obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TScreenPanel obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TScreenPanel obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TScreenPanel obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TScreenPanel) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TScreenPanel obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TScreenPanel) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TScreenPanel obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TScreenPanel) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TScreenPanel obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TScreenPanel obj )
    {
    ...
    public static Criteria buildSelectCriteria( TScreenPanel obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TScreenPanel retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TScreenPanel retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TScreenPanel retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TScreenPanel retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TScreenPanel retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TScreenPanel> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TScreenPanel> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TScreenPanel> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TScreenPanel> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TScreenPanel> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TScreenPanel>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TScreenPanel objects pre-filled with their
     * TScreenTab objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TScreenPanelPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TScreenPanel> doSelectJoinTScreenTab(Criteria criteria)
        throws TorqueException
    {
        return doSelectJoinTScreenTab(criteria, null);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TScreenPanel> doSelectJoinTScreenTab(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TScreenPanelPeer.PARENT,
            TScreenTabPeer.OBJECTID);
        ...
        List<TScreenPanel> results = new ArrayList<TScreenPanel>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TScreenPanelPeer.getOMClass();
            TScreenPanel obj1 = (TScreenPanel) TScreenPanelPeer
                .row2Object(row, 1, omClass);
             omClass = TScreenTabPeer.getOMClass();
            TScreenTab obj2 = (TScreenTab) TScreenTabPeer
                .row2Object(row, offset, omClass);

            boolean newObject = true;
            for (int j = 0; j < results.size(); j++)
            {
                TScreenPanel temp_obj1 =  results.get(j);
                TScreenTab temp_obj2 = (TScreenTab) temp_obj1.getTScreenTab();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTScreenPanel(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTScreenPanels();
                obj2.addTScreenPanel(obj1);
            }
            results.add(obj1);
        }
        return results;
