 ...
 * extended all references should be to TAttachmentVersion
 */
public abstract class BaseTAttachmentVersion extends TpBaseObject
{
    /** The Peer class */
    private static final TAttachmentVersionPeer peer =
        new TAttachmentVersionPeer();
    ...
    {
        if (name.equals(TAttachmentVersionPeer.OBJECTID))
        {
            return getObjectID();
        }
        if (name.equals(TAttachmentVersionPeer.WORKITEM))
        {
            return getWorkItem();
        }
        if (name.equals(TAttachmentVersionPeer.CHANGEDBY))
        {
            return getChangedBy();
        }
        if (name.equals(TAttachmentVersionPeer.DOCUMENTSTATE))
        {
            return getDocumentState();
        }
        if (name.equals(TAttachmentVersionPeer.FILENAME))
        {
            return getFileName();
        }
        if (name.equals(TAttachmentVersionPeer.ISURL))
        {
            return getIsUrl();
        }
        if (name.equals(TAttachmentVersionPeer.FILESIZE))
        {
            return getFileSize();
        }
        if (name.equals(TAttachmentVersionPeer.MIMETYPE))
        {
            return getMimeType();
        }
        if (name.equals(TAttachmentVersionPeer.LASTEDIT))
        {
            return getLastEdit();
        }
        if (name.equals(TAttachmentVersionPeer.VERSION))
        {
            return getVersion();
        }
        if (name.equals(TAttachmentVersionPeer.DESCRIPTION))
        {
            return getDescription();
        }
        if (name.equals(TAttachmentVersionPeer.CRYPTKEY))
        {
            return getCryptKey();
        }
        if (name.equals(TAttachmentVersionPeer.ISENCRYPTED))
        {
            return getIsEncrypted();
        }
        if (name.equals(TAttachmentVersionPeer.ISDELETED))
        {
            return getIsDeleted();
        }
        if (name.equals(TAttachmentVersionPeer.TPUUID))
        {
            return getUuid();
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (TAttachmentVersionPeer.OBJECTID.equals(name))
        {
            return setByName("ObjectID", value);
        }
      if (TAttachmentVersionPeer.WORKITEM.equals(name))
        {
            return setByName("WorkItem", value);
        }
      if (TAttachmentVersionPeer.CHANGEDBY.equals(name))
        {
            return setByName("ChangedBy", value);
        }
      if (TAttachmentVersionPeer.DOCUMENTSTATE.equals(name))
        {
            return setByName("DocumentState", value);
        }
      if (TAttachmentVersionPeer.FILENAME.equals(name))
        {
            return setByName("FileName", value);
        }
      if (TAttachmentVersionPeer.ISURL.equals(name))
        {
            return setByName("IsUrl", value);
        }
      if (TAttachmentVersionPeer.FILESIZE.equals(name))
        {
            return setByName("FileSize", value);
        }
      if (TAttachmentVersionPeer.MIMETYPE.equals(name))
        {
            return setByName("MimeType", value);
        }
      if (TAttachmentVersionPeer.LASTEDIT.equals(name))
        {
            return setByName("LastEdit", value);
        }
      if (TAttachmentVersionPeer.VERSION.equals(name))
        {
            return setByName("Version", value);
        }
      if (TAttachmentVersionPeer.DESCRIPTION.equals(name))
        {
            return setByName("Description", value);
        }
      if (TAttachmentVersionPeer.CRYPTKEY.equals(name))
        {
            return setByName("CryptKey", value);
        }
      if (TAttachmentVersionPeer.ISENCRYPTED.equals(name))
        {
            return setByName("IsEncrypted", value);
        }
      if (TAttachmentVersionPeer.ISDELETED.equals(name))
        {
            return setByName("IsDeleted", value);
        }
      if (TAttachmentVersionPeer.TPUUID.equals(name))
        {
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    TAttachmentVersionPeer.doInsert((TAttachmentVersion) this, con);
                    setNew(false);
                }
                else
                {
                    TAttachmentVersionPeer.doUpdate((TAttachmentVersion) this, con);
                }
            }
     ...
     */
    public TAttachmentVersion copy(Connection con) throws TorqueException
    {
     ...
     */
    public TAttachmentVersion copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new TAttachmentVersion(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public TAttachmentVersion copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new TAttachmentVersion(), deepcopy, con);
    }
     ...
     */
    protected TAttachmentVersion copyInto(TAttachmentVersion copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected TAttachmentVersion copyInto(TAttachmentVersion copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected TAttachmentVersion copyInto(TAttachmentVersion copyObj, boolean deepcopy) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected TAttachmentVersion copyInto(TAttachmentVersion copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setObjectID(objectID);
        copyObj.setWorkItem(workItem);
        copyObj.setChangedBy(changedBy);
    ...
    /**
     * Creates a TAttachmentVersionBean with the contents of this object
     * This also creates beans for cached related objects, if they exist
     * @return a TAttachmentVersionBean with the contents of this object
     */
     ...
     * @return a TAttachmentVersionBean with the contents of this object
     */
    public TAttachmentVersionBean getBean(IdentityMap createdBeans)
    {
        TAttachmentVersionBean result = (TAttachmentVersionBean) createdBeans.get(this);
        if (result != null ) {
            // we have already created a bean for this object, return it
            return result;
        }
        // no bean exists for this object; create a new one
        result = new TAttachmentVersionBean();
    ...
    /**
     * Creates an instance of TAttachmentVersion with the contents
     * of a TAttachmentVersionBean.
     * This behaviour could have also been achieved using a constructor,
     * however as this class is abstract no constructors are allowed
     * @param bean the TAttachmentVersionBean which contents are used to create
     *        the resulting class
     * @return an instance of TAttachmentVersion with the contents of bean
     */
    public static TAttachmentVersion createTAttachmentVersion(TAttachmentVersionBean bean)
        throws TorqueException
    {
        return createTAttachmentVersion(bean, new IdentityMap());
    }
    ...
    public static TAttachmentVersion createTAttachmentVersion(TAttachmentVersionBean bean, IdentityMap createdObjects)
        throws TorqueException
    {
        TAttachmentVersion result = (TAttachmentVersion) createdObjects.get(bean);
        if (result != null)
        {
            // we already have an object for the bean, return it
            return result;
        }
        result = new TAttachmentVersion();
