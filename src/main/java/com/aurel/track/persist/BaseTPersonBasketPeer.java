 ...
 *
 */
public abstract class BaseTPersonBasketPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TPersonBasketMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TPersonBasketMapBuilder.CLASS_NAME);
    }

    /** the column name for the OBJECTID field */
    public static final String OBJECTID;
    /** the column name for the BASKET field */
    ...
    /** the column name for the DELEGATETEXT field */
    public static final String DELEGATETEXT;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TPERSONBASKET";

        OBJECTID = "TPERSONBASKET.OBJECTID";
        BASKET = "TPERSONBASKET.BASKET";
        WORKITEM = "TPERSONBASKET.WORKITEM";
        PERSON = "TPERSONBASKET.PERSON";
        REMINDERDATE = "TPERSONBASKET.REMINDERDATE";
        DELEGATETEXT = "TPERSONBASKET.DELEGATETEXT";
        MOREPROPS = "TPERSONBASKET.MOREPROPS";
        TPUUID = "TPERSONBASKET.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TPersonBasketMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TPersonBasketMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TPersonBasket";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPersonBasket> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TPersonBasket row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TPersonBasket obj = (TPersonBasket) cls.newInstance();
            TPersonBasketPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setBasket(row.getValue(offset + 1).asIntegerObj());
            obj.setWorkItem(row.getValue(offset + 2).asIntegerObj());
            obj.setPerson(row.getValue(offset + 3).asIntegerObj());
            obj.setReminderDate(row.getValue(offset + 4).asUtilDate());
            obj.setDelegateText(row.getValue(offset + 5).asString());
            obj.setMoreProps(row.getValue(offset + 6).asString());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPersonBasket> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPersonBasket> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPersonBasket> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TPersonBasket> results = new ArrayList<TPersonBasket>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TPersonBasketPeer.row2Object(row, 1,
                TPersonBasketPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPersonBasket> doSelect(TPersonBasket obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TPersonBasket obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TPersonBasket obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TPersonBasket obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TPersonBasket) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TPersonBasket obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TPersonBasket) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TPersonBasket obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TPersonBasket) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TPersonBasket obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildSelectCriteria( TPersonBasket obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TPersonBasket retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TPersonBasket retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TPersonBasket retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TPersonBasket retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TPersonBasket retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TPersonBasket> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPersonBasket> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TPersonBasket> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPersonBasket> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TPersonBasket> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TPersonBasket>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TPersonBasket objects pre-filled with their
     * TBasket objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TPersonBasketPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPersonBasket> doSelectJoinTBasket(Criteria criteria)
        throws TorqueException
    {
        return doSelectJoinTBasket(criteria, null);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPersonBasket> doSelectJoinTBasket(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TPersonBasketPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TBasketPeer.addSelectColumns(criteria);

        criteria.addJoin(TPersonBasketPeer.BASKET,
            TBasketPeer.OBJECTID);
        ...
        List<TPersonBasket> results = new ArrayList<TPersonBasket>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TPersonBasketPeer.getOMClass();
            TPersonBasket obj1 = (TPersonBasket) TPersonBasketPeer
                .row2Object(row, 1, omClass);
             omClass = TBasketPeer.getOMClass();
            TBasket obj2 = (TBasket) TBasketPeer
                .row2Object(row, offset, omClass);

            boolean newObject = true;
            for (int j = 0; j < results.size(); j++)
            {
                TPersonBasket temp_obj1 =  results.get(j);
                TBasket temp_obj2 = (TBasket) temp_obj1.getTBasket();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTPersonBasket(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTPersonBaskets();
                obj2.addTPersonBasket(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPersonBasket> doSelectJoinTWorkItem(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPersonBasket> doSelectJoinTWorkItem(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TPersonBasketPeer.WORKITEM,
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPersonBasket> doSelectJoinTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPersonBasket> doSelectJoinTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TPersonBasketPeer.PERSON,
            TPersonPeer.PKEY);
    ...
    /**
     * selects a collection of TPersonBasket objects pre-filled with
     * all related objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPersonBasket> doSelectJoinAllExceptTBasket(Criteria criteria)
        throws TorqueException
    {
        return doSelectJoinAllExceptTBasket(criteria, null);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPersonBasket> doSelectJoinAllExceptTBasket(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        TWorkItemPeer.addSelectColumns(criteria);
        criteria.addJoin(TPersonBasketPeer.WORKITEM, TWorkItemPeer.WORKITEMKEY);
        int offset3 = offset2 + TWorkItemPeer.numColumns;

        TPersonPeer.addSelectColumns(criteria);
        criteria.addJoin(TPersonBasketPeer.PERSON, TPersonPeer.PKEY);
 ...
 newObject = true;
            for (int j = 0; j < results.size(); j++)
            {
                ...
                {
                    newObject = false;
                    temp_obj3.addTPersonBasket(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj3.initTPersonBaskets();
                obj3.addTPersonBasket(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPersonBasket> doSelectJoinAllExceptTWorkItem(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPersonBasket> doSelectJoinAllExceptTWorkItem(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        TBasketPeer.addSelectColumns(criteria);
        criteria.addJoin(TPersonBasketPeer.BASKET, TBasketPeer.OBJECTID);
        int offset3 = offset2 + TBasketPeer.numColumns;
 ...
 newObject = true;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPersonBasket> doSelectJoinAllExceptTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPersonBasket> doSelectJoinAllExceptTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
