...
/**
 */
public abstract class BaseTItemTransitionPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TItemTransitionMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TItemTransitionMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the TRANSITION field */
    public static final String TRANSITION;
    /** the column name for the TRANSITIONTIME field */
    public static final String TRANSITIONTIME;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TITEMTRANSITION";

        OBJECTID = "TITEMTRANSITION.OBJECTID";
        WORKITEM = "TITEMTRANSITION.WORKITEM";
        TRANSITION = "TITEMTRANSITION.TRANSITION";
        TRANSITIONTIME = "TITEMTRANSITION.TRANSITIONTIME";
        TPUUID = "TITEMTRANSITION.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TItemTransitionMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TItemTransitionMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TItemTransition";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TItemTransition> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTItemTransitionPeer
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(TRANSITION);
        criteria.addSelectColumn(TRANSITIONTIME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TItemTransition row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TItemTransition obj = (TItemTransition) cls.newInstance();
            TItemTransitionPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setTransition(row.getValue(offset + 2).asIntegerObj());
            obj.setTransitionTime(row.getValue(offset + 3).asUtilDate());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TItemTransition> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TItemTransition> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TItemTransition> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TItemTransition> results = new ArrayList<TItemTransition>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TItemTransitionPeer.row2Object(row, 1,
                TItemTransitionPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TItemTransition> doSelect(TItemTransition obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TItemTransition obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TItemTransition obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TItemTransition obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TItemTransition) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TItemTransition obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TItemTransition) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TItemTransition obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TItemTransition) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TItemTransition obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TItemTransition obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(OBJECTID, obj.getObjectID());
        criteria.add(WORKITEM, obj.getWorkItem());
        criteria.add(TRANSITION, obj.getTransition());
        criteria.add(TRANSITIONTIME, obj.getTransitionTime());
        criteria.add(TPUUID, obj.getUuid());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( TItemTransition obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TItemTransition retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TItemTransition retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TItemTransition retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TItemTransition retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TItemTransition retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TItemTransition> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (TItemTransition)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TItemTransition> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TItemTransition> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TItemTransition> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TItemTransition> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TItemTransition>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TItemTransition objects pre-filled with their
     * TWorkItem objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TItemTransitionPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TItemTransition> doSelectJoinTWorkItem(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TItemTransition> doSelectJoinTWorkItem(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TItemTransitionPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TWorkItemPeer.addSelectColumns(criteria);

        criteria.addJoin(TItemTransitionPeer.WORKITEM,
        ...
        List<TItemTransition> results = new ArrayList<TItemTransition>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TItemTransitionPeer.getOMClass();
            TItemTransition obj1 = (TItemTransition) TItemTransitionPeer
            ...
            {
                TItemTransition temp_obj1 =  results.get(j);
                TWorkItem temp_obj2 = (TWorkItem) temp_obj1.getTWorkItem();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTItemTransition(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTItemTransitions();
                obj2.addTItemTransition(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TItemTransition> doSelectJoinTWorkflowTransition(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TItemTransition> doSelectJoinTWorkflowTransition(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TItemTransitionPeer.TRANSITION,
