...
/**
 */
public abstract class BaseTFieldPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TFieldMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TFieldMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the FILTERFIELD field */
    public static final String FILTERFIELD;
    ...
    static
    {
        ...
        OBJECTID = "TFIELD.OBJECTID";
        NAME = "TFIELD.NAME";
        FIELDTYPE = "TFIELD.FIELDTYPE";
        DEPRECATED = "TFIELD.DEPRECATED";
        ISCUSTOM = "TFIELD.ISCUSTOM";
        REQUIRED = "TFIELD.REQUIRED";
        FILTERFIELD = "TFIELD.FILTERFIELD";
        DESCRIPTION = "TFIELD.DESCRIPTION";
        OWNER = "TFIELD.OWNER";
        PROJECTTYPE = "TFIELD.PROJECTTYPE";
        PROJECT = "TFIELD.PROJECT";
        TPUUID = "TFIELD.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TFieldMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TFieldMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TField";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TField> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(DEPRECATED);
        criteria.addSelectColumn(ISCUSTOM);
        criteria.addSelectColumn(REQUIRED);
        criteria.addSelectColumn(FILTERFIELD);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TField row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TField obj = (TField) cls.newInstance();
            TFieldPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setFieldType(row.getValue(offset + 2).asString());
            obj.setDeprecated(row.getValue(offset + 3).asString());
            obj.setIsCustom(row.getValue(offset + 4).asString());
            obj.setRequired(row.getValue(offset + 5).asString());
            obj.setFilterField(row.getValue(offset + 6).asString());
            obj.setDescription(row.getValue(offset + 7).asString());
            obj.setOwner(row.getValue(offset + 8).asIntegerObj());
            obj.setProjectType(row.getValue(offset + 9).asIntegerObj());
            obj.setProject(row.getValue(offset + 10).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TField> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TField> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TField> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TField> results = new ArrayList<TField>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TFieldPeer.row2Object(row, 1,
                TFieldPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TField> doSelect(TField obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TField obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TField obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TField obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TField) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TField obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TField) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TField obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TField) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TField obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TField obj )
    {
        ...
        criteria.add(DEPRECATED, obj.getDeprecated());
        criteria.add(ISCUSTOM, obj.getIsCustom());
        criteria.add(REQUIRED, obj.getRequired());
        criteria.add(FILTERFIELD, obj.getFilterField());
    ...
    public static Criteria buildSelectCriteria( TField obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TField retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TField retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TField retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TField retVal = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TField retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TField> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TField> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TField> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TField> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TField> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TField>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TField objects pre-filled with their
     * TPerson objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TFieldPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TField> doSelectJoinTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TField> doSelectJoinTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TFieldPeer.OWNER,
            TPersonPeer.PKEY);
        ...
        List<TField> results = new ArrayList<TField>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TFieldPeer.getOMClass();
            TField obj1 = (TField) TFieldPeer
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TField> doSelectJoinTProjectType(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TField> doSelectJoinTProjectType(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TFieldPeer.PROJECTTYPE,
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TField> doSelectJoinTProject(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TField> doSelectJoinTProject(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TFieldPeer.PROJECT,
            TProjectPeer.PKEY);
    ...
    /**
     * selects a collection of TField objects pre-filled with
     * all related objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TField> doSelectJoinAllExceptTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TField> doSelectJoinAllExceptTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        TProjectTypePeer.addSelectColumns(criteria);
        criteria.addJoin(TFieldPeer.PROJECTTYPE, TProjectTypePeer.OBJECTID);
        int offset3 = offset2 + TProjectTypePeer.numColumns;

        TProjectPeer.addSelectColumns(criteria);
        criteria.addJoin(TFieldPeer.PROJECT, TProjectPeer.PKEY);
 ...
 newObject = true;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TField> doSelectJoinAllExceptTProjectType(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TField> doSelectJoinAllExceptTProjectType(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        TPersonPeer.addSelectColumns(criteria);
        criteria.addJoin(TFieldPeer.OWNER, TPersonPeer.PKEY);
 ...
 newObject = true;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TField> doSelectJoinAllExceptTProject(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TField> doSelectJoinAllExceptTProject(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
