...
/**
 */
public abstract class BaseTRoleFieldPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TRoleFieldMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TRoleFieldMapBuilder.CLASS_NAME);
    }
    ...
    public static final String ACCESSRIGHT;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TROLEFIELD";

        OBJECTID = "TROLEFIELD.OBJECTID";
        ROLEKEY = "TROLEFIELD.ROLEKEY";
        FIELDKEY = "TROLEFIELD.FIELDKEY";
        ACCESSRIGHT = "TROLEFIELD.ACCESSRIGHT";
        TPUUID = "TROLEFIELD.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TRoleFieldMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TRoleFieldMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TRoleField";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRoleField> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(ACCESSRIGHT);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TRoleField row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TRoleField obj = (TRoleField) cls.newInstance();
            TRoleFieldPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setRoleKey(row.getValue(offset + 1).asIntegerObj());
            obj.setFieldKey(row.getValue(offset + 2).asIntegerObj());
            obj.setAccessRight(row.getValue(offset + 3).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRoleField> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRoleField> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRoleField> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TRoleField> results = new ArrayList<TRoleField>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TRoleFieldPeer.row2Object(row, 1,
                TRoleFieldPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRoleField> doSelect(TRoleField obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TRoleField obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TRoleField obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TRoleField obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TRoleField) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TRoleField obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TRoleField) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TRoleField obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TRoleField) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TRoleField obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TRoleField obj )
    {
        ...
        criteria.add(ACCESSRIGHT, obj.getAccessRight());
        criteria.add(TPUUID, obj.getUuid());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( TRoleField obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TRoleField retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TRoleField retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TRoleField retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TRoleField retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TRoleField retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TRoleField> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRoleField> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TRoleField> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRoleField> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TRoleField> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TRoleField>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TRoleField objects pre-filled with their
     * TRole objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TRoleFieldPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TRoleField> doSelectJoinTRole(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TRoleField> doSelectJoinTRole(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TRoleFieldPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TRolePeer.addSelectColumns(criteria);

        criteria.addJoin(TRoleFieldPeer.ROLEKEY,
            TRolePeer.PKEY);
        ...
        List<TRoleField> results = new ArrayList<TRoleField>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TRoleFieldPeer.getOMClass();
            TRoleField obj1 = (TRoleField) TRoleFieldPeer
            ...
            {
                TRoleField temp_obj1 =  results.get(j);
                TRole temp_obj2 = (TRole) temp_obj1.getTRole();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTRoleField(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTRoleFields();
                obj2.addTRoleField(obj1);
            }
            results.add(obj1);
        }
        return results;
