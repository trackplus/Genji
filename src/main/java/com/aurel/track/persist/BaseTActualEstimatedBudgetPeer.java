...
/**
 */
public abstract class BaseTActualEstimatedBudgetPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TActualEstimatedBudgetMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TActualEstimatedBudgetMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TACTUALESTIMATEDBUDGET";

        OBJECTID = "TACTUALESTIMATEDBUDGET.OBJECTID";
        WORKITEMKEY = "TACTUALESTIMATEDBUDGET.WORKITEMKEY";
        ESTIMATEDHOURS = "TACTUALESTIMATEDBUDGET.ESTIMATEDHOURS";
        TIMEUNIT = "TACTUALESTIMATEDBUDGET.TIMEUNIT";
        ESTIMATEDCOST = "TACTUALESTIMATEDBUDGET.ESTIMATEDCOST";
        EFFORTTYPE = "TACTUALESTIMATEDBUDGET.EFFORTTYPE";
        EFFORTVALUE = "TACTUALESTIMATEDBUDGET.EFFORTVALUE";
        CHANGEDBY = "TACTUALESTIMATEDBUDGET.CHANGEDBY";
        LASTEDIT = "TACTUALESTIMATEDBUDGET.LASTEDIT";
        TPUUID = "TACTUALESTIMATEDBUDGET.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TActualEstimatedBudgetMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TActualEstimatedBudgetMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TActualEstimatedBudget";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TActualEstimatedBudget> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTActualEstimatedBudgetPeer
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(ESTIMATEDHOURS);
        criteria.addSelectColumn(TIMEUNIT);
        criteria.addSelectColumn(ESTIMATEDCOST);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TActualEstimatedBudget row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TActualEstimatedBudget obj = (TActualEstimatedBudget) cls.newInstance();
            TActualEstimatedBudgetPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setEstimatedHours(row.getValue(offset + 2).asDoubleObj());
            obj.setTimeUnit(row.getValue(offset + 3).asIntegerObj());
            obj.setEstimatedCost(row.getValue(offset + 4).asDoubleObj());
            obj.setEfforttype(row.getValue(offset + 5).asIntegerObj());
            obj.setEffortvalue(row.getValue(offset + 6).asDoubleObj());
            obj.setChangedByID(row.getValue(offset + 7).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TActualEstimatedBudget> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TActualEstimatedBudget> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TActualEstimatedBudget> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TActualEstimatedBudget> results = new ArrayList<TActualEstimatedBudget>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TActualEstimatedBudgetPeer.row2Object(row, 1,
                TActualEstimatedBudgetPeer.getOMClass()));
        }
        return results;
    }
    ...
    {
         BaseTActualEstimatedBudgetPeer
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TActualEstimatedBudget> doSelect(TActualEstimatedBudget obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TActualEstimatedBudget obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TActualEstimatedBudget obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TActualEstimatedBudget obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TActualEstimatedBudget) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TActualEstimatedBudget obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TActualEstimatedBudget) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TActualEstimatedBudget obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TActualEstimatedBudget) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TActualEstimatedBudget obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TActualEstimatedBudget obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(OBJECTID, obj.getObjectID());
        criteria.add(WORKITEMKEY, obj.getWorkItemID());
        criteria.add(ESTIMATEDHOURS, obj.getEstimatedHours());
        criteria.add(TIMEUNIT, obj.getTimeUnit());
        criteria.add(ESTIMATEDCOST, obj.getEstimatedCost());
    ...
    public static Criteria buildSelectCriteria( TActualEstimatedBudget obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TActualEstimatedBudget retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TActualEstimatedBudget retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TActualEstimatedBudget retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TActualEstimatedBudget retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TActualEstimatedBudget retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TActualEstimatedBudget> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (TActualEstimatedBudget)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TActualEstimatedBudget> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TActualEstimatedBudget> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TActualEstimatedBudget> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TActualEstimatedBudget> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TActualEstimatedBudget>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TActualEstimatedBudget objects pre-filled with their
     * TWorkItem objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TActualEstimatedBudgetPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TActualEstimatedBudget> doSelectJoinTWorkItem(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TActualEstimatedBudget> doSelectJoinTWorkItem(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TActualEstimatedBudgetPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TWorkItemPeer.addSelectColumns(criteria);

        criteria.addJoin(TActualEstimatedBudgetPeer.WORKITEMKEY,
        ...
        List<TActualEstimatedBudget> results = new ArrayList<TActualEstimatedBudget>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TActualEstimatedBudgetPeer.getOMClass();
            TActualEstimatedBudget obj1 = (TActualEstimatedBudget) TActualEstimatedBudgetPeer
            ...
            {
                TActualEstimatedBudget temp_obj1 =  results.get(j);
                TWorkItem temp_obj2 = (TWorkItem) temp_obj1.getTWorkItem();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTActualEstimatedBudget(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTActualEstimatedBudgets();
                obj2.addTActualEstimatedBudget(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TActualEstimatedBudget> doSelectJoinTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TActualEstimatedBudget> doSelectJoinTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TActualEstimatedBudgetPeer.CHANGEDBY,
            TPersonPeer.PKEY);
