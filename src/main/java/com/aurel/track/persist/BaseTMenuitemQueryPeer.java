 ...
 *
 */
public abstract class BaseTMenuitemQueryPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TMenuitemQueryMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TMenuitemQueryMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the INCLUDEINMENU field */
    public static final String INCLUDEINMENU;
    /** the column name for the CSSSTYLEFIELD field */
    public static final String CSSSTYLEFIELD;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TMENUITEMQUERY";

        OBJECTID = "TMENUITEMQUERY.OBJECTID";
        PERSON = "TMENUITEMQUERY.PERSON";
        QUERYKEY = "TMENUITEMQUERY.QUERYKEY";
        INCLUDEINMENU = "TMENUITEMQUERY.INCLUDEINMENU";
        CSSSTYLEFIELD = "TMENUITEMQUERY.CSSSTYLEFIELD";
        TPUUID = "TMENUITEMQUERY.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TMenuitemQueryMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TMenuitemQueryMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TMenuitemQuery";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TMenuitemQuery> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(INCLUDEINMENU);
        criteria.addSelectColumn(CSSSTYLEFIELD);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TMenuitemQuery row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TMenuitemQuery obj = (TMenuitemQuery) cls.newInstance();
            TMenuitemQueryPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setQueryKey(row.getValue(offset + 2).asIntegerObj());
            obj.setIncludeInMenu(row.getValue(offset + 3).asString());
            obj.setCSSStyleField(row.getValue(offset + 4).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TMenuitemQuery> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TMenuitemQuery> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TMenuitemQuery> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TMenuitemQuery> results = new ArrayList<TMenuitemQuery>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TMenuitemQueryPeer.row2Object(row, 1,
                TMenuitemQueryPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TMenuitemQuery> doSelect(TMenuitemQuery obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TMenuitemQuery obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TMenuitemQuery obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TMenuitemQuery obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TMenuitemQuery) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TMenuitemQuery obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TMenuitemQuery) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TMenuitemQuery obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TMenuitemQuery) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TMenuitemQuery obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TMenuitemQuery obj )
    {
        ...
        criteria.add(INCLUDEINMENU, obj.getIncludeInMenu());
        criteria.add(CSSSTYLEFIELD, obj.getCSSStyleField());
        criteria.add(TPUUID, obj.getUuid());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( TMenuitemQuery obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TMenuitemQuery retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TMenuitemQuery retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TMenuitemQuery retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TMenuitemQuery retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TMenuitemQuery retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TMenuitemQuery> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TMenuitemQuery> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TMenuitemQuery> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TMenuitemQuery> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TMenuitemQuery> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TMenuitemQuery>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TMenuitemQuery objects pre-filled with their
     * TPerson objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TMenuitemQueryPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TMenuitemQuery> doSelectJoinTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TMenuitemQuery> doSelectJoinTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TMenuitemQueryPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TPersonPeer.addSelectColumns(criteria);

        criteria.addJoin(TMenuitemQueryPeer.PERSON,
            TPersonPeer.PKEY);
        ...
        List<TMenuitemQuery> results = new ArrayList<TMenuitemQuery>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TMenuitemQueryPeer.getOMClass();
            TMenuitemQuery obj1 = (TMenuitemQuery) TMenuitemQueryPeer
            ...
            {
                TMenuitemQuery temp_obj1 =  results.get(j);
                TPerson temp_obj2 = (TPerson) temp_obj1.getTPerson();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTMenuitemQuery(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTMenuitemQuerys();
                obj2.addTMenuitemQuery(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TMenuitemQuery> doSelectJoinTQueryRepository(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TMenuitemQuery> doSelectJoinTQueryRepository(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TMenuitemQueryPeer.QUERYKEY,
