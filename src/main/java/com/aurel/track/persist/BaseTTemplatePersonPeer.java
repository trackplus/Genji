 ...
 *
 */
public abstract class BaseTTemplatePersonPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TTemplatePersonMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TTemplatePersonMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the RIGHTFLAG field */
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TTEMPLATEPERSON";

        OBJECTID = "TTEMPLATEPERSON.OBJECTID";
        REPORTTEMPLATE = "TTEMPLATEPERSON.REPORTTEMPLATE";
        PERSON = "TTEMPLATEPERSON.PERSON";
        RIGHTFLAG = "TTEMPLATEPERSON.RIGHTFLAG";
        TPUUID = "TTEMPLATEPERSON.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TTemplatePersonMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TTemplatePersonMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TTemplatePerson";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TTemplatePerson> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTTemplatePersonPeer
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(RIGHTFLAG);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TTemplatePerson row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TTemplatePerson obj = (TTemplatePerson) cls.newInstance();
            TTemplatePersonPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setReportTemplate(row.getValue(offset + 1).asIntegerObj());
            obj.setPerson(row.getValue(offset + 2).asIntegerObj());
            obj.setRightFlag(row.getValue(offset + 3).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TTemplatePerson> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TTemplatePerson> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TTemplatePerson> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TTemplatePerson> results = new ArrayList<TTemplatePerson>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TTemplatePersonPeer.row2Object(row, 1,
                TTemplatePersonPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TTemplatePerson> doSelect(TTemplatePerson obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TTemplatePerson obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TTemplatePerson obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TTemplatePerson obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TTemplatePerson) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TTemplatePerson obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TTemplatePerson) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TTemplatePerson obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TTemplatePerson) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TTemplatePerson obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TTemplatePerson obj )
    {
        ...
        criteria.add(RIGHTFLAG, obj.getRightFlag());
        criteria.add(TPUUID, obj.getUuid());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( TTemplatePerson obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TTemplatePerson retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TTemplatePerson retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TTemplatePerson retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TTemplatePerson retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TTemplatePerson retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TTemplatePerson> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (TTemplatePerson)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TTemplatePerson> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TTemplatePerson> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TTemplatePerson> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TTemplatePerson> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TTemplatePerson>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TTemplatePerson objects pre-filled with their
     * TPerson objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TTemplatePersonPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TTemplatePerson> doSelectJoinTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TTemplatePerson> doSelectJoinTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TTemplatePersonPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TPersonPeer.addSelectColumns(criteria);

        criteria.addJoin(TTemplatePersonPeer.PERSON,
            TPersonPeer.PKEY);
        ...
        List<TTemplatePerson> results = new ArrayList<TTemplatePerson>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TTemplatePersonPeer.getOMClass();
            TTemplatePerson obj1 = (TTemplatePerson) TTemplatePersonPeer
            ...
            {
                TTemplatePerson temp_obj1 =  results.get(j);
                TPerson temp_obj2 = (TPerson) temp_obj1.getTPerson();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTTemplatePerson(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTTemplatePersons();
                obj2.addTTemplatePerson(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TTemplatePerson> doSelectJoinTExportTemplate(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TTemplatePerson> doSelectJoinTExportTemplate(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TTemplatePersonPeer.REPORTTEMPLATE,
