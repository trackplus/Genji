...
/**
 */
public abstract class BaseTEmailProcessedPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TEmailProcessedMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TEmailProcessedMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the MESSAGEUID field */
    public static final String MESSAGEUID;
    /** the column name for the RECEIVEDAT field */
    public static final String RECEIVEDAT;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TEMAILPROCESSED";

        OBJECTID = "TEMAILPROCESSED.OBJECTID";
        PROCESSEDDATE = "TEMAILPROCESSED.PROCESSEDDATE";
        MESSAGEUID = "TEMAILPROCESSED.MESSAGEUID";
        RECEIVEDAT = "TEMAILPROCESSED.RECEIVEDAT";
        TPUUID = "TEMAILPROCESSED.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TEmailProcessedMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TEmailProcessedMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TEmailProcessed";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEmailProcessed> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTEmailProcessedPeer
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(PROCESSEDDATE);
        criteria.addSelectColumn(MESSAGEUID);
        criteria.addSelectColumn(RECEIVEDAT);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TEmailProcessed row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TEmailProcessed obj = (TEmailProcessed) cls.newInstance();
            TEmailProcessedPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setProcessedDate(row.getValue(offset + 1).asUtilDate());
            obj.setMessageUID(row.getValue(offset + 2).asString());
            obj.setReceivedAt(row.getValue(offset + 3).asString());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEmailProcessed> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEmailProcessed> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEmailProcessed> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TEmailProcessed> results = new ArrayList<TEmailProcessed>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TEmailProcessedPeer.row2Object(row, 1,
                TEmailProcessedPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEmailProcessed> doSelect(TEmailProcessed obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TEmailProcessed obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TEmailProcessed obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TEmailProcessed obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TEmailProcessed) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TEmailProcessed obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TEmailProcessed) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TEmailProcessed obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TEmailProcessed) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TEmailProcessed obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TEmailProcessed obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(OBJECTID, obj.getObjectID());
        criteria.add(PROCESSEDDATE, obj.getProcessedDate());
        criteria.add(MESSAGEUID, obj.getMessageUID());
        criteria.add(RECEIVEDAT, obj.getReceivedAt());
        criteria.add(TPUUID, obj.getUuid());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( TEmailProcessed obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TEmailProcessed retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TEmailProcessed retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TEmailProcessed retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TEmailProcessed retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TEmailProcessed retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TEmailProcessed> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (TEmailProcessed)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEmailProcessed> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TEmailProcessed> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEmailProcessed> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TEmailProcessed> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TEmailProcessed>();
        }
        else
        {
            Criteria criteria = new Criteria();
