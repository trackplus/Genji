...
/**
 */
public abstract class BaseTPpriorityPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TPpriorityMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TPpriorityMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TPPRIORITY";

        OBJECTID = "TPPRIORITY.OBJECTID";
        PRIORITY = "TPPRIORITY.PRIORITY";
        PROJECTTYPE = "TPPRIORITY.PROJECTTYPE";
        LISTTYPE = "TPPRIORITY.LISTTYPE";
        TPUUID = "TPPRIORITY.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TPpriorityMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TPpriorityMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TPpriority";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPpriority> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TPpriority row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TPpriority obj = (TPpriority) cls.newInstance();
            TPpriorityPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setPriority(row.getValue(offset + 1).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPpriority> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPpriority> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPpriority> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TPpriority> results = new ArrayList<TPpriority>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TPpriorityPeer.row2Object(row, 1,
                TPpriorityPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPpriority> doSelect(TPpriority obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TPpriority obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TPpriority obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TPpriority obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TPpriority) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TPpriority obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TPpriority) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TPpriority obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TPpriority) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TPpriority obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TPpriority obj )
    {
    ...
    public static Criteria buildSelectCriteria( TPpriority obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TPpriority retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TPpriority retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TPpriority retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TPpriority retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TPpriority retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TPpriority> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPpriority> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TPpriority> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPpriority> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TPpriority> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TPpriority>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TPpriority objects pre-filled with their
     * TPriority objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TPpriorityPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPpriority> doSelectJoinTPriority(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPpriority> doSelectJoinTPriority(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TPpriorityPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TPriorityPeer.addSelectColumns(criteria);

        criteria.addJoin(TPpriorityPeer.PRIORITY,
            TPriorityPeer.PKEY);
        ...
        List<TPpriority> results = new ArrayList<TPpriority>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TPpriorityPeer.getOMClass();
            TPpriority obj1 = (TPpriority) TPpriorityPeer
            ...
            {
                TPpriority temp_obj1 =  results.get(j);
                TPriority temp_obj2 = (TPriority) temp_obj1.getTPriority();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTPpriority(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTPprioritys();
                obj2.addTPpriority(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPpriority> doSelectJoinTProjectType(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPpriority> doSelectJoinTProjectType(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TPpriorityPeer.PROJECTTYPE,
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPpriority> doSelectJoinTListType(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPpriority> doSelectJoinTListType(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TPpriorityPeer.LISTTYPE,
            TListTypePeer.PKEY);
    ...
    /**
     * selects a collection of TPpriority objects pre-filled with
     * all related objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPpriority> doSelectJoinAllExceptTPriority(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPpriority> doSelectJoinAllExceptTPriority(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        TProjectTypePeer.addSelectColumns(criteria);
        criteria.addJoin(TPpriorityPeer.PROJECTTYPE, TProjectTypePeer.OBJECTID);
        int offset3 = offset2 + TProjectTypePeer.numColumns;

        TListTypePeer.addSelectColumns(criteria);
        criteria.addJoin(TPpriorityPeer.LISTTYPE, TListTypePeer.PKEY);
 ...
 newObject = true;
            for (int j = 0; j < results.size(); j++)
            {
                ...
                {
                    newObject = false;
                    temp_obj3.addTPpriority(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj3.initTPprioritys();
                obj3.addTPpriority(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPpriority> doSelectJoinAllExceptTProjectType(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPpriority> doSelectJoinAllExceptTProjectType(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        TPriorityPeer.addSelectColumns(criteria);
        criteria.addJoin(TPpriorityPeer.PRIORITY, TPriorityPeer.PKEY);
 ...
 newObject = true;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPpriority> doSelectJoinAllExceptTListType(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPpriority> doSelectJoinAllExceptTListType(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
