...
/**
 */
public abstract class BaseTUserLevelSettingPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TUserLevelSettingMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TUserLevelSettingMapBuilder.CLASS_NAME);
    }
    ...
    public static final String ISACTIVE;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TUSERLEVELSETTING";

        OBJECTID = "TUSERLEVELSETTING.OBJECTID";
        USERLEVEL = "TUSERLEVELSETTING.USERLEVEL";
        ACTIONKEY = "TUSERLEVELSETTING.ACTIONKEY";
        ISACTIVE = "TUSERLEVELSETTING.ISACTIVE";
        TPUUID = "TUSERLEVELSETTING.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TUserLevelSettingMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TUserLevelSettingMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TUserLevelSetting";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TUserLevelSetting> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTUserLevelSettingPeer
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(ISACTIVE);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TUserLevelSetting row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TUserLevelSetting obj = (TUserLevelSetting) cls.newInstance();
            TUserLevelSettingPeer.populateObject(row, offset, obj);
    ...
    public static void populateObject(Record row,
                                      int offset,
                                      TUserLevelSetting obj)
        throws TorqueException
    {
        try
        {
            obj.setObjectID(row.getValue(offset + 0).asIntegerObj());
            obj.setUserLevel(row.getValue(offset + 1).asIntegerObj());
            obj.setACTIONKEY(row.getValue(offset + 2).asIntegerObj());
            obj.setIsActive(row.getValue(offset + 3).asString());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TUserLevelSetting> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TUserLevelSetting> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TUserLevelSetting> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TUserLevelSetting> results = new ArrayList<TUserLevelSetting>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TUserLevelSettingPeer.row2Object(row, 1,
                TUserLevelSettingPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TUserLevelSetting> doSelect(TUserLevelSetting obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TUserLevelSetting obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TUserLevelSetting obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TUserLevelSetting obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TUserLevelSetting) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TUserLevelSetting obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TUserLevelSetting) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TUserLevelSetting obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TUserLevelSetting) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TUserLevelSetting obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TUserLevelSetting obj )
    {
        ...
        criteria.add(ISACTIVE, obj.getIsActive());
        criteria.add(TPUUID, obj.getUuid());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( TUserLevelSetting obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TUserLevelSetting retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TUserLevelSetting retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TUserLevelSetting retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TUserLevelSetting retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TUserLevelSetting retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TUserLevelSetting> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (TUserLevelSetting)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TUserLevelSetting> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TUserLevelSetting> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TUserLevelSetting> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TUserLevelSetting> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TUserLevelSetting>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TUserLevelSetting objects pre-filled with their
     * TUserLevel objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TUserLevelSettingPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TUserLevelSetting> doSelectJoinTUserLevel(Criteria criteria)
        throws TorqueException
    {
        return doSelectJoinTUserLevel(criteria, null);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TUserLevelSetting> doSelectJoinTUserLevel(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TUserLevelSettingPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TUserLevelPeer.addSelectColumns(criteria);

        criteria.addJoin(TUserLevelSettingPeer.USERLEVEL,
        ...
        List<TUserLevelSetting> results = new ArrayList<TUserLevelSetting>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TUserLevelSettingPeer.getOMClass();
            TUserLevelSetting obj1 = (TUserLevelSetting) TUserLevelSettingPeer
                .row2Object(row, 1, omClass);
             omClass = TUserLevelPeer.getOMClass();
            TUserLevel obj2 = (TUserLevel) TUserLevelPeer
                .row2Object(row, offset, omClass);

            boolean newObject = true;
            for (int j = 0; j < results.size(); j++)
            {
                TUserLevelSetting temp_obj1 =  results.get(j);
                TUserLevel temp_obj2 = (TUserLevel) temp_obj1.getTUserLevel();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTUserLevelSetting(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTUserLevelSettings();
                obj2.addTUserLevelSetting(obj1);
            }
            results.add(obj1);
        }
        return results;
