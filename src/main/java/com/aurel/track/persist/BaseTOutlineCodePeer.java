 ...
 *
 */
public abstract class BaseTOutlineCodePeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TOutlineCodeMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TOutlineCodeMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the LEVELCODE field */
    public static final String LEVELCODE;
    /** the column name for the FULLCODE field */
    public static final String FULLCODE;
    /** the column name for the ENTITYID field */
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TOUTLINECODE";

        OBJECTID = "TOUTLINECODE.OBJECTID";
        PARENTID = "TOUTLINECODE.PARENTID";
        LEVELNO = "TOUTLINECODE.LEVELNO";
        LEVELCODE = "TOUTLINECODE.LEVELCODE";
        FULLCODE = "TOUTLINECODE.FULLCODE";
        ENTITYID = "TOUTLINECODE.ENTITYID";
        OUTLINETEMPLATE = "TOUTLINECODE.OUTLINETEMPLATE";
        TPUUID = "TOUTLINECODE.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TOutlineCodeMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TOutlineCodeMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TOutlineCode";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TOutlineCode> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(LEVELCODE);
        criteria.addSelectColumn(FULLCODE);
        criteria.addSelectColumn(ENTITYID);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TOutlineCode row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TOutlineCode obj = (TOutlineCode) cls.newInstance();
            TOutlineCodePeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setParentID(row.getValue(offset + 1).asIntegerObj());
            obj.setLevelNo(row.getValue(offset + 2).asIntegerObj());
            obj.setLevelCode(row.getValue(offset + 3).asString());
            obj.setFullCode(row.getValue(offset + 4).asString());
            obj.setEntityID(row.getValue(offset + 5).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TOutlineCode> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TOutlineCode> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TOutlineCode> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TOutlineCode> results = new ArrayList<TOutlineCode>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TOutlineCodePeer.row2Object(row, 1,
                TOutlineCodePeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TOutlineCode> doSelect(TOutlineCode obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TOutlineCode obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TOutlineCode obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TOutlineCode obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TOutlineCode) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TOutlineCode obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TOutlineCode) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TOutlineCode obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TOutlineCode) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TOutlineCode obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TOutlineCode obj )
    {
        ...
        criteria.add(LEVELCODE, obj.getLevelCode());
        criteria.add(FULLCODE, obj.getFullCode());
        criteria.add(ENTITYID, obj.getEntityID());
    ...
    public static Criteria buildSelectCriteria( TOutlineCode obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TOutlineCode retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TOutlineCode retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TOutlineCode retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TOutlineCode retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TOutlineCode retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TOutlineCode> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TOutlineCode> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TOutlineCode> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TOutlineCode> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TOutlineCode> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TOutlineCode>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TOutlineCode objects pre-filled with their
     * TOutlineTemplate objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TOutlineCodePeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TOutlineCode> doSelectJoinTOutlineTemplate(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TOutlineCode> doSelectJoinTOutlineTemplate(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TOutlineCodePeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TOutlineTemplatePeer.addSelectColumns(criteria);

        criteria.addJoin(TOutlineCodePeer.OUTLINETEMPLATE,
        ...
        List<TOutlineCode> results = new ArrayList<TOutlineCode>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TOutlineCodePeer.getOMClass();
            TOutlineCode obj1 = (TOutlineCode) TOutlineCodePeer
            ...
            {
                TOutlineCode temp_obj1 =  results.get(j);
                TOutlineTemplate temp_obj2 = (TOutlineTemplate) temp_obj1.getTOutlineTemplate();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTOutlineCode(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTOutlineCodes();
                obj2.addTOutlineCode(obj1);
            }
            results.add(obj1);
        }
        return results;
