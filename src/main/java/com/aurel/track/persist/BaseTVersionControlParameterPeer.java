...
/**
 */
public abstract class BaseTVersionControlParameterPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TVersionControlParameterMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TVersionControlParameterMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TVERSIONCONTROLPARAMETER";

        OBJECTID = "TVERSIONCONTROLPARAMETER.OBJECTID";
        NAME = "TVERSIONCONTROLPARAMETER.NAME";
        PARAMVALUE = "TVERSIONCONTROLPARAMETER.PARAMVALUE";
        PROJECT = "TVERSIONCONTROLPARAMETER.PROJECT";
        TPUUID = "TVERSIONCONTROLPARAMETER.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TVersionControlParameterMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TVersionControlParameterMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TVersionControlParameter";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TVersionControlParameter> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTVersionControlParameterPeer
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TVersionControlParameter row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TVersionControlParameter obj = (TVersionControlParameter) cls.newInstance();
            TVersionControlParameterPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setProject(row.getValue(offset + 3).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TVersionControlParameter> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TVersionControlParameter> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TVersionControlParameter> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TVersionControlParameter> results = new ArrayList<TVersionControlParameter>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TVersionControlParameterPeer.row2Object(row, 1,
                TVersionControlParameterPeer.getOMClass()));
        }
        return results;
    }
    ...
    {
         BaseTVersionControlParameterPeer
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TVersionControlParameter> doSelect(TVersionControlParameter obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TVersionControlParameter obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TVersionControlParameter obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TVersionControlParameter obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TVersionControlParameter) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TVersionControlParameter obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TVersionControlParameter) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TVersionControlParameter obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TVersionControlParameter) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TVersionControlParameter obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TVersionControlParameter obj )
    {
    ...
    public static Criteria buildSelectCriteria( TVersionControlParameter obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TVersionControlParameter retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TVersionControlParameter retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TVersionControlParameter retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TVersionControlParameter retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TVersionControlParameter retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TVersionControlParameter> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (TVersionControlParameter)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TVersionControlParameter> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TVersionControlParameter> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TVersionControlParameter> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TVersionControlParameter> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TVersionControlParameter>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TVersionControlParameter objects pre-filled with their
     * TProject objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TVersionControlParameterPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TVersionControlParameter> doSelectJoinTProject(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TVersionControlParameter> doSelectJoinTProject(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TVersionControlParameterPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TProjectPeer.addSelectColumns(criteria);

        criteria.addJoin(TVersionControlParameterPeer.PROJECT,
            TProjectPeer.PKEY);
        ...
        List<TVersionControlParameter> results = new ArrayList<TVersionControlParameter>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TVersionControlParameterPeer.getOMClass();
            TVersionControlParameter obj1 = (TVersionControlParameter) TVersionControlParameterPeer
            ...
            {
                TVersionControlParameter temp_obj1 =  results.get(j);
                TProject temp_obj2 = (TProject) temp_obj1.getTProject();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTVersionControlParameter(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTVersionControlParameters();
                obj2.addTVersionControlParameter(obj1);
            }
            results.add(obj1);
        }
        return results;
