 ...
 *
 */
public abstract class BaseTNavigatorGroupingSortingPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TNavigatorGroupingSortingMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TNavigatorGroupingSortingMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TNAVIGATORGROUPINGSORTING";

        OBJECTID = "TNAVIGATORGROUPINGSORTING.OBJECTID";
        NAVIGATORLAYOUT = "TNAVIGATORGROUPINGSORTING.NAVIGATORLAYOUT";
        FIELD = "TNAVIGATORGROUPINGSORTING.FIELD";
        SORTPOSITION = "TNAVIGATORGROUPINGSORTING.SORTPOSITION";
        ISGROUPING = "TNAVIGATORGROUPINGSORTING.ISGROUPING";
        ISDESCENDING = "TNAVIGATORGROUPINGSORTING.ISDESCENDING";
        ISCOLLAPSED = "TNAVIGATORGROUPINGSORTING.ISCOLLAPSED";
        TPUUID = "TNAVIGATORGROUPINGSORTING.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TNavigatorGroupingSortingMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TNavigatorGroupingSortingMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TNavigatorGroupingSorting";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TNavigatorGroupingSorting> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTNavigatorGroupingSortingPeer
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TNavigatorGroupingSorting row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TNavigatorGroupingSorting obj = (TNavigatorGroupingSorting) cls.newInstance();
            TNavigatorGroupingSortingPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setField(row.getValue(offset + 2).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TNavigatorGroupingSorting> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TNavigatorGroupingSorting> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TNavigatorGroupingSorting> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TNavigatorGroupingSorting> results = new ArrayList<TNavigatorGroupingSorting>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TNavigatorGroupingSortingPeer.row2Object(row, 1,
                TNavigatorGroupingSortingPeer.getOMClass()));
        }
        return results;
    }
    ...
    {
         BaseTNavigatorGroupingSortingPeer
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TNavigatorGroupingSorting> doSelect(TNavigatorGroupingSorting obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TNavigatorGroupingSorting obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TNavigatorGroupingSorting obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TNavigatorGroupingSorting obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TNavigatorGroupingSorting) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TNavigatorGroupingSorting obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TNavigatorGroupingSorting) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TNavigatorGroupingSorting obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TNavigatorGroupingSorting) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TNavigatorGroupingSorting obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TNavigatorGroupingSorting obj )
    {
    ...
    public static Criteria buildSelectCriteria( TNavigatorGroupingSorting obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TNavigatorGroupingSorting retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TNavigatorGroupingSorting retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TNavigatorGroupingSorting retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TNavigatorGroupingSorting retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TNavigatorGroupingSorting retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TNavigatorGroupingSorting> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (TNavigatorGroupingSorting)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TNavigatorGroupingSorting> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TNavigatorGroupingSorting> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TNavigatorGroupingSorting> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TNavigatorGroupingSorting> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TNavigatorGroupingSorting>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TNavigatorGroupingSorting objects pre-filled with their
     * TNavigatorLayout objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TNavigatorGroupingSortingPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TNavigatorGroupingSorting> doSelectJoinTNavigatorLayout(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TNavigatorGroupingSorting> doSelectJoinTNavigatorLayout(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TNavigatorGroupingSortingPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TNavigatorLayoutPeer.addSelectColumns(criteria);

        criteria.addJoin(TNavigatorGroupingSortingPeer.NAVIGATORLAYOUT,
        ...
        List<TNavigatorGroupingSorting> results = new ArrayList<TNavigatorGroupingSorting>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TNavigatorGroupingSortingPeer.getOMClass();
            TNavigatorGroupingSorting obj1 = (TNavigatorGroupingSorting) TNavigatorGroupingSortingPeer
            ...
            {
                TNavigatorGroupingSorting temp_obj1 =  results.get(j);
                TNavigatorLayout temp_obj2 = (TNavigatorLayout) temp_obj1.getTNavigatorLayout();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTNavigatorGroupingSorting(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTNavigatorGroupingSortings();
                obj2.addTNavigatorGroupingSorting(obj1);
            }
            results.add(obj1);
        }
        return results;
