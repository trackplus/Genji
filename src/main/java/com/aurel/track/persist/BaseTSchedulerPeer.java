...
/**
 */
public abstract class BaseTSchedulerPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TSchedulerMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TSchedulerMapBuilder.CLASS_NAME);
    }

    /** the column name for the OBJECTID field */
    public static final String OBJECTID;
    /** the column name for the CRONWHEN field */
    public static final String CRONWHEN;
    /** the column name for the JAVACLASSNAME field */
    public static final String JAVACLASSNAME;
    /** the column name for the EXTERNALEXE field */
    public static final String EXTERNALEXE;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TSCHEDULER";

        OBJECTID = "TSCHEDULER.OBJECTID";
        CRONWHEN = "TSCHEDULER.CRONWHEN";
        JAVACLASSNAME = "TSCHEDULER.JAVACLASSNAME";
        EXTERNALEXE = "TSCHEDULER.EXTERNALEXE";
        PERSON = "TSCHEDULER.PERSON";
        TPUUID = "TSCHEDULER.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TSchedulerMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TSchedulerMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TScheduler";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TScheduler> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(CRONWHEN);
        criteria.addSelectColumn(JAVACLASSNAME);
        criteria.addSelectColumn(EXTERNALEXE);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TScheduler row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TScheduler obj = (TScheduler) cls.newInstance();
            TSchedulerPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setCronWhen(row.getValue(offset + 1).asString());
            obj.setJavaClassName(row.getValue(offset + 2).asString());
            obj.setExternalExe(row.getValue(offset + 3).asString());
            obj.setPerson(row.getValue(offset + 4).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TScheduler> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TScheduler> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TScheduler> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TScheduler> results = new ArrayList<TScheduler>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TSchedulerPeer.row2Object(row, 1,
                TSchedulerPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TScheduler> doSelect(TScheduler obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TScheduler obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TScheduler obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TScheduler obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TScheduler) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TScheduler obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TScheduler) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TScheduler obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TScheduler) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TScheduler obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TScheduler obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(OBJECTID, obj.getObjectID());
        criteria.add(CRONWHEN, obj.getCronWhen());
        criteria.add(JAVACLASSNAME, obj.getJavaClassName());
        criteria.add(EXTERNALEXE, obj.getExternalExe());
    ...
    public static Criteria buildSelectCriteria( TScheduler obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TScheduler retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TScheduler retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TScheduler retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TScheduler retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TScheduler retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TScheduler> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TScheduler> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TScheduler> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TScheduler> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TScheduler> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TScheduler>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TScheduler objects pre-filled with their
     * TPerson objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TSchedulerPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TScheduler> doSelectJoinTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TScheduler> doSelectJoinTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TSchedulerPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TPersonPeer.addSelectColumns(criteria);

        criteria.addJoin(TSchedulerPeer.PERSON,
            TPersonPeer.PKEY);
        ...
        List<TScheduler> results = new ArrayList<TScheduler>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TSchedulerPeer.getOMClass();
            TScheduler obj1 = (TScheduler) TSchedulerPeer
            ...
            {
                TScheduler temp_obj1 =  results.get(j);
                TPerson temp_obj2 = (TPerson) temp_obj1.getTPerson();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTScheduler(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTSchedulers();
                obj2.addTScheduler(obj1);
            }
            results.add(obj1);
        }
        return results;
