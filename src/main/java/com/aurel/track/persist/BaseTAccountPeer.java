...
/**
 */
public abstract class BaseTAccountPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TAccountMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TAccountMapBuilder.CLASS_NAME);
    }

    /** the column name for the OBJECTID field */
    public static final String OBJECTID;
    /** the column name for the ACCOUNTNUMBER field */
    public static final String ACCOUNTNUMBER;
    /** the column name for the ACCOUNTNAME field */
    ...
    static
    {
        ...
        OBJECTID = "TACCOUNT.OBJECTID";
        ACCOUNTNUMBER = "TACCOUNT.ACCOUNTNUMBER";
        ACCOUNTNAME = "TACCOUNT.ACCOUNTNAME";
        STATUS = "TACCOUNT.STATUS";
        COSTCENTER = "TACCOUNT.COSTCENTER";
        DESCRIPTION = "TACCOUNT.DESCRIPTION";
        MOREPROPS = "TACCOUNT.MOREPROPS";
        TPUUID = "TACCOUNT.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TAccountMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TAccountMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TAccount";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAccount> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(ACCOUNTNUMBER);
        criteria.addSelectColumn(ACCOUNTNAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TAccount row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TAccount obj = (TAccount) cls.newInstance();
            TAccountPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setAccountNumber(row.getValue(offset + 1).asString());
            obj.setAccountName(row.getValue(offset + 2).asString());
            obj.setStatus(row.getValue(offset + 3).asIntegerObj());
            obj.setCostCenter(row.getValue(offset + 4).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAccount> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAccount> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAccount> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TAccount> results = new ArrayList<TAccount>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TAccountPeer.row2Object(row, 1,
                TAccountPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAccount> doSelect(TAccount obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TAccount obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TAccount obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TAccount obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TAccount) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TAccount obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TAccount) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TAccount obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TAccount) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TAccount obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TAccount obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(OBJECTID, obj.getObjectID());
        criteria.add(ACCOUNTNUMBER, obj.getAccountNumber());
        criteria.add(ACCOUNTNAME, obj.getAccountName());
    ...
    public static Criteria buildSelectCriteria( TAccount obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TAccount retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TAccount retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TAccount retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TAccount retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TAccount retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TAccount> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAccount> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TAccount> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAccount> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TAccount> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TAccount>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TAccount objects pre-filled with their
     * TSystemState objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TAccountPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TAccount> doSelectJoinTSystemState(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TAccount> doSelectJoinTSystemState(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TAccountPeer.STATUS,
        ...
        List<TAccount> results = new ArrayList<TAccount>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TAccountPeer.getOMClass();
            TAccount obj1 = (TAccount) TAccountPeer
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TAccount> doSelectJoinTCostCenter(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TAccount> doSelectJoinTCostCenter(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TAccountPeer.COSTCENTER,
