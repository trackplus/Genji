...
/**
 */
public abstract class BaseTCLOBPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TCLOBMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TCLOBMapBuilder.CLASS_NAME);
    }

    /** the column name for the OBJECTID field */
    public static final String OBJECTID;
    /** the column name for the CLOBVALUE field */
    public static final String CLOBVALUE;
    ...
    static
    {
        ...
        OBJECTID = "TCLOB.OBJECTID";
        CLOBVALUE = "TCLOB.CLOBVALUE";
        TPUUID = "TCLOB.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TCLOBMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TCLOBMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TCLOB> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(CLOBVALUE);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TCLOB row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TCLOB obj = (TCLOB) cls.newInstance();
            TCLOBPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setCLOBValue(row.getValue(offset + 1).asString());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TCLOB> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TCLOB> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TCLOB> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TCLOB> results = new ArrayList<TCLOB>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TCLOBPeer.row2Object(row, 1,
                TCLOBPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TCLOB> doSelect(TCLOB obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TCLOB obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TCLOB obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TCLOB obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TCLOB) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TCLOB obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TCLOB) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TCLOB obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TCLOB) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TCLOB obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TCLOB obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(OBJECTID, obj.getObjectID());
        criteria.add(CLOBVALUE, obj.getCLOBValue());
        criteria.add(TPUUID, obj.getUuid());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( TCLOB obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TCLOB retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TCLOB retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TCLOB retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TCLOB retVal = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TCLOB retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TCLOB> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TCLOB> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TCLOB> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TCLOB> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TCLOB> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TCLOB>();
        }
        else
        {
            Criteria criteria = new Criteria();
