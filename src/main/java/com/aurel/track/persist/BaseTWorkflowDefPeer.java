...
/**
 */
public abstract class BaseTWorkflowDefPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TWorkflowDefMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TWorkflowDefMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TWORKFLOWDEF";

        OBJECTID = "TWORKFLOWDEF.OBJECTID";
        NAME = "TWORKFLOWDEF.NAME";
        DESCRIPTION = "TWORKFLOWDEF.DESCRIPTION";
        TAGLABEL = "TWORKFLOWDEF.TAGLABEL";
        OWNER = "TWORKFLOWDEF.OWNER";
        TPUUID = "TWORKFLOWDEF.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TWorkflowDefMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TWorkflowDefMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TWorkflowDef";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkflowDef> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TWorkflowDef row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TWorkflowDef obj = (TWorkflowDef) cls.newInstance();
            TWorkflowDefPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setOwner(row.getValue(offset + 4).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkflowDef> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkflowDef> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkflowDef> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TWorkflowDef> results = new ArrayList<TWorkflowDef>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TWorkflowDefPeer.row2Object(row, 1,
                TWorkflowDefPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkflowDef> doSelect(TWorkflowDef obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TWorkflowDef obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TWorkflowDef obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TWorkflowDef obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TWorkflowDef) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TWorkflowDef obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TWorkflowDef) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TWorkflowDef obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TWorkflowDef) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TWorkflowDef obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TWorkflowDef obj )
    {
    ...
    public static Criteria buildSelectCriteria( TWorkflowDef obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TWorkflowDef retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TWorkflowDef retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TWorkflowDef retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TWorkflowDef retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TWorkflowDef retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TWorkflowDef> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkflowDef> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TWorkflowDef> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkflowDef> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TWorkflowDef> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TWorkflowDef>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TWorkflowDef objects pre-filled with their
     * TPerson objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TWorkflowDefPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TWorkflowDef> doSelectJoinTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TWorkflowDef> doSelectJoinTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TWorkflowDefPeer.OWNER,
            TPersonPeer.PKEY);
        ...
        List<TWorkflowDef> results = new ArrayList<TWorkflowDef>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TWorkflowDefPeer.getOMClass();
            TWorkflowDef obj1 = (TWorkflowDef) TWorkflowDefPeer
            ...
            {
                TWorkflowDef temp_obj1 =  results.get(j);
                TPerson temp_obj2 = (TPerson) temp_obj1.getTPerson();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTWorkflowDef(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTWorkflowDefs();
                obj2.addTWorkflowDef(obj1);
            }
            results.add(obj1);
        }
        return results;
