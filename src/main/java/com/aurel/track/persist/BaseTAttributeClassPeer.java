...
/**
 */
public abstract class BaseTAttributeClassPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TAttributeClassMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TAttributeClassMapBuilder.CLASS_NAME);
    }

    /** the column name for the OBJECTID field */
    public static final String OBJECTID;
    /** the column name for the ATTRIBUTECLASSNAME field */
    public static final String ATTRIBUTECLASSNAME;
    /** the column name for the ATTRIBUTECLASSDESC field */
    public static final String ATTRIBUTECLASSDESC;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TATTRIBUTECLASS";

        OBJECTID = "TATTRIBUTECLASS.OBJECTID";
        ATTRIBUTECLASSNAME = "TATTRIBUTECLASS.ATTRIBUTECLASSNAME";
        ATTRIBUTECLASSDESC = "TATTRIBUTECLASS.ATTRIBUTECLASSDESC";
        JAVACLASSNAME = "TATTRIBUTECLASS.JAVACLASSNAME";
        TPUUID = "TATTRIBUTECLASS.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TAttributeClassMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TAttributeClassMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TAttributeClass";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAttributeClass> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTAttributeClassPeer
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(ATTRIBUTECLASSNAME);
        criteria.addSelectColumn(ATTRIBUTECLASSDESC);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TAttributeClass row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TAttributeClass obj = (TAttributeClass) cls.newInstance();
            TAttributeClassPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setAttributeClassName(row.getValue(offset + 1).asString());
            obj.setAttributeClassDescription(row.getValue(offset + 2).asString());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAttributeClass> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAttributeClass> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAttributeClass> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TAttributeClass> results = new ArrayList<TAttributeClass>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TAttributeClassPeer.row2Object(row, 1,
                TAttributeClassPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAttributeClass> doSelect(TAttributeClass obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TAttributeClass obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TAttributeClass obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TAttributeClass obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TAttributeClass) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TAttributeClass obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TAttributeClass) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TAttributeClass obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TAttributeClass) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TAttributeClass obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TAttributeClass obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(OBJECTID, obj.getObjectID());
        criteria.add(ATTRIBUTECLASSNAME, obj.getAttributeClassName());
        criteria.add(ATTRIBUTECLASSDESC, obj.getAttributeClassDescription());
    ...
    public static Criteria buildSelectCriteria( TAttributeClass obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TAttributeClass retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TAttributeClass retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TAttributeClass retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TAttributeClass retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TAttributeClass retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TAttributeClass> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (TAttributeClass)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAttributeClass> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TAttributeClass> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAttributeClass> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TAttributeClass> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TAttributeClass>();
        }
        else
        {
            Criteria criteria = new Criteria();
