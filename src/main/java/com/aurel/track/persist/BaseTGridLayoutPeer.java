 ...
 *
 */
public abstract class BaseTGridLayoutPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TGridLayoutMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TGridLayoutMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TGRIDLAYOUT";

        OBJECTID = "TGRIDLAYOUT.OBJECTID";
        PERSON = "TGRIDLAYOUT.PERSON";
        LAYOUTKEY = "TGRIDLAYOUT.LAYOUTKEY";
        TPUUID = "TGRIDLAYOUT.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TGridLayoutMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TGridLayoutMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TGridLayout> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TGridLayout row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TGridLayout obj = (TGridLayout) cls.newInstance();
            TGridLayoutPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setLayoutKey(row.getValue(offset + 2).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TGridLayout> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TGridLayout> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TGridLayout> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TGridLayout> results = new ArrayList<TGridLayout>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TGridLayoutPeer.row2Object(row, 1,
                TGridLayoutPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TGridLayout> doSelect(TGridLayout obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TGridLayout obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TGridLayout obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TGridLayout obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TGridLayout) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TGridLayout obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TGridLayout) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TGridLayout obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TGridLayout) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TGridLayout obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TGridLayout obj )
    {
    ...
    public static Criteria buildSelectCriteria( TGridLayout obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TGridLayout retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TGridLayout retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TGridLayout retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TGridLayout retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TGridLayout retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TGridLayout> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TGridLayout> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TGridLayout> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TGridLayout> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TGridLayout> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TGridLayout>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TGridLayout objects pre-filled with their
     * TPerson objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TGridLayoutPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TGridLayout> doSelectJoinTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TGridLayout> doSelectJoinTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TGridLayoutPeer.PERSON,
            TPersonPeer.PKEY);
        ...
        List<TGridLayout> results = new ArrayList<TGridLayout>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TGridLayoutPeer.getOMClass();
            TGridLayout obj1 = (TGridLayout) TGridLayoutPeer
            ...
            {
                TGridLayout temp_obj1 =  results.get(j);
                TPerson temp_obj2 = (TPerson) temp_obj1.getTPerson();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTGridLayout(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTGridLayouts();
                obj2.addTGridLayout(obj1);
            }
            results.add(obj1);
        }
        return results;
