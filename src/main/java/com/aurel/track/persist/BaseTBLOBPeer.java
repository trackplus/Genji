...
/**
 */
public abstract class BaseTBLOBPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TBLOBMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TBLOBMapBuilder.CLASS_NAME);
    }

    /** the column name for the OBJECTID field */
    public static final String OBJECTID;
    /** the column name for the BLOBVALUE field */
    public static final String BLOBVALUE;
    ...
    static
    {
        ...
        OBJECTID = "TBLOB.OBJECTID";
        BLOBVALUE = "TBLOB.BLOBVALUE";
        TPUUID = "TBLOB.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TBLOBMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TBLOBMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TBLOB> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(BLOBVALUE);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TBLOB row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TBLOB obj = (TBLOB) cls.newInstance();
            TBLOBPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setBLOBValue(row.getValue(offset + 1).asBytes());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TBLOB> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TBLOB> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TBLOB> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TBLOB> results = new ArrayList<TBLOB>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TBLOBPeer.row2Object(row, 1,
                TBLOBPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TBLOB> doSelect(TBLOB obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TBLOB obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TBLOB obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TBLOB obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TBLOB) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TBLOB obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TBLOB) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TBLOB obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TBLOB) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TBLOB obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TBLOB obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(OBJECTID, obj.getObjectID());
        criteria.add(BLOBVALUE, obj.getBLOBValue());
        criteria.add(TPUUID, obj.getUuid());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( TBLOB obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TBLOB retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TBLOB retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TBLOB retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TBLOB retVal = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TBLOB retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TBLOB> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TBLOB> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TBLOB> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TBLOB> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TBLOB> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TBLOB>();
        }
        else
        {
            Criteria criteria = new Criteria();
