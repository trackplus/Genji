 ...
 *
 */
public abstract class BaseTBasketPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TBasketMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TBasketMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the DIVISIBLE field */
    public static final String DIVISIBLE;
    /** the column name for the PARENTBASKET field */
    public static final String PARENTBASKET;
    ...
    static
    {
        ...
        OBJECTID = "TBASKET.OBJECTID";
        LABEL = "TBASKET.LABEL";
        DIVISIBLE = "TBASKET.DIVISIBLE";
        PARENTBASKET = "TBASKET.PARENTBASKET";
        PERSON = "TBASKET.PERSON";
        TPUUID = "TBASKET.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TBasketMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TBasketMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TBasket";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TBasket> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(DIVISIBLE);
        criteria.addSelectColumn(PARENTBASKET);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TBasket row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TBasket obj = (TBasket) cls.newInstance();
            TBasketPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setDivisible(row.getValue(offset + 2).asString());
            obj.setParentBasket(row.getValue(offset + 3).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TBasket> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TBasket> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TBasket> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TBasket> results = new ArrayList<TBasket>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TBasketPeer.row2Object(row, 1,
                TBasketPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TBasket> doSelect(TBasket obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TBasket obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TBasket obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TBasket obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TBasket) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TBasket obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TBasket) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TBasket obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TBasket) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TBasket obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TBasket obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(OBJECTID, obj.getObjectID());
        criteria.add(LABEL, obj.getLabel());
        criteria.add(DIVISIBLE, obj.getDivisible());
        criteria.add(PARENTBASKET, obj.getParentBasket());
    ...
    public static Criteria buildSelectCriteria( TBasket obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TBasket retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TBasket retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TBasket retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TBasket retVal = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TBasket retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TBasket> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TBasket> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TBasket> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TBasket> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TBasket> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TBasket>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TBasket objects pre-filled with their
     * TPerson objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TBasketPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TBasket> doSelectJoinTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TBasket> doSelectJoinTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TBasketPeer.PERSON,
            TPersonPeer.PKEY);
        ...
        List<TBasket> results = new ArrayList<TBasket>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TBasketPeer.getOMClass();
            TBasket obj1 = (TBasket) TBasketPeer
            ...
            {
                TBasket temp_obj1 =  results.get(j);
                TPerson temp_obj2 = (TPerson) temp_obj1.getTPerson();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTBasket(obj1);
                    break;
                }
            }
            if (newObject)
