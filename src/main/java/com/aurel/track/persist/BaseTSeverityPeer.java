...
/**
 */
public abstract class BaseTSeverityPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TSeverityMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TSeverityMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TSEVERITY";

        PKEY = "TSEVERITY.PKEY";
        LABEL = "TSEVERITY.LABEL";
        TOOLTIP = "TSEVERITY.TOOLTIP";
        SORTORDER = "TSEVERITY.SORTORDER";
        WLEVEL = "TSEVERITY.WLEVEL";
        SYMBOL = "TSEVERITY.SYMBOL";
        ICONKEY = "TSEVERITY.ICONKEY";
        ICONCHANGED = "TSEVERITY.ICONCHANGED";
        CSSSTYLE = "TSEVERITY.CSSSTYLE";
        TPUUID = "TSEVERITY.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TSeverityMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TSeverityMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TSeverity";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TSeverity> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TSeverity row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TSeverity obj = (TSeverity) cls.newInstance();
            TSeverityPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setSortorder(row.getValue(offset + 3).asIntegerObj());
            obj.setWlevel(row.getValue(offset + 4).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TSeverity> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TSeverity> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TSeverity> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TSeverity> results = new ArrayList<TSeverity>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TSeverityPeer.row2Object(row, 1,
                TSeverityPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TSeverity> doSelect(TSeverity obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TSeverity obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TSeverity obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TSeverity obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TSeverity) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TSeverity obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TSeverity) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TSeverity obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TSeverity) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TSeverity obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TSeverity obj )
    {
        ...
        criteria.add(WLEVEL, obj.getWlevel());
    ...
    public static Criteria buildSelectCriteria( TSeverity obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TSeverity retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TSeverity retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TSeverity retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TSeverity retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TSeverity retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TSeverity> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TSeverity> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TSeverity> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TSeverity> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TSeverity> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TSeverity>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TSeverity objects pre-filled with their
     * TBLOB objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TSeverityPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TSeverity> doSelectJoinTBLOB(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TSeverity> doSelectJoinTBLOB(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TSeverityPeer.ICONKEY,
            TBLOBPeer.OBJECTID);
        ...
        List<TSeverity> results = new ArrayList<TSeverity>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TSeverityPeer.getOMClass();
            TSeverity obj1 = (TSeverity) TSeverityPeer
            ...
            {
                TSeverity temp_obj1 =  results.get(j);
                TBLOB temp_obj2 = (TBLOB) temp_obj1.getTBLOB();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTSeverity(obj1);
                    break;
                }
            }
            if (newObject)
