...
/**
 */
public abstract class BaseTUserLevelPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TUserLevelMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TUserLevelMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TUSERLEVEL";

        OBJECTID = "TUSERLEVEL.OBJECTID";
        LABEL = "TUSERLEVEL.LABEL";
        DESCRIPTION = "TUSERLEVEL.DESCRIPTION";
        TPUUID = "TUSERLEVEL.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TUserLevelMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TUserLevelMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TUserLevel";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TUserLevel> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TUserLevel row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TUserLevel obj = (TUserLevel) cls.newInstance();
            TUserLevelPeer.populateObject(row, offset, obj);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TUserLevel> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TUserLevel> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TUserLevel> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TUserLevel> results = new ArrayList<TUserLevel>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TUserLevelPeer.row2Object(row, 1,
                TUserLevelPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TUserLevel> doSelect(TUserLevel obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TUserLevel obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TUserLevel obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TUserLevel obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TUserLevel) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TUserLevel obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TUserLevel) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TUserLevel obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TUserLevel) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TUserLevel obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TUserLevel obj )
    {
    ...
    public static Criteria buildSelectCriteria( TUserLevel obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TUserLevel retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TUserLevel retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TUserLevel retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TUserLevel retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TUserLevel retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TUserLevel> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TUserLevel> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TUserLevel> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TUserLevel> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TUserLevel> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TUserLevel>();
        }
        else
        {
            Criteria criteria = new Criteria();
