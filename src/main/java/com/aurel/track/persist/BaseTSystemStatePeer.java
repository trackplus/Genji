...
/**
 */
public abstract class BaseTSystemStatePeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TSystemStateMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TSystemStateMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the STATEFLAG field */
    public static final String STATEFLAG;
    /** the column name for the SYMBOL field */
    public static final String SYMBOL;
    /** the column name for the ENTITYFLAG field */
    public static final String ENTITYFLAG;
    ...
    /** the column name for the CSSSTYLE field */
    public static final String CSSSTYLE;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TSYSTEMSTATE";

        OBJECTID = "TSYSTEMSTATE.OBJECTID";
        LABEL = "TSYSTEMSTATE.LABEL";
        STATEFLAG = "TSYSTEMSTATE.STATEFLAG";
        SYMBOL = "TSYSTEMSTATE.SYMBOL";
        ENTITYFLAG = "TSYSTEMSTATE.ENTITYFLAG";
        SORTORDER = "TSYSTEMSTATE.SORTORDER";
        ICONKEY = "TSYSTEMSTATE.ICONKEY";
        CSSSTYLE = "TSYSTEMSTATE.CSSSTYLE";
        TPUUID = "TSYSTEMSTATE.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TSystemStateMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TSystemStateMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TSystemState";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TSystemState> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(STATEFLAG);
        criteria.addSelectColumn(SYMBOL);
        criteria.addSelectColumn(ENTITYFLAG);
        criteria.addSelectColumn(SORTORDER);
        criteria.addSelectColumn(ICONKEY);
        criteria.addSelectColumn(CSSSTYLE);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TSystemState row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TSystemState obj = (TSystemState) cls.newInstance();
            TSystemStatePeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setStateflag(row.getValue(offset + 2).asIntegerObj());
            obj.setSymbol(row.getValue(offset + 3).asString());
            obj.setEntityflag(row.getValue(offset + 4).asIntegerObj());
            obj.setSortorder(row.getValue(offset + 5).asIntegerObj());
            obj.setIconKey(row.getValue(offset + 6).asIntegerObj());
            obj.setCSSStyle(row.getValue(offset + 7).asString());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TSystemState> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TSystemState> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TSystemState> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TSystemState> results = new ArrayList<TSystemState>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TSystemStatePeer.row2Object(row, 1,
                TSystemStatePeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TSystemState> doSelect(TSystemState obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TSystemState obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TSystemState obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TSystemState obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TSystemState) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TSystemState obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TSystemState) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TSystemState obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TSystemState) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TSystemState obj, Connection con)
        throws TorqueException
    {
     ...
     */
    public static TSystemState retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TSystemState retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TSystemState retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TSystemState retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TSystemState retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TSystemState> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TSystemState> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TSystemState> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TSystemState> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TSystemState> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TSystemState>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TSystemState objects pre-filled with their
     * TBLOB objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TSystemStatePeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TSystemState> doSelectJoinTBLOB(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TSystemState> doSelectJoinTBLOB(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TSystemStatePeer.ICONKEY,
            TBLOBPeer.OBJECTID);
        ...
        List<TSystemState> results = new ArrayList<TSystemState>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TSystemStatePeer.getOMClass();
            TSystemState obj1 = (TSystemState) TSystemStatePeer
            ...
            {
                TSystemState temp_obj1 =  results.get(j);
                TBLOB temp_obj2 = (TBLOB) temp_obj1.getTBLOB();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTSystemState(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTSystemStates();
                obj2.addTSystemState(obj1);
            }
            results.add(obj1);
        }
        return results;
