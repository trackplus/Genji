...
/**
 */
public abstract class BaseTLocalizedResourcesPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TLocalizedResourcesMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TLocalizedResourcesMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the PRIMARYKEYVALUE field */
    public static final String PRIMARYKEYVALUE;
    /** the column name for the FIELDNAME field */
    public static final String FIELDNAME;
    /** the column name for the LOCALIZEDTEXT field */
    public static final String LOCALIZEDTEXT;
    /** the column name for the LOCALE field */
    public static final String LOCALE;
    /** the column name for the TEXTCHANGED field */
    public static final String TEXTCHANGED;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TLOCALIZEDRESOURCES";

        OBJECTID = "TLOCALIZEDRESOURCES.OBJECTID";
        TABLENAME = "TLOCALIZEDRESOURCES.TABLENAME";
        PRIMARYKEYVALUE = "TLOCALIZEDRESOURCES.PRIMARYKEYVALUE";
        FIELDNAME = "TLOCALIZEDRESOURCES.FIELDNAME";
        LOCALIZEDTEXT = "TLOCALIZEDRESOURCES.LOCALIZEDTEXT";
        LOCALE = "TLOCALIZEDRESOURCES.LOCALE";
        TEXTCHANGED = "TLOCALIZEDRESOURCES.TEXTCHANGED";
        TPUUID = "TLOCALIZEDRESOURCES.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TLocalizedResourcesMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TLocalizedResourcesMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TLocalizedResources";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TLocalizedResources> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTLocalizedResourcesPeer
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(PRIMARYKEYVALUE);
        criteria.addSelectColumn(FIELDNAME);
        criteria.addSelectColumn(LOCALIZEDTEXT);
        criteria.addSelectColumn(LOCALE);
        criteria.addSelectColumn(TEXTCHANGED);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TLocalizedResources row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TLocalizedResources obj = (TLocalizedResources) cls.newInstance();
            TLocalizedResourcesPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setPrimaryKeyValue(row.getValue(offset + 2).asIntegerObj());
            obj.setFieldName(row.getValue(offset + 3).asString());
            obj.setLocalizedText(row.getValue(offset + 4).asString());
            obj.setLocale(row.getValue(offset + 5).asString());
            obj.setTextChanged(row.getValue(offset + 6).asString());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TLocalizedResources> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TLocalizedResources> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TLocalizedResources> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TLocalizedResources> results = new ArrayList<TLocalizedResources>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TLocalizedResourcesPeer.row2Object(row, 1,
                TLocalizedResourcesPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TLocalizedResources> doSelect(TLocalizedResources obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TLocalizedResources obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TLocalizedResources obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TLocalizedResources obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TLocalizedResources) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TLocalizedResources obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TLocalizedResources) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TLocalizedResources obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TLocalizedResources) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TLocalizedResources obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TLocalizedResources obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(OBJECTID, obj.getObjectID());
        criteria.add(TABLENAME, obj.getTableName());
        criteria.add(PRIMARYKEYVALUE, obj.getPrimaryKeyValue());
        criteria.add(FIELDNAME, obj.getFieldName());
        criteria.add(LOCALIZEDTEXT, obj.getLocalizedText());
        criteria.add(LOCALE, obj.getLocale());
        criteria.add(TEXTCHANGED, obj.getTextChanged());
        criteria.add(TPUUID, obj.getUuid());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( TLocalizedResources obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TLocalizedResources retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TLocalizedResources retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TLocalizedResources retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TLocalizedResources retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TLocalizedResources retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TLocalizedResources> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (TLocalizedResources)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TLocalizedResources> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TLocalizedResources> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TLocalizedResources> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TLocalizedResources> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TLocalizedResources>();
        }
        else
        {
            Criteria criteria = new Criteria();
