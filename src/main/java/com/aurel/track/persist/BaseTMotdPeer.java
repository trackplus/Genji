...
/**
 */
public abstract class BaseTMotdPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TMotdMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TMotdMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the THEMESSAGE field */
    public static final String THEMESSAGE;
    /** the column name for the TEASERTEXT field */
    public static final String TEASERTEXT;
    ...
    static
    {
        ...
        OBJECTID = "TMOTD.OBJECTID";
        THELOCALE = "TMOTD.THELOCALE";
        THEMESSAGE = "TMOTD.THEMESSAGE";
        TEASERTEXT = "TMOTD.TEASERTEXT";
        TPUUID = "TMOTD.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TMotdMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TMotdMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TMotd> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(THEMESSAGE);
        criteria.addSelectColumn(TEASERTEXT);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TMotd row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TMotd obj = (TMotd) cls.newInstance();
            TMotdPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setTheLocale(row.getValue(offset + 1).asString());
            obj.setTheMessage(row.getValue(offset + 2).asString());
            obj.setTeaserText(row.getValue(offset + 3).asString());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TMotd> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TMotd> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TMotd> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TMotd> results = new ArrayList<TMotd>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TMotdPeer.row2Object(row, 1,
                TMotdPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TMotd> doSelect(TMotd obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TMotd obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TMotd obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TMotd obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TMotd) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TMotd obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TMotd) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TMotd obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TMotd) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TMotd obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TMotd obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(OBJECTID, obj.getObjectID());
        criteria.add(THELOCALE, obj.getTheLocale());
        criteria.add(THEMESSAGE, obj.getTheMessage());
        criteria.add(TEASERTEXT, obj.getTeaserText());
        criteria.add(TPUUID, obj.getUuid());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( TMotd obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TMotd retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TMotd retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TMotd retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TMotd retVal = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TMotd retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TMotd> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TMotd> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TMotd> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TMotd> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TMotd> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TMotd>();
        }
        else
        {
            Criteria criteria = new Criteria();
