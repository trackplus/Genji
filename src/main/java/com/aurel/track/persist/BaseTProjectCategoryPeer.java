...
/**
 */
public abstract class BaseTProjectCategoryPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TProjectCategoryMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TProjectCategoryMapBuilder.CLASS_NAME);
    }
    ...
    static
    {
        ...
        PKEY = "TPROJCAT.PKEY";
        LABEL = "TPROJCAT.LABEL";
        PROJKEY = "TPROJCAT.PROJKEY";
        TPUUID = "TPROJCAT.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TProjectCategoryMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TProjectCategoryMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TProjectCategory";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TProjectCategory> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTProjectCategoryPeer
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TProjectCategory row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TProjectCategory obj = (TProjectCategory) cls.newInstance();
            TProjectCategoryPeer.populateObject(row, offset, obj);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TProjectCategory> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TProjectCategory> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TProjectCategory> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TProjectCategory> results = new ArrayList<TProjectCategory>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TProjectCategoryPeer.row2Object(row, 1,
                TProjectCategoryPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TProjectCategory> doSelect(TProjectCategory obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TProjectCategory obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TProjectCategory obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TProjectCategory obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TProjectCategory) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TProjectCategory obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TProjectCategory) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TProjectCategory obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TProjectCategory) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TProjectCategory obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TProjectCategory obj )
    {
    ...
    public static Criteria buildSelectCriteria( TProjectCategory obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TProjectCategory retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TProjectCategory retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TProjectCategory retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TProjectCategory retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TProjectCategory retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TProjectCategory> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (TProjectCategory)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TProjectCategory> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TProjectCategory> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TProjectCategory> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TProjectCategory> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TProjectCategory>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TProjectCategory objects pre-filled with their
     * TProject objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TProjectCategoryPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TProjectCategory> doSelectJoinTProject(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TProjectCategory> doSelectJoinTProject(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TProjectCategoryPeer.PROJKEY,
            TProjectPeer.PKEY);
        ...
        List<TProjectCategory> results = new ArrayList<TProjectCategory>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TProjectCategoryPeer.getOMClass();
            TProjectCategory obj1 = (TProjectCategory) TProjectCategoryPeer
            ...
            {
                TProjectCategory temp_obj1 =  results.get(j);
                TProject temp_obj2 = (TProject) temp_obj1.getTProject();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTProjectCategory(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTProjectCategorys();
                obj2.addTProjectCategory(obj1);
            }
            results.add(obj1);
        }
        return results;
