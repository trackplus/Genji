...
/**
 */
public abstract class BaseTStateChangePeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TStateChangeMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TStateChangeMapBuilder.CLASS_NAME);
    }

    /** the column name for the STATECHANGEKEY field */
    public static final String STATECHANGEKEY;
    ...
    /** the column name for the CHANGEDTO field */
    public static final String CHANGEDTO;
    /** the column name for the CHANGEDESCRIPTION field */
    public static final String CHANGEDESCRIPTION;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TSTATECHANGE";

        STATECHANGEKEY = "TSTATECHANGE.STATECHANGEKEY";
        WORKITEMKEY = "TSTATECHANGE.WORKITEMKEY";
        CHANGEDBY = "TSTATECHANGE.CHANGEDBY";
        CHANGEDTO = "TSTATECHANGE.CHANGEDTO";
        CHANGEDESCRIPTION = "TSTATECHANGE.CHANGEDESCRIPTION";
        LASTEDIT = "TSTATECHANGE.LASTEDIT";
        TPUUID = "TSTATECHANGE.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TStateChangeMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TStateChangeMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TStateChange";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TStateChange> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static void addSelectColumns(Criteria criteria)
            throws TorqueException
    {
        criteria.addSelectColumn(STATECHANGEKEY);
        criteria.addSelectColumn(WORKITEMKEY);
        criteria.addSelectColumn(CHANGEDBY);
        criteria.addSelectColumn(CHANGEDTO);
        criteria.addSelectColumn(CHANGEDESCRIPTION);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TStateChange row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TStateChange obj = (TStateChange) cls.newInstance();
            TStateChangePeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setWorkItemID(row.getValue(offset + 1).asIntegerObj());
            obj.setChangedByID(row.getValue(offset + 2).asIntegerObj());
            obj.setChangedToID(row.getValue(offset + 3).asIntegerObj());
            obj.setChangeDescription(row.getValue(offset + 4).asString());
            obj.setLastEdit(row.getValue(offset + 5).asUtilDate());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TStateChange> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TStateChange> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TStateChange> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TStateChange> results = new ArrayList<TStateChange>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TStateChangePeer.row2Object(row, 1,
                TStateChangePeer.getOMClass()));
        }
        return results;
    }
        ...
        throws TorqueException
    {
        ...
        correctBooleans(criteria);
         ...
         selectCriteria.put(STATECHANGEKEY, criteria.remove(STATECHANGEKEY));
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TStateChange> doSelect(TStateChange obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TStateChange obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TStateChange obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TStateChange obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TStateChange) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TStateChange obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TStateChange) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TStateChange obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TStateChange) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TStateChange obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( ObjectKey pk )
    {
        Criteria criteria = new Criteria();
            criteria.add(STATECHANGEKEY, pk);
        return criteria;
     }

    /** Build a Criteria object from the data object for this peer */
    public static Criteria buildCriteria( TStateChange obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(STATECHANGEKEY, obj.getObjectID());
        criteria.add(WORKITEMKEY, obj.getWorkItemID());
        criteria.add(CHANGEDBY, obj.getChangedByID());
        criteria.add(CHANGEDTO, obj.getChangedToID());
        criteria.add(CHANGEDESCRIPTION, obj.getChangeDescription());
    ...
    public static Criteria buildSelectCriteria( TStateChange obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TStateChange retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TStateChange retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TStateChange retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TStateChange retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TStateChange retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TStateChange> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TStateChange> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TStateChange> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TStateChange> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TStateChange> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TStateChange>();
        }
        else
        {
            Criteria criteria = new Criteria();
            criteria.addIn( STATECHANGEKEY, pks );
    ...
    /**
     * selects a collection of TStateChange objects pre-filled with their
     * TPerson objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TStateChangePeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TStateChange> doSelectJoinTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TStateChange> doSelectJoinTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TStateChangePeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TPersonPeer.addSelectColumns(criteria);

        criteria.addJoin(TStateChangePeer.CHANGEDBY,
            TPersonPeer.PKEY);
        ...
        List<TStateChange> results = new ArrayList<TStateChange>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TStateChangePeer.getOMClass();
            TStateChange obj1 = (TStateChange) TStateChangePeer
            ...
            {
                TStateChange temp_obj1 =  results.get(j);
                TPerson temp_obj2 = (TPerson) temp_obj1.getTPerson();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTStateChange(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTStateChanges();
                obj2.addTStateChange(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TStateChange> doSelectJoinTState(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TStateChange> doSelectJoinTState(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TStateChangePeer.CHANGEDTO,
            TStatePeer.PKEY);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TStateChange> doSelectJoinTWorkItem(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TStateChange> doSelectJoinTWorkItem(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TStateChangePeer.WORKITEMKEY,
    ...
    /**
     * selects a collection of TStateChange objects pre-filled with
     * all related objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TStateChange> doSelectJoinAllExceptTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TStateChange> doSelectJoinAllExceptTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        TStatePeer.addSelectColumns(criteria);
        criteria.addJoin(TStateChangePeer.CHANGEDTO, TStatePeer.PKEY);
        int offset3 = offset2 + TStatePeer.numColumns;

        TWorkItemPeer.addSelectColumns(criteria);
        criteria.addJoin(TStateChangePeer.WORKITEMKEY, TWorkItemPeer.WORKITEMKEY);
 ...
 newObject = true;
            for (int j = 0; j < results.size(); j++)
            {
                ...
                {
                    newObject = false;
                    temp_obj3.addTStateChange(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj3.initTStateChanges();
                obj3.addTStateChange(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TStateChange> doSelectJoinAllExceptTState(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TStateChange> doSelectJoinAllExceptTState(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        TPersonPeer.addSelectColumns(criteria);
        criteria.addJoin(TStateChangePeer.CHANGEDBY, TPersonPeer.PKEY);
 ...
 newObject = true;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TStateChange> doSelectJoinAllExceptTWorkItem(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TStateChange> doSelectJoinAllExceptTWorkItem(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
