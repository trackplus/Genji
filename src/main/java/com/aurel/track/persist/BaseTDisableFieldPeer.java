...
/**
 */
public abstract class BaseTDisableFieldPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TDisableFieldMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TDisableFieldMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TDISABLEFIELD";

        OBJECTID = "TDISABLEFIELD.OBJECTID";
        FIELDNAME = "TDISABLEFIELD.FIELDNAME";
        LISTTYPE = "TDISABLEFIELD.LISTTYPE";
        PROJECTTYPE = "TDISABLEFIELD.PROJECTTYPE";
        TPUUID = "TDISABLEFIELD.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TDisableFieldMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TDisableFieldMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TDisableField";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDisableField> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TDisableField row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TDisableField obj = (TDisableField) cls.newInstance();
            TDisableFieldPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setFieldName(row.getValue(offset + 1).asString());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDisableField> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDisableField> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDisableField> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TDisableField> results = new ArrayList<TDisableField>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TDisableFieldPeer.row2Object(row, 1,
                TDisableFieldPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDisableField> doSelect(TDisableField obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TDisableField obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TDisableField obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TDisableField obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TDisableField) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TDisableField obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TDisableField) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TDisableField obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TDisableField) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TDisableField obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TDisableField obj )
    {
    ...
    public static Criteria buildSelectCriteria( TDisableField obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TDisableField retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TDisableField retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TDisableField retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TDisableField retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TDisableField retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TDisableField> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDisableField> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TDisableField> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDisableField> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TDisableField> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TDisableField>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TDisableField objects pre-filled with their
     * TListType objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TDisableFieldPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TDisableField> doSelectJoinTListType(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TDisableField> doSelectJoinTListType(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TDisableFieldPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TListTypePeer.addSelectColumns(criteria);

        criteria.addJoin(TDisableFieldPeer.LISTTYPE,
            TListTypePeer.PKEY);
        ...
        List<TDisableField> results = new ArrayList<TDisableField>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TDisableFieldPeer.getOMClass();
            TDisableField obj1 = (TDisableField) TDisableFieldPeer
            ...
            {
                TDisableField temp_obj1 =  results.get(j);
                TListType temp_obj2 = (TListType) temp_obj1.getTListType();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTDisableField(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTDisableFields();
                obj2.addTDisableField(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TDisableField> doSelectJoinTProjectType(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TDisableField> doSelectJoinTProjectType(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TDisableFieldPeer.PROJECTTYPE,
