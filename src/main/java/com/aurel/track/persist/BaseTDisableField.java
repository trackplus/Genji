 ...
 * extended all references should be to TDisableField
 */
public abstract class BaseTDisableField extends TpBaseObject
{
    /** The Peer class */
    private static final TDisableFieldPeer peer =
        new TDisableFieldPeer();
    ...
    {
        if (name.equals(TDisableFieldPeer.OBJECTID))
        {
            return getObjectID();
        }
        if (name.equals(TDisableFieldPeer.FIELDNAME))
        {
            return getFieldName();
        }
        if (name.equals(TDisableFieldPeer.LISTTYPE))
        {
            return getListType();
        }
        if (name.equals(TDisableFieldPeer.PROJECTTYPE))
        {
            return getProjectType();
        }
        if (name.equals(TDisableFieldPeer.TPUUID))
        {
            return getUuid();
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (TDisableFieldPeer.OBJECTID.equals(name))
        {
            return setByName("ObjectID", value);
        }
      if (TDisableFieldPeer.FIELDNAME.equals(name))
        {
            return setByName("FieldName", value);
        }
      if (TDisableFieldPeer.LISTTYPE.equals(name))
        {
            return setByName("ListType", value);
        }
      if (TDisableFieldPeer.PROJECTTYPE.equals(name))
        {
            return setByName("ProjectType", value);
        }
      if (TDisableFieldPeer.TPUUID.equals(name))
        {
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    TDisableFieldPeer.doInsert((TDisableField) this, con);
                    setNew(false);
                }
                else
                {
                    TDisableFieldPeer.doUpdate((TDisableField) this, con);
                }
            }
     ...
     */
    public TDisableField copy(Connection con) throws TorqueException
    {
     ...
     */
    public TDisableField copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new TDisableField(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public TDisableField copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new TDisableField(), deepcopy, con);
    }
     ...
     */
    protected TDisableField copyInto(TDisableField copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected TDisableField copyInto(TDisableField copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected TDisableField copyInto(TDisableField copyObj, boolean deepcopy) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected TDisableField copyInto(TDisableField copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setObjectID(objectID);
        copyObj.setFieldName(fieldName);
        copyObj.setListType(listType);
    ...
    /**
     * Creates a TDisableFieldBean with the contents of this object
     * This also creates beans for cached related objects, if they exist
     * @return a TDisableFieldBean with the contents of this object
     */
     ...
     * @return a TDisableFieldBean with the contents of this object
     */
    public TDisableFieldBean getBean(IdentityMap createdBeans)
    {
        TDisableFieldBean result = (TDisableFieldBean) createdBeans.get(this);
        if (result != null ) {
            // we have already created a bean for this object, return it
            return result;
        }
        // no bean exists for this object; create a new one
        result = new TDisableFieldBean();
    ...
    /**
     * Creates an instance of TDisableField with the contents
     * of a TDisableFieldBean.
     * This behaviour could have also been achieved using a constructor,
     * however as this class is abstract no constructors are allowed
     * @param bean the TDisableFieldBean which contents are used to create
     *        the resulting class
     * @return an instance of TDisableField with the contents of bean
     */
    public static TDisableField createTDisableField(TDisableFieldBean bean)
        throws TorqueException
    {
        return createTDisableField(bean, new IdentityMap());
    }
    ...
    public static TDisableField createTDisableField(TDisableFieldBean bean, IdentityMap createdObjects)
        throws TorqueException
    {
        TDisableField result = (TDisableField) createdObjects.get(bean);
        if (result != null)
        {
            // we already have an object for the bean, return it
            return result;
        }
        result = new TDisableField();
