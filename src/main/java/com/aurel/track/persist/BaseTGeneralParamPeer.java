 ...
 *
 */
public abstract class BaseTGeneralParamPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TGeneralParamMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TGeneralParamMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TGENERALPARAM";

        OBJECTID = "TGENERALPARAM.OBJECTID";
        PARAMNAME = "TGENERALPARAM.PARAMNAME";
        PARAMVALUE = "TGENERALPARAM.PARAMVALUE";
        TPUUID = "TGENERALPARAM.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TGeneralParamMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TGeneralParamMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TGeneralParam";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TGeneralParam> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TGeneralParam row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TGeneralParam obj = (TGeneralParam) cls.newInstance();
            TGeneralParamPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setParamName(row.getValue(offset + 1).asString());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TGeneralParam> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TGeneralParam> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TGeneralParam> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TGeneralParam> results = new ArrayList<TGeneralParam>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TGeneralParamPeer.row2Object(row, 1,
                TGeneralParamPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TGeneralParam> doSelect(TGeneralParam obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TGeneralParam obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TGeneralParam obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TGeneralParam obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TGeneralParam) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TGeneralParam obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TGeneralParam) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TGeneralParam obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TGeneralParam) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TGeneralParam obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TGeneralParam obj )
    {
    ...
    public static Criteria buildSelectCriteria( TGeneralParam obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TGeneralParam retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TGeneralParam retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TGeneralParam retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TGeneralParam retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TGeneralParam retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TGeneralParam> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TGeneralParam> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TGeneralParam> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TGeneralParam> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TGeneralParam> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TGeneralParam>();
        }
        else
        {
            Criteria criteria = new Criteria();
