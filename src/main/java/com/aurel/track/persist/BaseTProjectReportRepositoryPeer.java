...
/**
 */
public abstract class BaseTProjectReportRepositoryPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TProjectReportRepositoryMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TProjectReportRepositoryMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TPROJECTREPORTREPOSITORY";

        PKEY = "TPROJECTREPORTREPOSITORY.PKEY";
        PROJECT = "TPROJECTREPORTREPOSITORY.PROJECT";
        NAME = "TPROJECTREPORTREPOSITORY.NAME";
        QUERY = "TPROJECTREPORTREPOSITORY.QUERY";
        TPUUID = "TPROJECTREPORTREPOSITORY.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TProjectReportRepositoryMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TProjectReportRepositoryMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TProjectReportRepository";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TProjectReportRepository> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTProjectReportRepositoryPeer
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TProjectReportRepository row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TProjectReportRepository obj = (TProjectReportRepository) cls.newInstance();
            TProjectReportRepositoryPeer.populateObject(row, offset, obj);
    ...
    public static void populateObject(Record row,
                                      int offset,
                                      TProjectReportRepository obj)
        throws TorqueException
    {
        try
        {
            obj.setObjectID(row.getValue(offset + 0).asIntegerObj());
            obj.setProjectID(row.getValue(offset + 1).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TProjectReportRepository> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TProjectReportRepository> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TProjectReportRepository> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TProjectReportRepository> results = new ArrayList<TProjectReportRepository>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TProjectReportRepositoryPeer.row2Object(row, 1,
                TProjectReportRepositoryPeer.getOMClass()));
        }
        return results;
    }
    ...
    {
         BaseTProjectReportRepositoryPeer
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TProjectReportRepository> doSelect(TProjectReportRepository obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TProjectReportRepository obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TProjectReportRepository obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TProjectReportRepository obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TProjectReportRepository) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TProjectReportRepository obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TProjectReportRepository) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TProjectReportRepository obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TProjectReportRepository) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TProjectReportRepository obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TProjectReportRepository obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(PKEY, obj.getObjectID());
        criteria.add(PROJECT, obj.getProjectID());
    ...
    public static Criteria buildSelectCriteria( TProjectReportRepository obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TProjectReportRepository retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TProjectReportRepository retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TProjectReportRepository retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TProjectReportRepository retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TProjectReportRepository retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TProjectReportRepository> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (TProjectReportRepository)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TProjectReportRepository> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TProjectReportRepository> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TProjectReportRepository> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TProjectReportRepository> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TProjectReportRepository>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TProjectReportRepository objects pre-filled with their
     * TProject objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TProjectReportRepositoryPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TProjectReportRepository> doSelectJoinTProject(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TProjectReportRepository> doSelectJoinTProject(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TProjectReportRepositoryPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TProjectPeer.addSelectColumns(criteria);

        criteria.addJoin(TProjectReportRepositoryPeer.PROJECT,
            TProjectPeer.PKEY);
        ...
        List<TProjectReportRepository> results = new ArrayList<TProjectReportRepository>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TProjectReportRepositoryPeer.getOMClass();
            TProjectReportRepository obj1 = (TProjectReportRepository) TProjectReportRepositoryPeer
            ...
            {
                TProjectReportRepository temp_obj1 =  results.get(j);
                TProject temp_obj2 = (TProject) temp_obj1.getTProject();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTProjectReportRepository(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTProjectReportRepositorys();
                obj2.addTProjectReportRepository(obj1);
            }
            results.add(obj1);
        }
        return results;
