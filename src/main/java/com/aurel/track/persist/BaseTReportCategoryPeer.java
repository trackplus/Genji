 ...
 *
 */
public abstract class BaseTReportCategoryPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TReportCategoryMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TReportCategoryMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TREPORTCATEGORY";

        OBJECTID = "TREPORTCATEGORY.OBJECTID";
        LABEL = "TREPORTCATEGORY.LABEL";
        REPOSITORY = "TREPORTCATEGORY.REPOSITORY";
        CREATEDBY = "TREPORTCATEGORY.CREATEDBY";
        PROJECT = "TREPORTCATEGORY.PROJECT";
        PARENTID = "TREPORTCATEGORY.PARENTID";
        SORTORDER = "TREPORTCATEGORY.SORTORDER";
        TPUUID = "TREPORTCATEGORY.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TReportCategoryMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TReportCategoryMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TReportCategory";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TReportCategory> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTReportCategoryPeer
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TReportCategory row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TReportCategory obj = (TReportCategory) cls.newInstance();
            TReportCategoryPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setParentID(row.getValue(offset + 5).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TReportCategory> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TReportCategory> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TReportCategory> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TReportCategory> results = new ArrayList<TReportCategory>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TReportCategoryPeer.row2Object(row, 1,
                TReportCategoryPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TReportCategory> doSelect(TReportCategory obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TReportCategory obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TReportCategory obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TReportCategory obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TReportCategory) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TReportCategory obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TReportCategory) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TReportCategory obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TReportCategory) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TReportCategory obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TReportCategory obj )
    {
    ...
    public static Criteria buildSelectCriteria( TReportCategory obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TReportCategory retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TReportCategory retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TReportCategory retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TReportCategory retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TReportCategory retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TReportCategory> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (TReportCategory)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TReportCategory> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TReportCategory> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TReportCategory> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TReportCategory> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TReportCategory>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TReportCategory objects pre-filled with their
     * TProject objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TReportCategoryPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TReportCategory> doSelectJoinTProject(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TReportCategory> doSelectJoinTProject(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TReportCategoryPeer.PROJECT,
            TProjectPeer.PKEY);
        ...
        List<TReportCategory> results = new ArrayList<TReportCategory>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TReportCategoryPeer.getOMClass();
            TReportCategory obj1 = (TReportCategory) TReportCategoryPeer
            ...
            {
                TReportCategory temp_obj1 =  results.get(j);
                TProject temp_obj2 = (TProject) temp_obj1.getTProject();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTReportCategory(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTReportCategorys();
                obj2.addTReportCategory(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TReportCategory> doSelectJoinTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TReportCategory> doSelectJoinTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TReportCategoryPeer.CREATEDBY,
            TPersonPeer.PKEY);
    ...
    /**
     * selects a collection of TReportCategory objects pre-filled with
     * all related objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TReportCategory> doSelectJoinAllExceptTProject(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TReportCategory> doSelectJoinAllExceptTProject(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        TPersonPeer.addSelectColumns(criteria);
        criteria.addJoin(TReportCategoryPeer.CREATEDBY, TPersonPeer.PKEY);
 ...
 boolean  newObject = true;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TReportCategory> doSelectJoinAllExceptTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TReportCategory> doSelectJoinAllExceptTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        TProjectPeer.addSelectColumns(criteria);
        criteria.addJoin(TReportCategoryPeer.PROJECT, TProjectPeer.PKEY);
 ...
 boolean  newObject = true;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TReportCategory> doSelectJoinAllExceptTReportCategory(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TReportCategory> doSelectJoinAllExceptTReportCategory(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
 ...
 newObject = true;
            for (int j = 0; j < results.size(); j++)
            {
                ...
                {
                    newObject = false;
                    temp_obj3.addTReportCategory(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj3.initTReportCategorys();
                obj3.addTReportCategory(obj1);
            }
            results.add(obj1);
        }
        return results;
