...
/**
 */
public abstract class BaseTEventPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TEventMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TEventMapBuilder.CLASS_NAME);
    }

    /** the column name for the OBJECTID field */
    public static final String OBJECTID;
    /** the column name for the EVENTNAME field */
    ...
    /** the column name for the EVENTSCRIPT field */
    public static final String EVENTSCRIPT;
    ...
    static
    {
        ...
        OBJECTID = "TEVENT.OBJECTID";
        EVENTNAME = "TEVENT.EVENTNAME";
        EVENTTYPE = "TEVENT.EVENTTYPE";
        PROJECTTYPE = "TEVENT.PROJECTTYPE";
        PROJECT = "TEVENT.PROJECT";
        EVENTSCRIPT = "TEVENT.EVENTSCRIPT";
        TPUUID = "TEVENT.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TEventMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TEventMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TEvent";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEvent> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(EVENTNAME);
        criteria.addSelectColumn(EVENTTYPE);
        criteria.addSelectColumn(PROJECTTYPE);
        criteria.addSelectColumn(PROJECT);
        criteria.addSelectColumn(EVENTSCRIPT);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TEvent row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TEvent obj = (TEvent) cls.newInstance();
            TEventPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setEventName(row.getValue(offset + 1).asString());
            obj.setEventType(row.getValue(offset + 2).asIntegerObj());
            obj.setProjectType(row.getValue(offset + 3).asIntegerObj());
            obj.setProject(row.getValue(offset + 4).asIntegerObj());
            obj.setEventScript(row.getValue(offset + 5).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEvent> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEvent> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEvent> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TEvent> results = new ArrayList<TEvent>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TEventPeer.row2Object(row, 1,
                TEventPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEvent> doSelect(TEvent obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TEvent obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TEvent obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TEvent obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TEvent) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TEvent obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TEvent) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TEvent obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TEvent) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TEvent obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TEvent obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(OBJECTID, obj.getObjectID());
        criteria.add(EVENTNAME, obj.getEventName());
        criteria.add(EVENTTYPE, obj.getEventType());
        criteria.add(PROJECTTYPE, obj.getProjectType());
        criteria.add(PROJECT, obj.getProject());
        criteria.add(EVENTSCRIPT, obj.getEventScript());
        criteria.add(TPUUID, obj.getUuid());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( TEvent obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TEvent retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TEvent retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TEvent retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TEvent retVal = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TEvent retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TEvent> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEvent> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TEvent> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEvent> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TEvent> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TEvent>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TEvent objects pre-filled with their
     * TProjectType objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TEventPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TEvent> doSelectJoinTProjectType(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TEvent> doSelectJoinTProjectType(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TEventPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TProjectTypePeer.addSelectColumns(criteria);

        criteria.addJoin(TEventPeer.PROJECTTYPE,
        ...
        List<TEvent> results = new ArrayList<TEvent>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TEventPeer.getOMClass();
            TEvent obj1 = (TEvent) TEventPeer
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TEvent> doSelectJoinTProject(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TEvent> doSelectJoinTProject(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TEventPeer.PROJECT,
            TProjectPeer.PKEY);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TEvent> doSelectJoinTCLOB(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TEvent> doSelectJoinTCLOB(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TEventPeer.EVENTSCRIPT,
            TCLOBPeer.OBJECTID);
    ...
    /**
     * selects a collection of TEvent objects pre-filled with
     * all related objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TEvent> doSelectJoinAllExceptTProjectType(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TEvent> doSelectJoinAllExceptTProjectType(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        TProjectPeer.addSelectColumns(criteria);
        criteria.addJoin(TEventPeer.PROJECT, TProjectPeer.PKEY);
        int offset3 = offset2 + TProjectPeer.numColumns;

        TCLOBPeer.addSelectColumns(criteria);
        criteria.addJoin(TEventPeer.EVENTSCRIPT, TCLOBPeer.OBJECTID);
 ...
 newObject = true;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TEvent> doSelectJoinAllExceptTProject(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TEvent> doSelectJoinAllExceptTProject(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        TProjectTypePeer.addSelectColumns(criteria);
        criteria.addJoin(TEventPeer.PROJECTTYPE, TProjectTypePeer.OBJECTID);
 ...
 newObject = true;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TEvent> doSelectJoinAllExceptTCLOB(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TEvent> doSelectJoinAllExceptTCLOB(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
