 ...
 *
 */
public abstract class BaseTListTypePeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TListTypeMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TListTypeMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the TYPEFLAG field */
    public static final String TYPEFLAG;
    ...
    static
    {
        ...
        TOOLTIP = "TCATEGORY.TOOLTIP";
        TYPEFLAG = "TCATEGORY.TYPEFLAG";
        SORTORDER = "TCATEGORY.SORTORDER";
        SYMBOL = "TCATEGORY.SYMBOL";
        ICONKEY = "TCATEGORY.ICONKEY";
        ICONCHANGED = "TCATEGORY.ICONCHANGED";
        CSSSTYLE = "TCATEGORY.CSSSTYLE";
        TPUUID = "TCATEGORY.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TListTypeMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TListTypeMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TListType";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TListType> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(TYPEFLAG);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TListType row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TListType obj = (TListType) cls.newInstance();
            TListTypePeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setTypeflag(row.getValue(offset + 3).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TListType> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TListType> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TListType> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TListType> results = new ArrayList<TListType>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TListTypePeer.row2Object(row, 1,
                TListTypePeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TListType> doSelect(TListType obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TListType obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TListType obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TListType obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TListType) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TListType obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TListType) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TListType obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TListType) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TListType obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TListType obj )
    {
        ...
        criteria.add(TYPEFLAG, obj.getTypeflag());
    ...
    public static Criteria buildSelectCriteria( TListType obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TListType retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TListType retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TListType retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TListType retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TListType retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TListType> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TListType> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TListType> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TListType> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TListType> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TListType>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TListType objects pre-filled with their
     * TBLOB objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TListTypePeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TListType> doSelectJoinTBLOB(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TListType> doSelectJoinTBLOB(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TListTypePeer.ICONKEY,
            TBLOBPeer.OBJECTID);
        ...
        List<TListType> results = new ArrayList<TListType>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TListTypePeer.getOMClass();
            TListType obj1 = (TListType) TListTypePeer
            ...
            {
                TListType temp_obj1 =  results.get(j);
                TBLOB temp_obj2 = (TBLOB) temp_obj1.getTBLOB();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTListType(obj1);
                    break;
                }
            }
            if (newObject)
