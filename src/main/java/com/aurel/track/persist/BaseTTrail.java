 ...
 * extended all references should be to TTrail
 */
public abstract class BaseTTrail extends TpBaseObject
{
    /** The Peer class */
    private static final TTrailPeer peer =
        new TTrailPeer();
    ...
    {
        if (name.equals(TTrailPeer.TRAILKEY))
        {
            return getObjectID();
        }
        if (name.equals(TTrailPeer.WORKITEMKEY))
        {
            return getWorkItemID();
        }
        if (name.equals(TTrailPeer.CHANGEDBY))
        {
            return getChangedByID();
        }
        if (name.equals(TTrailPeer.CHANGEDESCRIPTION))
        {
            return getChangeDescription();
        }
        if (name.equals(TTrailPeer.LASTEDIT))
        {
            return getLastEdit();
        }
        if (name.equals(TTrailPeer.TPUUID))
        {
            return getUuid();
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (TTrailPeer.TRAILKEY.equals(name))
        {
            return setByName("ObjectID", value);
        }
      if (TTrailPeer.WORKITEMKEY.equals(name))
        {
            return setByName("WorkItemID", value);
        }
      if (TTrailPeer.CHANGEDBY.equals(name))
        {
            return setByName("ChangedByID", value);
        }
      if (TTrailPeer.CHANGEDESCRIPTION.equals(name))
        {
            return setByName("ChangeDescription", value);
        }
      if (TTrailPeer.LASTEDIT.equals(name))
        {
            return setByName("LastEdit", value);
        }
      if (TTrailPeer.TPUUID.equals(name))
        {
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    TTrailPeer.doInsert((TTrail) this, con);
                    setNew(false);
                }
                else
                {
                    TTrailPeer.doUpdate((TTrail) this, con);
                }
            }
     ...
     */
    public TTrail copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     */
    public TTrail copy(Connection con) throws TorqueException
    {
     ...
     */
    public TTrail copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new TTrail(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public TTrail copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new TTrail(), deepcopy, con);
    }
     ...
     */
    protected TTrail copyInto(TTrail copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected TTrail copyInto(TTrail copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected TTrail copyInto(TTrail copyObj, boolean deepcopy) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected TTrail copyInto(TTrail copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setObjectID(objectID);
        copyObj.setWorkItemID(workItemID);
        copyObj.setChangedByID(changedByID);
    ...
    {
        return TTrailPeer.getTableMap();
    }

  
    /**
     * Creates a TTrailBean with the contents of this object
     * This also creates beans for cached related objects, if they exist
     * @return a TTrailBean with the contents of this object
     */
    public TTrailBean getBean()
    {
     ...
     * @return a TTrailBean with the contents of this object
     */
    public TTrailBean getBean(IdentityMap createdBeans)
    {
        TTrailBean result = (TTrailBean) createdBeans.get(this);
        if (result != null ) {
            // we have already created a bean for this object, return it
            return result;
        }
        // no bean exists for this object; create a new one
        result = new TTrailBean();
    ...
    /**
     * Creates an instance of TTrail with the contents
     * of a TTrailBean.
     * This behaviour could have also been achieved using a constructor,
     * however as this class is abstract no constructors are allowed
     * @param bean the TTrailBean which contents are used to create
     *        the resulting class
     * @return an instance of TTrail with the contents of bean
     */
    public static TTrail createTTrail(TTrailBean bean)
        throws TorqueException
    {
        return createTTrail(bean, new IdentityMap());
    }
    ...
    public static TTrail createTTrail(TTrailBean bean, IdentityMap createdObjects)
        throws TorqueException
    {
        TTrail result = (TTrail) createdObjects.get(bean);
        if (result != null)
        {
