 ...
 *
 */
public abstract class BaseTViewParamPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TViewParamMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TViewParamMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TVIEWPARAM";

        OBJECTID = "TVIEWPARAM.OBJECTID";
        NAVIGATORLAYOUT = "TVIEWPARAM.NAVIGATORLAYOUT";
        PARAMNAME = "TVIEWPARAM.PARAMNAME";
        PARAMVALUE = "TVIEWPARAM.PARAMVALUE";
        TPUUID = "TVIEWPARAM.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TViewParamMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TViewParamMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TViewParam";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TViewParam> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TViewParam row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TViewParam obj = (TViewParam) cls.newInstance();
            TViewParamPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setParamName(row.getValue(offset + 2).asString());
            obj.setParamValue(row.getValue(offset + 3).asString());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TViewParam> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TViewParam> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TViewParam> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TViewParam> results = new ArrayList<TViewParam>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TViewParamPeer.row2Object(row, 1,
                TViewParamPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TViewParam> doSelect(TViewParam obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TViewParam obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TViewParam obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TViewParam obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TViewParam) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TViewParam obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TViewParam) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TViewParam obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TViewParam) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TViewParam obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TViewParam obj )
    {
    ...
    public static Criteria buildSelectCriteria( TViewParam obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TViewParam retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TViewParam retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TViewParam retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TViewParam retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TViewParam retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TViewParam> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TViewParam> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TViewParam> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TViewParam> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TViewParam> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TViewParam>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TViewParam objects pre-filled with their
     * TNavigatorLayout objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TViewParamPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TViewParam> doSelectJoinTNavigatorLayout(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TViewParam> doSelectJoinTNavigatorLayout(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TViewParamPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TNavigatorLayoutPeer.addSelectColumns(criteria);

        criteria.addJoin(TViewParamPeer.NAVIGATORLAYOUT,
        ...
        List<TViewParam> results = new ArrayList<TViewParam>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TViewParamPeer.getOMClass();
            TViewParam obj1 = (TViewParam) TViewParamPeer
            ...
            {
                TViewParam temp_obj1 =  results.get(j);
                TNavigatorLayout temp_obj2 = (TNavigatorLayout) temp_obj1.getTNavigatorLayout();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTViewParam(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTViewParams();
                obj2.addTViewParam(obj1);
            }
            results.add(obj1);
        }
        return results;
