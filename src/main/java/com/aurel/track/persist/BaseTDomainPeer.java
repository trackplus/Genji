...
/**
 */
public abstract class BaseTDomainPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TDomainMapBuilder.CLASS_NAME) instead
     */
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TDomain";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDomain> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TDomain row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDomain> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDomain> populateObjects(List<Record> records)
        throws TorqueException
    {
        ...
        for (int i = 0; i < records.size(); i++)
        {
            ...
            results.add(TDomainPeer.row2Object(row, 1,
                TDomainPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDomain> doSelect(TDomain obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TDomain obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TDomain obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TDomain obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TDomain) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TDomain obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TDomain) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TDomain obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TDomain) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TDomain obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TDomain obj )
    {
    ...
    public static Criteria buildSelectCriteria( TDomain obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TDomain retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TDomain retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TDomain retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TDomain retVal = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TDomain retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TDomain> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDomain> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TDomain> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDomain> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TDomain> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TDomain>();
        }
        else
        {
            Criteria criteria = new Criteria();
