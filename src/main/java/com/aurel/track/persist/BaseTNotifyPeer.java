...
/**
 */
public abstract class BaseTNotifyPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TNotifyMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TNotifyMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the RACIROLE field */
    public static final String RACIROLE;
    ...
    static
    {
        ...
        PKEY = "TNOTIFY.PKEY";
        PROJCATKEY = "TNOTIFY.PROJCATKEY";
        STATEKEY = "TNOTIFY.STATEKEY";
        PERSONKEY = "TNOTIFY.PERSONKEY";
        WORKITEM = "TNOTIFY.WORKITEM";
        RACIROLE = "TNOTIFY.RACIROLE";
        TPUUID = "TNOTIFY.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TNotifyMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TNotifyMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TNotify";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TNotify> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(RACIROLE);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TNotify row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TNotify obj = (TNotify) cls.newInstance();
            TNotifyPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setProjectCategoryID(row.getValue(offset + 1).asIntegerObj());
            obj.setStateID(row.getValue(offset + 2).asIntegerObj());
            obj.setPersonID(row.getValue(offset + 3).asIntegerObj());
            obj.setWorkItem(row.getValue(offset + 4).asIntegerObj());
            obj.setRaciRole(row.getValue(offset + 5).asString());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TNotify> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TNotify> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TNotify> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TNotify> results = new ArrayList<TNotify>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TNotifyPeer.row2Object(row, 1,
                TNotifyPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TNotify> doSelect(TNotify obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TNotify obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TNotify obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TNotify obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TNotify) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TNotify obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TNotify) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TNotify obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TNotify) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TNotify obj, Connection con)
        throws TorqueException
    {
     ...
     */
    public static TNotify retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TNotify retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TNotify retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TNotify retVal = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TNotify retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TNotify> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TNotify> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TNotify> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TNotify> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TNotify> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TNotify>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TNotify objects pre-filled with their
     * TProjectCategory objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TNotifyPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TNotify> doSelectJoinTProjectCategory(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TNotify> doSelectJoinTProjectCategory(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TNotifyPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TProjectCategoryPeer.addSelectColumns(criteria);

        criteria.addJoin(TNotifyPeer.PROJCATKEY,
        ...
        List<TNotify> results = new ArrayList<TNotify>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TNotifyPeer.getOMClass();
            TNotify obj1 = (TNotify) TNotifyPeer
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TNotify> doSelectJoinTState(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TNotify> doSelectJoinTState(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TNotifyPeer.STATEKEY,
            TStatePeer.PKEY);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TNotify> doSelectJoinTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TNotify> doSelectJoinTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TNotifyPeer.PERSONKEY,
            TPersonPeer.PKEY);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TNotify> doSelectJoinTWorkItem(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TNotify> doSelectJoinTWorkItem(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TNotifyPeer.WORKITEM,
    ...
    /**
     * selects a collection of TNotify objects pre-filled with
     * all related objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TNotify> doSelectJoinAllExceptTProjectCategory(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TNotify> doSelectJoinAllExceptTProjectCategory(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        TStatePeer.addSelectColumns(criteria);
        criteria.addJoin(TNotifyPeer.STATEKEY, TStatePeer.PKEY);
        int offset3 = offset2 + TStatePeer.numColumns;

        TPersonPeer.addSelectColumns(criteria);
        criteria.addJoin(TNotifyPeer.PERSONKEY, TPersonPeer.PKEY);
 ...
 newObject = true;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TNotify> doSelectJoinAllExceptTState(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TNotify> doSelectJoinAllExceptTState(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        TProjectCategoryPeer.addSelectColumns(criteria);
        criteria.addJoin(TNotifyPeer.PROJCATKEY, TProjectCategoryPeer.PKEY);
 ...
 newObject = true;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TNotify> doSelectJoinAllExceptTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TNotify> doSelectJoinAllExceptTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
 ...
 newObject = true;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TNotify> doSelectJoinAllExceptTWorkItem(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TNotify> doSelectJoinAllExceptTWorkItem(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
