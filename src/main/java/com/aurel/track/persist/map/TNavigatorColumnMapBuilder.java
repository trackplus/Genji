 ...
 *
  */
public class TNavigatorColumnMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.aurel.track.persist.map.TNavigatorColumnMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("TNAVIGATORCOLUMN");
        TableMap tMap = dbMap.getTable("TNAVIGATORCOLUMN");
        tMap.setJavaName("TNavigatorColumn");
        tMap.setOMClass( com.aurel.track.persist.TNavigatorColumn.class );
        tMap.setPeerClass( com.aurel.track.persist.TNavigatorColumnPeer.class );
        tMap.setDescription("column in item navigator");
