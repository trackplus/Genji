...
/**
  */
public class TDashboardTabMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.aurel.track.persist.map.TDashboardTabMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("TDASHBOARDTAB");
        TableMap tMap = dbMap.getTable("TDASHBOARDTAB");
        tMap.setJavaName("TDashboardTab");
        tMap.setOMClass( com.aurel.track.persist.TDashboardTab.class );
        tMap.setPeerClass( com.aurel.track.persist.TDashboardTabPeer.class );
  ...
  // ------------- Column: PARENT --------------------
        ...
        cMap.setProtected(false);
        cMap.setInheritance("false");
        cMap.setForeignKey("TDASHBOARDSCREEN", "OBJECTID");
        cMap.setPosition(6);
        tMap.addColumn(cMap);
  // ------------- Column: TPUUID --------------------
