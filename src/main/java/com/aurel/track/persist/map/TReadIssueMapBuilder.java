 ...
 *
  */
public class TReadIssueMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.aurel.track.persist.map.TReadIssueMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("TREADISSUE");
        TableMap tMap = dbMap.getTable("TREADISSUE");
        tMap.setJavaName("TReadIssue");
        tMap.setOMClass( com.aurel.track.persist.TReadIssue.class );
        tMap.setPeerClass( com.aurel.track.persist.TReadIssuePeer.class );
        tMap.setDescription("Mark issues as unread if it is missing from this table");
  ...
  // ------------- Column: FIELDKEY --------------------
        ...
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setDescription("null for the entire item, but could be comment, attachment");
        cMap.setInheritance("false");
        cMap.setPosition(3);
        tMap.addColumn(cMap);
  // ------------- Column: PERSON --------------------
        ...
        tMap.addColumn(cMap);
  // ------------- Column: READTYPE --------------------
        cMap = new ColumnMap( "READTYPE", tMap);
        cMap.setType( new Integer(0) );
        cMap.setTorqueType( "INTEGER" );
        cMap.setUsePrimitive(false);
        cMap.setPrimaryKey(false);
        cMap.setNotNull(false);
        cMap.setJavaName( "ReadType" );
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setInheritance("false");
        cMap.setPosition(5);
