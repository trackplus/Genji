...
/**
  */
public class TTrailMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.aurel.track.persist.map.TTrailMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("TTRAIL");
        TableMap tMap = dbMap.getTable("TTRAIL");
        tMap.setJavaName("TTrail");
        tMap.setOMClass( com.aurel.track.persist.TTrail.class );
        tMap.setPeerClass( com.aurel.track.persist.TTrailPeer.class );
  ...
  // ------------- Column: TRAILKEY --------------------
        cMap = new ColumnMap( "TRAILKEY", tMap);
