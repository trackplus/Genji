 ...
 *
  */
public class TListTypeMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.aurel.track.persist.map.TListTypeMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("TCATEGORY");
        TableMap tMap = dbMap.getTable("TCATEGORY");
        tMap.setJavaName("TListType");
        tMap.setOMClass( com.aurel.track.persist.TListType.class );
        tMap.setPeerClass( com.aurel.track.persist.TListTypePeer.class );
        tMap.setDescription("Holds all known issue types.");
  ...
  // ------------- Column: LABEL --------------------
        ...
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setDescription("The name of this issue type. Localization will be applied if possible by the business logic.");
        cMap.setInheritance("false");
        cMap.setSize( 255 );
        cMap.setPosition(2);
        tMap.addColumn(cMap);
  // ------------- Column: TOOLTIP --------------------
        ...
        tMap.addColumn(cMap);
  // ------------- Column: TYPEFLAG --------------------
        cMap = new ColumnMap( "TYPEFLAG", tMap);
        cMap.setType( new Integer(0) );
        cMap.setTorqueType( "INTEGER" );
        cMap.setUsePrimitive(false);
        cMap.setPrimaryKey(false);
        cMap.setNotNull(false);
        cMap.setJavaName( "Typeflag" );
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setInheritance("false");
        cMap.setPosition(4);
  ...
  // ------------- Column: CSSSTYLE --------------------
        ...
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setDescription("CSS styles for rows with this issue type");
        cMap.setInheritance("false");
        cMap.setSize( 255 );
        cMap.setPosition(9);
        tMap.addColumn(cMap);
