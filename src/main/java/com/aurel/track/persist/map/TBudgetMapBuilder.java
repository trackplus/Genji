...
/**
  */
public class TBudgetMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.aurel.track.persist.map.TBudgetMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("TBUDGET");
        TableMap tMap = dbMap.getTable("TBUDGET");
        tMap.setJavaName("TBudget");
        tMap.setOMClass( com.aurel.track.persist.TBudget.class );
        tMap.setPeerClass( com.aurel.track.persist.TBudgetPeer.class );
  ...
  // ------------- Column: ESTIMATEDHOURS --------------------
        cMap = new ColumnMap( "ESTIMATEDHOURS", tMap);
        cMap.setType( new Double(0) );
        cMap.setTorqueType( "DOUBLE" );
        cMap.setUsePrimitive(false);
        cMap.setPrimaryKey(false);
        cMap.setNotNull(false);
        cMap.setJavaName( "EstimatedHours" );
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setInheritance("false");
        cMap.setPosition(3);
  ...
  // ------------- Column: ESTIMATEDCOST --------------------
        cMap = new ColumnMap( "ESTIMATEDCOST", tMap);
        cMap.setType( new Double(0) );
        cMap.setTorqueType( "DOUBLE" );
        cMap.setUsePrimitive(false);
        cMap.setPrimaryKey(false);
        cMap.setNotNull(false);
        cMap.setJavaName( "EstimatedCost" );
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setInheritance("false");
        cMap.setPosition(5);
  ...
  // ------------- Column: LASTEDIT --------------------
        ...
        tMap.addColumn(cMap);
  // ------------- Column: BUDGETTYPE --------------------
        cMap = new ColumnMap( "BUDGETTYPE", tMap);
        cMap.setType( new Integer(0) );
        cMap.setTorqueType( "INTEGER" );
        cMap.setUsePrimitive(false);
        cMap.setPrimaryKey(false);
        cMap.setNotNull(false);
        cMap.setJavaName( "BudgetType" );
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setDescription("top-down (agreement) or bottom up (commitment) budget");
        cMap.setInheritance("false");
        cMap.setPosition(12);
        tMap.addColumn(cMap);
  // ------------- Column: TPUUID --------------------
