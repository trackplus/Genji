 ...
 *
  */
public class TFilterCategoryMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.aurel.track.persist.map.TFilterCategoryMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("TFILTERCATEGORY");
        TableMap tMap = dbMap.getTable("TFILTERCATEGORY");
        tMap.setJavaName("TFilterCategory");
        tMap.setOMClass( com.aurel.track.persist.TFilterCategory.class );
        tMap.setPeerClass( com.aurel.track.persist.TFilterCategoryPeer.class );
        tMap.setDescription("Hierarchical categorization of the queries");
  ...
  // ------------- Column: PARENTID --------------------
        ...
        cMap.setProtected(false);
        cMap.setInheritance("false");
        cMap.setForeignKey("TFILTERCATEGORY", "OBJECTID");
        cMap.setPosition(7);
        tMap.addColumn(cMap);
  // ------------- Column: SORTORDER --------------------
