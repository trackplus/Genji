...
/**
  */
public class TPpriorityMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.aurel.track.persist.map.TPpriorityMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("TPPRIORITY");
        TableMap tMap = dbMap.getTable("TPPRIORITY");
        tMap.setJavaName("TPpriority");
        tMap.setOMClass( com.aurel.track.persist.TPpriority.class );
        tMap.setPeerClass( com.aurel.track.persist.TPpriorityPeer.class );
