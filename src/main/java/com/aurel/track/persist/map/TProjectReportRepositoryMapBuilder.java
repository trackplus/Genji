...
/**
  */
public class TProjectReportRepositoryMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.aurel.track.persist.map.TProjectReportRepositoryMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        TableMap tMap = dbMap.getTable("TPROJECTREPORTREPOSITORY");
        tMap.setJavaName("TProjectReportRepository");
        tMap.setOMClass( com.aurel.track.persist.TProjectReportRepository.class );
        tMap.setPeerClass( com.aurel.track.persist.TProjectReportRepositoryPeer.class );
