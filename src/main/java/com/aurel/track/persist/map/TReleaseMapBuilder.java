...
/**
  */
public class TReleaseMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.aurel.track.persist.map.TReleaseMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("TRELEASE");
        TableMap tMap = dbMap.getTable("TRELEASE");
        tMap.setJavaName("TRelease");
        tMap.setOMClass( com.aurel.track.persist.TRelease.class );
        tMap.setPeerClass( com.aurel.track.persist.TReleasePeer.class );
  ...
  // ------------- Column: DESCRIPTION --------------------
        ...
        tMap.addColumn(cMap);
  // ------------- Column: DUEDATE --------------------
        cMap = new ColumnMap( "DUEDATE", tMap);
        cMap.setType( new Date() );
        cMap.setTorqueType( "TIMESTAMP" );
        cMap.setUsePrimitive(false);
        cMap.setPrimaryKey(false);
        cMap.setNotNull(false);
        cMap.setJavaName( "DueDate" );
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setInheritance("false");
        cMap.setPosition(8);
