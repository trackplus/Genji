...
/**
  */
public class TCardFieldMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.aurel.track.persist.map.TCardFieldMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("TCARDFIELD");
        TableMap tMap = dbMap.getTable("TCARDFIELD");
        tMap.setJavaName("TCardField");
        tMap.setOMClass( com.aurel.track.persist.TCardField.class );
        tMap.setPeerClass( com.aurel.track.persist.TCardFieldPeer.class );
  ...
  // ------------- Column: VALUEVALIGN --------------------
        ...
        tMap.addColumn(cMap);
  // ------------- Column: CARDPANEL --------------------
        cMap = new ColumnMap( "CARDPANEL", tMap);
        cMap.setType( new Integer(0) );
        cMap.setTorqueType( "INTEGER" );
        cMap.setUsePrimitive(false);
        cMap.setPrimaryKey(false);
        cMap.setNotNull(true);
        cMap.setJavaName( "CardPanel" );
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setInheritance("false");
        cMap.setForeignKey("TCARDPANEL", "OBJECTID");
        cMap.setPosition(11);
        tMap.addColumn(cMap);
  // ------------- Column: FIELDKEY --------------------
