...
/**
  */
public class TOptionSettingsMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.aurel.track.persist.map.TOptionSettingsMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("TOPTIONSETTINGS");
        TableMap tMap = dbMap.getTable("TOPTIONSETTINGS");
        tMap.setJavaName("TOptionSettings");
        tMap.setOMClass( com.aurel.track.persist.TOptionSettings.class );
        tMap.setPeerClass( com.aurel.track.persist.TOptionSettingsPeer.class );
  ...
  // ------------- Column: PARAMETERCODE --------------------
        ...
        tMap.addColumn(cMap);
  // ------------- Column: MULTIPLE --------------------
        cMap = new ColumnMap( "MULTIPLE", tMap);
        cMap.setType( "" );
        cMap.setTorqueType( "CHAR" );
        cMap.setUsePrimitive(false);
        cMap.setPrimaryKey(false);
        cMap.setNotNull(false);
        cMap.setJavaName( "Multiple" );
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setDefault("N");
        cMap.setInheritance("false");
