...
/**
  */
public class TScreenConfigMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.aurel.track.persist.map.TScreenConfigMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("TSCREENCONFIG");
        TableMap tMap = dbMap.getTable("TSCREENCONFIG");
        tMap.setJavaName("TScreenConfig");
        tMap.setOMClass( com.aurel.track.persist.TScreenConfig.class );
        tMap.setPeerClass( com.aurel.track.persist.TScreenConfigPeer.class );
