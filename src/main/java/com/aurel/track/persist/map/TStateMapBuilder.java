...
/**
  */
public class TStateMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.aurel.track.persist.map.TStateMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("TSTATE");
        TableMap tMap = dbMap.getTable("TSTATE");
        tMap.setJavaName("TState");
        tMap.setOMClass( com.aurel.track.persist.TState.class );
        tMap.setPeerClass( com.aurel.track.persist.TStatePeer.class );
  ...
  // ------------- Column: CSSSTYLE --------------------
        ...
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setDescription("CSS style for rows with this status");
        cMap.setInheritance("false");
        cMap.setSize( 255 );
        cMap.setPosition(9);
        tMap.addColumn(cMap);
  // ------------- Column: PERCENTCOMPLETE --------------------
        cMap = new ColumnMap( "PERCENTCOMPLETE", tMap);
        cMap.setType( new Integer(0) );
        cMap.setTorqueType( "INTEGER" );
        cMap.setUsePrimitive(false);
        cMap.setPrimaryKey(false);
        cMap.setNotNull(false);
        cMap.setJavaName( "PercentComplete" );
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setInheritance("false");
        cMap.setPosition(10);
