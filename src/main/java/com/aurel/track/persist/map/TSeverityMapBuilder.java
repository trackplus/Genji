...
/**
  */
public class TSeverityMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.aurel.track.persist.map.TSeverityMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("TSEVERITY");
        TableMap tMap = dbMap.getTable("TSEVERITY");
        tMap.setJavaName("TSeverity");
        tMap.setOMClass( com.aurel.track.persist.TSeverity.class );
        tMap.setPeerClass( com.aurel.track.persist.TSeverityPeer.class );
  ...
  // ------------- Column: CSSSTYLE --------------------
        ...
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setDescription("CSS style for rows with this severity");
        cMap.setInheritance("false");
        cMap.setSize( 255 );
        cMap.setPosition(9);
        tMap.addColumn(cMap);
