...
/**
  */
public class TFieldConfigMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.aurel.track.persist.map.TFieldConfigMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("TFIELDCONFIG");
        TableMap tMap = dbMap.getTable("TFIELDCONFIG");
        tMap.setJavaName("TFieldConfig");
        tMap.setOMClass( com.aurel.track.persist.TFieldConfig.class );
        tMap.setPeerClass( com.aurel.track.persist.TFieldConfigPeer.class );
  ...
  // ------------- Column: REQUIRED --------------------
        ...
        tMap.addColumn(cMap);
  // ------------- Column: HISTORY --------------------
        cMap = new ColumnMap( "HISTORY", tMap);
        cMap.setType( "" );
        cMap.setTorqueType( "CHAR" );
        cMap.setUsePrimitive(false);
        cMap.setPrimaryKey(false);
        cMap.setNotNull(true);
        cMap.setJavaName( "History" );
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setDefault("N");
        cMap.setInheritance("false");
  ...
  // ------------- Column: GROOVYSCRIPT --------------------
        ...
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setDescription("script for calculated fields");
        cMap.setInheritance("false");
