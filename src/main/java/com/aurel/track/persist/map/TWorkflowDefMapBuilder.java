...
/**
  */
public class TWorkflowDefMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.aurel.track.persist.map.TWorkflowDefMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("TWORKFLOWDEF");
        TableMap tMap = dbMap.getTable("TWORKFLOWDEF");
        tMap.setJavaName("TWorkflowDef");
        tMap.setOMClass( com.aurel.track.persist.TWorkflowDef.class );
        tMap.setPeerClass( com.aurel.track.persist.TWorkflowDefPeer.class );
  ...
  // ------------- Column: TAGLABEL --------------------
        ...
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setDescription("A user defined tag used for filtering/grouping the workflows");
        cMap.setInheritance("false");
        cMap.setSize( 255 );
        cMap.setPosition(4);
        tMap.addColumn(cMap);
