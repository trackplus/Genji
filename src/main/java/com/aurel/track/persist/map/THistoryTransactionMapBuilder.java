...
/**
  */
public class THistoryTransactionMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.aurel.track.persist.map.THistoryTransactionMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("THISTORYTRANSACTION");
        TableMap tMap = dbMap.getTable("THISTORYTRANSACTION");
        tMap.setJavaName("THistoryTransaction");
        tMap.setOMClass( com.aurel.track.persist.THistoryTransaction.class );
        tMap.setPeerClass( com.aurel.track.persist.THistoryTransactionPeer.class );
