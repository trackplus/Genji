...
/**
  */
public class TScreenTabMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.aurel.track.persist.map.TScreenTabMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("TSCREENTAB");
        TableMap tMap = dbMap.getTable("TSCREENTAB");
        tMap.setJavaName("TScreenTab");
        tMap.setOMClass( com.aurel.track.persist.TScreenTab.class );
        tMap.setPeerClass( com.aurel.track.persist.TScreenTabPeer.class );
