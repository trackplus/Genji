...
/**
  */
public class TSystemStateMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.aurel.track.persist.map.TSystemStateMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("TSYSTEMSTATE");
        TableMap tMap = dbMap.getTable("TSYSTEMSTATE");
        tMap.setJavaName("TSystemState");
        tMap.setOMClass( com.aurel.track.persist.TSystemState.class );
        tMap.setPeerClass( com.aurel.track.persist.TSystemStatePeer.class );
  ...
  // ------------- Column: LABEL --------------------
        ...
        tMap.addColumn(cMap);
  // ------------- Column: STATEFLAG --------------------
        cMap = new ColumnMap( "STATEFLAG", tMap);
        cMap.setType( new Integer(0) );
        cMap.setTorqueType( "INTEGER" );
        cMap.setUsePrimitive(false);
        cMap.setPrimaryKey(false);
        cMap.setNotNull(false);
        cMap.setJavaName( "Stateflag" );
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setInheritance("false");
        cMap.setPosition(3);
  ...
  // ------------- Column: SYMBOL --------------------
        ...
        tMap.addColumn(cMap);
  // ------------- Column: ENTITYFLAG --------------------
        cMap = new ColumnMap( "ENTITYFLAG", tMap);
        cMap.setType( new Integer(0) );
        cMap.setTorqueType( "INTEGER" );
        cMap.setUsePrimitive(false);
        cMap.setPrimaryKey(false);
        cMap.setNotNull(false);
        cMap.setJavaName( "Entityflag" );
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setInheritance("false");
        cMap.setPosition(5);
  ...
  // ------------- Column: CSSSTYLE --------------------
        ...
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setDescription("CSS style for rows with this system status");
        cMap.setInheritance("false");
        cMap.setSize( 255 );
        cMap.setPosition(8);
        tMap.addColumn(cMap);
