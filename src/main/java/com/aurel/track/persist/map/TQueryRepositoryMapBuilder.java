...
/**
  */
public class TQueryRepositoryMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.aurel.track.persist.map.TQueryRepositoryMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("TQUERYREPOSITORY");
        TableMap tMap = dbMap.getTable("TQUERYREPOSITORY");
        tMap.setJavaName("TQueryRepository");
        tMap.setOMClass( com.aurel.track.persist.TQueryRepository.class );
        tMap.setPeerClass( com.aurel.track.persist.TQueryRepositoryPeer.class );
  ...
  // ------------- Column: SORTORDER --------------------
        ...
        tMap.addColumn(cMap);
  // ------------- Column: VIEWID --------------------
        cMap = new ColumnMap( "VIEWID", tMap);
        cMap.setType( "" );
        cMap.setTorqueType( "VARCHAR" );
        cMap.setUsePrimitive(false);
        cMap.setPrimaryKey(false);
        cMap.setNotNull(false);
        cMap.setJavaName( "ViewID" );
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setInheritance("false");
        cMap.setSize( 255 );
