...
/**
  */
public class TPersonInDomainMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.aurel.track.persist.map.TPersonInDomainMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("TPERSONINDOMAIN");
        TableMap tMap = dbMap.getTable("TPERSONINDOMAIN");
        tMap.setJavaName("TPersonInDomain");
        tMap.setOMClass( com.aurel.track.persist.TPersonInDomain.class );
        tMap.setPeerClass( com.aurel.track.persist.TPersonInDomainPeer.class );
