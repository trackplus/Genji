...
/**
  */
public class TActionMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.aurel.track.persist.map.TActionMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("TACTION");
        TableMap tMap = dbMap.getTable("TACTION");
        tMap.setJavaName("TAction");
        tMap.setOMClass( com.aurel.track.persist.TAction.class );
        tMap.setPeerClass( com.aurel.track.persist.TActionPeer.class );
  ...
  // ------------- Column: ACTIONTYPE --------------------
        ...
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setDescription("whether it is a workflow action or a general item action (used in screen assignments)");
        cMap.setInheritance("false");
        cMap.setPosition(5);
        tMap.addColumn(cMap);
  // ------------- Column: ICONKEY --------------------
