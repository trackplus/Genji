...
/**
  */
public class TDashboardScreenMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.aurel.track.persist.map.TDashboardScreenMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("TDASHBOARDSCREEN");
        TableMap tMap = dbMap.getTable("TDASHBOARDSCREEN");
        tMap.setJavaName("TDashboardScreen");
        tMap.setOMClass( com.aurel.track.persist.TDashboardScreen.class );
        tMap.setPeerClass( com.aurel.track.persist.TDashboardScreenPeer.class );
  ...
  // ------------- Column: LABEL --------------------
        ...
        tMap.addColumn(cMap);
  // ------------- Column: PERSONPKEY --------------------
        cMap = new ColumnMap( "PERSONPKEY", tMap);
        cMap.setType( new Integer(0) );
        cMap.setTorqueType( "INTEGER" );
        cMap.setUsePrimitive(false);
        cMap.setPrimaryKey(false);
  ...
  // ------------- Column: PROJECT --------------------
        ...
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setDescription("specified if dashboard screen is project specific");
        cMap.setInheritance("false");
  ...
  // ------------- Column: ENTITYTYPE --------------------
        ...
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setDescription("whether the dashboard screen is project specific or release specific");
        cMap.setInheritance("false");
        cMap.setPosition(6);
        tMap.addColumn(cMap);
  // ------------- Column: OWNER --------------------
