 ...
 *
  */
public class TBaseLineMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.aurel.track.persist.map.TBaseLineMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("TBASELINE");
        TableMap tMap = dbMap.getTable("TBASELINE");
        tMap.setJavaName("TBaseLine");
        tMap.setOMClass( com.aurel.track.persist.TBaseLine.class );
        tMap.setPeerClass( com.aurel.track.persist.TBaseLinePeer.class );
        tMap.setDescription("For each workitem this table contains the history of start and due dates.");
  ...
  // ------------- Column: REASONFORCHANGE --------------------
        cMap = new ColumnMap( "REASONFORCHANGE", tMap);
        cMap.setType( "" );
        cMap.setTorqueType( "VARCHAR" );
        cMap.setUsePrimitive(false);
        cMap.setPrimaryKey(false);
        cMap.setNotNull(false);
        cMap.setJavaName( "ReasonForChange" );
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setInheritance("false");
        cMap.setSize( 6000 );
