...
/**
  */
public class TFieldMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.aurel.track.persist.map.TFieldMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("TFIELD");
        TableMap tMap = dbMap.getTable("TFIELD");
        tMap.setJavaName("TField");
        tMap.setOMClass( com.aurel.track.persist.TField.class );
        tMap.setPeerClass( com.aurel.track.persist.TFieldPeer.class );
  ...
  // ------------- Column: FIELDTYPE --------------------
        ...
        tMap.addColumn(cMap);
  // ------------- Column: DEPRECATED --------------------
        cMap = new ColumnMap( "DEPRECATED", tMap);
        cMap.setType( "" );
        cMap.setTorqueType( "CHAR" );
        cMap.setUsePrimitive(false);
        cMap.setPrimaryKey(false);
        cMap.setNotNull(false);
        cMap.setJavaName( "Deprecated" );
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setDefault("N");
        cMap.setInheritance("false");
        ...
        tMap.addColumn(cMap);
  // ------------- Column: ISCUSTOM --------------------
        cMap = new ColumnMap( "ISCUSTOM", tMap);
        cMap.setType( "" );
        cMap.setTorqueType( "CHAR" );
        cMap.setUsePrimitive(false);
        cMap.setPrimaryKey(false);
        cMap.setNotNull(true);
        cMap.setJavaName( "IsCustom" );
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setDefault("Y");
        cMap.setInheritance("false");
  ...
  // ------------- Column: REQUIRED --------------------
        ...
        tMap.addColumn(cMap);
  // ------------- Column: FILTERFIELD --------------------
        cMap = new ColumnMap( "FILTERFIELD", tMap);
        cMap.setType( "" );
        cMap.setTorqueType( "CHAR" );
        cMap.setUsePrimitive(false);
        cMap.setPrimaryKey(false);
        cMap.setNotNull(false);
        cMap.setJavaName( "FilterField" );
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setDefault("N");
        cMap.setInheritance("false");
