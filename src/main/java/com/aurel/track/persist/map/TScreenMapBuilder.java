...
/**
  */
public class TScreenMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.aurel.track.persist.map.TScreenMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("TSCREEN");
        TableMap tMap = dbMap.getTable("TSCREEN");
        tMap.setJavaName("TScreen");
        tMap.setOMClass( com.aurel.track.persist.TScreen.class );
        tMap.setPeerClass( com.aurel.track.persist.TScreenPeer.class );
  ...
  // ------------- Column: TAGLABEL --------------------
        ...
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setDescription("A user defined tag used for filtering/grouping the screens");
        cMap.setInheritance("false");
        cMap.setSize( 50 );
        cMap.setPosition(4);
        tMap.addColumn(cMap);
