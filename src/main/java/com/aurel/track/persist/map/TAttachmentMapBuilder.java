...
/**
  */
public class TAttachmentMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.aurel.track.persist.map.TAttachmentMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("TATTACHMENT");
        TableMap tMap = dbMap.getTable("TATTACHMENT");
        tMap.setJavaName("TAttachment");
        tMap.setOMClass( com.aurel.track.persist.TAttachment.class );
        tMap.setPeerClass( com.aurel.track.persist.TAttachmentPeer.class );
