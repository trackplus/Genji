...
/**
  */
public class TDomainMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.aurel.track.persist.map.TDomainMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("TDOMAIN");
        TableMap tMap = dbMap.getTable("TDOMAIN");
        tMap.setJavaName("TDomain");
        tMap.setOMClass( com.aurel.track.persist.TDomain.class );
        tMap.setPeerClass( com.aurel.track.persist.TDomainPeer.class );
