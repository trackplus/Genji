...
/**
  */
public class TPstateMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.aurel.track.persist.map.TPstateMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("TPSTATE");
        TableMap tMap = dbMap.getTable("TPSTATE");
        tMap.setJavaName("TPstate");
        tMap.setOMClass( com.aurel.track.persist.TPstate.class );
        tMap.setPeerClass( com.aurel.track.persist.TPstatePeer.class );
