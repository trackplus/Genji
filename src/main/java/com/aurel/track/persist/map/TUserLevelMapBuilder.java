...
/**
  */
public class TUserLevelMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.aurel.track.persist.map.TUserLevelMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("TUSERLEVEL");
        TableMap tMap = dbMap.getTable("TUSERLEVEL");
        tMap.setJavaName("TUserLevel");
        tMap.setOMClass( com.aurel.track.persist.TUserLevel.class );
        tMap.setPeerClass( com.aurel.track.persist.TUserLevelPeer.class );
