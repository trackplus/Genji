...
/**
  */
public class TDisableFieldMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.aurel.track.persist.map.TDisableFieldMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("TDISABLEFIELD");
        TableMap tMap = dbMap.getTable("TDISABLEFIELD");
        tMap.setJavaName("TDisableField");
        tMap.setOMClass( com.aurel.track.persist.TDisableField.class );
        tMap.setPeerClass( com.aurel.track.persist.TDisableFieldPeer.class );
