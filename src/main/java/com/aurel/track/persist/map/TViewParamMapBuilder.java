 ...
 *
  */
public class TViewParamMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.aurel.track.persist.map.TViewParamMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("TVIEWPARAM");
        TableMap tMap = dbMap.getTable("TVIEWPARAM");
        tMap.setJavaName("TViewParam");
        tMap.setOMClass( com.aurel.track.persist.TViewParam.class );
        tMap.setPeerClass( com.aurel.track.persist.TViewParamPeer.class );
        tMap.setDescription("general parameters for a view");
