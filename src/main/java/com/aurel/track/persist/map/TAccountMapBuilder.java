...
/**
  */
public class TAccountMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.aurel.track.persist.map.TAccountMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("TACCOUNT");
        TableMap tMap = dbMap.getTable("TACCOUNT");
        tMap.setJavaName("TAccount");
        tMap.setOMClass( com.aurel.track.persist.TAccount.class );
        tMap.setPeerClass( com.aurel.track.persist.TAccountPeer.class );
  ...
  // ------------- Column: ACCOUNTNUMBER --------------------
        cMap = new ColumnMap( "ACCOUNTNUMBER", tMap);
        cMap.setType( "" );
        cMap.setTorqueType( "VARCHAR" );
        cMap.setUsePrimitive(false);
        cMap.setPrimaryKey(false);
        cMap.setNotNull(true);
        cMap.setJavaName( "AccountNumber" );
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setInheritance("false");
        cMap.setSize( 30 );
        ...
        tMap.addColumn(cMap);
  // ------------- Column: ACCOUNTNAME --------------------
        cMap = new ColumnMap( "ACCOUNTNAME", tMap);
        cMap.setType( "" );
        cMap.setTorqueType( "VARCHAR" );
        cMap.setUsePrimitive(false);
        cMap.setPrimaryKey(false);
        cMap.setNotNull(false);
        cMap.setJavaName( "AccountName" );
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setInheritance("false");
        cMap.setSize( 80 );
