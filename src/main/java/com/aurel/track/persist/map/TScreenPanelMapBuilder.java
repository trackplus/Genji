...
/**
  */
public class TScreenPanelMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.aurel.track.persist.map.TScreenPanelMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("TSCREENPANEL");
        TableMap tMap = dbMap.getTable("TSCREENPANEL");
        tMap.setJavaName("TScreenPanel");
        tMap.setOMClass( com.aurel.track.persist.TScreenPanel.class );
        tMap.setPeerClass( com.aurel.track.persist.TScreenPanelPeer.class );
  ...
  // ------------- Column: PARENT --------------------
        ...
        cMap.setProtected(false);
        cMap.setInheritance("false");
        cMap.setForeignKey("TSCREENTAB", "OBJECTID");
        cMap.setPosition(8);
        tMap.addColumn(cMap);
  // ------------- Column: TPUUID --------------------
