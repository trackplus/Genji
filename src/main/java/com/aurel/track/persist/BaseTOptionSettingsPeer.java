...
/**
 */
public abstract class BaseTOptionSettingsPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TOptionSettingsMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TOptionSettingsMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TOPTIONSETTINGS";

        OBJECTID = "TOPTIONSETTINGS.OBJECTID";
        LIST = "TOPTIONSETTINGS.LIST";
        CONFIG = "TOPTIONSETTINGS.CONFIG";
        PARAMETERCODE = "TOPTIONSETTINGS.PARAMETERCODE";
        MULTIPLE = "TOPTIONSETTINGS.MULTIPLE";
        TPUUID = "TOPTIONSETTINGS.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TOptionSettingsMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TOptionSettingsMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TOptionSettings";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TOptionSettings> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTOptionSettingsPeer
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(MULTIPLE);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TOptionSettings row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TOptionSettings obj = (TOptionSettings) cls.newInstance();
            TOptionSettingsPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setConfig(row.getValue(offset + 2).asIntegerObj());
            obj.setParameterCode(row.getValue(offset + 3).asIntegerObj());
            obj.setMultiple(row.getValue(offset + 4).asString());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TOptionSettings> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TOptionSettings> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TOptionSettings> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TOptionSettings> results = new ArrayList<TOptionSettings>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TOptionSettingsPeer.row2Object(row, 1,
                TOptionSettingsPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TOptionSettings> doSelect(TOptionSettings obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TOptionSettings obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TOptionSettings obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TOptionSettings obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TOptionSettings) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TOptionSettings obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TOptionSettings) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TOptionSettings obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TOptionSettings) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TOptionSettings obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TOptionSettings obj )
    {
        ...
        criteria.add(MULTIPLE, obj.getMultiple());
        criteria.add(TPUUID, obj.getUuid());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( TOptionSettings obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TOptionSettings retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TOptionSettings retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TOptionSettings retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TOptionSettings retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TOptionSettings retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TOptionSettings> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (TOptionSettings)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TOptionSettings> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TOptionSettings> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TOptionSettings> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TOptionSettings> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TOptionSettings>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TOptionSettings objects pre-filled with their
     * TList objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TOptionSettingsPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TOptionSettings> doSelectJoinTList(Criteria criteria)
        throws TorqueException
    {
        return doSelectJoinTList(criteria, null);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TOptionSettings> doSelectJoinTList(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TOptionSettingsPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TListPeer.addSelectColumns(criteria);

        criteria.addJoin(TOptionSettingsPeer.LIST,
            TListPeer.OBJECTID);
        ...
        List<TOptionSettings> results = new ArrayList<TOptionSettings>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TOptionSettingsPeer.getOMClass();
            TOptionSettings obj1 = (TOptionSettings) TOptionSettingsPeer
                .row2Object(row, 1, omClass);
             omClass = TListPeer.getOMClass();
            TList obj2 = (TList) TListPeer
                .row2Object(row, offset, omClass);

            boolean newObject = true;
            for (int j = 0; j < results.size(); j++)
            {
                TOptionSettings temp_obj1 =  results.get(j);
                TList temp_obj2 = (TList) temp_obj1.getTList();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTOptionSettings(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTOptionSettingss();
                obj2.addTOptionSettings(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TOptionSettings> doSelectJoinTFieldConfig(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TOptionSettings> doSelectJoinTFieldConfig(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TOptionSettingsPeer.CONFIG,
