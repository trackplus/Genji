 ...
 *
 */
public abstract class BaseTShortcutPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TShortcutMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TShortcutMapBuilder.CLASS_NAME);
    }

    /** the column name for the OBJECTID field */
    public static final String OBJECTID;
    /** the column name for the SHORTCUTKEY field */
    public static final String SHORTCUTKEY;
    /** the column name for the CTRLKEY field */
    public static final String CTRLKEY;
    /** the column name for the SHIFTKEY field */
    public static final String SHIFTKEY;
    /** the column name for the ALTKEY field */
    public static final String ALTKEY;
    /** the column name for the MENUITEMKEY field */
    public static final String MENUITEMKEY;
    /** the column name for the MENUCONTEXT field */
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TSHORTCUT";

        OBJECTID = "TSHORTCUT.OBJECTID";
        SHORTCUTKEY = "TSHORTCUT.SHORTCUTKEY";
        CTRLKEY = "TSHORTCUT.CTRLKEY";
        SHIFTKEY = "TSHORTCUT.SHIFTKEY";
        ALTKEY = "TSHORTCUT.ALTKEY";
        MENUITEMKEY = "TSHORTCUT.MENUITEMKEY";
        MENUCONTEXT = "TSHORTCUT.MENUCONTEXT";
        TPUUID = "TSHORTCUT.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TShortcutMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TShortcutMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TShortcut";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TShortcut> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(SHORTCUTKEY);
        criteria.addSelectColumn(CTRLKEY);
        criteria.addSelectColumn(SHIFTKEY);
        criteria.addSelectColumn(ALTKEY);
        criteria.addSelectColumn(MENUITEMKEY);
        criteria.addSelectColumn(MENUCONTEXT);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TShortcut row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TShortcut obj = (TShortcut) cls.newInstance();
            TShortcutPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setShortcutKey(row.getValue(offset + 1).asIntegerObj());
            obj.setCtrlKey(row.getValue(offset + 2).asString());
            obj.setShiftKey(row.getValue(offset + 3).asString());
            obj.setAltKey(row.getValue(offset + 4).asString());
            obj.setMenuItemKey(row.getValue(offset + 5).asIntegerObj());
            obj.setMenuContext(row.getValue(offset + 6).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TShortcut> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TShortcut> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TShortcut> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TShortcut> results = new ArrayList<TShortcut>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TShortcutPeer.row2Object(row, 1,
                TShortcutPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TShortcut> doSelect(TShortcut obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TShortcut obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TShortcut obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TShortcut obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TShortcut) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TShortcut obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TShortcut) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TShortcut obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TShortcut) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TShortcut obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TShortcut obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(OBJECTID, obj.getObjectID());
        criteria.add(SHORTCUTKEY, obj.getShortcutKey());
        criteria.add(CTRLKEY, obj.getCtrlKey());
        criteria.add(SHIFTKEY, obj.getShiftKey());
        criteria.add(ALTKEY, obj.getAltKey());
        criteria.add(MENUITEMKEY, obj.getMenuItemKey());
        criteria.add(MENUCONTEXT, obj.getMenuContext());
        criteria.add(TPUUID, obj.getUuid());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( TShortcut obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TShortcut retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TShortcut retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TShortcut retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TShortcut retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TShortcut retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TShortcut> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TShortcut> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TShortcut> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TShortcut> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TShortcut> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TShortcut>();
        }
        else
        {
            Criteria criteria = new Criteria();
