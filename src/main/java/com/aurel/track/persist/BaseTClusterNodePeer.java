 ...
 *
 */
public abstract class BaseTClusterNodePeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TClusterNodeMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TClusterNodeMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the NODEURL field */
    public static final String NODEURL;
    /** the column name for the LASTUPDATE field */
    public static final String LASTUPDATE;
    /** the column name for the MASTERNODE field */
    public static final String MASTERNODE;
    /** the column name for the RELOADCONFIG field */
    public static final String RELOADCONFIG;
    /** the column name for the RELOADCHANGES field */
    public static final String RELOADCHANGES;

    static
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "CLUSTERNODE";

        OBJECTID = "CLUSTERNODE.OBJECTID";
        NODEADDRESS = "CLUSTERNODE.NODEADDRESS";
        NODEURL = "CLUSTERNODE.NODEURL";
        LASTUPDATE = "CLUSTERNODE.LASTUPDATE";
        MASTERNODE = "CLUSTERNODE.MASTERNODE";
        RELOADCONFIG = "CLUSTERNODE.RELOADCONFIG";
        RELOADCHANGES = "CLUSTERNODE.RELOADCHANGES";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TClusterNodeMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TClusterNodeMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TClusterNode";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TClusterNode> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(NODEURL);
        criteria.addSelectColumn(LASTUPDATE);
        criteria.addSelectColumn(MASTERNODE);
        criteria.addSelectColumn(RELOADCONFIG);
        criteria.addSelectColumn(RELOADCHANGES);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TClusterNode row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TClusterNode obj = (TClusterNode) cls.newInstance();
            TClusterNodePeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setNodeAddress(row.getValue(offset + 1).asString());
            obj.setNodeURL(row.getValue(offset + 2).asString());
            obj.setLastUpdate(row.getValue(offset + 3).asUtilDate());
            obj.setMasterNode(row.getValue(offset + 4).asIntegerObj());
            obj.setReloadConfig(row.getValue(offset + 5).asIntegerObj());
            obj.setReloadChanges(row.getValue(offset + 6).asString());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TClusterNode> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TClusterNode> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TClusterNode> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TClusterNode> results = new ArrayList<TClusterNode>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TClusterNodePeer.row2Object(row, 1,
                TClusterNodePeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TClusterNode> doSelect(TClusterNode obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TClusterNode obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TClusterNode obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TClusterNode obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TClusterNode) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TClusterNode obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TClusterNode) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TClusterNode obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TClusterNode) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TClusterNode obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TClusterNode obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(OBJECTID, obj.getObjectID());
        criteria.add(NODEADDRESS, obj.getNodeAddress());
        criteria.add(NODEURL, obj.getNodeURL());
        criteria.add(LASTUPDATE, obj.getLastUpdate());
        criteria.add(MASTERNODE, obj.getMasterNode());
        criteria.add(RELOADCONFIG, obj.getReloadConfig());
        criteria.add(RELOADCHANGES, obj.getReloadChanges());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( TClusterNode obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TClusterNode retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TClusterNode retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TClusterNode retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TClusterNode retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TClusterNode retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TClusterNode> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TClusterNode> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TClusterNode> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TClusterNode> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TClusterNode> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TClusterNode>();
        }
        else
        {
            Criteria criteria = new Criteria();
