...
/**
 */
public abstract class BaseTEffortUnitPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TEffortUnitMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TEffortUnitMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TEFFORTUNIT";

        OBJECTID = "TEFFORTUNIT.OBJECTID";
        LABEL = "TEFFORTUNIT.LABEL";
        DESCRIPTION = "TEFFORTUNIT.DESCRIPTION";
        TPUUID = "TEFFORTUNIT.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TEffortUnitMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TEffortUnitMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TEffortUnit";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEffortUnit> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TEffortUnit row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TEffortUnit obj = (TEffortUnit) cls.newInstance();
            TEffortUnitPeer.populateObject(row, offset, obj);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEffortUnit> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEffortUnit> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEffortUnit> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TEffortUnit> results = new ArrayList<TEffortUnit>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TEffortUnitPeer.row2Object(row, 1,
                TEffortUnitPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEffortUnit> doSelect(TEffortUnit obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TEffortUnit obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TEffortUnit obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TEffortUnit obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TEffortUnit) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TEffortUnit obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TEffortUnit) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TEffortUnit obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TEffortUnit) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TEffortUnit obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TEffortUnit obj )
    {
    ...
    public static Criteria buildSelectCriteria( TEffortUnit obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TEffortUnit retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TEffortUnit retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TEffortUnit retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TEffortUnit retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TEffortUnit retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TEffortUnit> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEffortUnit> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TEffortUnit> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEffortUnit> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TEffortUnit> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TEffortUnit>();
        }
        else
        {
            Criteria criteria = new Criteria();
