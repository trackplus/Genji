...
/**
 */
public abstract class BaseTAttachmentPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TAttachmentMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TAttachmentMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TATTACHMENT";

        OBJECTID = "TATTACHMENT.OBJECTID";
        WORKITEM = "TATTACHMENT.WORKITEM";
        CHANGEDBY = "TATTACHMENT.CHANGEDBY";
        DOCUMENTSTATE = "TATTACHMENT.DOCUMENTSTATE";
        FILENAME = "TATTACHMENT.FILENAME";
        ISURL = "TATTACHMENT.ISURL";
        FILESIZE = "TATTACHMENT.FILESIZE";
        MIMETYPE = "TATTACHMENT.MIMETYPE";
        LASTEDIT = "TATTACHMENT.LASTEDIT";
        VERSION = "TATTACHMENT.VERSION";
        DESCRIPTION = "TATTACHMENT.DESCRIPTION";
        CRYPTKEY = "TATTACHMENT.CRYPTKEY";
        ISENCRYPTED = "TATTACHMENT.ISENCRYPTED";
        ISDELETED = "TATTACHMENT.ISDELETED";
        TPUUID = "TATTACHMENT.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TAttachmentMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TAttachmentMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TAttachment";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAttachment> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TAttachment row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TAttachment obj = (TAttachment) cls.newInstance();
            TAttachmentPeer.populateObject(row, offset, obj);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAttachment> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAttachment> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAttachment> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TAttachment> results = new ArrayList<TAttachment>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TAttachmentPeer.row2Object(row, 1,
                TAttachmentPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAttachment> doSelect(TAttachment obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TAttachment obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TAttachment obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TAttachment obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TAttachment) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TAttachment obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TAttachment) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TAttachment obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TAttachment) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TAttachment obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TAttachment obj )
    {
    ...
    public static Criteria buildSelectCriteria( TAttachment obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TAttachment retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TAttachment retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TAttachment retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TAttachment retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TAttachment retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TAttachment> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAttachment> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TAttachment> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAttachment> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TAttachment> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TAttachment>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TAttachment objects pre-filled with their
     * TWorkItem objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TAttachmentPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TAttachment> doSelectJoinTWorkItem(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TAttachment> doSelectJoinTWorkItem(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TAttachmentPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TWorkItemPeer.addSelectColumns(criteria);

        criteria.addJoin(TAttachmentPeer.WORKITEM,
        ...
        List<TAttachment> results = new ArrayList<TAttachment>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TAttachmentPeer.getOMClass();
            TAttachment obj1 = (TAttachment) TAttachmentPeer
            ...
            {
                TAttachment temp_obj1 =  results.get(j);
                TWorkItem temp_obj2 = (TWorkItem) temp_obj1.getTWorkItem();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTAttachment(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTAttachments();
                obj2.addTAttachment(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TAttachment> doSelectJoinTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TAttachment> doSelectJoinTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TAttachmentPeer.CHANGEDBY,
            TPersonPeer.PKEY);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TAttachment> doSelectJoinTDocState(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TAttachment> doSelectJoinTDocState(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TAttachmentPeer.DOCUMENTSTATE,
    ...
    /**
     * selects a collection of TAttachment objects pre-filled with
     * all related objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TAttachment> doSelectJoinAllExceptTWorkItem(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TAttachment> doSelectJoinAllExceptTWorkItem(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        TPersonPeer.addSelectColumns(criteria);
        criteria.addJoin(TAttachmentPeer.CHANGEDBY, TPersonPeer.PKEY);
        int offset3 = offset2 + TPersonPeer.numColumns;

        TDocStatePeer.addSelectColumns(criteria);
        criteria.addJoin(TAttachmentPeer.DOCUMENTSTATE, TDocStatePeer.OBJECTID);
 ...
 newObject = true;
            for (int j = 0; j < results.size(); j++)
            {
                ...
                {
                    newObject = false;
                    temp_obj3.addTAttachment(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj3.initTAttachments();
                obj3.addTAttachment(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TAttachment> doSelectJoinAllExceptTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TAttachment> doSelectJoinAllExceptTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        TWorkItemPeer.addSelectColumns(criteria);
        criteria.addJoin(TAttachmentPeer.WORKITEM, TWorkItemPeer.WORKITEMKEY);
 ...
 newObject = true;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TAttachment> doSelectJoinAllExceptTDocState(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TAttachment> doSelectJoinAllExceptTDocState(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
