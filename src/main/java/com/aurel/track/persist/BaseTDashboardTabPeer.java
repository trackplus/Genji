...
/**
 */
public abstract class BaseTDashboardTabPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TDashboardTabMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TDashboardTabMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TDASHBOARDTAB";

        OBJECTID = "TDASHBOARDTAB.OBJECTID";
        NAME = "TDASHBOARDTAB.NAME";
        LABEL = "TDASHBOARDTAB.LABEL";
        DESCRIPTION = "TDASHBOARDTAB.DESCRIPTION";
        SORTORDER = "TDASHBOARDTAB.SORTORDER";
        PARENT = "TDASHBOARDTAB.PARENT";
        TPUUID = "TDASHBOARDTAB.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TDashboardTabMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TDashboardTabMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TDashboardTab";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDashboardTab> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TDashboardTab row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TDashboardTab obj = (TDashboardTab) cls.newInstance();
            TDashboardTabPeer.populateObject(row, offset, obj);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDashboardTab> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDashboardTab> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDashboardTab> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TDashboardTab> results = new ArrayList<TDashboardTab>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TDashboardTabPeer.row2Object(row, 1,
                TDashboardTabPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDashboardTab> doSelect(TDashboardTab obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TDashboardTab obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TDashboardTab obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TDashboardTab obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TDashboardTab) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TDashboardTab obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TDashboardTab) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TDashboardTab obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TDashboardTab) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TDashboardTab obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TDashboardTab obj )
    {
    ...
    public static Criteria buildSelectCriteria( TDashboardTab obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TDashboardTab retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TDashboardTab retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TDashboardTab retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TDashboardTab retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TDashboardTab retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TDashboardTab> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDashboardTab> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TDashboardTab> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDashboardTab> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TDashboardTab> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TDashboardTab>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TDashboardTab objects pre-filled with their
     * TDashboardScreen objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TDashboardTabPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TDashboardTab> doSelectJoinTDashboardScreen(Criteria criteria)
        throws TorqueException
    {
        return doSelectJoinTDashboardScreen(criteria, null);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TDashboardTab> doSelectJoinTDashboardScreen(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TDashboardTabPeer.PARENT,
            TDashboardScreenPeer.OBJECTID);
        ...
        List<TDashboardTab> results = new ArrayList<TDashboardTab>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TDashboardTabPeer.getOMClass();
            TDashboardTab obj1 = (TDashboardTab) TDashboardTabPeer
                .row2Object(row, 1, omClass);
             omClass = TDashboardScreenPeer.getOMClass();
            TDashboardScreen obj2 = (TDashboardScreen) TDashboardScreenPeer
                .row2Object(row, offset, omClass);

            boolean newObject = true;
            for (int j = 0; j < results.size(); j++)
            {
                TDashboardTab temp_obj1 =  results.get(j);
                TDashboardScreen temp_obj2 = (TDashboardScreen) temp_obj1.getTDashboardScreen();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTDashboardTab(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTDashboardTabs();
                obj2.addTDashboardTab(obj1);
            }
            results.add(obj1);
        }
        return results;
