...
/**
 */
public abstract class BaseTRoleListTypePeer
    extends BasePeer
{
    ...
    /** the column name for the PROLE field */
    public static final String PROLE;
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TRoleListType";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRoleListType> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(PROLE);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TRoleListType row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRoleListType> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRoleListType> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRoleListType> populateObjects(List<Record> records)
        throws TorqueException
    {
        ...
        for (int i = 0; i < records.size(); i++)
        {
            ...
            results.add(TRoleListTypePeer.row2Object(row, 1,
                TRoleListTypePeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRoleListType> doSelect(TRoleListType obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TRoleListType obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TRoleListType obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TRoleListType obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TRoleListType) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TRoleListType obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TRoleListType) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TRoleListType obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TRoleListType) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TRoleListType obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildSelectCriteria( TRoleListType obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TRoleListType retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TRoleListType retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TRoleListType retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TRoleListType retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TRoleListType retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TRoleListType> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRoleListType> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
    ...
    /**
     * selects a collection of TRoleListType objects pre-filled with their
     * TRole objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TRoleListTypePeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TRoleListType> doSelectJoinTRole(Criteria criteria)
        throws TorqueException
    {
        ...
        throws TorqueException
    {
        ...
        criteria.addJoin(TRoleListTypePeer.PROLE,
            TRolePeer.PKEY);
        ...
        for (int i = 0; i < rows.size(); i++)
        {
            ...
            TRoleListType obj1 = (TRoleListType) TRoleListTypePeer
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TRoleListType> doSelectJoinTListType(Criteria criteria)
        throws TorqueException
    {
        ...
        throws TorqueException
    {
        ...
        criteria.addJoin(TRoleListTypePeer.LISTTYPE,
            TListTypePeer.PKEY);
