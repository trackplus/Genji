...
/**
 */
public abstract class BaseTOptionPeer
    extends BasePeer
{
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TOption";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TOption> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TOption row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TOption obj = (TOption) cls.newInstance();
            TOptionPeer.populateObject(row, offset, obj);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TOption> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TOption> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TOption> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TOption> results = new ArrayList<TOption>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TOptionPeer.row2Object(row, 1,
                TOptionPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TOption> doSelect(TOption obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TOption obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TOption obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TOption obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TOption) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TOption obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TOption) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TOption obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TOption) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TOption obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TOption obj )
    {
    ...
    public static Criteria buildSelectCriteria( TOption obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TOption retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TOption retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TOption retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TOption retVal = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TOption retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TOption> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TOption> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TOption> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TOption> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TOption> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TOption>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TOption objects pre-filled with their
     * TList objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TOptionPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TOption> doSelectJoinTList(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TOption> doSelectJoinTList(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TOptionPeer.LIST,
            TListPeer.OBJECTID);
        ...
        for (int i = 0; i < rows.size(); i++)
        {
            ...
            TOption obj1 = (TOption) TOptionPeer
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TOption> doSelectJoinTBLOB(Criteria criteria)
        throws TorqueException
    {
        ...
        throws TorqueException
    {
        ...
        criteria.addJoin(TOptionPeer.ICONKEY,
            TBLOBPeer.OBJECTID);
