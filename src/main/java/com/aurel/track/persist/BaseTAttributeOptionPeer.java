...
/**
 */
public abstract class BaseTAttributeOptionPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TAttributeOptionMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TAttributeOptionMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the PARENTOPTION field */
    public static final String PARENTOPTION;
    /** the column name for the OPTIONNAME field */
    public static final String OPTIONNAME;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TATTRIBUTEOPTION";

        OBJECTID = "TATTRIBUTEOPTION.OBJECTID";
        ATTRIBUTEID = "TATTRIBUTEOPTION.ATTRIBUTEID";
        PARENTOPTION = "TATTRIBUTEOPTION.PARENTOPTION";
        OPTIONNAME = "TATTRIBUTEOPTION.OPTIONNAME";
        DELETED = "TATTRIBUTEOPTION.DELETED";
        SORTORDER = "TATTRIBUTEOPTION.SORTORDER";
        TPUUID = "TATTRIBUTEOPTION.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TAttributeOptionMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TAttributeOptionMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TAttributeOption";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAttributeOption> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTAttributeOptionPeer
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(PARENTOPTION);
        criteria.addSelectColumn(OPTIONNAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TAttributeOption row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TAttributeOption obj = (TAttributeOption) cls.newInstance();
            TAttributeOptionPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setParentOption(row.getValue(offset + 2).asIntegerObj());
            obj.setOptionName(row.getValue(offset + 3).asString());
            obj.setDeleted(row.getValue(offset + 4).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAttributeOption> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAttributeOption> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAttributeOption> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TAttributeOption> results = new ArrayList<TAttributeOption>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TAttributeOptionPeer.row2Object(row, 1,
                TAttributeOptionPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAttributeOption> doSelect(TAttributeOption obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TAttributeOption obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TAttributeOption obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TAttributeOption obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TAttributeOption) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TAttributeOption obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TAttributeOption) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TAttributeOption obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TAttributeOption) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TAttributeOption obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TAttributeOption obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(OBJECTID, obj.getObjectID());
        criteria.add(ATTRIBUTEID, obj.getAttributeID());
        criteria.add(PARENTOPTION, obj.getParentOption());
        criteria.add(OPTIONNAME, obj.getOptionName());
    ...
    public static Criteria buildSelectCriteria( TAttributeOption obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TAttributeOption retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TAttributeOption retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TAttributeOption retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TAttributeOption retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TAttributeOption retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TAttributeOption> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (TAttributeOption)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAttributeOption> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TAttributeOption> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TAttributeOption> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TAttributeOption> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TAttributeOption>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TAttributeOption objects pre-filled with their
     * TAttribute objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TAttributeOptionPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TAttributeOption> doSelectJoinTAttribute(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TAttributeOption> doSelectJoinTAttribute(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TAttributeOptionPeer.ATTRIBUTEID,
        ...
        List<TAttributeOption> results = new ArrayList<TAttributeOption>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TAttributeOptionPeer.getOMClass();
            TAttributeOption obj1 = (TAttributeOption) TAttributeOptionPeer
            ...
            {
                TAttributeOption temp_obj1 =  results.get(j);
                TAttribute temp_obj2 = (TAttribute) temp_obj1.getTAttribute();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTAttributeOption(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTAttributeOptions();
                obj2.addTAttributeOption(obj1);
            }
            results.add(obj1);
        }
        return results;
