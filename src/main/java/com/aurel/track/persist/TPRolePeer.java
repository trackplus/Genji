    ...
    extends com.aurel.track.persist.BaseTPRolePeer implements PRoleDAO
{
	...
	public List<TPRoleBean> loadByProjectType(Integer projectTypeID) {
    	...
    	try {
            ...
            LOGGER.error("Loading roles associated with projectType " + projectTypeID + " failed with " + e.getMessage(), e);
	...
	public Integer save(TPRoleBean pRoleBean) {
		...
		try {						
			...
			LOGGER.error("Saving of an tpRoleBean failed with " + e.getMessage(), e);
			return null;
		}	
	}
