 ...
 * extended all references should be to TClass
 */
public abstract class BaseTClass extends TpBaseObject
{
    /** The Peer class */
    private static final TClassPeer peer =
        new TClassPeer();
     ...
     * Otherwise if this TClass has previously
     * been saved, it will retrieve related TWorkItems from storage.
     * If this TClass is new, it will return
     ...
     * If this collection has already been initialized with
     * an identical criteria, it returns the collection.
     * Otherwise if this TClass is new, it will return
     * an empty collection; or if this TClass has previously
     * been saved, it will retrieve related TWorkItems from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TClass.
     */
    ...
    {
        if (name.equals(TClassPeer.PKEY))
        {
            return getObjectID();
        }
        if (name.equals(TClassPeer.LABEL))
        {
            return getLabel();
        }
        if (name.equals(TClassPeer.PROJKEY))
        {
            return getProjectID();
        }
        if (name.equals(TClassPeer.TPUUID))
        {
            return getUuid();
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (TClassPeer.PKEY.equals(name))
        {
            return setByName("ObjectID", value);
        }
      if (TClassPeer.LABEL.equals(name))
        {
            return setByName("Label", value);
        }
      if (TClassPeer.PROJKEY.equals(name))
        {
            return setByName("ProjectID", value);
        }
      if (TClassPeer.TPUUID.equals(name))
        {
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    TClassPeer.doInsert((TClass) this, con);
                    setNew(false);
                }
                else
                {
                    TClassPeer.doUpdate((TClass) this, con);
                }
            }
     ...
     */
    public TClass copy(Connection con) throws TorqueException
    {
     ...
     */
    public TClass copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new TClass(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public TClass copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new TClass(), deepcopy, con);
    }
     ...
     */
    protected TClass copyInto(TClass copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected TClass copyInto(TClass copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected TClass copyInto(TClass copyObj, boolean deepcopy) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected TClass copyInto(TClass copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setObjectID(objectID);
        copyObj.setLabel(label);
        copyObj.setProjectID(projectID);
    ...
    /**
     * Creates a TClassBean with the contents of this object
     * This also creates beans for cached related objects, if they exist
     * @return a TClassBean with the contents of this object
     */
    ...
    {
        TClassBean result = (TClassBean) createdBeans.get(this);
        if (result != null ) {
            // we have already created a bean for this object, return it
            return result;
        }
        // no bean exists for this object; create a new one
        result = new TClassBean();
    ...
    /**
     * Creates an instance of TClass with the contents
     * of a TClassBean.
     * This behaviour could have also been achieved using a constructor,
     * however as this class is abstract no constructors are allowed
     * @param bean the TClassBean which contents are used to create
     *        the resulting class
     * @return an instance of TClass with the contents of bean
     */
    public static TClass createTClass(TClassBean bean)
        throws TorqueException
    {
        return createTClass(bean, new IdentityMap());
    }
    ...
    public static TClass createTClass(TClassBean bean, IdentityMap createdObjects)
        throws TorqueException
    {
        TClass result = (TClass) createdObjects.get(bean);
        if (result != null)
        {
