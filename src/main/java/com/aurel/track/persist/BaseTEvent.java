 ...
 * extended all references should be to TEvent
 */
public abstract class BaseTEvent extends TpBaseObject
{
    /** The Peer class */
    private static final TEventPeer peer =
        new TEventPeer();
    ...
    public void setEventName(String v) 
    {
        ...
        if (!ObjectUtils.equals(this.eventName, v))
        {
            this.eventName = v;
            setModified(true);
        }
    ...
    public void setEventType(Integer v) 
    {
        ...
        if (!ObjectUtils.equals(this.eventType, v))
        {
            this.eventType = v;
            setModified(true);
        }
     ...
     * @param v new value
     */
    public void setEventScript(Integer v) throws TorqueException
    {

        if (!ObjectUtils.equals(this.eventScript, v))
        {
            this.eventScript = v;
            setModified(true);
        }
    ...
    public TCLOB getTCLOB()
        throws TorqueException
    {
        if (aTCLOB == null && (!ObjectUtils.equals(this.eventScript, null)))
        {
            aTCLOB = TCLOBPeer.retrieveByPK(SimpleKey.keyFor(this.eventScript));
        }
        return aTCLOB;
    }
        ...
        throws TorqueException
    {
        if (aTCLOB == null && (!ObjectUtils.equals(this.eventScript, null)))
        {
            aTCLOB = TCLOBPeer.retrieveByPK(SimpleKey.keyFor(this.eventScript), connection);
        }
        return aTCLOB;
    }
    ...
    public void setTCLOBKey(ObjectKey key) throws TorqueException
    {
        ...
        setEventScript(new Integer(((NumberKey) key).intValue()));
    }
    ...
    {
        if (name.equals(TEventPeer.OBJECTID))
        {
            return getObjectID();
        }
        if (name.equals(TEventPeer.EVENTNAME))
        {
            return getEventName();
        }
        if (name.equals(TEventPeer.EVENTTYPE))
        {
            return getEventType();
        }
        if (name.equals(TEventPeer.PROJECTTYPE))
        {
            return getProjectType();
        }
        if (name.equals(TEventPeer.PROJECT))
        {
            return getProject();
        }
        if (name.equals(TEventPeer.EVENTSCRIPT))
        {
            return getEventScript();
        }
        if (name.equals(TEventPeer.TPUUID))
        {
            return getUuid();
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (TEventPeer.OBJECTID.equals(name))
        {
            return setByName("ObjectID", value);
        }
      if (TEventPeer.EVENTNAME.equals(name))
        {
            return setByName("EventName", value);
        }
      if (TEventPeer.EVENTTYPE.equals(name))
        {
            return setByName("EventType", value);
        }
      if (TEventPeer.PROJECTTYPE.equals(name))
        {
            return setByName("ProjectType", value);
        }
      if (TEventPeer.PROJECT.equals(name))
        {
            return setByName("Project", value);
        }
      if (TEventPeer.EVENTSCRIPT.equals(name))
        {
            return setByName("EventScript", value);
        }
      if (TEventPeer.TPUUID.equals(name))
        {
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    TEventPeer.doInsert((TEvent) this, con);
                    setNew(false);
                }
                else
                {
                    TEventPeer.doUpdate((TEvent) this, con);
                }
            }
     ...
     */
    public TEvent copy(Connection con) throws TorqueException
    {
     ...
     */
    public TEvent copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new TEvent(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public TEvent copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new TEvent(), deepcopy, con);
    }
     ...
     */
    protected TEvent copyInto(TEvent copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected TEvent copyInto(TEvent copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected TEvent copyInto(TEvent copyObj, boolean deepcopy) throws TorqueException
    {
        copyObj.setObjectID(objectID);
        copyObj.setEventName(eventName);
        copyObj.setEventType(eventType);
        copyObj.setProjectType(projectType);
        copyObj.setProject(project);
        copyObj.setEventScript(eventScript);
     ...
     * @param con the database connection to read associated objects.
     */
    protected TEvent copyInto(TEvent copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setObjectID(objectID);
        copyObj.setEventName(eventName);
        copyObj.setEventType(eventType);
    ...
    /**
     * Creates a TEventBean with the contents of this object
     * This also creates beans for cached related objects, if they exist
     * @return a TEventBean with the contents of this object
     */
     ...
     * @return a TEventBean with the contents of this object
     */
    public TEventBean getBean(IdentityMap createdBeans)
    {
        TEventBean result = (TEventBean) createdBeans.get(this);
        if (result != null ) {
            // we have already created a bean for this object, return it
            return result;
        }
        // no bean exists for this object; create a new one
        result = new TEventBean();
        createdBeans.put(this, result);

        result.setObjectID(getObjectID());
        result.setEventName(getEventName());
        result.setEventType(getEventType());
        result.setProjectType(getProjectType());
        result.setProject(getProject());
        result.setEventScript(getEventScript());
    ...
    /**
     * Creates an instance of TEvent with the contents
     * of a TEventBean.
     * This behaviour could have also been achieved using a constructor,
     * however as this class is abstract no constructors are allowed
     * @param bean the TEventBean which contents are used to create
     *        the resulting class
     * @return an instance of TEvent with the contents of bean
     */
    public static TEvent createTEvent(TEventBean bean)
        throws TorqueException
    {
        return createTEvent(bean, new IdentityMap());
    }
    ...
    public static TEvent createTEvent(TEventBean bean, IdentityMap createdObjects)
        throws TorqueException
    {
        TEvent result = (TEvent) createdObjects.get(bean);
        if (result != null)
        {
        ...
        result.setEventType(bean.getEventType());
        result.setProjectType(bean.getProjectType());
        result.setProject(bean.getProject());
        result.setEventScript(bean.getEventScript());
    ...
    public String toString()
    {
        ...
        str.append("Project = ")
           .append(getProject())
           .append("\n");
        str.append("EventScript = ")
           .append(getEventScript())
           .append("\n");
        str.append("Uuid = ")
           .append(getUuid())
           .append("\n");
