...
/**
 */
public abstract class BaseTReportParameterPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TReportParameterMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TReportParameterMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the REPORTPERSONSETTINGS field */
    public static final String REPORTPERSONSETTINGS;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TREPORTPARAMETER";

        OBJECTID = "TREPORTPARAMETER.OBJECTID";
        NAME = "TREPORTPARAMETER.NAME";
        PARAMVALUE = "TREPORTPARAMETER.PARAMVALUE";
        REPORTPERSONSETTINGS = "TREPORTPARAMETER.REPORTPERSONSETTINGS";
        TPUUID = "TREPORTPARAMETER.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TReportParameterMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TReportParameterMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TReportParameter";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TReportParameter> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTReportParameterPeer
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(REPORTPERSONSETTINGS);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TReportParameter row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TReportParameter obj = (TReportParameter) cls.newInstance();
            TReportParameterPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setReportPersonSettings(row.getValue(offset + 3).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TReportParameter> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TReportParameter> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TReportParameter> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TReportParameter> results = new ArrayList<TReportParameter>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TReportParameterPeer.row2Object(row, 1,
                TReportParameterPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TReportParameter> doSelect(TReportParameter obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TReportParameter obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TReportParameter obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TReportParameter obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TReportParameter) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TReportParameter obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TReportParameter) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TReportParameter obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TReportParameter) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TReportParameter obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TReportParameter obj )
    {
        ...
        criteria.add(REPORTPERSONSETTINGS, obj.getReportPersonSettings());
        criteria.add(TPUUID, obj.getUuid());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( TReportParameter obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TReportParameter retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TReportParameter retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TReportParameter retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TReportParameter retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TReportParameter retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TReportParameter> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (TReportParameter)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TReportParameter> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TReportParameter> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TReportParameter> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TReportParameter> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TReportParameter>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TReportParameter objects pre-filled with their
     * TReportPersonSettings objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TReportParameterPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TReportParameter> doSelectJoinTReportPersonSettings(Criteria criteria)
        throws TorqueException
    {
        return doSelectJoinTReportPersonSettings(criteria, null);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TReportParameter> doSelectJoinTReportPersonSettings(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TReportParameterPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TReportPersonSettingsPeer.addSelectColumns(criteria);

        criteria.addJoin(TReportParameterPeer.REPORTPERSONSETTINGS,
            TReportPersonSettingsPeer.OBJECTID);
        ...
        List<TReportParameter> results = new ArrayList<TReportParameter>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TReportParameterPeer.getOMClass();
            TReportParameter obj1 = (TReportParameter) TReportParameterPeer
                .row2Object(row, 1, omClass);
             omClass = TReportPersonSettingsPeer.getOMClass();
            TReportPersonSettings obj2 = (TReportPersonSettings) TReportPersonSettingsPeer
                .row2Object(row, offset, omClass);

            boolean newObject = true;
            for (int j = 0; j < results.size(); j++)
            {
                TReportParameter temp_obj1 =  results.get(j);
                TReportPersonSettings temp_obj2 = (TReportPersonSettings) temp_obj1.getTReportPersonSettings();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTReportParameter(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTReportParameters();
                obj2.addTReportParameter(obj1);
            }
            results.add(obj1);
        }
        return results;
