 ...
 *
 */
public abstract class BaseTRevisionPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TRevisionMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TRevisionMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the AUTHORNAME field */
    ...
    /** the column name for the REVISIONDATE field */
    public static final String REVISIONDATE;
    /** the column name for the REVISIONNUMBR field */
    public static final String REVISIONNUMBR;
    /** the column name for the REPOSITORYKEY field */
    public static final String REPOSITORYKEY;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TREVISION";

        OBJECTID = "TREVISION.OBJECTID";
        FILENAME = "TREVISION.FILENAME";
        AUTHORNAME = "TREVISION.AUTHORNAME";
        CHANGEDESCRIPTION = "TREVISION.CHANGEDESCRIPTION";
        REVISIONDATE = "TREVISION.REVISIONDATE";
        REVISIONNUMBR = "TREVISION.REVISIONNUMBR";
        REPOSITORYKEY = "TREVISION.REPOSITORYKEY";
        TPUUID = "TREVISION.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TRevisionMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TRevisionMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TRevision";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRevision> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(AUTHORNAME);
        criteria.addSelectColumn(CHANGEDESCRIPTION);
        criteria.addSelectColumn(REVISIONDATE);
        criteria.addSelectColumn(REVISIONNUMBR);
        criteria.addSelectColumn(REPOSITORYKEY);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TRevision row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TRevision obj = (TRevision) cls.newInstance();
            TRevisionPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setAuthorName(row.getValue(offset + 2).asString());
            obj.setChangeDescription(row.getValue(offset + 3).asString());
            obj.setRevisionDate(row.getValue(offset + 4).asUtilDate());
            obj.setRevisionNumber(row.getValue(offset + 5).asString());
            obj.setRepositoryKey(row.getValue(offset + 6).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRevision> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRevision> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRevision> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TRevision> results = new ArrayList<TRevision>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TRevisionPeer.row2Object(row, 1,
                TRevisionPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRevision> doSelect(TRevision obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TRevision obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TRevision obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TRevision obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TRevision) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TRevision obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TRevision) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TRevision obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TRevision) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TRevision obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TRevision obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(OBJECTID, obj.getObjectID());
        criteria.add(FILENAME, obj.getFileName());
        criteria.add(AUTHORNAME, obj.getAuthorName());
        criteria.add(CHANGEDESCRIPTION, obj.getChangeDescription());
        criteria.add(REVISIONDATE, obj.getRevisionDate());
        criteria.add(REVISIONNUMBR, obj.getRevisionNumber());
        criteria.add(REPOSITORYKEY, obj.getRepositoryKey());
        criteria.add(TPUUID, obj.getUuid());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( TRevision obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TRevision retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TRevision retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TRevision retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TRevision retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TRevision retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TRevision> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRevision> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TRevision> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRevision> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TRevision> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TRevision>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TRevision objects pre-filled with their
     * TRepository objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TRevisionPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TRevision> doSelectJoinTRepository(Criteria criteria)
        throws TorqueException
    {
        return doSelectJoinTRepository(criteria, null);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TRevision> doSelectJoinTRepository(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TRevisionPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TRepositoryPeer.addSelectColumns(criteria);

        criteria.addJoin(TRevisionPeer.REPOSITORYKEY,
            TRepositoryPeer.OBJECTID);
        ...
        List<TRevision> results = new ArrayList<TRevision>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TRevisionPeer.getOMClass();
            TRevision obj1 = (TRevision) TRevisionPeer
                .row2Object(row, 1, omClass);
             omClass = TRepositoryPeer.getOMClass();
            TRepository obj2 = (TRepository) TRepositoryPeer
                .row2Object(row, offset, omClass);

            boolean newObject = true;
            for (int j = 0; j < results.size(); j++)
            {
                TRevision temp_obj1 =  results.get(j);
                TRepository temp_obj2 = (TRepository) temp_obj1.getTRepository();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTRevision(obj1);
                    break;
                }
            }
            if (newObject)
