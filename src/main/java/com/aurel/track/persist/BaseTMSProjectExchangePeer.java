...
/**
 */
public abstract class BaseTMSProjectExchangePeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TMSProjectExchangeMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TMSProjectExchangeMapBuilder.CLASS_NAME);
    }

    /** the column name for the OBJECTID field */
    public static final String OBJECTID;
    /** the column name for the EXCHANGEDIRECTION field */
    public static final String EXCHANGEDIRECTION;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TMSPROJECTEXCHANGE";

        OBJECTID = "TMSPROJECTEXCHANGE.OBJECTID";
        EXCHANGEDIRECTION = "TMSPROJECTEXCHANGE.EXCHANGEDIRECTION";
        ENTITYID = "TMSPROJECTEXCHANGE.ENTITYID";
        ENTITYTYPE = "TMSPROJECTEXCHANGE.ENTITYTYPE";
        FILENAME = "TMSPROJECTEXCHANGE.FILENAME";
        FILECONTENT = "TMSPROJECTEXCHANGE.FILECONTENT";
        CHANGEDBY = "TMSPROJECTEXCHANGE.CHANGEDBY";
        LASTEDIT = "TMSPROJECTEXCHANGE.LASTEDIT";
        TPUUID = "TMSPROJECTEXCHANGE.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TMSProjectExchangeMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TMSProjectExchangeMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TMSProjectExchange";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TMSProjectExchange> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTMSProjectExchangePeer
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TMSProjectExchange row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TMSProjectExchange obj = (TMSProjectExchange) cls.newInstance();
            TMSProjectExchangePeer.populateObject(row, offset, obj);
    ...
    public static void populateObject(Record row,
                                      int offset,
                                      TMSProjectExchange obj)
        throws TorqueException
    {
        try
        {
            obj.setObjectID(row.getValue(offset + 0).asIntegerObj());
            obj.setExchangeDirection(row.getValue(offset + 1).asIntegerObj());
            obj.setEntityID(row.getValue(offset + 2).asIntegerObj());
            obj.setEntityType(row.getValue(offset + 3).asIntegerObj());
            obj.setFileName(row.getValue(offset + 4).asString());
            obj.setFileContent(row.getValue(offset + 5).asString());
            obj.setChangedBy(row.getValue(offset + 6).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TMSProjectExchange> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TMSProjectExchange> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TMSProjectExchange> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TMSProjectExchange> results = new ArrayList<TMSProjectExchange>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TMSProjectExchangePeer.row2Object(row, 1,
                TMSProjectExchangePeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TMSProjectExchange> doSelect(TMSProjectExchange obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TMSProjectExchange obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TMSProjectExchange obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TMSProjectExchange obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TMSProjectExchange) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TMSProjectExchange obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TMSProjectExchange) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TMSProjectExchange obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TMSProjectExchange) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TMSProjectExchange obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildSelectCriteria( TMSProjectExchange obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TMSProjectExchange retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TMSProjectExchange retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TMSProjectExchange retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TMSProjectExchange retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TMSProjectExchange retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TMSProjectExchange> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (TMSProjectExchange)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TMSProjectExchange> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TMSProjectExchange> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TMSProjectExchange> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TMSProjectExchange> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TMSProjectExchange>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TMSProjectExchange objects pre-filled with their
     * TPerson objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TMSProjectExchangePeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TMSProjectExchange> doSelectJoinTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TMSProjectExchange> doSelectJoinTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TMSProjectExchangePeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TPersonPeer.addSelectColumns(criteria);

        criteria.addJoin(TMSProjectExchangePeer.CHANGEDBY,
            TPersonPeer.PKEY);
        ...
        List<TMSProjectExchange> results = new ArrayList<TMSProjectExchange>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TMSProjectExchangePeer.getOMClass();
            TMSProjectExchange obj1 = (TMSProjectExchange) TMSProjectExchangePeer
            ...
            {
                TMSProjectExchange temp_obj1 =  results.get(j);
                TPerson temp_obj2 = (TPerson) temp_obj1.getTPerson();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTMSProjectExchange(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTMSProjectExchanges();
                obj2.addTMSProjectExchange(obj1);
            }
            results.add(obj1);
        }
        return results;
