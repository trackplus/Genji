    ...
    implements RoleFieldDAO
{
	...
	public List<TRoleFieldBean> loadAll() {
		...
		try {
			...
			LOGGER.error("Getting all limited fields failed with " + e.getMessage(), e);
			return null;
		}
	}
	...
	public List<TRoleFieldBean> getByRole(Integer roleID) {
		...
		try {
			...
			LOGGER.error("Getting the limited fields for role " + roleID + " failed with " + e.getMessage(), e);
			return null;
		}
	}
	...
	public List<TRoleFieldBean> getRoleFieldsByKeys(List<Integer> roleFieldBeanIDs) {
		...
		try {
			...
			LOGGER.error("Getting the role fields by ids failed with " + e.getMessage(), e);
			return null;
		}
	}
	...
	public List<TRoleFieldBean> getByFields(List<Integer> fieldIDs) {
		...
		try {
			...
			LOGGER.error("Loading the roleFieldBeans by fields " + fieldIDs.size() +  " failed with " + e.getMessage(), e);
			return null;
		}
	}
