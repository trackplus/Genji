...
/**
 */
public abstract class BaseTListPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TListMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TListMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the PARENTLIST field */
    public static final String PARENTLIST;
    /** the column name for the LISTTYPE field */
    public static final String LISTTYPE;
    /** the column name for the CHILDNUMBER field */
    public static final String CHILDNUMBER;
    ...
    static
    {
        ...
        OBJECTID = "TLIST.OBJECTID";
        NAME = "TLIST.NAME";
        DESCRIPTION = "TLIST.DESCRIPTION";
        TAGLABEL = "TLIST.TAGLABEL";
        PARENTLIST = "TLIST.PARENTLIST";
        LISTTYPE = "TLIST.LISTTYPE";
        CHILDNUMBER = "TLIST.CHILDNUMBER";
        DELETED = "TLIST.DELETED";
        REPOSITORYTYPE = "TLIST.REPOSITORYTYPE";
        PROJECT = "TLIST.PROJECT";
        OWNER = "TLIST.OWNER";
        MOREPROPS = "TLIST.MOREPROPS";
        TPUUID = "TLIST.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TListMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TListMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TList> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(PARENTLIST);
        criteria.addSelectColumn(LISTTYPE);
        criteria.addSelectColumn(CHILDNUMBER);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TList row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TList obj = (TList) cls.newInstance();
            TListPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setParentList(row.getValue(offset + 4).asIntegerObj());
            obj.setListType(row.getValue(offset + 5).asIntegerObj());
            obj.setChildNumber(row.getValue(offset + 6).asIntegerObj());
            obj.setDeleted(row.getValue(offset + 7).asString());
            obj.setRepositoryType(row.getValue(offset + 8).asIntegerObj());
            obj.setProject(row.getValue(offset + 9).asIntegerObj());
            obj.setOwner(row.getValue(offset + 10).asIntegerObj());
            obj.setMoreProps(row.getValue(offset + 11).asString());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TList> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TList> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TList> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TList> results = new ArrayList<TList>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TListPeer.row2Object(row, 1,
                TListPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TList> doSelect(TList obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TList obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TList obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TList obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TList) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TList obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TList) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TList obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TList) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TList obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TList obj )
    {
        ...
        criteria.add(PARENTLIST, obj.getParentList());
        criteria.add(LISTTYPE, obj.getListType());
        criteria.add(CHILDNUMBER, obj.getChildNumber());
    ...
    public static Criteria buildSelectCriteria( TList obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TList retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TList retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TList retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TList retVal = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TList retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TList> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TList> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TList> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TList> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TList> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TList>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TList objects pre-filled with their
     * TProject objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TListPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TList> doSelectJoinTProject(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TList> doSelectJoinTProject(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TListPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TProjectPeer.addSelectColumns(criteria);

        criteria.addJoin(TListPeer.PROJECT,
            TProjectPeer.PKEY);
        ...
        for (int i = 0; i < rows.size(); i++)
        {
            ...
            Class omClass = TListPeer.getOMClass();
            TList obj1 = (TList) TListPeer
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TList> doSelectJoinTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TList> doSelectJoinTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TListPeer.OWNER,
            TPersonPeer.PKEY);
    ...
    /**
     * selects a collection of TList objects pre-filled with
     * all related objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TList> doSelectJoinAllExceptTList(Criteria criteria)
        throws TorqueException
    {
        return doSelectJoinAllExceptTList(criteria, null);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TList> doSelectJoinAllExceptTList(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        TProjectPeer.addSelectColumns(criteria);
        criteria.addJoin(TListPeer.PROJECT, TProjectPeer.PKEY);
        int offset3 = offset2 + TProjectPeer.numColumns;

        TPersonPeer.addSelectColumns(criteria);
        criteria.addJoin(TListPeer.OWNER, TPersonPeer.PKEY);
 ...
 newObject = true;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TList> doSelectJoinAllExceptTProject(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TList> doSelectJoinAllExceptTProject(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
 ...
 boolean  newObject = true;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TList> doSelectJoinAllExceptTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TList> doSelectJoinAllExceptTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
