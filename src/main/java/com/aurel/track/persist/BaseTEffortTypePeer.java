...
/**
 */
public abstract class BaseTEffortTypePeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TEffortTypeMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TEffortTypeMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the EFFORTUNIT field */
    public static final String EFFORTUNIT;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TEFFORTTYPE";

        OBJECTID = "TEFFORTTYPE.OBJECTID";
        LABEL = "TEFFORTTYPE.LABEL";
        EFFORTUNIT = "TEFFORTTYPE.EFFORTUNIT";
        DESCRIPTION = "TEFFORTTYPE.DESCRIPTION";
        TPUUID = "TEFFORTTYPE.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TEffortTypeMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TEffortTypeMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TEffortType";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEffortType> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(EFFORTUNIT);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TEffortType row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TEffortType obj = (TEffortType) cls.newInstance();
            TEffortTypePeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setEffortUnit(row.getValue(offset + 2).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEffortType> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEffortType> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEffortType> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TEffortType> results = new ArrayList<TEffortType>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TEffortTypePeer.row2Object(row, 1,
                TEffortTypePeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEffortType> doSelect(TEffortType obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TEffortType obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TEffortType obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TEffortType obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TEffortType) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TEffortType obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TEffortType) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TEffortType obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TEffortType) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TEffortType obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TEffortType obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(OBJECTID, obj.getObjectID());
        criteria.add(LABEL, obj.getLabel());
        criteria.add(EFFORTUNIT, obj.getEffortUnit());
    ...
    public static Criteria buildSelectCriteria( TEffortType obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TEffortType retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TEffortType retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TEffortType retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TEffortType retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TEffortType retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TEffortType> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEffortType> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TEffortType> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TEffortType> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TEffortType> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TEffortType>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TEffortType objects pre-filled with their
     * TEffortUnit objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TEffortTypePeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TEffortType> doSelectJoinTEffortUnit(Criteria criteria)
        throws TorqueException
    {
        return doSelectJoinTEffortUnit(criteria, null);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TEffortType> doSelectJoinTEffortUnit(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        TEffortUnitPeer.addSelectColumns(criteria);

        criteria.addJoin(TEffortTypePeer.EFFORTUNIT,
            TEffortUnitPeer.OBJECTID);
        ...
        List<TEffortType> results = new ArrayList<TEffortType>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TEffortTypePeer.getOMClass();
            TEffortType obj1 = (TEffortType) TEffortTypePeer
                .row2Object(row, 1, omClass);
             omClass = TEffortUnitPeer.getOMClass();
            TEffortUnit obj2 = (TEffortUnit) TEffortUnitPeer
                .row2Object(row, offset, omClass);

            boolean newObject = true;
            for (int j = 0; j < results.size(); j++)
            {
                TEffortType temp_obj1 =  results.get(j);
                TEffortUnit temp_obj2 = (TEffortUnit) temp_obj1.getTEffortUnit();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTEffortType(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTEffortTypes();
                obj2.addTEffortType(obj1);
            }
            results.add(obj1);
        }
        return results;
