    ...
    extends BasePeer
{
    ...
    {
        return Torque.getMapBuilder(TDashboardPanelMapBuilder.CLASS_NAME);
    }
    ...
    public static final String ROWSNO;
    /** the column name for the COLSNO field */
    public static final String COLSNO;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TDASHBOARDPANEL";

        OBJECTID = "TDASHBOARDPANEL.OBJECTID";
        NAME = "TDASHBOARDPANEL.NAME";
        LABEL = "TDASHBOARDPANEL.LABEL";
        DESCRIPTION = "TDASHBOARDPANEL.DESCRIPTION";
        SORTORDER = "TDASHBOARDPANEL.SORTORDER";
        ROWSNO = "TDASHBOARDPANEL.ROWSNO";
        COLSNO = "TDASHBOARDPANEL.COLSNO";
        PARENT = "TDASHBOARDPANEL.PARENT";
        TPUUID = "TDASHBOARDPANEL.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TDashboardPanelMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TDashboardPanelMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TDashboardPanel";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDashboardPanel> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTDashboardPanelPeer
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(ROWSNO);
        criteria.addSelectColumn(COLSNO);
        ...
        throws TorqueException
    {
        try
        {
            TDashboardPanel obj = (TDashboardPanel) cls.newInstance();
            TDashboardPanelPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setRowsNo(row.getValue(offset + 5).asIntegerObj());
            obj.setColsNo(row.getValue(offset + 6).asIntegerObj());
            obj.setParent(row.getValue(offset + 7).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDashboardPanel> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDashboardPanel> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDashboardPanel> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TDashboardPanel> results = new ArrayList<TDashboardPanel>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TDashboardPanelPeer.row2Object(row, 1,
                TDashboardPanelPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDashboardPanel> doSelect(TDashboardPanel obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TDashboardPanel obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TDashboardPanel obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TDashboardPanel obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TDashboardPanel) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TDashboardPanel obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TDashboardPanel) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TDashboardPanel obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TDashboardPanel) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TDashboardPanel obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TDashboardPanel obj )
    {
        ...
        criteria.add(ROWSNO, obj.getRowsNo());
        criteria.add(COLSNO, obj.getColsNo());
     ...
     */
    public static TDashboardPanel retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TDashboardPanel retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TDashboardPanel retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TDashboardPanel retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TDashboardPanel retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TDashboardPanel> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (TDashboardPanel)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDashboardPanel> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TDashboardPanel> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDashboardPanel> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TDashboardPanel> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TDashboardPanel>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TDashboardPanel objects pre-filled with their
     * TDashboardTab objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TDashboardPanelPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TDashboardPanel> doSelectJoinTDashboardTab(Criteria criteria)
        throws TorqueException
    {
        return doSelectJoinTDashboardTab(criteria, null);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TDashboardPanel> doSelectJoinTDashboardTab(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        TDashboardTabPeer.addSelectColumns(criteria);

        criteria.addJoin(TDashboardPanelPeer.PARENT,
            TDashboardTabPeer.OBJECTID);
        ...
        List<TDashboardPanel> results = new ArrayList<TDashboardPanel>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TDashboardPanelPeer.getOMClass();
            TDashboardPanel obj1 = (TDashboardPanel) TDashboardPanelPeer
                .row2Object(row, 1, omClass);
             omClass = TDashboardTabPeer.getOMClass();
            TDashboardTab obj2 = (TDashboardTab) TDashboardTabPeer
                .row2Object(row, offset, omClass);

            boolean newObject = true;
            for (int j = 0; j < results.size(); j++)
            {
                TDashboardPanel temp_obj1 =  results.get(j);
                TDashboardTab temp_obj2 = (TDashboardTab) temp_obj1.getTDashboardTab();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTDashboardPanel(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTDashboardPanels();
                obj2.addTDashboardPanel(obj1);
            }
            results.add(obj1);
        }
        return results;
