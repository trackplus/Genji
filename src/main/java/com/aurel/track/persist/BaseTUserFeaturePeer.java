...
/**
 */
public abstract class BaseTUserFeaturePeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TUserFeatureMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TUserFeatureMapBuilder.CLASS_NAME);
    }

    /** the column name for the OBJECTID field */
    public static final String OBJECTID;
    /** the column name for the FEATURENAME field */
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TUSERFEATURE";

        OBJECTID = "TUSERFEATURE.OBJECTID";
        FEATURENAME = "TUSERFEATURE.FEATURENAME";
        PERSON = "TUSERFEATURE.PERSON";
        ISACTIVE = "TUSERFEATURE.ISACTIVE";
        TPUUID = "TUSERFEATURE.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TUserFeatureMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TUserFeatureMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TUserFeature";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TUserFeature> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(FEATURENAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TUserFeature row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TUserFeature obj = (TUserFeature) cls.newInstance();
            TUserFeaturePeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setFeatureName(row.getValue(offset + 1).asString());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TUserFeature> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TUserFeature> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TUserFeature> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TUserFeature> results = new ArrayList<TUserFeature>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TUserFeaturePeer.row2Object(row, 1,
                TUserFeaturePeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TUserFeature> doSelect(TUserFeature obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TUserFeature obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TUserFeature obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TUserFeature obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TUserFeature) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TUserFeature obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TUserFeature) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TUserFeature obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TUserFeature) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TUserFeature obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TUserFeature obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(OBJECTID, obj.getObjectID());
        criteria.add(FEATURENAME, obj.getFeatureName());
    ...
    public static Criteria buildSelectCriteria( TUserFeature obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TUserFeature retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TUserFeature retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TUserFeature retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TUserFeature retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TUserFeature retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TUserFeature> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TUserFeature> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TUserFeature> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TUserFeature> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TUserFeature> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TUserFeature>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TUserFeature objects pre-filled with their
     * TPerson objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TUserFeaturePeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TUserFeature> doSelectJoinTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TUserFeature> doSelectJoinTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TUserFeaturePeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TPersonPeer.addSelectColumns(criteria);

        criteria.addJoin(TUserFeaturePeer.PERSON,
            TPersonPeer.PKEY);
        ...
        List<TUserFeature> results = new ArrayList<TUserFeature>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TUserFeaturePeer.getOMClass();
            TUserFeature obj1 = (TUserFeature) TUserFeaturePeer
            ...
            {
                TUserFeature temp_obj1 =  results.get(j);
                TPerson temp_obj2 = (TPerson) temp_obj1.getTPerson();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTUserFeature(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTUserFeatures();
                obj2.addTUserFeature(obj1);
            }
            results.add(obj1);
        }
        return results;
