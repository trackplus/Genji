...
/**
 */
public abstract class BaseTDashboardParameterPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TDashboardParameterMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TDashboardParameterMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the PARAMVALUE field */
    public static final String PARAMVALUE;
    /** the column name for the DASHBOARDFIELD field */
    public static final String DASHBOARDFIELD;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TDASHBOARDPARAMETER";

        OBJECTID = "TDASHBOARDPARAMETER.OBJECTID";
        NAME = "TDASHBOARDPARAMETER.NAME";
        PARAMVALUE = "TDASHBOARDPARAMETER.PARAMVALUE";
        DASHBOARDFIELD = "TDASHBOARDPARAMETER.DASHBOARDFIELD";
        TPUUID = "TDASHBOARDPARAMETER.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TDashboardParameterMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TDashboardParameterMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TDashboardParameter";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDashboardParameter> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTDashboardParameterPeer
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(PARAMVALUE);
        criteria.addSelectColumn(DASHBOARDFIELD);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TDashboardParameter row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TDashboardParameter obj = (TDashboardParameter) cls.newInstance();
            TDashboardParameterPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setParamValue(row.getValue(offset + 2).asString());
            obj.setDashboardField(row.getValue(offset + 3).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDashboardParameter> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDashboardParameter> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDashboardParameter> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TDashboardParameter> results = new ArrayList<TDashboardParameter>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TDashboardParameterPeer.row2Object(row, 1,
                TDashboardParameterPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDashboardParameter> doSelect(TDashboardParameter obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TDashboardParameter obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TDashboardParameter obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TDashboardParameter obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TDashboardParameter) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TDashboardParameter obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TDashboardParameter) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TDashboardParameter obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TDashboardParameter) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TDashboardParameter obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TDashboardParameter obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(OBJECTID, obj.getObjectID());
        criteria.add(NAME, obj.getName());
        criteria.add(PARAMVALUE, obj.getParamValue());
        criteria.add(DASHBOARDFIELD, obj.getDashboardField());
        criteria.add(TPUUID, obj.getUuid());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( TDashboardParameter obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TDashboardParameter retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TDashboardParameter retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TDashboardParameter retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TDashboardParameter retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TDashboardParameter retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TDashboardParameter> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (TDashboardParameter)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDashboardParameter> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TDashboardParameter> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TDashboardParameter> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TDashboardParameter> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TDashboardParameter>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TDashboardParameter objects pre-filled with their
     * TDashboardField objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TDashboardParameterPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TDashboardParameter> doSelectJoinTDashboardField(Criteria criteria)
        throws TorqueException
    {
        return doSelectJoinTDashboardField(criteria, null);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TDashboardParameter> doSelectJoinTDashboardField(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TDashboardParameterPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TDashboardFieldPeer.addSelectColumns(criteria);

        criteria.addJoin(TDashboardParameterPeer.DASHBOARDFIELD,
            TDashboardFieldPeer.OBJECTID);
        ...
        List<TDashboardParameter> results = new ArrayList<TDashboardParameter>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TDashboardParameterPeer.getOMClass();
            TDashboardParameter obj1 = (TDashboardParameter) TDashboardParameterPeer
                .row2Object(row, 1, omClass);
             omClass = TDashboardFieldPeer.getOMClass();
            TDashboardField obj2 = (TDashboardField) TDashboardFieldPeer
                .row2Object(row, offset, omClass);

            boolean newObject = true;
            for (int j = 0; j < results.size(); j++)
            {
                TDashboardParameter temp_obj1 =  results.get(j);
                TDashboardField temp_obj2 = (TDashboardField) temp_obj1.getTDashboardField();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTDashboardParameter(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTDashboardParameters();
                obj2.addTDashboardParameter(obj1);
            }
            results.add(obj1);
        }
        return results;
