...
/**
 */
public abstract class BaseTCostCenterPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TCostCenterMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TCostCenterMapBuilder.CLASS_NAME);
    }

    /** the column name for the OBJECTID field */
    public static final String OBJECTID;
    /** the column name for the COSTCENTERNUMBER field */
    public static final String COSTCENTERNUMBER;
    /** the column name for the COSTCENTERNAME field */
    public static final String COSTCENTERNAME;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TCOSTCENTER";

        OBJECTID = "TCOSTCENTER.OBJECTID";
        COSTCENTERNUMBER = "TCOSTCENTER.COSTCENTERNUMBER";
        COSTCENTERNAME = "TCOSTCENTER.COSTCENTERNAME";
        MOREPROPS = "TCOSTCENTER.MOREPROPS";
        TPUUID = "TCOSTCENTER.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TCostCenterMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TCostCenterMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TCostCenter";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TCostCenter> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(COSTCENTERNUMBER);
        criteria.addSelectColumn(COSTCENTERNAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TCostCenter row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TCostCenter obj = (TCostCenter) cls.newInstance();
            TCostCenterPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setCostcenterNumber(row.getValue(offset + 1).asString());
            obj.setCostcenterName(row.getValue(offset + 2).asString());
            obj.setMoreProps(row.getValue(offset + 3).asString());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TCostCenter> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TCostCenter> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TCostCenter> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TCostCenter> results = new ArrayList<TCostCenter>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TCostCenterPeer.row2Object(row, 1,
                TCostCenterPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TCostCenter> doSelect(TCostCenter obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TCostCenter obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TCostCenter obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TCostCenter obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TCostCenter) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TCostCenter obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TCostCenter) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TCostCenter obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TCostCenter) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TCostCenter obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TCostCenter obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(OBJECTID, obj.getObjectID());
        criteria.add(COSTCENTERNUMBER, obj.getCostcenterNumber());
        criteria.add(COSTCENTERNAME, obj.getCostcenterName());
    ...
    public static Criteria buildSelectCriteria( TCostCenter obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TCostCenter retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TCostCenter retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TCostCenter retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TCostCenter retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TCostCenter retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TCostCenter> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TCostCenter> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TCostCenter> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TCostCenter> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TCostCenter> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TCostCenter>();
        }
        else
        {
            Criteria criteria = new Criteria();
