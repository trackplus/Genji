...
/**
 */
public abstract class BaseTWorkflowStationPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TWorkflowStationMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TWorkflowStationMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the NODEX field */
    public static final String NODEX;
    /** the column name for the NODEY field */
    public static final String NODEY;
    /** the column name for the STATIONTYPE field */
    public static final String STATIONTYPE;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TWORKFLOWSTATION";

        OBJECTID = "TWORKFLOWSTATION.OBJECTID";
        NAME = "TWORKFLOWSTATION.NAME";
        STATUS = "TWORKFLOWSTATION.STATUS";
        WORKFLOW = "TWORKFLOWSTATION.WORKFLOW";
        NODEX = "TWORKFLOWSTATION.NODEX";
        NODEY = "TWORKFLOWSTATION.NODEY";
        STATIONTYPE = "TWORKFLOWSTATION.STATIONTYPE";
        TPUUID = "TWORKFLOWSTATION.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TWorkflowStationMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TWorkflowStationMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TWorkflowStation";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkflowStation> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTWorkflowStationPeer
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(NODEX);
        criteria.addSelectColumn(NODEY);
        criteria.addSelectColumn(STATIONTYPE);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TWorkflowStation row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TWorkflowStation obj = (TWorkflowStation) cls.newInstance();
            TWorkflowStationPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setStatus(row.getValue(offset + 2).asIntegerObj());
            obj.setWorkflow(row.getValue(offset + 3).asIntegerObj());
            obj.setNodeX(row.getValue(offset + 4).asIntegerObj());
            obj.setNodeY(row.getValue(offset + 5).asIntegerObj());
            obj.setStationType(row.getValue(offset + 6).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkflowStation> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkflowStation> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkflowStation> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TWorkflowStation> results = new ArrayList<TWorkflowStation>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TWorkflowStationPeer.row2Object(row, 1,
                TWorkflowStationPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkflowStation> doSelect(TWorkflowStation obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TWorkflowStation obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TWorkflowStation obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TWorkflowStation obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TWorkflowStation) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TWorkflowStation obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TWorkflowStation) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TWorkflowStation obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TWorkflowStation) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TWorkflowStation obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TWorkflowStation obj )
    {
        ...
        criteria.add(NODEX, obj.getNodeX());
        criteria.add(NODEY, obj.getNodeY());
        criteria.add(STATIONTYPE, obj.getStationType());
        criteria.add(TPUUID, obj.getUuid());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( TWorkflowStation obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TWorkflowStation retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TWorkflowStation retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TWorkflowStation retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TWorkflowStation retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TWorkflowStation retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TWorkflowStation> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (TWorkflowStation)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkflowStation> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TWorkflowStation> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkflowStation> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TWorkflowStation> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TWorkflowStation>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TWorkflowStation objects pre-filled with their
     * TState objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TWorkflowStationPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TWorkflowStation> doSelectJoinTState(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TWorkflowStation> doSelectJoinTState(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TWorkflowStationPeer.STATUS,
            TStatePeer.PKEY);
        ...
        List<TWorkflowStation> results = new ArrayList<TWorkflowStation>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TWorkflowStationPeer.getOMClass();
            TWorkflowStation obj1 = (TWorkflowStation) TWorkflowStationPeer
            ...
            {
                TWorkflowStation temp_obj1 =  results.get(j);
                TState temp_obj2 = (TState) temp_obj1.getTState();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTWorkflowStation(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTWorkflowStations();
                obj2.addTWorkflowStation(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TWorkflowStation> doSelectJoinTWorkflowDef(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TWorkflowStation> doSelectJoinTWorkflowDef(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TWorkflowStationPeer.WORKFLOW,
