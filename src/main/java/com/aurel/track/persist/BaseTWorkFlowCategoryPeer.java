...
/**
 */
public abstract class BaseTWorkFlowCategoryPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TWorkFlowCategoryMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TWorkFlowCategoryMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TWORKFLOWCATEGORY";

        OBJECTID = "TWORKFLOWCATEGORY.OBJECTID";
        WORKFLOW = "TWORKFLOWCATEGORY.WORKFLOW";
        CATEGORY = "TWORKFLOWCATEGORY.CATEGORY";
        TPUUID = "TWORKFLOWCATEGORY.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TWorkFlowCategoryMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TWorkFlowCategoryMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TWorkFlowCategory";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkFlowCategory> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTWorkFlowCategoryPeer
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TWorkFlowCategory row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TWorkFlowCategory obj = (TWorkFlowCategory) cls.newInstance();
            TWorkFlowCategoryPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setCategory(row.getValue(offset + 2).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkFlowCategory> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkFlowCategory> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkFlowCategory> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TWorkFlowCategory> results = new ArrayList<TWorkFlowCategory>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TWorkFlowCategoryPeer.row2Object(row, 1,
                TWorkFlowCategoryPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkFlowCategory> doSelect(TWorkFlowCategory obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TWorkFlowCategory obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TWorkFlowCategory obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TWorkFlowCategory obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TWorkFlowCategory) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TWorkFlowCategory obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TWorkFlowCategory) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TWorkFlowCategory obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TWorkFlowCategory) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TWorkFlowCategory obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TWorkFlowCategory obj )
    {
    ...
    public static Criteria buildSelectCriteria( TWorkFlowCategory obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TWorkFlowCategory retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TWorkFlowCategory retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TWorkFlowCategory retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TWorkFlowCategory retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TWorkFlowCategory retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TWorkFlowCategory> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (TWorkFlowCategory)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkFlowCategory> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TWorkFlowCategory> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkFlowCategory> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TWorkFlowCategory> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TWorkFlowCategory>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TWorkFlowCategory objects pre-filled with their
     * TWorkFlow objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TWorkFlowCategoryPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TWorkFlowCategory> doSelectJoinTWorkFlow(Criteria criteria)
        throws TorqueException
    {
        return doSelectJoinTWorkFlow(criteria, null);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TWorkFlowCategory> doSelectJoinTWorkFlow(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TWorkFlowCategoryPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TWorkFlowPeer.addSelectColumns(criteria);

        criteria.addJoin(TWorkFlowCategoryPeer.WORKFLOW,
            TWorkFlowPeer.OBJECTID);
        ...
        List<TWorkFlowCategory> results = new ArrayList<TWorkFlowCategory>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TWorkFlowCategoryPeer.getOMClass();
            TWorkFlowCategory obj1 = (TWorkFlowCategory) TWorkFlowCategoryPeer
                .row2Object(row, 1, omClass);
             omClass = TWorkFlowPeer.getOMClass();
            TWorkFlow obj2 = (TWorkFlow) TWorkFlowPeer
                .row2Object(row, offset, omClass);

            boolean newObject = true;
            for (int j = 0; j < results.size(); j++)
            {
                TWorkFlowCategory temp_obj1 =  results.get(j);
                TWorkFlow temp_obj2 = (TWorkFlow) temp_obj1.getTWorkFlow();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTWorkFlowCategory(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTWorkFlowCategorys();
                obj2.addTWorkFlowCategory(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TWorkFlowCategory> doSelectJoinTListType(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TWorkFlowCategory> doSelectJoinTListType(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TWorkFlowCategoryPeer.CATEGORY,
            TListTypePeer.PKEY);
