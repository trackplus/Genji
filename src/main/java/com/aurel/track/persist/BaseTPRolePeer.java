...
/**
 */
public abstract class BaseTPRolePeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TPRoleMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TPRoleMapBuilder.CLASS_NAME);
    }
    ...
    static
    {
        ...
        OBJECTID = "TPROLE.OBJECTID";
        PROJECTTYPE = "TPROLE.PROJECTTYPE";
        ROLEKEY = "TPROLE.ROLEKEY";
        TPUUID = "TPROLE.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TPRoleMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TPRoleMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TPRole";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPRole> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TPRole row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TPRole obj = (TPRole) cls.newInstance();
            TPRolePeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setRole(row.getValue(offset + 2).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPRole> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPRole> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPRole> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TPRole> results = new ArrayList<TPRole>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TPRolePeer.row2Object(row, 1,
                TPRolePeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPRole> doSelect(TPRole obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TPRole obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TPRole obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TPRole obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TPRole) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TPRole obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TPRole) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TPRole obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TPRole) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TPRole obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TPRole obj )
    {
    ...
    public static Criteria buildSelectCriteria( TPRole obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TPRole retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TPRole retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TPRole retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TPRole retVal = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TPRole retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TPRole> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPRole> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TPRole> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TPRole> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TPRole> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TPRole>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TPRole objects pre-filled with their
     * TProjectType objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TPRolePeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPRole> doSelectJoinTProjectType(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPRole> doSelectJoinTProjectType(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TPRolePeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TProjectTypePeer.addSelectColumns(criteria);

        criteria.addJoin(TPRolePeer.PROJECTTYPE,
        ...
        List<TPRole> results = new ArrayList<TPRole>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TPRolePeer.getOMClass();
            TPRole obj1 = (TPRole) TPRolePeer
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPRole> doSelectJoinTRole(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TPRole> doSelectJoinTRole(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TPRolePeer.ROLEKEY,
            TRolePeer.PKEY);
