...
/**
 */
public abstract class BaseTWorkItemLockPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TWorkItemLockMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TWorkItemLockMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the HTTPSESSION field */
    public static final String HTTPSESSION;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TWORKITEMLOCK";

        WORKITEM = "TWORKITEMLOCK.WORKITEM";
        PERSON = "TWORKITEMLOCK.PERSON";
        HTTPSESSION = "TWORKITEMLOCK.HTTPSESSION";
        TPUUID = "TWORKITEMLOCK.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TWorkItemLockMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TWorkItemLockMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TWorkItemLock";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkItemLock> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(HTTPSESSION);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TWorkItemLock row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TWorkItemLock obj = (TWorkItemLock) cls.newInstance();
            TWorkItemLockPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            obj.setWorkItem(row.getValue(offset + 0).asIntegerObj());
            obj.setPerson(row.getValue(offset + 1).asIntegerObj());
            obj.setHttpSession(row.getValue(offset + 2).asString());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkItemLock> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkItemLock> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkItemLock> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TWorkItemLock> results = new ArrayList<TWorkItemLock>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TWorkItemLockPeer.row2Object(row, 1,
                TWorkItemLockPeer.getOMClass()));
        }
        return results;
    }
        ...
        throws TorqueException
    {
        ...
        correctBooleans(criteria);
         ...
         selectCriteria.put(WORKITEM, criteria.remove(WORKITEM));
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkItemLock> doSelect(TWorkItemLock obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TWorkItemLock obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TWorkItemLock obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TWorkItemLock obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TWorkItemLock) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TWorkItemLock obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TWorkItemLock) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TWorkItemLock obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TWorkItemLock) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TWorkItemLock obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( ObjectKey pk )
    {
        Criteria criteria = new Criteria();
            criteria.add(WORKITEM, pk);
        return criteria;
     }

    /** Build a Criteria object from the data object for this peer */
    public static Criteria buildCriteria( TWorkItemLock obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        criteria.add(WORKITEM, obj.getWorkItem());
        criteria.add(PERSON, obj.getPerson());
        criteria.add(HTTPSESSION, obj.getHttpSession());
        criteria.add(TPUUID, obj.getUuid());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( TWorkItemLock obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
            criteria.add(WORKITEM, obj.getWorkItem());
            criteria.add(PERSON, obj.getPerson());
     ...
     */
    public static TWorkItemLock retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TWorkItemLock retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TWorkItemLock retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TWorkItemLock retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TWorkItemLock retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TWorkItemLock> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkItemLock> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TWorkItemLock> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkItemLock> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TWorkItemLock> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TWorkItemLock>();
        }
        else
        {
            Criteria criteria = new Criteria();
            criteria.addIn( WORKITEM, pks );
    ...
    /**
     * selects a collection of TWorkItemLock objects pre-filled with their
     * TWorkItem objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TWorkItemLockPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TWorkItemLock> doSelectJoinTWorkItem(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TWorkItemLock> doSelectJoinTWorkItem(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TWorkItemLockPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TWorkItemPeer.addSelectColumns(criteria);

        criteria.addJoin(TWorkItemLockPeer.WORKITEM,
        ...
        List<TWorkItemLock> results = new ArrayList<TWorkItemLock>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TWorkItemLockPeer.getOMClass();
            TWorkItemLock obj1 = (TWorkItemLock) TWorkItemLockPeer
            ...
            {
                TWorkItemLock temp_obj1 =  results.get(j);
                TWorkItem temp_obj2 = (TWorkItem) temp_obj1.getTWorkItem();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTWorkItemLock(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTWorkItemLocks();
                obj2.addTWorkItemLock(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TWorkItemLock> doSelectJoinTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TWorkItemLock> doSelectJoinTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TWorkItemLockPeer.PERSON,
            TPersonPeer.PKEY);
