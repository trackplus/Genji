 ...
 *
 */
public abstract class BaseTLastVisitedItemPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TLastVisitedItemMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TLastVisitedItemMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the LASTVISITEDDATE field */
    public static final String LASTVISITEDDATE;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TLASTVISITEDITEM";

        OBJECTID = "TLASTVISITEDITEM.OBJECTID";
        WORKITEM = "TLASTVISITEDITEM.WORKITEM";
        PERSON = "TLASTVISITEDITEM.PERSON";
        LASTVISITEDDATE = "TLASTVISITEDITEM.LASTVISITEDDATE";
        TPUUID = "TLASTVISITEDITEM.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TLastVisitedItemMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TLastVisitedItemMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TLastVisitedItem";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TLastVisitedItem> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTLastVisitedItemPeer
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(LASTVISITEDDATE);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TLastVisitedItem row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TLastVisitedItem obj = (TLastVisitedItem) cls.newInstance();
            TLastVisitedItemPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setLastVisitedDate(row.getValue(offset + 3).asUtilDate());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TLastVisitedItem> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TLastVisitedItem> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TLastVisitedItem> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TLastVisitedItem> results = new ArrayList<TLastVisitedItem>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TLastVisitedItemPeer.row2Object(row, 1,
                TLastVisitedItemPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TLastVisitedItem> doSelect(TLastVisitedItem obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TLastVisitedItem obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TLastVisitedItem obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TLastVisitedItem obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TLastVisitedItem) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TLastVisitedItem obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TLastVisitedItem) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TLastVisitedItem obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TLastVisitedItem) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TLastVisitedItem obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TLastVisitedItem obj )
    {
        ...
        criteria.add(LASTVISITEDDATE, obj.getLastVisitedDate());
        criteria.add(TPUUID, obj.getUuid());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( TLastVisitedItem obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TLastVisitedItem retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TLastVisitedItem retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TLastVisitedItem retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TLastVisitedItem retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TLastVisitedItem retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TLastVisitedItem> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (TLastVisitedItem)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TLastVisitedItem> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TLastVisitedItem> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TLastVisitedItem> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TLastVisitedItem> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TLastVisitedItem>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TLastVisitedItem objects pre-filled with their
     * TWorkItem objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TLastVisitedItemPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TLastVisitedItem> doSelectJoinTWorkItem(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TLastVisitedItem> doSelectJoinTWorkItem(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TLastVisitedItemPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TWorkItemPeer.addSelectColumns(criteria);

        criteria.addJoin(TLastVisitedItemPeer.WORKITEM,
        ...
        List<TLastVisitedItem> results = new ArrayList<TLastVisitedItem>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TLastVisitedItemPeer.getOMClass();
            TLastVisitedItem obj1 = (TLastVisitedItem) TLastVisitedItemPeer
            ...
            {
                TLastVisitedItem temp_obj1 =  results.get(j);
                TWorkItem temp_obj2 = (TWorkItem) temp_obj1.getTWorkItem();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTLastVisitedItem(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTLastVisitedItems();
                obj2.addTLastVisitedItem(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TLastVisitedItem> doSelectJoinTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TLastVisitedItem> doSelectJoinTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TLastVisitedItemPeer.PERSON,
            TPersonPeer.PKEY);
