...
/**
 */
public abstract class BaseTGroupMemberPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TGroupMemberMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TGroupMemberMapBuilder.CLASS_NAME);
    }

    /** the column name for the OBJECTID field */
    public static final String OBJECTID;
    /** the column name for the THEGROUP field */
    public static final String THEGROUP;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TGROUPMEMBER";

        OBJECTID = "TGROUPMEMBER.OBJECTID";
        THEGROUP = "TGROUPMEMBER.THEGROUP";
        PERSON = "TGROUPMEMBER.PERSON";
        TPUUID = "TGROUPMEMBER.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TGroupMemberMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TGroupMemberMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TGroupMember";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TGroupMember> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TGroupMember row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TGroupMember obj = (TGroupMember) cls.newInstance();
            TGroupMemberPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setTheGroup(row.getValue(offset + 1).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TGroupMember> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TGroupMember> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TGroupMember> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TGroupMember> results = new ArrayList<TGroupMember>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TGroupMemberPeer.row2Object(row, 1,
                TGroupMemberPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TGroupMember> doSelect(TGroupMember obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TGroupMember obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TGroupMember obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TGroupMember obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TGroupMember) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TGroupMember obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TGroupMember) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TGroupMember obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TGroupMember) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TGroupMember obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TGroupMember obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(OBJECTID, obj.getObjectId());
        criteria.add(THEGROUP, obj.getTheGroup());
    ...
    public static Criteria buildSelectCriteria( TGroupMember obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TGroupMember retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TGroupMember retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TGroupMember retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TGroupMember retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TGroupMember retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TGroupMember> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TGroupMember> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TGroupMember> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TGroupMember> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TGroupMember> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TGroupMember>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TGroupMember objects pre-filled with their
     * TPerson objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TGroupMemberPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TGroupMember> doSelectJoinTPersonRelatedByTheGroup(Criteria criteria)
        throws TorqueException
    {
        return doSelectJoinTPersonRelatedByTheGroup(criteria, null);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TGroupMember> doSelectJoinTPersonRelatedByTheGroup(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TGroupMemberPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TPersonPeer.addSelectColumns(criteria);

        criteria.addJoin(TGroupMemberPeer.THEGROUP,
            TPersonPeer.PKEY);
        ...
        List<TGroupMember> results = new ArrayList<TGroupMember>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TGroupMemberPeer.getOMClass();
            TGroupMember obj1 = (TGroupMember) TGroupMemberPeer
            ...
            {
                TGroupMember temp_obj1 =  results.get(j);
                TPerson temp_obj2 = (TPerson) temp_obj1.getTPersonRelatedByTheGroup();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTGroupMemberRelatedByTheGroup(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTGroupMembersRelatedByTheGroup();
                obj2.addTGroupMemberRelatedByTheGroup(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TGroupMember> doSelectJoinTPersonRelatedByPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TGroupMember> doSelectJoinTPersonRelatedByPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TGroupMemberPeer.PERSON,
            TPersonPeer.PKEY);
        ...
        for (int i = 0; i < rows.size(); i++)
        {
            ...
            for (int j = 0; j < results.size(); j++)
            {
                ...
                {
                    newObject = false;
                    temp_obj2.addTGroupMemberRelatedByPerson(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTGroupMembersRelatedByPerson();
                obj2.addTGroupMemberRelatedByPerson(obj1);
            }
            results.add(obj1);
        }
        return results;
