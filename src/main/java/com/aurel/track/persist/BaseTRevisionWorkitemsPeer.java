 ...
 *
 */
public abstract class BaseTRevisionWorkitemsPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TRevisionWorkitemsMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TRevisionWorkitemsMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the REVISIONKEY field */
    public static final String REVISIONKEY;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TREVISIONWORKITEMS";

        OBJECTID = "TREVISIONWORKITEMS.OBJECTID";
        WORKITEMKEY = "TREVISIONWORKITEMS.WORKITEMKEY";
        REVISIONKEY = "TREVISIONWORKITEMS.REVISIONKEY";
        TPUUID = "TREVISIONWORKITEMS.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TRevisionWorkitemsMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TRevisionWorkitemsMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TRevisionWorkitems";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRevisionWorkitems> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTRevisionWorkitemsPeer
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(REVISIONKEY);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TRevisionWorkitems row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TRevisionWorkitems obj = (TRevisionWorkitems) cls.newInstance();
            TRevisionWorkitemsPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setRevisionKey(row.getValue(offset + 2).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRevisionWorkitems> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRevisionWorkitems> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRevisionWorkitems> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TRevisionWorkitems> results = new ArrayList<TRevisionWorkitems>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TRevisionWorkitemsPeer.row2Object(row, 1,
                TRevisionWorkitemsPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRevisionWorkitems> doSelect(TRevisionWorkitems obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TRevisionWorkitems obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TRevisionWorkitems obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TRevisionWorkitems obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TRevisionWorkitems) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TRevisionWorkitems obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TRevisionWorkitems) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TRevisionWorkitems obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TRevisionWorkitems) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TRevisionWorkitems obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TRevisionWorkitems obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(OBJECTID, obj.getObjectID());
        criteria.add(WORKITEMKEY, obj.getWorkItemID());
        criteria.add(REVISIONKEY, obj.getRevisionKey());
        criteria.add(TPUUID, obj.getUuid());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( TRevisionWorkitems obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TRevisionWorkitems retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TRevisionWorkitems retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TRevisionWorkitems retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TRevisionWorkitems retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TRevisionWorkitems retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TRevisionWorkitems> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (TRevisionWorkitems)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRevisionWorkitems> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TRevisionWorkitems> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TRevisionWorkitems> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TRevisionWorkitems> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TRevisionWorkitems>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TRevisionWorkitems objects pre-filled with their
     * TRevision objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TRevisionWorkitemsPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TRevisionWorkitems> doSelectJoinTRevision(Criteria criteria)
        throws TorqueException
    {
        return doSelectJoinTRevision(criteria, null);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TRevisionWorkitems> doSelectJoinTRevision(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TRevisionWorkitemsPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TRevisionPeer.addSelectColumns(criteria);

        criteria.addJoin(TRevisionWorkitemsPeer.REVISIONKEY,
            TRevisionPeer.OBJECTID);
        ...
        List<TRevisionWorkitems> results = new ArrayList<TRevisionWorkitems>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TRevisionWorkitemsPeer.getOMClass();
            TRevisionWorkitems obj1 = (TRevisionWorkitems) TRevisionWorkitemsPeer
                .row2Object(row, 1, omClass);
             omClass = TRevisionPeer.getOMClass();
            TRevision obj2 = (TRevision) TRevisionPeer
                .row2Object(row, offset, omClass);

            boolean newObject = true;
            for (int j = 0; j < results.size(); j++)
            {
                TRevisionWorkitems temp_obj1 =  results.get(j);
                TRevision temp_obj2 = (TRevision) temp_obj1.getTRevision();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTRevisionWorkitems(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTRevisionWorkitemss();
                obj2.addTRevisionWorkitems(obj1);
            }
            results.add(obj1);
        }
        return results;
