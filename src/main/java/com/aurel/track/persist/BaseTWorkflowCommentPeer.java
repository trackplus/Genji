...
/**
 */
public abstract class BaseTWorkflowCommentPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TWorkflowCommentMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TWorkflowCommentMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TWORKFLOWCOMMENT";

        OBJECTID = "TWORKFLOWCOMMENT.OBJECTID";
        DESCRIPTION = "TWORKFLOWCOMMENT.DESCRIPTION";
        WORKFLOW = "TWORKFLOWCOMMENT.WORKFLOW";
        NODEX = "TWORKFLOWCOMMENT.NODEX";
        NODEY = "TWORKFLOWCOMMENT.NODEY";
        TPUUID = "TWORKFLOWCOMMENT.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TWorkflowCommentMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TWorkflowCommentMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TWorkflowComment";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkflowComment> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTWorkflowCommentPeer
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TWorkflowComment row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TWorkflowComment obj = (TWorkflowComment) cls.newInstance();
            TWorkflowCommentPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setWorkflow(row.getValue(offset + 2).asIntegerObj());
            obj.setNodeX(row.getValue(offset + 3).asIntegerObj());
            obj.setNodeY(row.getValue(offset + 4).asIntegerObj());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkflowComment> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkflowComment> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkflowComment> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TWorkflowComment> results = new ArrayList<TWorkflowComment>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TWorkflowCommentPeer.row2Object(row, 1,
                TWorkflowCommentPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkflowComment> doSelect(TWorkflowComment obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TWorkflowComment obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TWorkflowComment obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TWorkflowComment obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TWorkflowComment) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TWorkflowComment obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TWorkflowComment) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TWorkflowComment obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TWorkflowComment) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TWorkflowComment obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TWorkflowComment obj )
    {
    ...
    public static Criteria buildSelectCriteria( TWorkflowComment obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TWorkflowComment retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TWorkflowComment retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TWorkflowComment retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TWorkflowComment retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TWorkflowComment retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TWorkflowComment> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (TWorkflowComment)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkflowComment> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TWorkflowComment> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TWorkflowComment> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TWorkflowComment> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TWorkflowComment>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TWorkflowComment objects pre-filled with their
     * TWorkflowDef objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TWorkflowCommentPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TWorkflowComment> doSelectJoinTWorkflowDef(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TWorkflowComment> doSelectJoinTWorkflowDef(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        TWorkflowCommentPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        TWorkflowDefPeer.addSelectColumns(criteria);

        criteria.addJoin(TWorkflowCommentPeer.WORKFLOW,
        ...
        List<TWorkflowComment> results = new ArrayList<TWorkflowComment>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TWorkflowCommentPeer.getOMClass();
            TWorkflowComment obj1 = (TWorkflowComment) TWorkflowCommentPeer
            ...
            {
                TWorkflowComment temp_obj1 =  results.get(j);
                TWorkflowDef temp_obj2 = (TWorkflowDef) temp_obj1.getTWorkflowDef();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTWorkflowComment(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTWorkflowComments();
                obj2.addTWorkflowComment(obj1);
            }
            results.add(obj1);
        }
        return results;
