 ...
 * extended all references should be to TGeneralParam
 */
public abstract class BaseTGeneralParam extends TpBaseObject
{
    /** The Peer class */
    private static final TGeneralParamPeer peer =
        new TGeneralParamPeer();
    ...
    {
        if (name.equals(TGeneralParamPeer.OBJECTID))
        {
            return getObjectID();
        }
        if (name.equals(TGeneralParamPeer.PARAMNAME))
        {
            return getParamName();
        }
        if (name.equals(TGeneralParamPeer.PARAMVALUE))
        {
            return getParamValue();
        }
        if (name.equals(TGeneralParamPeer.TPUUID))
        {
            return getUuid();
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (TGeneralParamPeer.OBJECTID.equals(name))
        {
            return setByName("ObjectID", value);
        }
      if (TGeneralParamPeer.PARAMNAME.equals(name))
        {
            return setByName("ParamName", value);
        }
      if (TGeneralParamPeer.PARAMVALUE.equals(name))
        {
            return setByName("ParamValue", value);
        }
      if (TGeneralParamPeer.TPUUID.equals(name))
        {
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    TGeneralParamPeer.doInsert((TGeneralParam) this, con);
                    setNew(false);
                }
                else
                {
                    TGeneralParamPeer.doUpdate((TGeneralParam) this, con);
                }
            }
     ...
     */
    public TGeneralParam copy(Connection con) throws TorqueException
    {
     ...
     */
    public TGeneralParam copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new TGeneralParam(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public TGeneralParam copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new TGeneralParam(), deepcopy, con);
    }
     ...
     */
    protected TGeneralParam copyInto(TGeneralParam copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected TGeneralParam copyInto(TGeneralParam copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected TGeneralParam copyInto(TGeneralParam copyObj, boolean deepcopy) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected TGeneralParam copyInto(TGeneralParam copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setObjectID(objectID);
        copyObj.setParamName(paramName);
        copyObj.setParamValue(paramValue);
     ...
     * @return a TGeneralParamBean with the contents of this object
     */
    public TGeneralParamBean getBean(IdentityMap createdBeans)
    {
        TGeneralParamBean result = (TGeneralParamBean) createdBeans.get(this);
        if (result != null ) {
            // we have already created a bean for this object, return it
            return result;
        }
        // no bean exists for this object; create a new one
        result = new TGeneralParamBean();
     ...
     */
    public static TGeneralParam createTGeneralParam(TGeneralParamBean bean)
        throws TorqueException
    {
