...
/**
 */
public abstract class BaseTNotifyTriggerPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TNotifyTriggerMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TNotifyTriggerMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the ISSYSTEM field */
    public static final String ISSYSTEM;
    ...
    {
        DATABASE_NAME = "track";
        TABLE_NAME = "TNOTIFYTRIGGER";

        OBJECTID = "TNOTIFYTRIGGER.OBJECTID";
        LABEL = "TNOTIFYTRIGGER.LABEL";
        PERSON = "TNOTIFYTRIGGER.PERSON";
        ISSYSTEM = "TNOTIFYTRIGGER.ISSYSTEM";
        TPUUID = "TNOTIFYTRIGGER.TPUUID";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TNotifyTriggerMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TNotifyTriggerMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.aurel.track.persist.TNotifyTrigger";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TNotifyTrigger> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(ISSYSTEM);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TNotifyTrigger row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TNotifyTrigger obj = (TNotifyTrigger) cls.newInstance();
            TNotifyTriggerPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setIsSystem(row.getValue(offset + 3).asString());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TNotifyTrigger> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TNotifyTrigger> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TNotifyTrigger> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TNotifyTrigger> results = new ArrayList<TNotifyTrigger>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TNotifyTriggerPeer.row2Object(row, 1,
                TNotifyTriggerPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TNotifyTrigger> doSelect(TNotifyTrigger obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TNotifyTrigger obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TNotifyTrigger obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TNotifyTrigger obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TNotifyTrigger) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TNotifyTrigger obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TNotifyTrigger) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TNotifyTrigger obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TNotifyTrigger) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TNotifyTrigger obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TNotifyTrigger obj )
    {
        ...
        criteria.add(ISSYSTEM, obj.getIsSystem());
        criteria.add(TPUUID, obj.getUuid());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( TNotifyTrigger obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TNotifyTrigger retrieveByPK(Integer pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TNotifyTrigger retrieveByPK(Integer pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TNotifyTrigger retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TNotifyTrigger retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TNotifyTrigger retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TNotifyTrigger> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TNotifyTrigger> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TNotifyTrigger> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TNotifyTrigger> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TNotifyTrigger> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TNotifyTrigger>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of TNotifyTrigger objects pre-filled with their
     * TPerson objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TNotifyTriggerPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TNotifyTrigger> doSelectJoinTPerson(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<TNotifyTrigger> doSelectJoinTPerson(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(TNotifyTriggerPeer.PERSON,
            TPersonPeer.PKEY);
        ...
        List<TNotifyTrigger> results = new ArrayList<TNotifyTrigger>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = TNotifyTriggerPeer.getOMClass();
            TNotifyTrigger obj1 = (TNotifyTrigger) TNotifyTriggerPeer
            ...
            {
                TNotifyTrigger temp_obj1 =  results.get(j);
                TPerson temp_obj2 = (TPerson) temp_obj1.getTPerson();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addTNotifyTrigger(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initTNotifyTriggers();
                obj2.addTNotifyTrigger(obj1);
            }
            results.add(obj1);
        }
        return results;
