 ...
 *
 */
public class SeverityGrouping extends AbstractGrouping{	
	public SeverityGrouping(int projectIndex) {
		super(projectIndex);
	}

	@Override
	protected Integer getWorkItemFieldValue(TWorkItemBean itemBean) {
		return itemBean.getSeverityID();
	}
	@Override
	protected String formatKey(Integer labelBeanID) {
		return "sever"+labelBeanID+"-"+projectIndex;
	}
