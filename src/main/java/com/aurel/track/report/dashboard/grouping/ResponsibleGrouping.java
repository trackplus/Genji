...
/**
 * Group items by responsible
 * @author Adrian Bojani
 *
 */
public class ResponsibleGrouping extends AbstractGrouping{
	public ResponsibleGrouping(int projectIndex) {
		super(projectIndex);
	}

	@Override
	protected Integer getWorkItemFieldValue(TWorkItemBean itemBean) {
		return itemBean.getResponsibleID();
	}

	@Override
	protected String formatKey(Integer labelBeanID) {
		return "resp"+labelBeanID+"-"+projectIndex;
	}
	@Override
