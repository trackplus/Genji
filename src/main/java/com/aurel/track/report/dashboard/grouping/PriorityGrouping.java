 ...
 *
 */
public class PriorityGrouping extends AbstractGrouping{	
	public PriorityGrouping(int projectIndex) {
		super(projectIndex);
	}

	@Override
	protected Integer getWorkItemFieldValue(TWorkItemBean itemBean) {
		return itemBean.getPriorityID();
	}
	@Override
	protected String formatKey(Integer labelBeanID) {
		return "prio"+labelBeanID+"-"+projectIndex;
	}
