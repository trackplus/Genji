 ...
 *
 */
public class StatusGrouping extends AbstractGrouping{
	public StatusGrouping(int projectIndex) {
		super(projectIndex);
	}

	@Override
	protected Integer getWorkItemFieldValue(TWorkItemBean itemBean) {
		return itemBean.getStateID();
	}
	@Override
	protected String formatKey(Integer labelBeanID) {
		return "stat"+labelBeanID+"-"+projectIndex;
	}
