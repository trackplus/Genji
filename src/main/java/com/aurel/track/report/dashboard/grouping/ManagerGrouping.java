 ...
 *
 */
public class ManagerGrouping extends AbstractGrouping{
	public ManagerGrouping(int projectIndex) {
		super(projectIndex);
	}

	@Override
	protected Integer getWorkItemFieldValue(TWorkItemBean itemBean) {
		return itemBean.getOwnerID();
	}

	@Override
	protected String formatKey(Integer labelBeanID) {
		return "man"+labelBeanID+"-"+projectIndex;
	}
