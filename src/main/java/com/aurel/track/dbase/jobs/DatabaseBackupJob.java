...
public class DatabaseBackupJob implements Job {
	...
	public void execute(JobExecutionContext context) {
		...
		if(!ApplicationBean.getApplicationBean().getSiteBean().getIsDatabaseBackupJobOn()){
    	...
    	// Properties torqueProperties = new Properties();
		PropertiesConfiguration tcfg = null;
		try {
			tcfg = ApplicationBean.getApplicationBean().getDbConfig();
		}
		catch (Exception e) {
			LOGGER.error(e.getMessage(), e);
		}
		...
		Boolean includeAttachments = ApplicationBean.getApplicationBean().getSiteBean().getIncludeAttachments();
		...
		Integer backupNumber = ApplicationBean.getApplicationBean().getSiteBean().getNoOfBackups();
