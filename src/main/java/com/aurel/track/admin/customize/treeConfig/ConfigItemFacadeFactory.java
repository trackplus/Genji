...
public class ConfigItemFacadeFactory {
	 ...
	 * @return
	 */
	public ConfigItemFacade getConfigItemFacade(String configType){
		if(configType.equals(TreeConfigBL.SCREEN_CONFIG)){
			return ScreenConfigItemFacade.getInstance();
		}
		if(configType.equals(TreeConfigBL.FIELD_CONFIG)){
			return FieldConfigItemFacade.getInstance();
		}
		if(configType.equals(TreeConfigBL.MAIL_TEMPLATE_CONFIG)){
