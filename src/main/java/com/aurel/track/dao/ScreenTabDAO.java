...
public interface ScreenTabDAO {
	 ...
	 * @return
	 */
	TScreenTabBean loadByPrimaryKey(Integer objectID);
	TScreenTabBean loadFullByPrimaryKey(Integer objectID);
	
	/**
	 * Loads all tabs from TScreenTab table 
	 * @return 
	 */
	List<TScreenTabBean> loadAll();
	 ...
	 * @return
	 */
	Integer save(TScreenTabBean screenTab);
	 ...
	 * @return 
	 */
	List<TScreenTabBean> loadByParent(Integer parentID);
}
