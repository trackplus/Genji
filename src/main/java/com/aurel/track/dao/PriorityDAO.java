 ...
 */public interface PriorityDAO {
	 ...
	 * @return
	 */
	TPriorityBean loadByPrimaryKey(Integer objectID);
	 ...
	 * @return
	 */
	List<TPriorityBean> loadByLabel(String label);
	 ...
	 * @param priorityIDs
	 */
	List<TPriorityBean> loadByPriorityIDs(List<Integer> priorityIDs);
	 ...
	 * @return
	 */
	List<TPriorityBean> loadByProjectAndIssueType(Integer projectID, 
			Integer issueType);
	 ...
	 * @return
	 */
	Integer save(TPriorityBean priorityBean);
	...
	/**
	 * Replaces the dependences with a newPriorityID and 
	 * deletes the oldPriorityID from the TPriority table 
	 * @param oldPriorityID
	 * @param newPriorityID
	 */
