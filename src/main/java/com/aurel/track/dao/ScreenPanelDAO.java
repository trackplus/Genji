...
public interface ScreenPanelDAO {
	 ...
	 * @return
	 */
	TScreenPanelBean loadByPrimaryKey(Integer objectID);
	
	TScreenPanelBean loadFullByPrimaryKey(Integer objectID);
	 ...
	 * @return
	 */
	Integer save(TScreenPanelBean screenPanel);
	 ...
	 * @return 
	 */
	List<TScreenPanelBean> loadByParent(Integer parentID);
}
