...
public interface DashboardPanelDAO {
	 ...
	 * @return
	 */
	TDashboardPanelBean loadByPrimaryKey(Integer objectID);
	TDashboardPanelBean loadFullByPrimaryKey(Integer objectID);
	 ...
	 * @return
	 */
	Integer save(TDashboardPanelBean screenPanel);
