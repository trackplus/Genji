...
public interface CostCenterDAO {
     ...
     * @return
     */
    TCostCenterBean loadByPrimaryKey(Integer objectID);
     ...
     * @return
     */
    List<TCostCenterBean> loadByNumber(String number);
    
	/**
	 * Gets all costcenters
	 * @return
	 */
    List<TCostCenterBean> loadAll();
	 ...
	 * @return
	 */
	Integer save(TCostCenterBean costCenterBean);
