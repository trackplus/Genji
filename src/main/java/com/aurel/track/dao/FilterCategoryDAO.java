...
public interface FilterCategoryDAO {
	 ...
	 * @return
	 */
	TFilterCategoryBean loadByPrimaryKey(Integer objectID);
	 ...
	 * @return
	 */
	List<TFilterCategoryBean> loadByKeys(List<Integer> categoryIDs);
	 ...
	 * @return
	 */
	List<TFilterCategoryBean> loadByLabel(Integer repository, Integer filterType,
	 ...
	 * @return
	 */
	List<TFilterCategoryBean> loadRootCategories(Integer repository, 
	 ...
	 * @return
	 */
	List<TFilterCategoryBean> loadProjectRootCategories(List<Integer> projectIDs, Integer filterType);
	 ...
	 * @return
	 */
	/*List<TFilterCategoryBean> loadByRepositoryPersonProjects(
	 ...
	 * @return
	 */
	List<TFilterCategoryBean> loadByParent(Integer parentID);
	 ...
	 * @return
	 */
	List<TFilterCategoryBean> loadByParents(List<Integer> parentIDs);			
	 ...
	 * @return
	 */
	Integer save(TFilterCategoryBean filterCategoryBean);
