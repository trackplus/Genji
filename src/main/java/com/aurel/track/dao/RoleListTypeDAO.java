...
public interface RoleListTypeDAO {
	 ...
	 * @return
	 */
	List<TRoleListTypeBean> loadByRole(Integer roleID);
	 ...
	 * @return
	 */
	List<TRoleListTypeBean> loadByRoles(List<Integer> roleIDs);
	 ...
	 * @return
	 */
	List<TRoleListTypeBean> loadByRolesAndListType(Object[] roleIDs, Integer listType);
	 ...
	 */
	Integer save(TRoleListTypeBean roleListTypebean);
