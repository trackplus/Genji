...
package com.aurel.track.dao.eclipselink;
...
public class DAOFactoryEl extends DAOFactory {
	private static DAOFactoryEl instance;
	...
	public static DAOFactoryEl getInstance(){
		if(instance==null){
			 instance=new DAOFactoryEl();
		}
		return instance;
	}
	...
	public SiteDAO getSiteDAO() {
		if (siteDAO == null) {
			siteDAO = new com.aurel.track.persist.TSitePeer(); // com.trackplus.persist.TSitePeer();
		}
		return siteDAO;
	}
	@Override
