...
public interface ScreenFieldDAO {
	 ...
	 * @return
	 */
	TScreenFieldBean loadByPrimaryKey(Integer objectID);
	
	/**
	 * Loads all fields from TScreenField table 
	 * @return 
	 */
	List<TScreenFieldBean> loadAll();
	 ...
	 * @return
	 */
	Integer save(TScreenFieldBean screenField);
	 ...
	 * @return 
	 */
	List<TScreenFieldBean> loadByParent(Integer parentID);
