...
public interface NotifyFieldDAO {
	 ...
	 * @return
	 */
	Integer save(TNotifyFieldBean notifyFieldBean);
	 ...
	 * @return
	 */
	List<TNotifyFieldBean> getNotifyFieldsForTrigger(Integer triggerID);
	 ...
	 * @return
	 */
	List<TNotifyFieldBean> getNotifyFieldsByKeys(List<Integer> notifyTriggerFieldIDs);
