...
public class StateExporter {
	public EntityContext createContext(TStateBean stateBean){
		EntityContext entityContext = new EntityContext();
		entityContext.setName("TStateBean");
		entityContext.setSerializableLabelBeans(stateBean);

		//dependency
		Integer iconKey=stateBean.getIconKey();
		if(iconKey!=null){
