...
public class SeverityExporter {
	public EntityContext createContext(TSeverityBean severityBean){
		EntityContext entityContext = new EntityContext();
		entityContext.setName("TSeverityBean");
		entityContext.setSerializableLabelBeans(severityBean);

		//dependency
		Integer iconKey=severityBean.getIconKey();
		if(iconKey!=null){
