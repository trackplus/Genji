 ...
 * extended; all references should be to TCardFieldsBean
 */
public abstract class BaseTCardFieldsBean
    implements Serializable
{
    ...
    /**
     * Collection to store aggregation of collTCardFieldOptionsBeans
     */
    protected List<TCardFieldOptionBean> collTCardFieldOptionsBeans;

    /**
     * Returns the collection of TCardFieldOptionsBeans
     */
    public List<TCardFieldOptionBean> getTCardFieldOptionsBeans()
    {
        return collTCardFieldOptionsBeans;
    }

    /**
     * Sets the collection of TCardFieldOptionsBeans to the specified value
     */
    public void setTCardFieldOptionsBeans(List<TCardFieldOptionBean> list)
    {
        if (list == null)
        {
            collTCardFieldOptionsBeans = null;
        }
        else
        {
            collTCardFieldOptionsBeans = new ArrayList<TCardFieldOptionBean>(list);
        }
    }
