 ...
 * extended; all references should be to TConfigOptionsRoleBean
 */
public abstract class BaseTConfigOptionsRoleBean
    implements Serializable
{
     ...
     * @param v new value
     */
    public void setConfigKey(Integer v)
    {
     ...
     * @param v new value
     */
    public void setOptionKey(Integer v)
    {
     ...
     * @param v TOptionBean
     */
    public void setTOptionBean(TOptionBean v)
    {
        if (v == null)
        {
