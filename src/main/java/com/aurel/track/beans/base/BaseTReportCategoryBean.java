 ...
 * extended; all references should be to TReportCategoryBean
 */
public abstract class BaseTReportCategoryBean
    implements Serializable
{
    ...
    private TReportCategoryBean aTReportCategoryBeanRelatedByParentID;
     ...
     */
    public void setTReportCategoryBeanRelatedByParentID(TReportCategoryBean v)
    {
        if (v == null)
        {
        ...
        aTReportCategoryBeanRelatedByParentID = v;
    }
     ...
     */
    public TReportCategoryBean getTReportCategoryBeanRelatedByParentID()
    {
        return aTReportCategoryBeanRelatedByParentID;
    }
