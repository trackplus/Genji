 ...
 * extended; all references should be to TWfActivityContextParamsBean
 */
public abstract class BaseTWfActivityContextParamsBean
    implements Serializable
{
     ...
     * @param v new value
     */
    public void setWorkflowActivity(Integer v)
    {
    ...
    private TWorkflowActivityBean aTWorkflowActivityBean;

    /**
     * sets an associated TWorkflowActivityBean object
     *
     * @param v TWorkflowActivityBean
     */
    public void setTWorkflowActivityBean(TWorkflowActivityBean v)
    {
        if (v == null)
        {
        ...
        aTWorkflowActivityBean = v;
    }


    /**
     * Get the associated TWorkflowActivityBean object
     *
     * @return the associated TWorkflowActivityBean object
     */
    public TWorkflowActivityBean getTWorkflowActivityBean()
    {
        return aTWorkflowActivityBean;
    }
