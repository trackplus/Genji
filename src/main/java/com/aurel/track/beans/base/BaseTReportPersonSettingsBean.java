 ...
 * extended; all references should be to TReportPersonSettingsBean
 */
public abstract class BaseTReportPersonSettingsBean
    implements Serializable
{
    ...
    /**
     * Collection to store aggregation of collTReportParameterBeans
     */
    protected List<TReportParameterBean> collTReportParameterBeans;

    /**
     * Returns the collection of TReportParameterBeans
     */
    public List<TReportParameterBean> getTReportParameterBeans()
    {
        return collTReportParameterBeans;
    }

    /**
     * Sets the collection of TReportParameterBeans to the specified value
     */
    public void setTReportParameterBeans(List<TReportParameterBean> list)
    {
        if (list == null)
        {
            collTReportParameterBeans = null;
        }
        else
        {
            collTReportParameterBeans = new ArrayList<TReportParameterBean>(list);
        }
    }
