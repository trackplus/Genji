 ...
 * extended; all references should be to TScreenPanelBean
 */
    ...
    implements Serializable
{
    ...
    private TScreenTabBean aTScreenTabBean;

    /**
     * sets an associated TScreenTabBean object
     *
     * @param v TScreenTabBean
     */
     ...
     *
     * @return the associated TScreenTabBean object
     */
    public TScreenTabBean getTScreenTabBean()
    {
        return aTScreenTabBean;
    }
