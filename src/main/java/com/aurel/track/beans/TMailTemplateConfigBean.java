 ...
 */
public class TMailTemplateConfigBean
    extends com.aurel.track.beans.base.BaseTMailTemplateConfigBean
    implements Serializable,ConfigItem{

	public Integer getConfigRel() {
		return getEventKey();
	}
	public void setConfigRel(Integer configRel) {
		setEventKey(configRel);
	}
