...
public class BooleanConverter extends DefaultTypeConverter {
	...
	/*public Object convertFromString(Map arg0, String[] arg1, Class arg2) {		
		...
		//why????
		String isChecked = arg1[0];
		if (isChecked!=null && isChecked.equals(BooleanFields.TRUE_VALUE)) {
			return Boolean.TRUE;
		} else {
	...
	/*public String convertToString(Map arg0, Object arg1) {
		...
		String isChecked = (String)arg1;
		if (Boolean.TRUE.toString().equals(isChecked)) {
