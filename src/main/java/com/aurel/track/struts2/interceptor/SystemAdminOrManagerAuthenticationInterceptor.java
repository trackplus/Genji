...
public class SystemAdminOrManagerAuthenticationInterceptor
	implements Interceptor {

	private static final long serialVersionUID = 340L;

	private static final Logger LOGGER = LogManager.getLogger(SystemAdminOrManagerAuthenticationInterceptor.class);
