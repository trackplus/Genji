...
public class DocxTemplateAction extends ActionSupport 
	...
	public String upload() {
		...
		JSONUtility.encodeJSON(servletResponse, DocxTemplateBL.renderSelectAndUploadTemplates(docxTemplateFileName), false);
		return null;
	}
	...
	public String delete() {
		...
		JSONUtility.encodeJSON(servletResponse, DocxTemplateBL.renderSelectAndUploadTemplates(null), false);
		return null;
	}
