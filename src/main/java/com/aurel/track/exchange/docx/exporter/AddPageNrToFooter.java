...
public class AddPageNrToFooter {
	...
	/**
	 * As in the previous example, we create a footer and a paragraph object.
	 * But this time, instead of adding text to a run, we add a field. And just
	 * as with the table of content, we have to add a begin and end character
	 * around the actual field with the page number. Finally we add the
	 * paragraph to the content of the footer and then return it.
	 *
	 * @return
	 */
