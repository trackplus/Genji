...
public class CardScreenDesignJSON extends AbstractScreenJSON{
	...
	protected void appendFieldProperties(FieldWrapper fieldWrapper,StringBuilder sb){
		...
		TCardFieldBean itemField=(TCardFieldBean)itemFieldWrapper.getField();
		...
		JSONUtility.appendIntegerValue(sb,"fieldID",itemFieldWrapper.getFieldID());
		//JSONUtility.appendIntegerValue(sb,"iconRendering",itemField.getIconRendering()==null?0:itemField.getIconRendering());
		super.appendFieldProperties(fieldWrapper, sb);
	}
	@Override
	protected String encodeFieldPropertiesExtra(IField field,String fieldType){
		TCardFieldBean itemField=(TCardFieldBean)field;
		StringBuilder sb=new StringBuilder();
		JSONUtility.appendIntegerValue(sb,"field.iconRendering",itemField.getIconRendering()==null?0:itemField.getIconRendering());
