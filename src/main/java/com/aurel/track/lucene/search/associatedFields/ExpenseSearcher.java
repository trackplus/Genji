 ...
 *
 */
public class ExpenseSearcher extends AbstractAssociatedFieldSearcher {
	
	private static ExpenseSearcher instance;
	/**
	 * Get a singleton instance
	 * @return
	 */
	public static ExpenseSearcher getInstance(){
		if(instance==null){
			instance=new ExpenseSearcher();
		}
		return instance;
	}
	/**
	...
	protected String[] getSearchFieldNames() {
		return new String[] {LuceneUtil.EXPENSE_INDEX_FIELDS.SUBJECT,
				LuceneUtil.EXPENSE_INDEX_FIELDS.DESCRIPTION};
	}
	/**
