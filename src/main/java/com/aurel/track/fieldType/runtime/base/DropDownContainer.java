...
public class DropDownContainer {
	 ...
	 * @return
	 */
	/*public ISerializableLabelBean getDataSourceEntry(String key, Integer objectID) {
		Map<Integer, ILabelBean> dataSourceMap = getDataSourceMap(key);
		if (dataSourceMap!=null && objectID!=null) {
			return (ISerializableLabelBean)dataSourceMap.get(objectID);
		}
		return null;
	}*/
