...
/**
 * Specific validator for build
 * @author Tamas
 *
 */
public class SystemBuildRT extends SystemShortTextRT {
	/**
	 * Max length for Build is 25
	 */
	@Override
	public Map<Integer, List<Validator>> getValidators(Integer fieldID, 
		...
		stringValidator.setMaxLength(Integer.valueOf(25));
