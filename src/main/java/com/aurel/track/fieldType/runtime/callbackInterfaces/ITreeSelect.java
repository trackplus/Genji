...
/**
 * Implemented by groupable tree based selections fields  
 * @author Tamas Ruff
 *
 */
public interface ITreeSelect extends ILookup {
	 ...
	 * @return
	 */
	List<SimpleTreeNode> getSimpleTreeNodesWithCompletePath(List<Integer> involvedValues);
}
