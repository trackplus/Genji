...
public abstract class TreePickerMatcherDT extends SelectMatcherDT {	
	...
	public TreePickerMatcherDT(Integer fieldID) {
		super(fieldID);	
	}
	 ...
	 * @param dataSource: for combos, lists, trees etc. the datasource is loaded in getMatcherDataSource()
	 * @param projectIDs: the selected projects for getting the datasource for project dependent lists/trees
	...
	public String getMatchValueJsonConfig(Integer fieldID, String baseName, Integer index, Object value,
		...
		JSONUtility.appendJSONValue(stringBuilder, JSONUtility.JSON_FIELDS.DATA_SOURCE, 
				JSONUtility.getTreeHierarchyJSON((List<TreeNode>)dataSource, true, getUseSelectable()));
