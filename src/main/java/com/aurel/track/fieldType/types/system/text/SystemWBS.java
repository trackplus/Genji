...
import com.aurel.track.fieldType.design.system.wbs.SystemWBSDT;
 ...
 *
 */
public class SystemWBS extends SystemTextBase {
	...
	public IFieldTypeDT getFieldTypeDT() {
		return new SystemWBSDT(getPluginID());
	}
	
	@Override
	public IFieldTypeRT getFieldTypeRT() {		
		return new SystemWBSRT();
	}
