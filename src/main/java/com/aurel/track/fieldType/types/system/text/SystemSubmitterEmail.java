...
import com.aurel.track.fieldType.design.text.EmaiAddressDT;
...
import com.aurel.track.fieldType.runtime.system.text.SystemSubmitterEmailRT;

public class SystemSubmitterEmail extends SystemTextBase {
	
	@Override
	public IFieldTypeDT getFieldTypeDT() {
		return new EmaiAddressDT(getPluginID());
	}
	
	
	@Override
	public IFieldTypeRT getFieldTypeRT() {		
		return new SystemSubmitterEmailRT();
	}
