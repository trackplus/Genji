...
/**
 * The class for Build system field, and base class for SystemSynopsis
 * The name is not SystemBuild because of the backward compatibility with the data in the TField table
 * @author Tamas
 *
 */
