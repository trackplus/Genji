...
import com.aurel.track.fieldType.runtime.renderer.StartDateRendererRT;
 ...
 *
 */
public class SystemStartDate extends SystemTextBoxDate {
	
	@Override
	public TypeRendererRT getRendererRT() {
		return StartDateRendererRT.getInstance();
	}
