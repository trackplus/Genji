...
import com.aurel.track.fieldType.runtime.renderer.IssueNoRendererRT;
import com.aurel.track.fieldType.runtime.renderer.TypeRendererRT;
import com.aurel.track.fieldType.runtime.system.text.SystemIssueNoRT;

/**
 * FieldType for issueNo
 * @author Tamas
 *
 */
public class SystemLabel extends SystemTextBase {
	...
	public TypeRendererRT getRendererRT() {
		return IssueNoRendererRT.getInstance();
	}
