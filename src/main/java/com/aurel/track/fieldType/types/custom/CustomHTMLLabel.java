...
import com.aurel.track.fieldType.design.text.CustomHTMLLabelDT;
import com.aurel.track.fieldType.runtime.base.IFieldTypeRT;
import com.aurel.track.fieldType.runtime.custom.text.CustomHTMLLabelRT;
import com.aurel.track.fieldType.runtime.renderer.HtmlLabelRendererRT;
import com.aurel.track.fieldType.runtime.renderer.TypeRendererRT;
import com.aurel.track.fieldType.types.FieldType;

public class CustomHTMLLabel extends FieldType {
	...
	public IFieldTypeDT getFieldTypeDT() {
		return new CustomHTMLLabelDT(getPluginID());
	}
	
	@Override
	public IFieldTypeRT getFieldTypeRT() {		
		return new CustomHTMLLabelRT();
	}
	...
	public TypeRendererRT getRendererRT() {
		return HtmlLabelRendererRT.getInstance();
	}
