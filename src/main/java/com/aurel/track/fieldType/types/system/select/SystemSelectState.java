...
import com.aurel.track.fieldType.design.BaseFieldTypeNotRenderHistoryDT;
import com.aurel.track.fieldType.design.IFieldTypeDT;
import com.aurel.track.fieldType.runtime.base.IFieldTypeRT;
import com.aurel.track.fieldType.runtime.renderer.StateRendererRT;
...
public class SystemSelectState extends SystemSelectBase {

	@Override
	public IFieldTypeDT getFieldTypeDT() {
		return new BaseFieldTypeNotRenderHistoryDT(getPluginID());
	}
	
	@Override
	public IFieldTypeRT getFieldTypeRT() {		
		return new SystemStateRT();
	}

	@Override
	public TypeRendererRT getRendererRT() {
		return StateRendererRT.getStateInstance();
	}
}
