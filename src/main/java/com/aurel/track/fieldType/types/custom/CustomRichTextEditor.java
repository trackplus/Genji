...
import com.aurel.track.fieldType.design.renderer.RichTextEditorRendererDT;
...
import com.aurel.track.fieldType.runtime.custom.text.CustomRichTextRT;
import com.aurel.track.fieldType.runtime.renderer.RichTextEditorRendererRT;
import com.aurel.track.fieldType.runtime.renderer.TypeRendererRT;
import com.aurel.track.fieldType.types.FieldType;

public class CustomRichTextEditor extends FieldType{
	...
	public TypeRendererDT getRendererDT() {
		return RichTextEditorRendererDT.getInstance();
	}

	@Override
	public IFieldTypeRT getFieldTypeRT() {
		return new CustomRichTextRT();
	}

	@Override
	public TypeRendererRT getRendererRT() {
		return RichTextEditorRendererRT.getInstance();
	}
}
