...
import com.aurel.track.fieldType.runtime.system.text.SystemLastEditedByRT;

public class SystemLastEditedBy extends SystemLabel {
	...
	public IFieldTypeRT getFieldTypeRT() {		
		return new SystemLastEditedByRT();
	}
	@Override
