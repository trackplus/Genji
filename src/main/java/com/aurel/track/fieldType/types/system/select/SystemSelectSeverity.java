...
import com.aurel.track.fieldType.runtime.renderer.SeverityRendererRT;
...
public class SystemSelectSeverity extends SystemSelectBase {
	@Override
	public IFieldTypeRT getFieldTypeRT() {		
		return new SystemSeverityRT();
	}
	@Override
	public TypeRendererRT getRendererRT() {
		return SeverityRendererRT.getSeverityInstance();
	}
}
