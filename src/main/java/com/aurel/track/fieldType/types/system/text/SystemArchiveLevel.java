...
import com.aurel.track.fieldType.runtime.system.text.SystemArchiveLevelRT;

public class SystemArchiveLevel extends SystemTextBase {
	...
	public IFieldTypeRT getFieldTypeRT() {		
		return new SystemArchiveLevelRT();
	}
