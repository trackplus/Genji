...
import com.aurel.track.fieldType.design.system.check.TaskIsMilestoneDT;
...
import com.aurel.track.fieldType.runtime.system.check.TaskIsMilestoneRT;
import com.aurel.track.fieldType.types.SystemFieldType;

public class SystemTaskIsMilestone extends SystemFieldType {
	...
	public IFieldTypeDT getFieldTypeDT() {
		return new TaskIsMilestoneDT(getPluginID());
	}
