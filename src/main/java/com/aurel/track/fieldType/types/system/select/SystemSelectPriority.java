...
import com.aurel.track.fieldType.runtime.renderer.PriorityRendererRT;
...
public class SystemSelectPriority extends SystemSelectBase {
	...
	public IFieldTypeRT getFieldTypeRT() {		
		return new SystemPriorityRT();
	}

	@Override
	public TypeRendererRT getRendererRT() {
		return PriorityRendererRT.getPriorityInstance();
	}
}
