...
public class CustomSelectParentChildGrandchildDT extends CustomSelectCascadingBaseDT {
	...
	public CustomSelectParentChildGrandchildDT(Integer parameterCode, String pluginID) {
		super(parameterCode, pluginID);		
	}

	public CustomSelectParentChildGrandchildDT(String pluginID) {
		super(pluginID);
	}
	...
	public CascadingHierarchy getCascadingHierarchy() {
		...
		List grandChildList = new ArrayList();
		CascadingHierarchy cascadingHierarchyGrandChild = new CascadingHierarchy();
		cascadingHierarchyGrandChild.setParentID(Integer.valueOf(3));
		grandChildList.add(cascadingHierarchyGrandChild);
		cascadingHierarchyChild.setChildLists(grandChildList);
