 ...
 *
 */
public class BaseFieldTypeNotRenderRequiredAndHistoryDT extends BaseFieldTypeDT {

	public BaseFieldTypeNotRenderRequiredAndHistoryDT(Integer parameterCode,
			String pluginID) {
		super(parameterCode, pluginID);	
	}

	public BaseFieldTypeNotRenderRequiredAndHistoryDT(String pluginID) {
		super(pluginID);
	}
