...
public class AccessLevelDT extends BaseFieldTypeNotRenderRequiredAndHistoryDT {
	
	
	public AccessLevelDT(Integer parameterCode, String pluginID) {
		super(parameterCode, pluginID);		
	}

	public AccessLevelDT(String pluginID) {
		super(pluginID);
	}
