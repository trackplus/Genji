 ...
 */
public class SystemSelectSetterConverter  extends AbstractValueConverter {
	private static final Logger LOGGER = LogManager.getLogger(SystemSelectSetterConverter.class);
	
	public SystemSelectSetterConverter(Integer activityType) {
		super(activityType);
	}
