...
/**
 * Configure field change for archive level field (archive/delete issue)
 * @author Tamas
 *
 */
public class ArchiveLevelFieldChangeConfig extends AbstractFieldChangeConfig {
	
	public ArchiveLevelFieldChangeConfig(Integer fieldID) {
		super(fieldID);
	}
	...
	public List<Integer> getPossibleSetters(boolean required, boolean withParameter) {
		...
		relations.add(Integer.valueOf(FieldChangeSetters.ARCHIVE));
		relations.add(Integer.valueOf(FieldChangeSetters.DELETE));
		relations.add(Integer.valueOf(FieldChangeSetters.UNARCHIVE_UNDELETE));
		return relations;
	}
