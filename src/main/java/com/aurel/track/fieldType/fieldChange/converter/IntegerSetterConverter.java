 ...
 */
public class IntegerSetterConverter  extends AbstractValueConverter {
	
	private static final Logger LOGGER = LogManager.getLogger(IntegerSetterConverter.class);
	
	public IntegerSetterConverter(Integer activityType) {
		super(activityType);
	}
