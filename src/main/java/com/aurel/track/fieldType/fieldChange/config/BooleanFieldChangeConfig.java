...
/**
 * Configure field change for custom boolean fields 
 * @author Tamas
 *
 */
public class BooleanFieldChangeConfig extends AbstractFieldChangeConfig {	
	public BooleanFieldChangeConfig(Integer fieldID) {
		super(fieldID);
	}
	...
	public List<Integer> getPossibleSetters(boolean required, boolean withParameter) {
		...
		setters.add(Integer.valueOf(FieldChangeSetters.SET_TRUE));
		setters.add(Integer.valueOf(FieldChangeSetters.SET_FALSE));		
		return setters;
	}
