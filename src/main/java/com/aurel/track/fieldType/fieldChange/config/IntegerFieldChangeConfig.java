...
/**
 * Configure field change for integer fields
 * @author Tamas
 *
 */
public class IntegerFieldChangeConfig extends AbstractFieldChangeConfig {
	public IntegerFieldChangeConfig(Integer fieldID) {
		super(fieldID);
	}
