...
/**
 * The persistent class for the TPSEVERITY database table.
 * 
 */
@Entity
@Table(name="TPSEVERITY")
@TableGenerator(name="TPSEVERITY_GEN", table="ID_TABLE",
  pkColumnName="ID_TABLE_ID",
  pkColumnValue=BaseEntity.TABLE_PSEVERITY, allocationSize = 10)
public class Tpseverity extends BaseEntity implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(generator="TPSEVERITY_GEN",strategy=GenerationType.TABLE)
