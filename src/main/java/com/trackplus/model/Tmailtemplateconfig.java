...
/**
 * The persistent class for the TMAILTEMPLATECONFIG database table.
 * 
 */
@Entity
@Table(name="TMAILTEMPLATECONFIG")
@TableGenerator(name="TMAILTEMPLATECONFIG_GEN", table="ID_TABLE",
  pkColumnName="ID_TABLE_ID",
  pkColumnValue=BaseEntity.TABLE_MAILTEMPLATECONFIG, allocationSize = 10)
public class Tmailtemplateconfig extends BaseEntity implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(generator="TMAILTEMPLATECONFIG_GEN",strategy=GenerationType.TABLE)
