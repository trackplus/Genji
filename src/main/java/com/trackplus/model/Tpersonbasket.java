...
/**
 * The persistent class for the TPERSONBASKET database table.
 * 
 */
@Entity
@Table(name="TPERSONBASKET")
@TableGenerator(name="TPERSONBASKET_GEN", table="ID_TABLE",
  pkColumnName="ID_TABLE_ID",
  pkColumnValue=BaseEntity.TABLE_PERSONBASKET, allocationSize = 10)
public class Tpersonbasket extends BaseEntity implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(generator="TPERSONBASKET_GEN",strategy=GenerationType.TABLE)
	...
	public void setDelegatetext(String delegatetext) {
		this.delegatetext = delegatetext;
	}
	...
	public void setTbasket(Tbasket tbasket) {
