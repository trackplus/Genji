...
/**
 * The persistent class for the TWORKFLOWCATEGORY database table.
 * 
 */
@Entity
@Table(name="TWORKFLOWCATEGORY")
@TableGenerator(name="TWORKFLOWCATEGORY_GEN", table="ID_TABLE",
  pkColumnName="ID_TABLE_ID",
  pkColumnValue=BaseEntity.TABLE_WORKFLOWCATEGORY, allocationSize = 10)
public class Tworkflowcategory extends BaseEntity implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(generator="TWORKFLOWCATEGORY_GEN",strategy=GenerationType.TABLE)
