...
import com.trackplus.model.Tdashboardtab;
...
public interface DashboardTabDAO {
	 ...
	 * @return
	 */
	Tdashboardtab loadByPrimaryKey(Integer objectID);

	Tdashboardtab loadFullByPrimaryKey(Integer objectID);
	 ...
	 * @return
	 */
	Integer save(Tdashboardtab screenTab);
