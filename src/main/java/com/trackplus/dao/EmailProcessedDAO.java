...
import com.trackplus.model.Temailprocessed;
...
public interface EmailProcessedDAO {
	 ...
	 * @return
	 */
	Temailprocessed loadByPrimaryKey(Integer objectID);
	 ...
	 * @return
	 */
	Integer save(Temailprocessed emailProcessed);

	/**
	 * Deletes a exportTemplate from the TEmailProcessed table Is deletable
