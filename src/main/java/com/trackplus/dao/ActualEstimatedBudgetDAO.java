...
import com.trackplus.model.Tactualestimatedbudget;
...
public interface ActualEstimatedBudgetDAO {
	 ...
	 * @return
	 */
	Tactualestimatedbudget loadByWorkItemKey(Integer objectID);
	 ...
	 * @return
	 */
	List<Tactualestimatedbudget> loadByWorkItemKeys(int[] workItemKeys);
	 ...
	 * @return
	 */
	Integer save(Tactualestimatedbudget actualEstimatedbudgetBean);
