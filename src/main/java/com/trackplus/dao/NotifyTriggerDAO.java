...
import com.trackplus.model.Tnotifytrigger;
...
public interface NotifyTriggerDAO {
	 ...
	 * @return
	 */
	Tnotifytrigger loadByPrimaryKey(Integer objectID);
	 ...
	 * @param personID
	 * @param includeOwn
	 *            whether do we include also the own defined triggers
	 * @return
	 */
	List<Tnotifytrigger> loadSystemAndOwn(Integer personID, boolean includeOwn);

	/**
	 * Loads a list of notifyTriggerBeans set for any project: for the personID
	 * (own) or those not linked to any person (default)
	 * 
	 * @param personID
	 * @return
	 */
	List<Tnotifytrigger> loadByOwnOrDefaultNotifySettings(Integer personID);

	/**
	 * Loads a list of notifyTriggerBeans set for any project which is not
	 * linked to any person (default)
	 * 
	 * @return
	 */
	List<Tnotifytrigger> loadByDefaultNotifySettings();
	 ...
	 * @return
	 */
	Integer save(Tnotifytrigger notifyTriggerBean);
