...
import com.trackplus.model.Tscreenfield;

/**
 * DAO for ScreenField object
 * 
...
public interface ScreenFieldDAO {
	 ...
	 * @return
	 */
	Tscreenfield loadByPrimaryKey(Integer objectID);
	 ...
	 * @return
	 */
	Integer save(Tscreenfield screenField);
	 ...
	 * @return
	 */
	List<Tscreenfield> loadByParent(Integer parentID);
	 ...
	 * @return
	 */
	Tscreenfield loadByParentAndIndex(Integer parentID, Integer row, Integer col);
