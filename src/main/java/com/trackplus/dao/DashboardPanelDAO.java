...
import com.trackplus.model.Tdashboardpanel;

/**
 */
public interface DashboardPanelDAO {
	/**
	 * Gets a screenPanelBean from the TDashboardPanel table
	 * 
	 * @param objectID
	 * @return
	 */
	Tdashboardpanel loadByPrimaryKey(Integer objectID);

	Tdashboardpanel loadFullByPrimaryKey(Integer objectID);
	 ...
	 * @return
	 */
	Integer save(Tdashboardpanel screenPanel);
